...
_onScroll : function(e, oSelf) {
    ...
    if(oSelf.disableOnScrollCount > 0){
    	oSelf.disableOnScrollCount--;
    	return;
    }
...
move : function() {
    ...
    var windowStart = Dom.getX(this._oDataTable._elContainer);
    var windowEnd = this._oDataTable._elHdContainer.offsetWidth - elTd.offsetWidth;
		 if (x > windowEnd  )
    {
			 this._oDataTable.disableOnScrollCount ++;
			 this._oDataTable._elBdContainer.scrollLeft += x - windowEnd;
   	 this._oDataTable._elHdContainer.scrollLeft = this._oDataTable._elBdContainer.scrollLeft;
      x = Dom.getX(elTd);
    }
		 if (x < windowStart )
    {
			  this._oDataTable.disableOnScrollCount ++;
		   	this._oDataTable._elBdContainer.scrollLeft -=  windowStart - x;
	    	this._oDataTable._elHdContainer.scrollLeft = this._oDataTable._elBdContainer.scrollLeft;
       x = Dom.getX(elTd);
    }
