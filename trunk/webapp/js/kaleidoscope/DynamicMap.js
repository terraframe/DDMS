...
(function(){
  ...
  var DynamicMapName = 'ddms.'+'DynamicMap';
  ...
  */
  ...
  var DynamicMap = Mojo.Meta.newClass('ddms.'+'DynamicMap', {
  ...
  var DataType = Mojo.Meta.newClass('ddms.'+'DataType', {
  ...
  var AbstractAttribute = Mojo.Meta.newClass('ddms.'+'AbstractAttribute', {
