  ...
  function StyleCategoryOntology($timeout, $compile) {
    return {
      ...
      link: function (scope, element, attrs, ctrl) {
        ...
        var tree = new dss.vector.solutions.kaleidoscope.ontology.OntologyTree({
          termType : "dss.vector.solutions.kaleidoscope.ontology.Classifier",
          relationshipTypes : [ "dss.vector.solutions.kaleidoscope.ontology.ClassifierIsARelationship" ],
          rootTerms : rootTerms,
          editable : false,
          slide : false,
          selectable : false,
  ...
  function LayerLabel($timeout) {
   ...
   function LayerAggregationController($scope) {
     ...
     controller.showAggregationMethods = function() {
       ...
       return (strategy != null && strategy.type === 'dss.vector.solutions.kaleidoscope.dashboard.UniversalAggregationStrategy');
     }
   }   
      ...
      $scope.getGeographicAggregationOptions = function(geoNodeId){
         ...
         */
         ...
         $scope._setLayerTypeOptions = function(value) {
           ...
           if(type === "dss.vector.solutions.kaleidoscope.dashboard.UniversalAggregationStrategy"){
           ...
           else if (type === "dss.vector.solutions.kaleidoscope.dashboard.GeometryAggregationStrategy"){
             for(var i=0; i<layerTypesJSON.length; i++){
               var lType = layerTypesJSON[i];
