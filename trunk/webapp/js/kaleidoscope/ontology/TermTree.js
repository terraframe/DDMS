...
(function(){
  ...
  var termTreeName = 'dss.vector.solutions.kaleidoscope.ontology.TermTree';
  ...
  var tree = Mojo.Meta.newClass('dss.vector.solutions.kaleidoscope.ontology.TermNodeLabel', {
    Instance : {
  ...
  var tree = Mojo.Meta.newClass('dss.vector.solutions.kaleidoscope.ontology.TermNode', {
    Instance : {
      initialize : function(id, label, type) {
         ...
         */
        this.id = id;
        this.label = new dss.vector.solutions.kaleidoscope.ontology.TermNodeLabel(label);
        this._type = type;
  ...
  Mojo.Meta.newClass('dss.vector.solutions.kaleidoscope.ontology.NodeMap', {
    Instance : {
  ...
  /**
   * @class dss.vector.solutions.kaleidoscope.ontology.TermTree A wrapper around JQuery widget jqTree to allow for integration with Term objects.
   * 
   * @constructs
   * @param Object config
  ...
  var tree = Mojo.Meta.newClass(termTreeName, {
    ...
    Instance : {
      ...
      initialize : function(config) {
        ...
        this._nodeMap = new dss.vector.solutions.kaleidoscope.ontology.NodeMap(this);
      ...
      refreshRoots : function()
      {
        ...
        for (var i = 0; i < this._config.rootTerms.length; ++i)
        {
          ...
          if (Mojo.Util.isObject(rootTerm))
          {
            ...
            if (term instanceof com.runwaysdk.business.TermDTO || term instanceof dss.vector.solutions.kaleidoscope.ontology.TermNode)
            {
...
//        }
      ...
      _createNodes : function (parentNode, nodes) {
        ...
        for(var i = 0; i < nodes.length; i++) {
          ...
          if(this.__getNodesById(node.id) == null) {
            ...
            var term = new dss.vector.solutions.kaleidoscope.ontology.TermNode(node.id, node.label, node.type);
  ...
  /**
   * @class dss.vector.solutions.kaleidoscope.ontology.ParentRelationshipCache A parent relationship cache that maps a childId to known parent records.
   */
  var ParentRelationshipCache = Mojo.Meta.newClass('dss.vector.solutions.kaleidoscope.ontology.ParentRelationshipCache', {
