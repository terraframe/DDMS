...
(function(){  
  ...
  var universalTreeName = "dss.vector.solutions.kaleidoscope.ontology.UniversalTree";
  ...
  var universalTree = ClassFramework.newClass(universalTreeName, {
    ...
    Instance : {
      ...
      initialize : function(config) {
        ...
        config.exportMenuType = "dss.vector.solutions.kaleidoscope.ontology.UniversalExportMenu";
        
        this.$initialize(config);
        
        this._wrapperDiv = this.getFactory().newElement("div");
        
        this._subtypeMap = new dss.vector.solutions.kaleidoscope.ontology.NodeMap(this);
      },
