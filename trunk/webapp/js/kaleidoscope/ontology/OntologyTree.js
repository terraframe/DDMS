...
(function(){  
  ...
  var ontologyTreeName = "dss.vector.solutions.kaleidoscope.ontology.OntologyTree";
  var TermTree = dss.vector.solutions.kaleidoscope.ontology.TermTree;
  ...
  Mojo.Meta.newClass('dss.vector.solutions.kaleidoscope.ontology.RefreshQueue', {
    Instance : {
  ...
  var ontologyTree = ClassFramework.newClass(ontologyTreeName, {
    ...
    Instance : {
      ...
      initialize : function(config) {
        ...
        config.exportMenuType = "dss.vector.solutions.kaleidoscope.ontology.ClassifierExportMenu";
          ...
          var okHandler = Mojo.Util.bind(this, function() {
            var request = new Mojo.ClientRequest({
              onSuccess : function(idsToUpdate) {
                var queue = new dss.vector.solutions.kaleidoscope.ontology.RefreshQueue(that, idsToUpdate);
                queue.start();
            ...
            dss.vector.solutions.kaleidoscope.ontology.Classifier.makeSynonym(request, movedNodeId, targetNodeId);            
          });          
      ...
      refreshTerm : function(termId, callback, nodes, pageNum) {
        ...
        if (parent.data != null && parent.data.isSynonymContainer) {
          ...
          Mojo.Util.invokeControllerAction("dss.vector.solutions.kaleidoscope.ontology.ClassifierSynonym", "getDirectDescendants", {parentId: parentId}, cr);
        }
        else {
      ...
      __onCreateSynonym : function(contextMenu, contextMenuItem, mouseEvent) {
        ...
        new com.runwaysdk.ui.RunwayControllerFormDialog({
          type: "dss.vector.solutions.kaleidoscope.ontology.ClassifierSynonym",
          action: "create",
      ...
      __onRestoreSynonym : function(contextMenu, contextMenuItem, mouseEvent) {
        ...
        var okHandler = Mojo.Util.bind(this, function() {
          ...
          dss.vector.solutions.kaleidoscope.ontology.Classifier.restoreSynonym(request, dto.getId());
        });          
      ...
      deleteProblem : function(termId, problemId) {
        ...
        dss.vector.solutions.kaleidoscope.ontology.Classifier.deleteClassifierProblem(request, problemId);
      },
      ...
      refreshClassifierProblems : function(callback) {
        ...
        dss.vector.solutions.kaleidoscope.ontology.Classifier.getAllProblems(request);
      },
      ...
      focusTerm : function(termId) {
        ...
        if(nodes == null) {
          ...
          dss.vector.solutions.kaleidoscope.ontology.Classifier.getClassifierTree(request, termId);
        }
        else {
          for(var i = 0; i < nodes.length; i++) {
            var node = nodes[i];
