...
(function(){  
  ...
  var geoentityTreeName = "dss.vector.solutions.kaleidoscope.ontology.GeoEntityTree";
  ...
  var geoentityTree = ClassFramework.newClass(geoentityTreeName, {
    ...
    Instance : {
      ...
      initialize : function(config) {
        ...
        config.exportMenuType = "dss.vector.solutions.kaleidoscope.ontology.GeoEntityExportMenu";
      ...
      deleteProblem : function(termId, problemId) {
        ...
        dss.vector.solutions.kaleidoscope.ontology.GeoEntityUtil.deleteEntityProblem(request, problemId);
      },
      ...
      _createNodeMoveMenu : function(event) {
        ...
        var mergeHandler = function(mouseEvent, contextMenu) {
          ...
          var okHandler = Mojo.Util.bind(this, function() {
            ...
            dss.vector.solutions.kaleidoscope.ontology.GeoEntityUtil.makeSynonym(request, movedNodeId, targetNodeId);            
          });          
      ...
      __onRestoreSynonym : function(contextMenu, contextMenuItem, mouseEvent) {
        ...
        var okHandler = Mojo.Util.bind(this, function() {
          ...
          dss.vector.solutions.kaleidoscope.ontology.GeoEntityUtil.restoreSynonym(request, dto.getId());
        });          
      ...
      focusTerm : function(termId) {
        ...
        if(nodes == null) {
          ...
          dss.vector.solutions.kaleidoscope.ontology.GeoEntityUtil.getGeoEntityTree(request, termId);
        }
        else {
          for(var i = 0; i < nodes.length; i++) {
            var node = nodes[i];
      ...
      refreshEntityProblems : function(callback) {
        ...
        dss.vector.solutions.kaleidoscope.ontology.GeoEntityUtil.getAllProblems(request);
      },
