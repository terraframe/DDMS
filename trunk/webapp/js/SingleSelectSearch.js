...
YAHOO.util.Event.onDOMReady(function(){
    ...
    function showGeoInfo(selected,currentGeoIdInput,valid)
    {
  ...
  for(var i=0; i<geoInputs.length; i++)
  {
    ...
    var request = new MDSS.Request({
      ...
      onFailure: function(){},
      onSuccess : function(result){
     	 showGeoInfo(result,this.geoInput,true);
      }
    });

    Mojo.$.dss.vector.solutions.geo.generated.GeoEntity.getViewByGeoId(request, geoInput.value);
