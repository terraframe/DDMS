Mojo.Meta.newClass('MDSS.QueryIRS', {
  ...
  Instance : {
    ...
    {
      return 'dss.vector.solutions.query.QueryController.exportIRSQueryToExcel.mojo';
    },

    _getExportCSVAction : function()
    {
      return 'dss.vector.solutions.query.QueryController.exportIRSQueryToCSV.mojo';
    },
...
//      xml = $('debug_xml').value;
    ...
    _buildQueryItems : function(selectableGroups)
    {
      ...
      this._queryPanel.addQueryItem({
        html: this._getCountDiv(this,"Group_By",Mojo.$.dss.vector.solutions.irs.SprayStatus,true),
        id: 'globalCount'
      });
