...
//        this._request = new net.geoprism.BlockingClientRequest({onSuccess: Util.bind(this, this._onSuccess), onFailure: Util.bind(this, this._onFailure)});
      ...
      _onClickSubmit : function() {
        ...
        var request = new MDSS.Request({onSuccess: Util.bind(this, this._onSuccess), onFailure: Util.bind(this, this._onFailure)});
      ...
      getHtmlFromController : function() {
        ...
        this._viewRequest = new MDSS.Request({onSuccess: Util.bind(this, this._onViewSuccess), onFailure: Util.bind(this, this._onFailure)});
