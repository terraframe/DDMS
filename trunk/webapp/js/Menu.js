...
YAHOO.util.Event.onContentReady("navmenu", function() {
	var ua = YAHOO.env.ua, oAnim; // Animation instance
		...
		/*
		 * "beforeshow" event handler for each submenu of the MenuBar instance,
		 * used to setup certain style properties before the menu is animated.
		 */
		...
		function onSubmenuBeforeShow(p_sType, p_sArgs) {
			...
			if (this.parent) {
				...
				/*
				 * Get a reference to the Menu's shadow element and set its
				 * "height" property to "0px" to syncronize it with the height
				...
				/*
				 * Stop the Animation instance if it is currently animating a
				 * Menu.
				 */
				...
				/*
				 * Set the body element's "overflow" property to "hidden" to
				 * clip the display of its negatively positioned <ul> element.
				 */
 ...
 * of the element in the page representing the MenuBar; the second is an object
