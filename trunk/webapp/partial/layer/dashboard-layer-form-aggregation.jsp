...
<div id="agg-level-holder" class="row-holder">
  <div class="label-holder style03">
    <strong><mdss:localize key="DashboardThematicLayer.form.defineAggMeth"/></strong>
  </div>
  <div class="holder add">
  
    <!-- Aggregation level (i.e. country, state, city, etc...) -->
    <div class="box">
      <label><mdss:localize key="DashboardThematicLayer.form.groupBy"/></label>
    ...
    <div class="box" ng-show="ctrl.showAggregationMethods()">
      <label><mdss:localize key="DashboardThematicLayer.form.accordingTo"/></label>
