      ...
      <form class="modal-form" name="ctrl.form">    
        <div class="modal-dialog">
          <div class="modal-content" show-on-ready>
            <div class="heading">
              <h1><mdss:localize key="dataset.editTooltip"/></h1>
            </div>      
            <fieldset>            
              ...
              <div class="row-holder">
                <div class="label-holder">
                  <label><mdss:localize key="dataset.label"/></label>
                </div>          
                <div class="holder" >
                  <span class="text">
              ...
              <div class="row-holder">
                <div class="label-holder">
                  <label><mdss:localize key="dataset.attributes"/></label>
                </div>          
                <div class="holder" >
                        ...
                        <td class="submit-form">
                          <dl>
                            ...
                            <dd ng-if="attribute.type == 'Category'">
                              <mdss:localize key="dataset.category"/> <a ng-click="ctrl.open(attribute.root)" title="<mdss:localize key="category.management.editThisCategoryTooltip"/>">{{attribute.root.label}}</a>
                            </dd>
                          </dl>
                        </td>
                      </tr>
