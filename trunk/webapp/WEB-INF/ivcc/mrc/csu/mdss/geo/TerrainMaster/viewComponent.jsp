...
<mjl:form name="ivcc.mrc.csu.mdss.geo.TerrainMaster.form.name" id="ivcc.mrc.csu.mdss.geo.TerrainMaster.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="ivcc.mrc.csu.mdss.geo.TerrainMasterController.edit.mojo" name="ivcc.mrc.csu.mdss.geo.TerrainMaster.form.edit.button" />
  <br />
</mjl:form>
<dl>
  <dt>
...
<mjl:commandLink display="View All" action="ivcc.mrc.csu.mdss.geo.TerrainMasterController.viewAll.mojo" name="ivcc.mrc.csu.mdss.geo.TerrainMaster.viewAll.link" />
