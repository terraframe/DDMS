...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.CollectionMethod.form.name" id="ivcc.mrc.csu.mdss.entomology.CollectionMethod.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.entomology.CollectionMethodController.create.mojo" name="ivcc.mrc.csu.mdss.entomology.CollectionMethod.form.create.button" />
</mjl:form>
