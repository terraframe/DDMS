...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.assay.molecular.EKDRTestResult.form.name" id="ivcc.mrc.csu.mdss.entomology.assay.molecular.EKDRTestResult.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="ivcc.mrc.csu.mdss.entomology.assay.molecular.EKDRTestResultController.edit.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.molecular.EKDRTestResult.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="ivcc.mrc.csu.mdss.entomology.assay.molecular.EKDRTestResultController.viewAll.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.molecular.EKDRTestResult.viewAll.link" />
