...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.ResistantCutOff.form.name" id="ivcc.mrc.csu.mdss.entomology.ResistantCutOff.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.entomology.ResistantCutOffController.create.mojo" name="ivcc.mrc.csu.mdss.entomology.ResistantCutOff.form.create.button" />
</mjl:form>
