...
<mjl:table var="item" query="${query}">
  <mjl:context action="ivcc.mrc.csu.mdss.entomology.MosquitoCollectionController.viewPage.mojo" />
  <mjl:columns>
...
<br />
<mjl:commandLink display="Create a new Mosquito Collection" action="ivcc.mrc.csu.mdss.entomology.MosquitoCollectionController.newInstance.mojo" name="MosquitoCollectionController.newInstance" />
