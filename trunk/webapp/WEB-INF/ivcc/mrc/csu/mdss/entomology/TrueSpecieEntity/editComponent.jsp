...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.TrueSpecieEntity.form.name" id="ivcc.mrc.csu.mdss.entomology.TrueSpecieEntity.form.id" method="POST">
  ...
  <mjl:command value="Update" action="ivcc.mrc.csu.mdss.entomology.TrueSpecieEntityController.update.mojo" name="ivcc.mrc.csu.mdss.entomology.TrueSpecieEntity.form.update.button" />
  <mjl:command value="Delete" action="ivcc.mrc.csu.mdss.entomology.TrueSpecieEntityController.delete.mojo" name="ivcc.mrc.csu.mdss.entomology.TrueSpecieEntity.form.delete.button" />
  <mjl:command value="Cancel" action="ivcc.mrc.csu.mdss.entomology.TrueSpecieEntityController.cancel.mojo" name="ivcc.mrc.csu.mdss.entomology.TrueSpecieEntity.form.cancel.button" />
</mjl:form>
