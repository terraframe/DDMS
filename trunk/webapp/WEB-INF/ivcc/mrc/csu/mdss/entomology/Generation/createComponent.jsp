...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.Generation.form.name" id="ivcc.mrc.csu.mdss.entomology.Generation.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.entomology.GenerationController.create.mojo" name="ivcc.mrc.csu.mdss.entomology.Generation.form.create.button" />
</mjl:form>
