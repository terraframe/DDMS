...
<mjl:table var="item" query="${query}">
  <mjl:context action="ivcc.mrc.csu.mdss.entomology.assay.AdultAssayController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="ivcc.mrc.csu.mdss.entomology.assay.AdultAssayController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Adult Assay" action="ivcc.mrc.csu.mdss.entomology.assay.AdultAssayController.newInstance.mojo" name="AdultAssayController.newInstance" />
