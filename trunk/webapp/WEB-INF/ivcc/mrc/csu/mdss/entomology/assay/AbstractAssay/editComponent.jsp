...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.assay.AbstractAssay.form.name" id="ivcc.mrc.csu.mdss.entomology.assay.AbstractAssay.form.id" method="POST">
  ...
  <mjl:command value="Update" action="ivcc.mrc.csu.mdss.entomology.assay.AbstractAssayController.update.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.AbstractAssay.form.update.button" />
  <mjl:command value="Delete" action="ivcc.mrc.csu.mdss.entomology.assay.AbstractAssayController.delete.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.AbstractAssay.form.delete.button" />
  <mjl:command value="Cancel" action="ivcc.mrc.csu.mdss.entomology.assay.AbstractAssayController.cancel.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.AbstractAssay.form.cancel.button" />
</mjl:form>
