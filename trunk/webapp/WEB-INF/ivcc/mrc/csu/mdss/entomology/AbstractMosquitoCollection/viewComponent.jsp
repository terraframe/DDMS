...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.AbstractMosquitoCollection.form.name" id="ivcc.mrc.csu.mdss.entomology.AbstractMosquitoCollection.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="ivcc.mrc.csu.mdss.entomology.AbstractMosquitoCollectionController.edit.mojo" name="ivcc.mrc.csu.mdss.entomology.AbstractMosquitoCollection.form.edit.button" />
  <br />
</mjl:form>
<dl>
  <dt>
...
<mjl:commandLink display="View All" action="ivcc.mrc.csu.mdss.entomology.AbstractMosquitoCollectionController.viewAll.mojo" name="ivcc.mrc.csu.mdss.entomology.AbstractMosquitoCollection.viewAll.link" />
