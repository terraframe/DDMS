...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.IdentificationMethod.form.name" id="ivcc.mrc.csu.mdss.entomology.IdentificationMethod.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.entomology.IdentificationMethodController.create.mojo" name="ivcc.mrc.csu.mdss.entomology.IdentificationMethod.form.create.button" />
</mjl:form>
