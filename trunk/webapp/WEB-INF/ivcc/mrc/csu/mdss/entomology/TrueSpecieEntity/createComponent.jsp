...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.TrueSpecieEntity.form.name" id="ivcc.mrc.csu.mdss.entomology.TrueSpecieEntity.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.entomology.TrueSpecieEntityController.create.mojo" name="ivcc.mrc.csu.mdss.entomology.TrueSpecieEntity.form.create.button" />
</mjl:form>
