...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.MosquitoCollectionPoint.form.name" id="ivcc.mrc.csu.mdss.entomology.MosquitoCollectionPoint.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.entomology.MosquitoCollectionPointController.create.mojo" name="ivcc.mrc.csu.mdss.entomology.MosquitoCollectionPoint.form.create.button" />
</mjl:form>
