...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.assay.biochemical.GSTTestResult.form.name" id="ivcc.mrc.csu.mdss.entomology.assay.biochemical.GSTTestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.entomology.assay.biochemical.GSTTestResultController.create.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.biochemical.GSTTestResult.form.create.button" />
</mjl:form>
