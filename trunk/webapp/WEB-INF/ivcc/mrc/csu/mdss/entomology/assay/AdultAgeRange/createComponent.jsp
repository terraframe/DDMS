...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.assay.AdultAgeRange.form.name" id="ivcc.mrc.csu.mdss.entomology.assay.AdultAgeRange.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.entomology.assay.AdultAgeRangeController.create.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.AdultAgeRange.form.create.button" />
</mjl:form>
