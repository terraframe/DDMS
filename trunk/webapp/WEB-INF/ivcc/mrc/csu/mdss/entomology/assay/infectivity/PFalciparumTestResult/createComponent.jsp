...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.assay.infectivity.PFalciparumTestResult.form.name" id="ivcc.mrc.csu.mdss.entomology.assay.infectivity.PFalciparumTestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.entomology.assay.infectivity.PFalciparumTestResultController.create.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.infectivity.PFalciparumTestResult.form.create.button" />
</mjl:form>
