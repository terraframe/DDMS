...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.Insecticide.form.name" id="ivcc.mrc.csu.mdss.entomology.Insecticide.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.entomology.InsecticideController.create.mojo" name="ivcc.mrc.csu.mdss.entomology.Insecticide.form.create.button" />
</mjl:form>
