...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.MorphologicalSpecieGroup.form.name" id="ivcc.mrc.csu.mdss.entomology.MorphologicalSpecieGroup.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.entomology.MorphologicalSpecieGroupController.create.mojo" name="ivcc.mrc.csu.mdss.entomology.MorphologicalSpecieGroup.form.create.button" />
</mjl:form>
