...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.assay.biochemical.GSTTestResult.form.name" id="ivcc.mrc.csu.mdss.entomology.assay.biochemical.GSTTestResult.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="ivcc.mrc.csu.mdss.entomology.assay.biochemical.GSTTestResultController.edit.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.biochemical.GSTTestResult.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="ivcc.mrc.csu.mdss.entomology.assay.biochemical.GSTTestResultController.viewAll.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.biochemical.GSTTestResult.viewAll.link" />
