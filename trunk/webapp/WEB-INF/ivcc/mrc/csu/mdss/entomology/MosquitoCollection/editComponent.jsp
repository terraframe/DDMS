...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.MosquitoCollection.form.name" id="ivcc.mrc.csu.mdss.entomology.MosquitoCollection.form.id" method="POST">
  ...
  <mjl:command value="Update" action="ivcc.mrc.csu.mdss.entomology.MosquitoCollectionController.update.mojo" name="ivcc.mrc.csu.mdss.entomology.MosquitoCollection.form.update.button" />
  <mjl:command value="Delete" action="ivcc.mrc.csu.mdss.entomology.MosquitoCollectionController.delete.mojo" name="ivcc.mrc.csu.mdss.entomology.MosquitoCollection.form.delete.button" />
  <mjl:command value="Cancel" action="ivcc.mrc.csu.mdss.entomology.MosquitoCollectionController.cancel.mojo" name="ivcc.mrc.csu.mdss.entomology.MosquitoCollection.form.cancel.button" />
</mjl:form>
