...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.ResistantCutOff.form.name" id="ivcc.mrc.csu.mdss.entomology.ResistantCutOff.form.id" method="POST">
  ...
  <mjl:command value="Update" action="ivcc.mrc.csu.mdss.entomology.ResistantCutOffController.update.mojo" name="ivcc.mrc.csu.mdss.entomology.ResistantCutOff.form.update.button" />
  <mjl:command value="Delete" action="ivcc.mrc.csu.mdss.entomology.ResistantCutOffController.delete.mojo" name="ivcc.mrc.csu.mdss.entomology.ResistantCutOff.form.delete.button" />
  <mjl:command value="Cancel" action="ivcc.mrc.csu.mdss.entomology.ResistantCutOffController.cancel.mojo" name="ivcc.mrc.csu.mdss.entomology.ResistantCutOff.form.cancel.button" />
</mjl:form>
