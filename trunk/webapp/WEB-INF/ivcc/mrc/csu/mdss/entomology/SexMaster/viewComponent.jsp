...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.SexMaster.form.name" id="ivcc.mrc.csu.mdss.entomology.SexMaster.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="ivcc.mrc.csu.mdss.entomology.SexMasterController.edit.mojo" name="ivcc.mrc.csu.mdss.entomology.SexMaster.form.edit.button" />
  <br />
</mjl:form>
<dl>
  <dt>
...
<mjl:commandLink display="View All" action="ivcc.mrc.csu.mdss.entomology.SexMasterController.viewAll.mojo" name="ivcc.mrc.csu.mdss.entomology.SexMaster.viewAll.link" />
