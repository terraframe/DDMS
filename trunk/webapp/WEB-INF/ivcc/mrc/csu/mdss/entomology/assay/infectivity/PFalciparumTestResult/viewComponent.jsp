...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.assay.infectivity.PFalciparumTestResult.form.name" id="ivcc.mrc.csu.mdss.entomology.assay.infectivity.PFalciparumTestResult.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="ivcc.mrc.csu.mdss.entomology.assay.infectivity.PFalciparumTestResultController.edit.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.infectivity.PFalciparumTestResult.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="ivcc.mrc.csu.mdss.entomology.assay.infectivity.PFalciparumTestResultController.viewAll.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.infectivity.PFalciparumTestResult.viewAll.link" />
