...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.assay.molecular.EKDRTestResult.form.name" id="ivcc.mrc.csu.mdss.entomology.assay.molecular.EKDRTestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.entomology.assay.molecular.EKDRTestResultController.create.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.molecular.EKDRTestResult.form.create.button" />
</mjl:form>
