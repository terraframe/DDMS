...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.assay.infectivity.PMalariaeTestResult.form.name" id="ivcc.mrc.csu.mdss.entomology.assay.infectivity.PMalariaeTestResult.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="ivcc.mrc.csu.mdss.entomology.assay.infectivity.PMalariaeTestResultController.edit.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.infectivity.PMalariaeTestResult.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="ivcc.mrc.csu.mdss.entomology.assay.infectivity.PMalariaeTestResultController.viewAll.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.infectivity.PMalariaeTestResult.viewAll.link" />
