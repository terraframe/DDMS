...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.MorphologicalSpecieGroup.form.name" id="ivcc.mrc.csu.mdss.entomology.MorphologicalSpecieGroup.form.id" method="POST">
  ...
  <mjl:command value="Update" action="ivcc.mrc.csu.mdss.entomology.MorphologicalSpecieGroupController.update.mojo" name="ivcc.mrc.csu.mdss.entomology.MorphologicalSpecieGroup.form.update.button" />
  <mjl:command value="Delete" action="ivcc.mrc.csu.mdss.entomology.MorphologicalSpecieGroupController.delete.mojo" name="ivcc.mrc.csu.mdss.entomology.MorphologicalSpecieGroup.form.delete.button" />
  <mjl:command value="Cancel" action="ivcc.mrc.csu.mdss.entomology.MorphologicalSpecieGroupController.cancel.mojo" name="ivcc.mrc.csu.mdss.entomology.MorphologicalSpecieGroup.form.cancel.button" />
</mjl:form>
