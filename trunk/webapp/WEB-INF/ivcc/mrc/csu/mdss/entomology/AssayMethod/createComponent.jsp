...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.AssayMethod.form.name" id="ivcc.mrc.csu.mdss.entomology.AssayMethod.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.entomology.AssayMethodController.create.mojo" name="ivcc.mrc.csu.mdss.entomology.AssayMethod.form.create.button" />
</mjl:form>
