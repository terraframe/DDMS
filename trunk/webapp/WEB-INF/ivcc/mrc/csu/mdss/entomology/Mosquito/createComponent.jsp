...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.Mosquito.form.name" id="ivcc.mrc.csu.mdss.entomology.Mosquito.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.entomology.MosquitoController.create.mojo" name="ivcc.mrc.csu.mdss.entomology.Mosquito.form.create.button" />
</mjl:form>
