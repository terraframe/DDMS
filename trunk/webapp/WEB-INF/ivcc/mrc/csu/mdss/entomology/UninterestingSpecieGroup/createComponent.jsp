...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.UninterestingSpecieGroup.form.name" id="ivcc.mrc.csu.mdss.entomology.UninterestingSpecieGroup.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.entomology.UninterestingSpecieGroupController.create.mojo" name="ivcc.mrc.csu.mdss.entomology.UninterestingSpecieGroup.form.create.button" />
</mjl:form>
