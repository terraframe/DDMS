...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.SexMaster.form.name" id="ivcc.mrc.csu.mdss.entomology.SexMaster.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.entomology.SexMasterController.create.mojo" name="ivcc.mrc.csu.mdss.entomology.SexMaster.form.create.button" />
</mjl:form>
