...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.assay.AdultAssay.form.name" id="ivcc.mrc.csu.mdss.entomology.assay.AdultAssay.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.entomology.assay.AdultAssayController.create.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.AdultAssay.form.create.button" />
</mjl:form>
