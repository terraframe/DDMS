...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.assay.AdultDiscriminatingDoseAssay.form.name" id="ivcc.mrc.csu.mdss.entomology.assay.AdultDiscriminatingDoseAssay.form.id" method="POST">
  <mjl:component item="${item}" param="dto">
   ...
   <mjl:command value="Update" action="ivcc.mrc.csu.mdss.entomology.assay.AdultDiscriminatingDoseAssayController.update.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.AdultDiscriminatingDoseAssay.form.update.button" />
  <mjl:command value="Delete" action="ivcc.mrc.csu.mdss.entomology.assay.AdultDiscriminatingDoseAssayController.delete.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.AdultDiscriminatingDoseAssay.form.delete.button" />
  <mjl:command value="Cancel" action="ivcc.mrc.csu.mdss.entomology.assay.AdultDiscriminatingDoseAssayController.cancel.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.AdultDiscriminatingDoseAssay.form.cancel.button" />
</mjl:form>
