...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.Mosquito.form.name" id="ivcc.mrc.csu.mdss.entomology.Mosquito.form.id" method="POST">
  ...
  <mjl:command value="Update" action="ivcc.mrc.csu.mdss.entomology.MosquitoController.update.mojo" name="ivcc.mrc.csu.mdss.entomology.Mosquito.form.update.button" />
  <mjl:command value="Delete" action="ivcc.mrc.csu.mdss.entomology.MosquitoController.delete.mojo" name="ivcc.mrc.csu.mdss.entomology.Mosquito.form.delete.button" />
  <mjl:command value="Cancel" action="ivcc.mrc.csu.mdss.entomology.MosquitoController.cancel.mojo" name="ivcc.mrc.csu.mdss.entomology.Mosquito.form.cancel.button" />
</mjl:form>
