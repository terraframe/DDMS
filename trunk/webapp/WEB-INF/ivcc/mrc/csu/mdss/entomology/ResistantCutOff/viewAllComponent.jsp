...
<mjl:table var="item" query="${query}">
  <mjl:context action="ivcc.mrc.csu.mdss.entomology.ResistantCutOffController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="ivcc.mrc.csu.mdss.entomology.ResistantCutOffController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Property" action="ivcc.mrc.csu.mdss.entomology.ResistantCutOffController.newInstance.mojo" name="ResistantCutOffController.newInstance" />
