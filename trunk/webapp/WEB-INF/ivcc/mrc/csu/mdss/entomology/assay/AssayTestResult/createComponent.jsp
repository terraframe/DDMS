...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.assay.AssayTestResult.form.name" id="ivcc.mrc.csu.mdss.entomology.assay.AssayTestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.entomology.assay.AssayTestResultController.create.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.AssayTestResult.form.create.button" />
</mjl:form>
