...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.assay.AdultDiscriminatingDoseAssay.form.name" id="ivcc.mrc.csu.mdss.entomology.assay.AdultDiscriminatingDoseAssay.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.entomology.assay.AdultDiscriminatingDoseAssayController.create.mojo" name="ivcc.mrc.csu.mdss.entomology.assay.AdultDiscriminatingDoseAssay.form.create.button" />
</mjl:form>
