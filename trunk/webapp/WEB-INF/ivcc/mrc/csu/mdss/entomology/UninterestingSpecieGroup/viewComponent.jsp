...
<mjl:form name="ivcc.mrc.csu.mdss.entomology.UninterestingSpecieGroup.form.name" id="ivcc.mrc.csu.mdss.entomology.UninterestingSpecieGroup.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="ivcc.mrc.csu.mdss.entomology.UninterestingSpecieGroupController.edit.mojo" name="ivcc.mrc.csu.mdss.entomology.UninterestingSpecieGroup.form.edit.button" />
  <br />
</mjl:form>
<dl>
  <dt>
...
<mjl:commandLink display="View All" action="ivcc.mrc.csu.mdss.entomology.UninterestingSpecieGroupController.viewAll.mojo" name="ivcc.mrc.csu.mdss.entomology.UninterestingSpecieGroup.viewAll.link" />
