...
<mjl:table var="item" query="${query}">
  <mjl:context action="ivcc.mrc.csu.mdss.entomology.assay.AdultDiscriminatingDoseAssayController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="ivcc.mrc.csu.mdss.entomology.assay.AdultDiscriminatingDoseAssayController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Adult Discriminating Dose Assay" action="ivcc.mrc.csu.mdss.entomology.assay.AdultDiscriminatingDoseAssayController.newInstance.mojo" name="AdultDiscriminatingDoseAssayController.newInstance" />
