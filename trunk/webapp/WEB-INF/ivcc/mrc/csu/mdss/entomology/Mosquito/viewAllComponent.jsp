...
<mjl:table var="item" query="${query}">
  <mjl:context action="ivcc.mrc.csu.mdss.entomology.MosquitoController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="ivcc.mrc.csu.mdss.entomology.MosquitoController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Mosquito" action="ivcc.mrc.csu.mdss.entomology.MosquitoController.newInstance.mojo" name="MosquitoController.newInstance" />
