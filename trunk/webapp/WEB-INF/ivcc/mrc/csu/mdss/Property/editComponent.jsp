...
<mjl:form name="ivcc.mrc.csu.mdss.Property.form.name" id="ivcc.mrc.csu.mdss.Property.form.id" method="POST">
  ...
  <mjl:command value="Update" action="ivcc.mrc.csu.mdss.PropertyController.update.mojo" name="ivcc.mrc.csu.mdss.Property.form.update.button" />
  <mjl:command value="Delete" action="ivcc.mrc.csu.mdss.PropertyController.delete.mojo" name="ivcc.mrc.csu.mdss.Property.form.delete.button" />
  <mjl:command value="Cancel" action="ivcc.mrc.csu.mdss.PropertyController.cancel.mojo" name="ivcc.mrc.csu.mdss.Property.form.cancel.button" />
</mjl:form>
