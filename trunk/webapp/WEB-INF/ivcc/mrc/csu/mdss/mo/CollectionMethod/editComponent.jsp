...
<mjl:form name="ivcc.mrc.csu.mdss.mo.CollectionMethod.form.name" id="ivcc.mrc.csu.mdss.mo.CollectionMethod.form.id" method="POST">
  ...
  <mjl:command value="Update" action="ivcc.mrc.csu.mdss.mo.CollectionMethodController.update.mojo" name="ivcc.mrc.csu.mdss.mo.CollectionMethod.form.update.button" />
  <mjl:command value="Delete" action="ivcc.mrc.csu.mdss.mo.CollectionMethodController.delete.mojo" name="ivcc.mrc.csu.mdss.mo.CollectionMethod.form.delete.button" />
  <mjl:command value="Cancel" action="ivcc.mrc.csu.mdss.mo.CollectionMethodController.cancel.mojo" name="ivcc.mrc.csu.mdss.mo.CollectionMethod.form.cancel.button" />
</mjl:form>
