...
<mjl:form name="ivcc.mrc.csu.mdss.mo.InsecticideMethodology.form.name" id="ivcc.mrc.csu.mdss.mo.InsecticideMethodology.form.id" method="POST">
  ...
  <mjl:command value="Update" action="ivcc.mrc.csu.mdss.mo.InsecticideMethodologyController.update.mojo" name="ivcc.mrc.csu.mdss.mo.InsecticideMethodology.form.update.button" />
  <mjl:command value="Delete" action="ivcc.mrc.csu.mdss.mo.InsecticideMethodologyController.delete.mojo" name="ivcc.mrc.csu.mdss.mo.InsecticideMethodology.form.delete.button" />
  <mjl:command value="Cancel" action="ivcc.mrc.csu.mdss.mo.InsecticideMethodologyController.cancel.mojo" name="ivcc.mrc.csu.mdss.mo.InsecticideMethodology.form.cancel.button" />
</mjl:form>
