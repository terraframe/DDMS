...
<mjl:form name="ivcc.mrc.csu.mdss.mo.IdentificationMethod.form.name" id="ivcc.mrc.csu.mdss.mo.IdentificationMethod.form.id" method="POST">
  ...
  <mjl:command value="Update" action="ivcc.mrc.csu.mdss.mo.IdentificationMethodController.update.mojo" name="ivcc.mrc.csu.mdss.mo.IdentificationMethod.form.update.button" />
  <mjl:command value="Delete" action="ivcc.mrc.csu.mdss.mo.IdentificationMethodController.delete.mojo" name="ivcc.mrc.csu.mdss.mo.IdentificationMethod.form.delete.button" />
  <mjl:command value="Cancel" action="ivcc.mrc.csu.mdss.mo.IdentificationMethodController.cancel.mojo" name="ivcc.mrc.csu.mdss.mo.IdentificationMethod.form.cancel.button" />
</mjl:form>
