...
<mjl:form name="ivcc.mrc.csu.mdss.mo.Insecticide.form.name" id="ivcc.mrc.csu.mdss.mo.Insecticide.form.id" method="POST">
  ...
  <mjl:command value="Update" action="ivcc.mrc.csu.mdss.mo.InsecticideController.update.mojo" name="ivcc.mrc.csu.mdss.mo.Insecticide.form.update.button" />
  <mjl:command value="Delete" action="ivcc.mrc.csu.mdss.mo.InsecticideController.delete.mojo" name="ivcc.mrc.csu.mdss.mo.Insecticide.form.delete.button" />
  <mjl:command value="Cancel" action="ivcc.mrc.csu.mdss.mo.InsecticideController.cancel.mojo" name="ivcc.mrc.csu.mdss.mo.Insecticide.form.cancel.button" />
</mjl:form>
