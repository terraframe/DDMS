...
<mjl:form name="ivcc.mrc.csu.mdss.mo.Specie.form.name" id="ivcc.mrc.csu.mdss.mo.Specie.form.id" method="POST">
  ...
  <mjl:command value="Update" action="ivcc.mrc.csu.mdss.mo.SpecieController.update.mojo" name="ivcc.mrc.csu.mdss.mo.Specie.form.update.button" />
  <mjl:command value="Delete" action="ivcc.mrc.csu.mdss.mo.SpecieController.delete.mojo" name="ivcc.mrc.csu.mdss.mo.Specie.form.delete.button" />
  <mjl:command value="Cancel" action="ivcc.mrc.csu.mdss.mo.SpecieController.cancel.mojo" name="ivcc.mrc.csu.mdss.mo.Specie.form.cancel.button" />
</mjl:form>
