...
<mjl:form name="ivcc.mrc.csu.mdss.mo.BiochemicalMethodology.form.name" id="ivcc.mrc.csu.mdss.mo.BiochemicalMethodology.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.mo.BiochemicalMethodologyController.create.mojo" name="ivcc.mrc.csu.mdss.mo.BiochemicalMethodology.form.create.button" />
</mjl:form>
