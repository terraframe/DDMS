...
<mjl:form name="ivcc.mrc.csu.mdss.mo.MolecularAssayResult.form.name" id="ivcc.mrc.csu.mdss.mo.MolecularAssayResult.form.id" method="POST">
  ...
  <mjl:command value="Update" action="ivcc.mrc.csu.mdss.mo.MolecularAssayResultController.update.mojo" name="ivcc.mrc.csu.mdss.mo.MolecularAssayResult.form.update.button" />
  <mjl:command value="Delete" action="ivcc.mrc.csu.mdss.mo.MolecularAssayResultController.delete.mojo" name="ivcc.mrc.csu.mdss.mo.MolecularAssayResult.form.delete.button" />
  <mjl:command value="Cancel" action="ivcc.mrc.csu.mdss.mo.MolecularAssayResultController.cancel.mojo" name="ivcc.mrc.csu.mdss.mo.MolecularAssayResult.form.cancel.button" />
</mjl:form>
