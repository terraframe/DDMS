...
<mjl:form name="ivcc.mrc.csu.mdss.mo.InsecticideMethodology.form.name" id="ivcc.mrc.csu.mdss.mo.InsecticideMethodology.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.mo.InsecticideMethodologyController.create.mojo" name="ivcc.mrc.csu.mdss.mo.InsecticideMethodology.form.create.button" />
</mjl:form>
