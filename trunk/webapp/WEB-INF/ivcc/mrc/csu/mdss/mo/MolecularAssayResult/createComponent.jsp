...
<mjl:form name="ivcc.mrc.csu.mdss.mo.MolecularAssayResult.form.name" id="ivcc.mrc.csu.mdss.mo.MolecularAssayResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.mo.MolecularAssayResultController.create.mojo" name="ivcc.mrc.csu.mdss.mo.MolecularAssayResult.form.create.button" />
</mjl:form>
