...
<mjl:form name="ivcc.mrc.csu.mdss.mo.InfectivityMethodology.form.name" id="ivcc.mrc.csu.mdss.mo.InfectivityMethodology.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.mo.InfectivityMethodologyController.create.mojo" name="ivcc.mrc.csu.mdss.mo.InfectivityMethodology.form.create.button" />
</mjl:form>
