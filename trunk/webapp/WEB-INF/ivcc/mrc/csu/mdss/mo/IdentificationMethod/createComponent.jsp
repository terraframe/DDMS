...
<mjl:form name="ivcc.mrc.csu.mdss.mo.IdentificationMethod.form.name" id="ivcc.mrc.csu.mdss.mo.IdentificationMethod.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.mo.IdentificationMethodController.create.mojo" name="ivcc.mrc.csu.mdss.mo.IdentificationMethod.form.create.button" />
</mjl:form>
