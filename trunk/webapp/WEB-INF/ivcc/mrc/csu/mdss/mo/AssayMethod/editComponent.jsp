...
<mjl:form name="ivcc.mrc.csu.mdss.mo.AssayMethod.form.name" id="ivcc.mrc.csu.mdss.mo.AssayMethod.form.id" method="POST">
  ...
  <mjl:command value="Update" action="ivcc.mrc.csu.mdss.mo.AssayMethodController.update.mojo" name="ivcc.mrc.csu.mdss.mo.AssayMethod.form.update.button" />
  <mjl:command value="Delete" action="ivcc.mrc.csu.mdss.mo.AssayMethodController.delete.mojo" name="ivcc.mrc.csu.mdss.mo.AssayMethod.form.delete.button" />
  <mjl:command value="Cancel" action="ivcc.mrc.csu.mdss.mo.AssayMethodController.cancel.mojo" name="ivcc.mrc.csu.mdss.mo.AssayMethod.form.cancel.button" />
</mjl:form>
