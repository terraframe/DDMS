...
<mjl:form name="ivcc.mrc.csu.mdss.mo.BiochemicalMethodology.form.name" id="ivcc.mrc.csu.mdss.mo.BiochemicalMethodology.form.id" method="POST">
  ...
  <mjl:command value="Update" action="ivcc.mrc.csu.mdss.mo.BiochemicalMethodologyController.update.mojo" name="ivcc.mrc.csu.mdss.mo.BiochemicalMethodology.form.update.button" />
  <mjl:command value="Delete" action="ivcc.mrc.csu.mdss.mo.BiochemicalMethodologyController.delete.mojo" name="ivcc.mrc.csu.mdss.mo.BiochemicalMethodology.form.delete.button" />
  <mjl:command value="Cancel" action="ivcc.mrc.csu.mdss.mo.BiochemicalMethodologyController.cancel.mojo" name="ivcc.mrc.csu.mdss.mo.BiochemicalMethodology.form.cancel.button" />
</mjl:form>
