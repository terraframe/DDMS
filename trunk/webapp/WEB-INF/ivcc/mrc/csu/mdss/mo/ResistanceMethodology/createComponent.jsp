...
<mjl:form name="ivcc.mrc.csu.mdss.mo.ResistanceMethodology.form.name" id="ivcc.mrc.csu.mdss.mo.ResistanceMethodology.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.mo.ResistanceMethodologyController.create.mojo" name="ivcc.mrc.csu.mdss.mo.ResistanceMethodology.form.create.button" />
</mjl:form>
