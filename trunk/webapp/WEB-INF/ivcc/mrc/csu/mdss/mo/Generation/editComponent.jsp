...
<mjl:form name="ivcc.mrc.csu.mdss.mo.Generation.form.name" id="ivcc.mrc.csu.mdss.mo.Generation.form.id" method="POST">
  ...
  <mjl:command value="Update" action="ivcc.mrc.csu.mdss.mo.GenerationController.update.mojo" name="ivcc.mrc.csu.mdss.mo.Generation.form.update.button" />
  <mjl:command value="Delete" action="ivcc.mrc.csu.mdss.mo.GenerationController.delete.mojo" name="ivcc.mrc.csu.mdss.mo.Generation.form.delete.button" />
  <mjl:command value="Cancel" action="ivcc.mrc.csu.mdss.mo.GenerationController.cancel.mojo" name="ivcc.mrc.csu.mdss.mo.Generation.form.cancel.button" />
</mjl:form>
