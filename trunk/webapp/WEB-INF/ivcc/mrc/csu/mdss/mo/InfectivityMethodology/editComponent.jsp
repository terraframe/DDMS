...
<mjl:form name="ivcc.mrc.csu.mdss.mo.InfectivityMethodology.form.name" id="ivcc.mrc.csu.mdss.mo.InfectivityMethodology.form.id" method="POST">
  ...
  <mjl:command value="Update" action="ivcc.mrc.csu.mdss.mo.InfectivityMethodologyController.update.mojo" name="ivcc.mrc.csu.mdss.mo.InfectivityMethodology.form.update.button" />
  <mjl:command value="Delete" action="ivcc.mrc.csu.mdss.mo.InfectivityMethodologyController.delete.mojo" name="ivcc.mrc.csu.mdss.mo.InfectivityMethodology.form.delete.button" />
  <mjl:command value="Cancel" action="ivcc.mrc.csu.mdss.mo.InfectivityMethodologyController.cancel.mojo" name="ivcc.mrc.csu.mdss.mo.InfectivityMethodology.form.cancel.button" />
</mjl:form>
