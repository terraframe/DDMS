...
<mjl:form name="ivcc.mrc.csu.mdss.mo.ResistanceMethodology.form.name" id="ivcc.mrc.csu.mdss.mo.ResistanceMethodology.form.id" method="POST">
  ...
  <mjl:command value="Update" action="ivcc.mrc.csu.mdss.mo.ResistanceMethodologyController.update.mojo" name="ivcc.mrc.csu.mdss.mo.ResistanceMethodology.form.update.button" />
  <mjl:command value="Delete" action="ivcc.mrc.csu.mdss.mo.ResistanceMethodologyController.delete.mojo" name="ivcc.mrc.csu.mdss.mo.ResistanceMethodology.form.delete.button" />
  <mjl:command value="Cancel" action="ivcc.mrc.csu.mdss.mo.ResistanceMethodologyController.cancel.mojo" name="ivcc.mrc.csu.mdss.mo.ResistanceMethodology.form.cancel.button" />
</mjl:form>
