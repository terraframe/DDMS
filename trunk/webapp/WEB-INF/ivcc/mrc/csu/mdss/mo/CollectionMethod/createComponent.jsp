...
<mjl:form name="ivcc.mrc.csu.mdss.mo.CollectionMethod.form.name" id="ivcc.mrc.csu.mdss.mo.CollectionMethod.form.id" method="POST">
  ...
  <mjl:command value="Create" action="ivcc.mrc.csu.mdss.mo.CollectionMethodController.create.mojo" name="ivcc.mrc.csu.mdss.mo.CollectionMethod.form.create.button" />
</mjl:form>
