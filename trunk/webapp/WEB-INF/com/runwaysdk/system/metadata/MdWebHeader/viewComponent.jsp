...
<c:set scope="request" var="page_title" value="View_MdWebHeader" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="com.runwaysdk.system.metadata.MdWebHeader.form.id" name="com.runwaysdk.system.metadata.MdWebHeader.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.system.metadata.MdWebHeader.form.edit.button" value="Edit" action="com.runwaysdk.system.metadata.MdWebHeaderController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="com.runwaysdk.system.metadata.MdWebHeader.viewAll.link" action="com.runwaysdk.system.metadata.MdWebHeaderController.viewAll.mojo">
