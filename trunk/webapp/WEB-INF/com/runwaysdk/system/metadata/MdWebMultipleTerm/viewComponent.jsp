...
<c:set scope="request" var="page_title" value="View_MdWebMultipleTerm" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="com.runwaysdk.system.metadata.MdWebMultipleTerm.form.id" name="com.runwaysdk.system.metadata.MdWebMultipleTerm.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.system.metadata.MdWebMultipleTerm.form.edit.button" value="Edit" action="com.runwaysdk.system.metadata.MdWebMultipleTermController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="com.runwaysdk.system.metadata.MdWebMultipleTerm.viewAll.link" action="com.runwaysdk.system.metadata.MdWebMultipleTermController.viewAll.mojo">
