...
<c:set scope="request" var="page_title" value="View_All_MdWebForm" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<mjl:table classes="displayTable" var="item" query="${query}" even="evenRow" odd="oddRow">
  <mjl:context action="com.runwaysdk.system.metadata.MdWebFormController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink name="view.link" action="com.runwaysdk.system.metadata.MdWebFormController.view.mojo">
...
<br />
<mjl:commandLink name="MdWebFormController.newInstance" action="com.runwaysdk.system.metadata.MdWebFormController.newInstance.mojo">
