...
<c:set scope="request" var="page_title" value="View_All_MdWebBreak" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<mjl:table classes="displayTable" var="item" query="${query}" even="evenRow" odd="oddRow">
  <mjl:context action="com.runwaysdk.system.metadata.MdWebBreakController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink name="view.link" action="com.runwaysdk.system.metadata.MdWebBreakController.view.mojo">
...
<br />
<mjl:commandLink name="MdWebBreakController.newInstance" action="com.runwaysdk.system.metadata.MdWebBreakController.newInstance.mojo">
