...
<c:set scope="request" var="page_title" value="View_All_MdWebMoment" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<mjl:table classes="displayTable" var="item" query="${query}" even="evenRow" odd="oddRow">
  <mjl:context action="com.runwaysdk.system.metadata.MdWebMomentController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink name="view.link" action="com.runwaysdk.system.metadata.MdWebMomentController.view.mojo">
...
<br />
<mjl:commandLink name="MdWebMomentController.newInstance" action="com.runwaysdk.system.metadata.MdWebMomentController.newInstance.mojo">
  <mdss:localize key="Create_a_new_MdWebMoment" />
</mjl:commandLink>
