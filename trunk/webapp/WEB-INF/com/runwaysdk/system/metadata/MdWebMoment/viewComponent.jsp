...
<c:set scope="request" var="page_title" value="View_MdWebMoment" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="com.runwaysdk.system.metadata.MdWebMoment.form.id" name="com.runwaysdk.system.metadata.MdWebMoment.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.system.metadata.MdWebMoment.form.edit.button" value="Edit" action="com.runwaysdk.system.metadata.MdWebMomentController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="com.runwaysdk.system.metadata.MdWebMoment.viewAll.link" action="com.runwaysdk.system.metadata.MdWebMomentController.viewAll.mojo">
