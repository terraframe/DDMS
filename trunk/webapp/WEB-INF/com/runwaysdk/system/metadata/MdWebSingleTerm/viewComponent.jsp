...
<c:set scope="request" var="page_title" value="View_MdWebSingleTerm" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="com.runwaysdk.system.metadata.MdWebSingleTerm.form.id" name="com.runwaysdk.system.metadata.MdWebSingleTerm.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.system.metadata.MdWebSingleTerm.form.edit.button" value="Edit" action="com.runwaysdk.system.metadata.MdWebSingleTermController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="com.runwaysdk.system.metadata.MdWebSingleTerm.viewAll.link" action="com.runwaysdk.system.metadata.MdWebSingleTermController.viewAll.mojo">
