...
<c:set scope="request" var="page_title" value="View_MdWebDouble" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="com.runwaysdk.system.metadata.MdWebDouble.form.id" name="com.runwaysdk.system.metadata.MdWebDouble.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.system.metadata.MdWebDouble.form.edit.button" value="Edit" action="com.runwaysdk.system.metadata.MdWebDoubleController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="com.runwaysdk.system.metadata.MdWebDouble.viewAll.link" action="com.runwaysdk.system.metadata.MdWebDoubleController.viewAll.mojo">
