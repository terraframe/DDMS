...
<mjl:form id="com.runwaysdk.system.metadata.WebGridField.form.id" name="com.runwaysdk.system.metadata.WebGridField.form.name" method="POST">
  <dl>
    ...
    <mjl:command name="com.runwaysdk.system.metadata.WebGridField.form.newInstance.button" value="New Instance" action="com.runwaysdk.system.metadata.WebGridFieldController.newInstance.mojo" />
  </dl>
</mjl:form>
