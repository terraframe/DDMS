...
<c:set scope="request" var="page_title" value="View_MdWebField" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="com.runwaysdk.system.metadata.MdWebField.form.id" name="com.runwaysdk.system.metadata.MdWebField.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.system.metadata.MdWebField.form.edit.button" value="Edit" action="com.runwaysdk.system.metadata.MdWebFieldController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="com.runwaysdk.system.metadata.MdWebField.viewAll.link" action="com.runwaysdk.system.metadata.MdWebFieldController.viewAll.mojo">
