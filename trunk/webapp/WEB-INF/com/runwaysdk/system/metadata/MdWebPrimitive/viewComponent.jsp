...
<c:set scope="request" var="page_title" value="View_MdWebPrimitive" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="com.runwaysdk.system.metadata.MdWebPrimitive.form.id" name="com.runwaysdk.system.metadata.MdWebPrimitive.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.system.metadata.MdWebPrimitive.form.edit.button" value="Edit" action="com.runwaysdk.system.metadata.MdWebPrimitiveController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="com.runwaysdk.system.metadata.MdWebPrimitive.viewAll.link" action="com.runwaysdk.system.metadata.MdWebPrimitiveController.viewAll.mojo">
