...
<c:set scope="request" var="page_title" value="View_MdWebDec" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="com.runwaysdk.system.metadata.MdWebDec.form.id" name="com.runwaysdk.system.metadata.MdWebDec.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.system.metadata.MdWebDec.form.edit.button" value="Edit" action="com.runwaysdk.system.metadata.MdWebDecController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="com.runwaysdk.system.metadata.MdWebDec.viewAll.link" action="com.runwaysdk.system.metadata.MdWebDecController.viewAll.mojo">
