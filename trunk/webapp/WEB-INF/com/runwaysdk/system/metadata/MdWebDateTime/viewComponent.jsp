...
<c:set scope="request" var="page_title" value="View_MdWebDateTime" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="com.runwaysdk.system.metadata.MdWebDateTime.form.id" name="com.runwaysdk.system.metadata.MdWebDateTime.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.system.metadata.MdWebDateTime.form.edit.button" value="Edit" action="com.runwaysdk.system.metadata.MdWebDateTimeController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="com.runwaysdk.system.metadata.MdWebDateTime.viewAll.link" action="com.runwaysdk.system.metadata.MdWebDateTimeController.viewAll.mojo">
