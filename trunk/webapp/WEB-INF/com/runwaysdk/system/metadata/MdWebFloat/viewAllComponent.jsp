...
<c:set scope="request" var="page_title" value="View_All_MdWebFloat" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<mjl:table classes="displayTable" var="item" query="${query}" even="evenRow" odd="oddRow">
  <mjl:context action="com.runwaysdk.system.metadata.MdWebFloatController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink name="view.link" action="com.runwaysdk.system.metadata.MdWebFloatController.view.mojo">
...
<br />
<mjl:commandLink name="MdWebFloatController.newInstance" action="com.runwaysdk.system.metadata.MdWebFloatController.newInstance.mojo">
