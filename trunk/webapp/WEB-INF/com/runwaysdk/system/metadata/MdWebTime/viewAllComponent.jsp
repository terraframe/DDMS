...
<c:set scope="request" var="page_title" value="View_All_MdWebTime" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<mjl:table classes="displayTable" var="item" query="${query}" even="evenRow" odd="oddRow">
  <mjl:context action="com.runwaysdk.system.metadata.MdWebTimeController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink name="view.link" action="com.runwaysdk.system.metadata.MdWebTimeController.view.mojo">
...
<br />
<mjl:commandLink name="MdWebTimeController.newInstance" action="com.runwaysdk.system.metadata.MdWebTimeController.newInstance.mojo">
  <mdss:localize key="Create_a_new_MdWebTime" />
</mjl:commandLink>
