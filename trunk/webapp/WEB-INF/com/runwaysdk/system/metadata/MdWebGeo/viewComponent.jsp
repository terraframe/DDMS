...
<c:set scope="request" var="page_title" value="View_MdWebGeo" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="com.runwaysdk.system.metadata.MdWebGeo.form.id" name="com.runwaysdk.system.metadata.MdWebGeo.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.system.metadata.MdWebGeo.form.edit.button" value="Edit" action="com.runwaysdk.system.metadata.MdWebGeoController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="com.runwaysdk.system.metadata.MdWebGeo.viewAll.link" action="com.runwaysdk.system.metadata.MdWebGeoController.viewAll.mojo">
