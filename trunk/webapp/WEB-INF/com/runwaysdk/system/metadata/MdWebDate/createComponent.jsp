...
<dl>
  <mjl:form id="com.runwaysdk.system.metadata.MdWebDate.form.id" name="com.runwaysdk.system.metadata.MdWebDate.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.system.metadata.MdWebDate.form.create.button" value="${Create_Localize}" action="com.runwaysdk.system.metadata.MdWebDateController.create.mojo" />
  </mjl:form>
</dl>
