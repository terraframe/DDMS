...
<c:set scope="request" var="page_title" value="View_MdWebDate" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="com.runwaysdk.system.metadata.MdWebDate.form.id" name="com.runwaysdk.system.metadata.MdWebDate.form.name" method="POST">
    ...
    <mjl:command name="com.runwaysdk.system.metadata.MdWebDate.form.edit.button" value="Edit" action="com.runwaysdk.system.metadata.MdWebDateController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="com.runwaysdk.system.metadata.MdWebDate.viewAll.link" action="com.runwaysdk.system.metadata.MdWebDateController.viewAll.mojo">
