...
<%=Halp.loadTypes((List<String>) Arrays.asList(new String[]{"dss.vector.solutions.geo.UnknownGeoEntity", "dss.vector.solutions.geo.GeoSynonym"}))%>
    ...
    <div class="pageTitle"><fmt:message key="Synonym_Finder" /></div>
      ...
      <ul>
        ...
        <li>
          <dl>
            <dt>
              ${unknownGeoEntity.entityTypeMd.displayLabel}<br />
            </dt>
            <dd>
              ${unknownGeoEntity.entityType}<br />
            </dd>
            <dt>
              ${unknownGeoEntity.entityNameMd.displayLabel}<br />
            </dt>
            <dd>
              ${unknownGeoEntity.entityName}<br />
            </dd>
            <dt>
              ${unknownGeoEntity.knownHierarchyMd.displayLabel}<br />
            </dt>
            <dd>
              ${unknownGeoEntity.knownHierarchy}<br />
            </dd>
            <dt>
              ${unknownGeoEntity.synonymsMd.displayLabel}<br />
            </dt>
            <dd>
              <input type="hidden" id="${unknownGeoEntity.id}_entityName" value="${unknownGeoEntity.entityName}" />
              <select id="${unknownGeoEntity.id}" class="possibleMatches">
              ...
              <input type="button" id="${unknownGeoEntity.id}_save" class="saveSynonym" value="${saveLocalized}" />
            </dd>
          </dl>
        </li> 
        </c:forEach>
