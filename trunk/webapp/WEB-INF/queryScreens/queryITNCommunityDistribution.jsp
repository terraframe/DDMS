...
<%
    ...
    String[] queryTypes = new String[]{EpiDateDTO.CLASS, LayerViewDTO.CLASS, SavedSearchDTO.CLASS, SavedSearchViewDTO.CLASS, QueryController.CLASS, QueryBuilderDTO.CLASS};
