...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <mjl:form name="mdss.test.GeoEntity.form.name" id="mdss.test.GeoEntity.form.id" method="POST">
      ...
      <mjl:command value="Update" action="mdss.test.GeoEntityController.update.mojo" name="mdss.test.GeoEntity.form.update.button" />
      <mjl:command value="Delete" action="mdss.test.GeoEntityController.delete.mojo" name="mdss.test.GeoEntity.form.delete.button" />
      <mjl:command value="Cancel" action="mdss.test.GeoEntityController.cancel.mojo" name="mdss.test.GeoEntity.form.cancel.button" />
    </mjl:form>
  </body>
</html>
