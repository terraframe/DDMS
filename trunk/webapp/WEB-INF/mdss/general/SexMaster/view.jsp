...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <mjl:form name="mdss.general.SexMaster.form.name" id="mdss.general.SexMaster.form.id" method="POST">
      ...
      <mjl:command value="Edit" action="mdss.general.SexMasterController.edit.mojo" name="mdss.general.SexMaster.form.edit.button" />
      <br />
    </mjl:form>
    <dl>
      <dt>
    ...
    <mjl:commandLink display="View All" action="mdss.general.SexMasterController.viewAll.mojo" name="mdss.general.SexMaster.viewAll.link" />
  </body>
</html>
