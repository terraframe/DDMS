...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <mjl:form name="mdss.entomology.UninterestingSpecieGroup.form.name" id="mdss.entomology.UninterestingSpecieGroup.form.id" method="POST">
      ...
      <mjl:command value="Edit" action="mdss.entomology.UninterestingSpecieGroupController.edit.mojo" name="mdss.entomology.UninterestingSpecieGroup.form.edit.button" />
      <br />
    </mjl:form>
    <dl>
      <dt>
    ...
    <mjl:commandLink display="View All" action="mdss.entomology.UninterestingSpecieGroupController.viewAll.mojo" name="mdss.entomology.UninterestingSpecieGroup.viewAll.link" />
  </body>
</html>
