...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <mjl:form name="mdss.entomology.UninterestingSpecieGroup.form.name" id="mdss.entomology.UninterestingSpecieGroup.form.id" method="POST">
      ...
      <mjl:command value="Update" action="mdss.entomology.UninterestingSpecieGroupController.update.mojo" name="mdss.entomology.UninterestingSpecieGroup.form.update.button" />
      <mjl:command value="Delete" action="mdss.entomology.UninterestingSpecieGroupController.delete.mojo" name="mdss.entomology.UninterestingSpecieGroup.form.delete.button" />
      <mjl:command value="Cancel" action="mdss.entomology.UninterestingSpecieGroupController.cancel.mojo" name="mdss.entomology.UninterestingSpecieGroup.form.cancel.button" />
    </mjl:form>
  </body>
</html>
