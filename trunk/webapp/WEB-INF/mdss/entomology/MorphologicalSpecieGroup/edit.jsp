...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <mjl:form name="mdss.entomology.MorphologicalSpecieGroup.form.name" id="mdss.entomology.MorphologicalSpecieGroup.form.id" method="POST">
      ...
      <mjl:command value="Update" action="mdss.entomology.MorphologicalSpecieGroupController.update.mojo" name="mdss.entomology.MorphologicalSpecieGroup.form.update.button" />
      <mjl:command value="Delete" action="mdss.entomology.MorphologicalSpecieGroupController.delete.mojo" name="mdss.entomology.MorphologicalSpecieGroup.form.delete.button" />
      <mjl:command value="Cancel" action="mdss.entomology.MorphologicalSpecieGroupController.cancel.mojo" name="mdss.entomology.MorphologicalSpecieGroup.form.cancel.button" />
    </mjl:form>
  </body>
</html>
