  ...
  <body>
    ...
    <dl>
      ...
      <dd>
        <ul>
          <li>
            <mjl:commandLink display="Abstract Mosqito Collection" action="mdss.entomology.CollectionSpecieController.childQuery.mojo" name="mdss.entomology.CollectionSpecie.childQuery.link">
