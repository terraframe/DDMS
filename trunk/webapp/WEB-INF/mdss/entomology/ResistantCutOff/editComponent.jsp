...
<mjl:form name="mdss.entomology.ResistantCutOff.form.name" id="mdss.entomology.ResistantCutOff.form.id" method="POST">
  ...
  <mjl:command value="Update" action="mdss.entomology.ResistantCutOffController.update.mojo" name="mdss.entomology.ResistantCutOff.form.update.button" />
  <mjl:command value="Delete" action="mdss.entomology.ResistantCutOffController.delete.mojo" name="mdss.entomology.ResistantCutOff.form.delete.button" />
  <mjl:command value="Cancel" action="mdss.entomology.ResistantCutOffController.cancel.mojo" name="mdss.entomology.ResistantCutOff.form.cancel.button" />
</mjl:form>
