...
<mjl:form name="mdss.entomology.MosquitoCollection.search" method="POST">
  <dl>
    <dt> Geo Id </dt>
...
<div class="bd">
<form method="POST" action="mdss.entomology.MosquitoCollectionController.create.mojax" name="mdss.entomology.MosquitoCollection.form.name" id="mdss.entomology.MosquitoCollection.form.id" >
