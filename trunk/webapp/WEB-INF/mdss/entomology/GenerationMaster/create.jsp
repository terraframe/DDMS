...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <mjl:form name="mdss.entomology.GenerationMaster.form.name" id="mdss.entomology.GenerationMaster.form.id" method="POST">
      ...
      <mjl:command value="Create" action="mdss.entomology.GenerationMasterController.create.mojo" name="mdss.entomology.GenerationMaster.form.create.button" />
    </mjl:form>
  </body>
</html>
