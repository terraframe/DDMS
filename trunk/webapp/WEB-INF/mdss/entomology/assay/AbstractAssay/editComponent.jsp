...
<mjl:form name="mdss.entomology.assay.AbstractAssay.form.name" id="mdss.entomology.assay.AbstractAssay.form.id" method="POST">
  ...
  <mjl:command value="Update" action="mdss.entomology.assay.AbstractAssayController.update.mojo" name="mdss.entomology.assay.AbstractAssay.form.update.button" />
  <mjl:command value="Delete" action="mdss.entomology.assay.AbstractAssayController.delete.mojo" name="mdss.entomology.assay.AbstractAssay.form.delete.button" />
  <mjl:command value="Cancel" action="mdss.entomology.assay.AbstractAssayController.cancel.mojo" name="mdss.entomology.assay.AbstractAssay.form.cancel.button" />
</mjl:form>
