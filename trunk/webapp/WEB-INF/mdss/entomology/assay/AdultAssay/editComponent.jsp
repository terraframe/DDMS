...
<mjl:form name="mdss.entomology.assay.AdultAssay.form.name" id="mdss.entomology.assay.AdultAssay.form.id" method="POST">
  ...
  <mjl:command value="Update" action="mdss.entomology.assay.AdultAssayController.update.mojo" name="mdss.entomology.assay.AdultAssay.form.update.button" />
  <mjl:command value="Delete" action="mdss.entomology.assay.AdultAssayController.delete.mojo" name="mdss.entomology.assay.AdultAssay.form.delete.button" />
  <mjl:command value="Cancel" action="mdss.entomology.assay.AdultAssayController.cancel.mojo" name="mdss.entomology.assay.AdultAssay.form.cancel.button" />
</mjl:form>
