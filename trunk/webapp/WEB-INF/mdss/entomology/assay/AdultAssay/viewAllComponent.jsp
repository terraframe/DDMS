...
<mjl:table var="item" query="${query}">
  <mjl:context action="mdss.entomology.assay.AdultAssayController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="mdss.entomology.assay.AdultAssayController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Adult Assay" action="mdss.entomology.assay.AdultAssayController.newInstance.mojo" name="AdultAssayController.newInstance" />
