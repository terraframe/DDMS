...
<mjl:form name="mdss.entomology.assay.AdultDiscriminatingDoseAssay.form.name" id="mdss.entomology.assay.AdultDiscriminatingDoseAssay.form.id" method="POST">
  ...
  <mjl:command value="Update" action="mdss.entomology.assay.AdultDiscriminatingDoseAssayController.update.mojo" name="mdss.entomology.assay.AdultDiscriminatingDoseAssay.form.update.button" />
  <mjl:command value="Delete" action="mdss.entomology.assay.AdultDiscriminatingDoseAssayController.delete.mojo" name="mdss.entomology.assay.AdultDiscriminatingDoseAssay.form.delete.button" />
  <mjl:command value="Cancel" action="mdss.entomology.assay.AdultDiscriminatingDoseAssayController.cancel.mojo" name="mdss.entomology.assay.AdultDiscriminatingDoseAssay.form.cancel.button" />
</mjl:form>
