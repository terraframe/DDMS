...
<mjl:form name="mdss.entomology.assay.AdultDiscriminatingDoseAssay.form.name" id="mdss.entomology.assay.AdultDiscriminatingDoseAssay.form.id" method="POST">
  ...
  <mjl:command value="Create" action="mdss.entomology.assay.AdultDiscriminatingDoseAssayController.create.mojo" name="mdss.entomology.assay.AdultDiscriminatingDoseAssay.form.create.button" />
</mjl:form>
