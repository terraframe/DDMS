...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>
      New AbstractMosquitoCollection
    </title>
  </head>
  <body>
    <mjl:messages>
    ...
    <mjl:form name="mdss.entomology.AbstractMosquitoCollection.form.name" id="mdss.entomology.AbstractMosquitoCollection.form.id" method="POST">
      ...
      <mjl:command value="Create" action="mdss.entomology.AbstractMosquitoCollectionController.create.mojo" name="mdss.entomology.AbstractMosquitoCollection.form.create.button" />
    </mjl:form>
  </body>
</html>
