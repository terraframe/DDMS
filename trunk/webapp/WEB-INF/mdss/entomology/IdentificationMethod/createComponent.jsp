...
<mjl:form name="mdss.entomology.IdentificationMethod.form.name" id="mdss.entomology.IdentificationMethod.form.id" method="POST">
  ...
  <mjl:command value="Create" action="mdss.entomology.IdentificationMethodController.create.mojo" name="mdss.entomology.IdentificationMethod.form.create.button" />
</mjl:form>
