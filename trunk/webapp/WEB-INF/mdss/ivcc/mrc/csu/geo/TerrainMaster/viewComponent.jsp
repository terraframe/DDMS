...
<mjl:form name="mdss.ivcc.mrc.csu.geo.TerrainMaster.form.name" id="mdss.ivcc.mrc.csu.geo.TerrainMaster.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="mdss.ivcc.mrc.csu.geo.TerrainMasterController.edit.mojo" name="mdss.ivcc.mrc.csu.geo.TerrainMaster.form.edit.button" />
  <br />
</mjl:form>
<dl>
  <dt>
...
<mjl:commandLink display="View All" action="mdss.ivcc.mrc.csu.geo.TerrainMasterController.viewAll.mojo" name="mdss.ivcc.mrc.csu.geo.TerrainMaster.viewAll.link" />
