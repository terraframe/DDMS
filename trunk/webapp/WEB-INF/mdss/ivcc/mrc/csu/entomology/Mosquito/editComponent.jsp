...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.Mosquito.form.name" id="mdss.ivcc.mrc.csu.entomology.Mosquito.form.id" method="POST">
  ...
  <mjl:command value="Update" action="mdss.ivcc.mrc.csu.entomology.MosquitoController.update.mojo" name="mdss.ivcc.mrc.csu.entomology.Mosquito.form.update.button" />
  <mjl:command value="Delete" action="mdss.ivcc.mrc.csu.entomology.MosquitoController.delete.mojo" name="mdss.ivcc.mrc.csu.entomology.Mosquito.form.delete.button" />
  <mjl:command value="Cancel" action="mdss.ivcc.mrc.csu.entomology.MosquitoController.cancel.mojo" name="mdss.ivcc.mrc.csu.entomology.Mosquito.form.cancel.button" />
</mjl:form>
