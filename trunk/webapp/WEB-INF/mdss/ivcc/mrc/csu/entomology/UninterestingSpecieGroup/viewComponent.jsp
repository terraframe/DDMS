...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.UninterestingSpecieGroup.form.name" id="mdss.ivcc.mrc.csu.entomology.UninterestingSpecieGroup.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="mdss.ivcc.mrc.csu.entomology.UninterestingSpecieGroupController.edit.mojo" name="mdss.ivcc.mrc.csu.entomology.UninterestingSpecieGroup.form.edit.button" />
  <br />
</mjl:form>
<dl>
  <dt>
  ...
  <dd>
    <ul>
      <li>
        <mjl:commandLink display="Abstract Mosqito Collection" action="mdss.ivcc.mrc.csu.entomology.CollectionTrueSpecieController.childQuery.mojo" name="mdss.ivcc.mrc.csu.entomology.CollectionTrueSpecie.childQuery.link">
...
<mjl:commandLink display="View All" action="mdss.ivcc.mrc.csu.entomology.UninterestingSpecieGroupController.viewAll.mojo" name="mdss.ivcc.mrc.csu.entomology.UninterestingSpecieGroup.viewAll.link" />
