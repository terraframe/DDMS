...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.assay.AdultAssay.form.name" id="mdss.ivcc.mrc.csu.entomology.assay.AdultAssay.form.id" method="POST">
  ...
  <mjl:command value="Create" action="mdss.ivcc.mrc.csu.entomology.assay.AdultAssayController.create.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.AdultAssay.form.create.button" />
</mjl:form>
