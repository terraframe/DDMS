...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.ResistantCutOff.form.name" id="mdss.ivcc.mrc.csu.entomology.ResistantCutOff.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="mdss.ivcc.mrc.csu.entomology.ResistantCutOffController.edit.mojo" name="mdss.ivcc.mrc.csu.entomology.ResistantCutOff.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="mdss.ivcc.mrc.csu.entomology.ResistantCutOffController.viewAll.mojo" name="mdss.ivcc.mrc.csu.entomology.ResistantCutOff.viewAll.link" />
