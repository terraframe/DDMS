...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.assay.infectivity.POvaleTestResult.form.name" id="mdss.ivcc.mrc.csu.entomology.assay.infectivity.POvaleTestResult.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="mdss.ivcc.mrc.csu.entomology.assay.infectivity.POvaleTestResultController.edit.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.infectivity.POvaleTestResult.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="mdss.ivcc.mrc.csu.entomology.assay.infectivity.POvaleTestResultController.viewAll.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.infectivity.POvaleTestResult.viewAll.link" />
