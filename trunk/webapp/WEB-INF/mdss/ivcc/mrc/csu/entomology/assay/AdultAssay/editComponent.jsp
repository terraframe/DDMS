...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.assay.AdultAssay.form.name" id="mdss.ivcc.mrc.csu.entomology.assay.AdultAssay.form.id" method="POST">
  ...
  <mjl:command value="Update" action="mdss.ivcc.mrc.csu.entomology.assay.AdultAssayController.update.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.AdultAssay.form.update.button" />
  <mjl:command value="Delete" action="mdss.ivcc.mrc.csu.entomology.assay.AdultAssayController.delete.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.AdultAssay.form.delete.button" />
  <mjl:command value="Cancel" action="mdss.ivcc.mrc.csu.entomology.assay.AdultAssayController.cancel.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.AdultAssay.form.cancel.button" />
</mjl:form>
