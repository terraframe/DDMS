...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.TrueSpecieEntity.form.name" id="mdss.ivcc.mrc.csu.entomology.TrueSpecieEntity.form.id" method="POST">
  ...
  <mjl:command value="Create" action="mdss.ivcc.mrc.csu.entomology.TrueSpecieEntityController.create.mojo" name="mdss.ivcc.mrc.csu.entomology.TrueSpecieEntity.form.create.button" />
</mjl:form>
