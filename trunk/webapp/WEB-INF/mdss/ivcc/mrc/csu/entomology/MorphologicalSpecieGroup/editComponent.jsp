...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.MorphologicalSpecieGroup.form.name" id="mdss.ivcc.mrc.csu.entomology.MorphologicalSpecieGroup.form.id" method="POST">
  ...
  <mjl:command value="Update" action="mdss.ivcc.mrc.csu.entomology.MorphologicalSpecieGroupController.update.mojo" name="mdss.ivcc.mrc.csu.entomology.MorphologicalSpecieGroup.form.update.button" />
  <mjl:command value="Delete" action="mdss.ivcc.mrc.csu.entomology.MorphologicalSpecieGroupController.delete.mojo" name="mdss.ivcc.mrc.csu.entomology.MorphologicalSpecieGroup.form.delete.button" />
  <mjl:command value="Cancel" action="mdss.ivcc.mrc.csu.entomology.MorphologicalSpecieGroupController.cancel.mojo" name="mdss.ivcc.mrc.csu.entomology.MorphologicalSpecieGroup.form.cancel.button" />
</mjl:form>
