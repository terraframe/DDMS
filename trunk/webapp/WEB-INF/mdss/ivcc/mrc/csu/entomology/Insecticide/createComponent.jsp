...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.Insecticide.form.name" id="mdss.ivcc.mrc.csu.entomology.Insecticide.form.id" method="POST">
  ...
  <mjl:command value="Create" action="mdss.ivcc.mrc.csu.entomology.InsecticideController.create.mojo" name="mdss.ivcc.mrc.csu.entomology.Insecticide.form.create.button" />
</mjl:form>
