...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.assay.biochemical.AEsteraseTestResult.form.name" id="mdss.ivcc.mrc.csu.entomology.assay.biochemical.AEsteraseTestResult.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="mdss.ivcc.mrc.csu.entomology.assay.biochemical.AEsteraseTestResultController.edit.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.biochemical.AEsteraseTestResult.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="mdss.ivcc.mrc.csu.entomology.assay.biochemical.AEsteraseTestResultController.viewAll.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.biochemical.AEsteraseTestResult.viewAll.link" />
