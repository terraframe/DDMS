...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.assay.AbstractAssay.form.name" id="mdss.ivcc.mrc.csu.entomology.assay.AbstractAssay.form.id" method="POST">
  ...
  <mjl:command value="Update" action="mdss.ivcc.mrc.csu.entomology.assay.AbstractAssayController.update.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.AbstractAssay.form.update.button" />
  <mjl:command value="Delete" action="mdss.ivcc.mrc.csu.entomology.assay.AbstractAssayController.delete.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.AbstractAssay.form.delete.button" />
  <mjl:command value="Cancel" action="mdss.ivcc.mrc.csu.entomology.assay.AbstractAssayController.cancel.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.AbstractAssay.form.cancel.button" />
</mjl:form>
