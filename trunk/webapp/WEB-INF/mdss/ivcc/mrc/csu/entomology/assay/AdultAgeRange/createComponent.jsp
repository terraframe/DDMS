...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.assay.AdultAgeRange.form.name" id="mdss.ivcc.mrc.csu.entomology.assay.AdultAgeRange.form.id" method="POST">
  ...
  <mjl:command value="Create" action="mdss.ivcc.mrc.csu.entomology.assay.AdultAgeRangeController.create.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.AdultAgeRange.form.create.button" />
</mjl:form>
