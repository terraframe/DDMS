...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.assay.AbstractAssay.form.name" id="mdss.ivcc.mrc.csu.entomology.assay.AbstractAssay.form.id" method="POST">
  ...
  <mjl:command value="Create" action="mdss.ivcc.mrc.csu.entomology.assay.AbstractAssayController.create.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.AbstractAssay.form.create.button" />
</mjl:form>
