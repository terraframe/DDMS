...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.assay.biochemical.MonooxygenaseTestResult.form.name" id="mdss.ivcc.mrc.csu.entomology.assay.biochemical.MonooxygenaseTestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="mdss.ivcc.mrc.csu.entomology.assay.biochemical.MonooxygenaseTestResultController.create.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.biochemical.MonooxygenaseTestResult.form.create.button" />
</mjl:form>
