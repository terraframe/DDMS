...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.assay.UnitMaster.form.name" id="mdss.ivcc.mrc.csu.entomology.assay.UnitMaster.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="mdss.ivcc.mrc.csu.entomology.assay.UnitMasterController.edit.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.UnitMaster.form.edit.button" />
  <br />
</mjl:form>
<dl>
  <dt>
...
<mjl:commandLink display="View All" action="mdss.ivcc.mrc.csu.entomology.assay.UnitMasterController.viewAll.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.UnitMaster.viewAll.link" />
