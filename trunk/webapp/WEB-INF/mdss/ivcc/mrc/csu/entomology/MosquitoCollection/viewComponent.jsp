...
<%@page import="mdss.ivcc.mrc.csu.mo.SpecieDTO"%>
<%@page import="mdss.ivcc.mrc.csu.mo.IdentificationMethodDTO"%><mjl:messages>
	<mjl:message />
</mjl:messages>
<mjl:form name="mdss.ivcc.mrc.csu.entomology.MosquitoCollection.form.name"
	id="mdss.ivcc.mrc.csu.entomology.MosquitoCollection.form.id" method="POST">
	<mjl:input value="${item.id}" type="hidden" param="id" />
	<dl>
		<dt><label> ${item.collectionMethodMd.displayLabel} </label></dt>
		<dd><mjl:commandLink display="${item.collectionMethod.termName}"
			action="mdss.ivcc.mrc.csu.entomology.CollectionMethodController.view.mojo"
			name="mdss.ivcc.mrc.csu.entomology.CollectionMethod.form.view.link">
		...
		<dd><mjl:commandLink display="${item.geoEntity.geoId}"
			action="mdss.ivcc.mrc.csu.geo.GeoEntityController.view.mojo"
			name="mdss.ivcc.mrc.csu.geo.GeoEntity.form.view.link">
			<mjl:property value="${item.geoEntity.id}" name="id" />
		</mjl:commandLink></dd>
	</dl>
	<mjl:command value="Edit"
		action="mdss.ivcc.mrc.csu.entomology.MosquitoCollectionController.edit.mojo"
		name="mdss.ivcc.mrc.csu.entomology.MosquitoCollection.form.edit.button" />
	<br />
</mjl:form>
...
<script type="text/javascript">      
    ...
    String[] types_to_load =
	{
	   ...
	   "mdss.ivcc.mrc.csu.geo.GeoEntity", "mdss.ivcc.mrc.csu.geo.Terrain"
	};
