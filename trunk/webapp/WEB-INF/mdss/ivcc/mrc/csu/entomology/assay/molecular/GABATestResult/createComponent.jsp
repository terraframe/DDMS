...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.assay.molecular.GABATestResult.form.name" id="mdss.ivcc.mrc.csu.entomology.assay.molecular.GABATestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="mdss.ivcc.mrc.csu.entomology.assay.molecular.GABATestResultController.create.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.molecular.GABATestResult.form.create.button" />
</mjl:form>
