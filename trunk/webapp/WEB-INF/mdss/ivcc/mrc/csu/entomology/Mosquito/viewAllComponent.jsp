...
<mjl:table var="item" query="${query}">
  <mjl:context action="mdss.ivcc.mrc.csu.entomology.MosquitoController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="mdss.ivcc.mrc.csu.entomology.MosquitoController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Mosquito" action="mdss.ivcc.mrc.csu.entomology.MosquitoController.newInstance.mojo" name="MosquitoController.newInstance" />
