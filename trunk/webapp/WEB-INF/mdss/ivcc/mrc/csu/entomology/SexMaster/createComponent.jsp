...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.SexMaster.form.name" id="mdss.ivcc.mrc.csu.entomology.SexMaster.form.id" method="POST">
  ...
  <mjl:command value="Create" action="mdss.ivcc.mrc.csu.entomology.SexMasterController.create.mojo" name="mdss.ivcc.mrc.csu.entomology.SexMaster.form.create.button" />
</mjl:form>
