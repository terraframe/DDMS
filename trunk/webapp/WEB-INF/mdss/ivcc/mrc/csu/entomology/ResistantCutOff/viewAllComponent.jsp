...
<mjl:table var="item" query="${query}">
  <mjl:context action="mdss.ivcc.mrc.csu.entomology.ResistantCutOffController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="mdss.ivcc.mrc.csu.entomology.ResistantCutOffController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Property" action="mdss.ivcc.mrc.csu.entomology.ResistantCutOffController.newInstance.mojo" name="ResistantCutOffController.newInstance" />
