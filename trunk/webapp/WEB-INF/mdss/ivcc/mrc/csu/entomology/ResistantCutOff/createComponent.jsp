...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.ResistantCutOff.form.name" id="mdss.ivcc.mrc.csu.entomology.ResistantCutOff.form.id" method="POST">
  ...
  <mjl:command value="Create" action="mdss.ivcc.mrc.csu.entomology.ResistantCutOffController.create.mojo" name="mdss.ivcc.mrc.csu.entomology.ResistantCutOff.form.create.button" />
</mjl:form>
