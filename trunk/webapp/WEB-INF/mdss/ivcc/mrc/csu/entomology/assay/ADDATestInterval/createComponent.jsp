...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.assay.ADDATestInterval.form.name" id="mdss.ivcc.mrc.csu.entomology.assay.ADDATestInterval.form.id" method="POST">
  ...
  <mjl:command value="Create" action="mdss.ivcc.mrc.csu.entomology.assay.ADDATestIntervalController.create.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.ADDATestInterval.form.create.button" />
</mjl:form>
