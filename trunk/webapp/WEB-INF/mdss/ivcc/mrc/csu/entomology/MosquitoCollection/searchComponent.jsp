...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.MosquitoCollection.search" method="POST">
  <dl>
    <dt> Geo Id </dt>
  ...
  <mjl:command action="mdss.ivcc.mrc.csu.entomology.MosquitoCollectionController.searchByGeoIdAndDate" name="search.button"
...
<div class="bd">
<form method="POST" action="mdss.ivcc.mrc.csu.entomology.MosquitoCollectionController.create.mojax" name="mdss.ivcc.mrc.csu.entomology.MosquitoCollection.form.name" id="mdss.ivcc.mrc.csu.entomology.MosquitoCollection.form.id" >
