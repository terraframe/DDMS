...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.assay.biochemical.GSTTestResult.form.name" id="mdss.ivcc.mrc.csu.entomology.assay.biochemical.GSTTestResult.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="mdss.ivcc.mrc.csu.entomology.assay.biochemical.GSTTestResultController.edit.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.biochemical.GSTTestResult.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="mdss.ivcc.mrc.csu.entomology.assay.biochemical.GSTTestResultController.viewAll.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.biochemical.GSTTestResult.viewAll.link" />
