...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.assay.biochemical.AEsteraseTestResult.form.name" id="mdss.ivcc.mrc.csu.entomology.assay.biochemical.AEsteraseTestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="mdss.ivcc.mrc.csu.entomology.assay.biochemical.AEsteraseTestResultController.create.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.biochemical.AEsteraseTestResult.form.create.button" />
</mjl:form>
