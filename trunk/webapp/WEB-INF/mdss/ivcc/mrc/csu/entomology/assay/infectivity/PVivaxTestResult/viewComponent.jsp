...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.assay.infectivity.PVivaxTestResult.form.name" id="mdss.ivcc.mrc.csu.entomology.assay.infectivity.PVivaxTestResult.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="mdss.ivcc.mrc.csu.entomology.assay.infectivity.PVivaxTestResultController.edit.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.infectivity.PVivaxTestResult.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="mdss.ivcc.mrc.csu.entomology.assay.infectivity.PVivaxTestResultController.viewAll.mojo" name="mdss.ivcc.mrc.csu.entomology.assay.infectivity.PVivaxTestResult.viewAll.link" />
