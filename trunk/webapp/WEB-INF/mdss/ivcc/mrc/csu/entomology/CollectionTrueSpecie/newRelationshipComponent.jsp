...
<mjl:form name="mdss.ivcc.mrc.csu.entomology.CollectionTrueSpecie.form.name" id="mdss.ivcc.mrc.csu.entomology.CollectionTrueSpecie.form.id" method="POST">
  ...
  <mjl:command value="New Instance" action="mdss.ivcc.mrc.csu.entomology.CollectionTrueSpecieController.newInstance.mojo" name="mdss.ivcc.mrc.csu.entomology.CollectionTrueSpecie.form.newInstance.button" />
</mjl:form>
