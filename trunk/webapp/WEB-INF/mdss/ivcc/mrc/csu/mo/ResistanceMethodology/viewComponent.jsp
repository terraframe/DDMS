...
<mjl:form name="mdss.ivcc.mrc.csu.mo.ResistanceMethodology.form.name" id="mdss.ivcc.mrc.csu.mo.ResistanceMethodology.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="mdss.ivcc.mrc.csu.mo.ResistanceMethodologyController.edit.mojo" name="mdss.ivcc.mrc.csu.mo.ResistanceMethodology.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="mdss.ivcc.mrc.csu.mo.ResistanceMethodologyController.viewAll.mojo" name="mdss.ivcc.mrc.csu.mo.ResistanceMethodology.viewAll.link" />
