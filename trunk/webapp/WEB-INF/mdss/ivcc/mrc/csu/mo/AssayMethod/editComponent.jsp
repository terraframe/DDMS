...
<mjl:form name="mdss.ivcc.mrc.csu.mo.AssayMethod.form.name" id="mdss.ivcc.mrc.csu.mo.AssayMethod.form.id" method="POST">
  ...
  <mjl:command value="Update" action="mdss.ivcc.mrc.csu.mo.AssayMethodController.update.mojo" name="mdss.ivcc.mrc.csu.mo.AssayMethod.form.update.button" />
  <mjl:command value="Delete" action="mdss.ivcc.mrc.csu.mo.AssayMethodController.delete.mojo" name="mdss.ivcc.mrc.csu.mo.AssayMethod.form.delete.button" />
  <mjl:command value="Cancel" action="mdss.ivcc.mrc.csu.mo.AssayMethodController.cancel.mojo" name="mdss.ivcc.mrc.csu.mo.AssayMethod.form.cancel.button" />
</mjl:form>
