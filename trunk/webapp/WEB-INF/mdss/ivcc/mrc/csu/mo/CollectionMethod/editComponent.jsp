...
<mjl:form name="mdss.ivcc.mrc.csu.mo.CollectionMethod.form.name" id="mdss.ivcc.mrc.csu.mo.CollectionMethod.form.id" method="POST">
  ...
  <mjl:command value="Update" action="mdss.ivcc.mrc.csu.mo.CollectionMethodController.update.mojo" name="mdss.ivcc.mrc.csu.mo.CollectionMethod.form.update.button" />
  <mjl:command value="Delete" action="mdss.ivcc.mrc.csu.mo.CollectionMethodController.delete.mojo" name="mdss.ivcc.mrc.csu.mo.CollectionMethod.form.delete.button" />
  <mjl:command value="Cancel" action="mdss.ivcc.mrc.csu.mo.CollectionMethodController.cancel.mojo" name="mdss.ivcc.mrc.csu.mo.CollectionMethod.form.cancel.button" />
</mjl:form>
