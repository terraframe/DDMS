...
<mjl:form name="mdss.ivcc.mrc.csu.mo.IdentificationMethod.form.name" id="mdss.ivcc.mrc.csu.mo.IdentificationMethod.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="mdss.ivcc.mrc.csu.mo.IdentificationMethodController.edit.mojo" name="mdss.ivcc.mrc.csu.mo.IdentificationMethod.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="mdss.ivcc.mrc.csu.mo.IdentificationMethodController.viewAll.mojo" name="mdss.ivcc.mrc.csu.mo.IdentificationMethod.viewAll.link" />
