...
<mjl:form name="mdss.ivcc.mrc.csu.mo.Specie.form.name" id="mdss.ivcc.mrc.csu.mo.Specie.form.id" method="POST">
  ...
  <mjl:command value="Update" action="mdss.ivcc.mrc.csu.mo.SpecieController.update.mojo" name="mdss.ivcc.mrc.csu.mo.Specie.form.update.button" />
  <mjl:command value="Delete" action="mdss.ivcc.mrc.csu.mo.SpecieController.delete.mojo" name="mdss.ivcc.mrc.csu.mo.Specie.form.delete.button" />
  <mjl:command value="Cancel" action="mdss.ivcc.mrc.csu.mo.SpecieController.cancel.mojo" name="mdss.ivcc.mrc.csu.mo.Specie.form.cancel.button" />
</mjl:form>
