...
<mjl:form name="mdss.ivcc.mrc.csu.mo.ResistanceMethodology.form.name" id="mdss.ivcc.mrc.csu.mo.ResistanceMethodology.form.id" method="POST">
  ...
  <mjl:command value="Create" action="mdss.ivcc.mrc.csu.mo.ResistanceMethodologyController.create.mojo" name="mdss.ivcc.mrc.csu.mo.ResistanceMethodology.form.create.button" />
</mjl:form>
