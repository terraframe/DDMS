...
<mjl:form name="mdss.ivcc.mrc.csu.mo.CollectionMethod.form.name" id="mdss.ivcc.mrc.csu.mo.CollectionMethod.form.id" method="POST">
  ...
  <mjl:command value="Create" action="mdss.ivcc.mrc.csu.mo.CollectionMethodController.create.mojo" name="mdss.ivcc.mrc.csu.mo.CollectionMethod.form.create.button" />
</mjl:form>
