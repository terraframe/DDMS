...
<mjl:form name="mdss.ivcc.mrc.csu.mo.Insecticide.form.name" id="mdss.ivcc.mrc.csu.mo.Insecticide.form.id" method="POST">
  ...
  <mjl:command value="Update" action="mdss.ivcc.mrc.csu.mo.InsecticideController.update.mojo" name="mdss.ivcc.mrc.csu.mo.Insecticide.form.update.button" />
  <mjl:command value="Delete" action="mdss.ivcc.mrc.csu.mo.InsecticideController.delete.mojo" name="mdss.ivcc.mrc.csu.mo.Insecticide.form.delete.button" />
  <mjl:command value="Cancel" action="mdss.ivcc.mrc.csu.mo.InsecticideController.cancel.mojo" name="mdss.ivcc.mrc.csu.mo.Insecticide.form.cancel.button" />
</mjl:form>
