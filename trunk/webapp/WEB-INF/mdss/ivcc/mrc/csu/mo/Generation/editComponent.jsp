...
<mjl:form name="mdss.ivcc.mrc.csu.mo.Generation.form.name" id="mdss.ivcc.mrc.csu.mo.Generation.form.id" method="POST">
  ...
  <mjl:command value="Update" action="mdss.ivcc.mrc.csu.mo.GenerationController.update.mojo" name="mdss.ivcc.mrc.csu.mo.Generation.form.update.button" />
  <mjl:command value="Delete" action="mdss.ivcc.mrc.csu.mo.GenerationController.delete.mojo" name="mdss.ivcc.mrc.csu.mo.Generation.form.delete.button" />
  <mjl:command value="Cancel" action="mdss.ivcc.mrc.csu.mo.GenerationController.cancel.mojo" name="mdss.ivcc.mrc.csu.mo.Generation.form.cancel.button" />
</mjl:form>
