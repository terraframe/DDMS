...
<mjl:form name="mdss.ivcc.mrc.csu.mo.IdentificationMethod.form.name" id="mdss.ivcc.mrc.csu.mo.IdentificationMethod.form.id" method="POST">
  ...
  <mjl:command value="Create" action="mdss.ivcc.mrc.csu.mo.IdentificationMethodController.create.mojo" name="mdss.ivcc.mrc.csu.mo.IdentificationMethod.form.create.button" />
</mjl:form>
