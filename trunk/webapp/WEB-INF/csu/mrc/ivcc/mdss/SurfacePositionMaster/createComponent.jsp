...
<mjl:form name="csu.mrc.ivcc.mdss.SurfacePositionMaster.form.name" id="csu.mrc.ivcc.mdss.SurfacePositionMaster.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.SurfacePositionMasterController.create.mojo" name="csu.mrc.ivcc.mdss.SurfacePositionMaster.form.create.button" />
</mjl:form>
