...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.AdultAssay.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.AdultAssay.form.id" method="POST">
  ...
  <mjl:command value="Update" action="csu.mrc.ivcc.mdss.entomology.assay.AdultAssayController.update.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.AdultAssay.form.update.button" />
  <mjl:command value="Delete" action="csu.mrc.ivcc.mdss.entomology.assay.AdultAssayController.delete.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.AdultAssay.form.delete.button" />
  <mjl:command value="Cancel" action="csu.mrc.ivcc.mdss.entomology.assay.AdultAssayController.cancel.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.AdultAssay.form.cancel.button" />
</mjl:form>
