...
<mjl:table var="item" query="${query}">
  <mjl:context action="csu.mrc.ivcc.mdss.entomology.assay.InsecticideAssayController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="csu.mrc.ivcc.mdss.entomology.assay.InsecticideAssayController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Insecticide Assay" action="csu.mrc.ivcc.mdss.entomology.assay.InsecticideAssayController.newInstance.mojo" name="InsecticideAssayController.newInstance" />
