...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.AssayMethod.form.name" id="csu.mrc.ivcc.mdss.entomology.AssayMethod.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.AssayMethodController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.AssayMethod.form.create.button" />
</mjl:form>
