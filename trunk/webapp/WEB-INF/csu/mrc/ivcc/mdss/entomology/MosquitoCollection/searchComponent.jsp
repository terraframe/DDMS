...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.MosquitoCollection.search" method="POST">
  ...
  <mjl:command action="csu.mrc.ivcc.mdss.entomology.MosquitoCollectionController.searchByGeoIdAndDate" name="search.button"
...
<div class="bd">
<form method="POST" action="csu.mrc.ivcc.mdss.entomology.MosquitoCollectionController.create.mojax" name="csu.mrc.ivcc.mdss.entomology.MosquitoCollection.form.name" id="csu.mrc.ivcc.mdss.entomology.MosquitoCollection.form.id" >
