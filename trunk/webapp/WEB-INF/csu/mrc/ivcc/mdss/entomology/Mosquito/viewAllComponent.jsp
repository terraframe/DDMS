...
<mjl:table var="item" query="${query}">
  <mjl:context action="csu.mrc.ivcc.mdss.entomology.MosquitoController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="csu.mrc.ivcc.mdss.entomology.MosquitoController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Mosquito" action="csu.mrc.ivcc.mdss.entomology.MosquitoController.newInstance.mojo" name="MosquitoController.newInstance" />
