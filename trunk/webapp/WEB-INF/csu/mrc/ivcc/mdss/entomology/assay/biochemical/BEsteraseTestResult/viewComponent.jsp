...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.biochemical.BEsteraseTestResult.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.biochemical.BEsteraseTestResult.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="csu.mrc.ivcc.mdss.entomology.assay.biochemical.BEsteraseTestResultController.edit.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.biochemical.BEsteraseTestResult.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="csu.mrc.ivcc.mdss.entomology.assay.biochemical.BEsteraseTestResultController.viewAll.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.biochemical.BEsteraseTestResult.viewAll.link" />
