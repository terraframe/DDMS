...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.assay.AssayTestResultController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.form.create.button" />
</mjl:form>
