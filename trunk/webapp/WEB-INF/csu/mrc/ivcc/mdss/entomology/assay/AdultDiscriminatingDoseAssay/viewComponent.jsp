...
<%@page import="csu.mrc.ivcc.mdss.entomology.assay.ADDATestInterval"%>
<%@page import="csu.mrc.ivcc.mdss.entomology.assay.AdultDiscriminatingDoseAssayDTO"%>
<%@page import="csu.mrc.ivcc.mdss.util.Halp" %>

<%@page import="csu.mrc.ivcc.mdss.entomology.assay.ADDATestIntervalViewDTO"%>
<%
...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.AdultDiscriminatingDoseAssay.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.AdultDiscriminatingDoseAssay.form.id" method="POST">
  ...
  <dl>
    ...
    <dd>
      <mjl:commandLink display="${item.collection.keyName}" action="csu.mrc.ivcc.mdss.entomology.MosquitoCollectionController.view.mojo" name="csu.mrc.ivcc.mdss.entomology.MosquitoCollection.form.view.link">
  ...
  <dt>
    ...
    <dd>
      <mjl:commandLink display="${item.testMethod.displayLabel}" action="csu.mrc.ivcc.mdss.mo.ResistanceMethodologyController.view.mojo" name="csu.mrc.ivcc.mdss.mo.ResistanceMethodology.form.view.link">
    ...
    <dd>
      <mjl:commandLink display="${item.generation.displayLabel}" action="csu.mrc.ivcc.mdss.mo.GenerationController.view.mojo" name="csu.mrc.ivcc.mdss.mo.Generation.form.view.link">
    ...
    <dd>
      <mjl:commandLink display="${item.specie.displayLabel}" action="csu.mrc.ivcc.mdss.mo.SpecieController.view.mojo" name="csu.mrc.ivcc.mdss.mo.Specie.form.view.link">
    ...
    <dd>
      <mjl:commandLink display="${item.identificationMethod.displayLabel}" action="csu.mrc.ivcc.mdss.mo.IdentificationMethodController.view.mojo" name="csu.mrc.ivcc.mdss.mo.IdentificationMethod.form.view.link">
    ...
    <dd>
      <mjl:commandLink display="${item.insecticide.displayLabel}" action="csu.mrc.ivcc.mdss.mo.InsecticideController.view.mojo" name="csu.mrc.ivcc.mdss.mo.Insecticide.form.view.link">
...
<script type="text/javascript">      
	...
	{
	   "csu.mrc.ivcc.mdss.entomology.assay.AdultDiscriminatingDoseAssay",
	   "csu.mrc.ivcc.mdss.entomology.assay.ADDATestIntervalView"
	}; 
