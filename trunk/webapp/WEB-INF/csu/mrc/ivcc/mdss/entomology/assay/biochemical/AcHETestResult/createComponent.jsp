...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.biochemical.AcHETestResult.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.biochemical.AcHETestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.assay.biochemical.AcHETestResultController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.biochemical.AcHETestResult.form.create.button" />
</mjl:form>
