...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.UninterestingSpecieGroup.form.name" id="csu.mrc.ivcc.mdss.entomology.UninterestingSpecieGroup.form.id" method="POST">
  ...
  <mjl:command value="Update" action="csu.mrc.ivcc.mdss.entomology.UninterestingSpecieGroupController.update.mojo" name="csu.mrc.ivcc.mdss.entomology.UninterestingSpecieGroup.form.update.button" />
  <mjl:command value="Delete" action="csu.mrc.ivcc.mdss.entomology.UninterestingSpecieGroupController.delete.mojo" name="csu.mrc.ivcc.mdss.entomology.UninterestingSpecieGroup.form.delete.button" />
  <mjl:command value="Cancel" action="csu.mrc.ivcc.mdss.entomology.UninterestingSpecieGroupController.cancel.mojo" name="csu.mrc.ivcc.mdss.entomology.UninterestingSpecieGroup.form.cancel.button" />
</mjl:form>
