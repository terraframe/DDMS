...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.ResistantCutOff.form.name" id="csu.mrc.ivcc.mdss.entomology.ResistantCutOff.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.ResistantCutOffController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.ResistantCutOff.form.create.button" />
</mjl:form>
