...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.infectivity.POvaleTestResult.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.infectivity.POvaleTestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.assay.infectivity.POvaleTestResultController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.infectivity.POvaleTestResult.form.create.button" />
</mjl:form>
