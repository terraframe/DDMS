...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.CollectionMethod.form.name" id="csu.mrc.ivcc.mdss.entomology.CollectionMethod.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.CollectionMethodController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.CollectionMethod.form.create.button" />
</mjl:form>
