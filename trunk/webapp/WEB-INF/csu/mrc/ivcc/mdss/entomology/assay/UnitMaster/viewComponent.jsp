...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.UnitMaster.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.UnitMaster.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="csu.mrc.ivcc.mdss.entomology.assay.UnitMasterController.edit.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.UnitMaster.form.edit.button" />
  <br />
</mjl:form>
<dl>
  <dt>
...
<mjl:commandLink display="View All" action="csu.mrc.ivcc.mdss.entomology.assay.UnitMasterController.viewAll.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.UnitMaster.viewAll.link" />
