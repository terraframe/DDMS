...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.SexMaster.form.name" id="csu.mrc.ivcc.mdss.entomology.SexMaster.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.SexMasterController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.SexMaster.form.create.button" />
</mjl:form>
