...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.Mosquito.form.name" id="csu.mrc.ivcc.mdss.entomology.Mosquito.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.MosquitoController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.Mosquito.form.create.button" />
</mjl:form>
