...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.AbstractMosquitoCollection.form.name" id="csu.mrc.ivcc.mdss.entomology.AbstractMosquitoCollection.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.AbstractMosquitoCollectionController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.AbstractMosquitoCollection.form.create.button" />
</mjl:form>
