...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.ResistantCutOff.form.name" id="csu.mrc.ivcc.mdss.entomology.ResistantCutOff.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="csu.mrc.ivcc.mdss.entomology.ResistantCutOffController.edit.mojo" name="csu.mrc.ivcc.mdss.entomology.ResistantCutOff.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="csu.mrc.ivcc.mdss.entomology.ResistantCutOffController.viewAll.mojo" name="csu.mrc.ivcc.mdss.entomology.ResistantCutOff.viewAll.link" />
