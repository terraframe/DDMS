...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.AdultAssay.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.AdultAssay.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.assay.AdultAssayController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.AdultAssay.form.create.button" />
</mjl:form>
