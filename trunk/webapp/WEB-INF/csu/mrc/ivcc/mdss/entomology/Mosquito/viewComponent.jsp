...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.Mosquito.form.name" id="csu.mrc.ivcc.mdss.entomology.Mosquito.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="csu.mrc.ivcc.mdss.entomology.MosquitoController.edit.mojo" name="csu.mrc.ivcc.mdss.entomology.Mosquito.form.edit.button" />
  <br />
</mjl:form>
<dl>
  <dt>
...
<mjl:commandLink display="View All" action="csu.mrc.ivcc.mdss.entomology.MosquitoController.viewAll.mojo" name="csu.mrc.ivcc.mdss.entomology.Mosquito.viewAll.link" />
