...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.InsecticideAssay.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.InsecticideAssay.form.id" method="POST">
  ...
  <mjl:command value="Update" action="csu.mrc.ivcc.mdss.entomology.assay.InsecticideAssayController.update.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.InsecticideAssay.form.update.button" />
  <mjl:command value="Delete" action="csu.mrc.ivcc.mdss.entomology.assay.InsecticideAssayController.delete.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.InsecticideAssay.form.delete.button" />
  <mjl:command value="Cancel" action="csu.mrc.ivcc.mdss.entomology.assay.InsecticideAssayController.cancel.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.InsecticideAssay.form.cancel.button" />
</mjl:form>
