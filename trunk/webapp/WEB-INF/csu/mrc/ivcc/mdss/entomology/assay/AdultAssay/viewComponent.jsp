...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.AdultAssay.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.AdultAssay.form.id" method="POST">
  ...
  <dl>
    ...
    <dd>
      <mjl:commandLink display="${item.generation.keyName}" action="csu.mrc.ivcc.mdss.entomology.GenerationController.view.mojo" name="csu.mrc.ivcc.mdss.entomology.Generation.form.view.link">
    ...
    <dd>
      <mjl:commandLink display="${item.insecticide.keyName}" action="csu.mrc.ivcc.mdss.entomology.InsecticideController.view.mojo" name="csu.mrc.ivcc.mdss.entomology.Insecticide.form.view.link">
    ...
    <dd>
      <mjl:commandLink display="${item.testMethod.keyName}" action="csu.mrc.ivcc.mdss.entomology.AssayMethodController.view.mojo" name="csu.mrc.ivcc.mdss.entomology.AssayMethod.form.view.link">
        <mjl:property value="${item.testMethod.id}" name="id" />
      </mjl:commandLink>
    </dd>
  </dl>
  <mjl:command value="Edit" action="csu.mrc.ivcc.mdss.entomology.assay.AdultAssayController.edit.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.AdultAssay.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="csu.mrc.ivcc.mdss.entomology.assay.AdultAssayController.viewAll.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.AdultAssay.viewAll.link" />
