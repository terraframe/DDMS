...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.SexMaster.form.name" id="csu.mrc.ivcc.mdss.entomology.SexMaster.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="csu.mrc.ivcc.mdss.entomology.SexMasterController.edit.mojo" name="csu.mrc.ivcc.mdss.entomology.SexMaster.form.edit.button" />
  <br />
</mjl:form>
<dl>
  <dt>
...
<mjl:commandLink display="View All" action="csu.mrc.ivcc.mdss.entomology.SexMasterController.viewAll.mojo" name="csu.mrc.ivcc.mdss.entomology.SexMaster.viewAll.link" />
