...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.AbstractAssay.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.AbstractAssay.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.assay.AbstractAssayController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.AbstractAssay.form.create.button" />
</mjl:form>
