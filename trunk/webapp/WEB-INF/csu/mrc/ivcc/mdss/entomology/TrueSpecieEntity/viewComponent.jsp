...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.TrueSpecieEntity.form.name" id="csu.mrc.ivcc.mdss.entomology.TrueSpecieEntity.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="csu.mrc.ivcc.mdss.entomology.TrueSpecieEntityController.edit.mojo" name="csu.mrc.ivcc.mdss.entomology.TrueSpecieEntity.form.edit.button" />
  <br />
</mjl:form>
<dl>
  <dt>
...
<mjl:commandLink display="View All" action="csu.mrc.ivcc.mdss.entomology.TrueSpecieEntityController.viewAll.mojo" name="csu.mrc.ivcc.mdss.entomology.TrueSpecieEntity.viewAll.link" />
