...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.biochemical.MonooxygenaseTestResult.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.biochemical.MonooxygenaseTestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.assay.biochemical.MonooxygenaseTestResultController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.biochemical.MonooxygenaseTestResult.form.create.button" />
</mjl:form>
