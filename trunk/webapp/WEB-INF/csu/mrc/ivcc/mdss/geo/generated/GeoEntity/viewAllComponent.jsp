...
<mjl:table var="item" query="${query}">
  <mjl:context action="csu.mrc.ivcc.mdss.geo.generated.GeoEntityController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="csu.mrc.ivcc.mdss.geo.generated.GeoEntityController.view.mojo" name="view.link">
