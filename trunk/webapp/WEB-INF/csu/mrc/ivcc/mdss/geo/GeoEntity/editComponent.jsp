...
<mjl:form name="csu.mrc.ivcc.mdss.geo.GeoEntity.form.name" id="csu.mrc.ivcc.mdss.geo.GeoEntity.form.id" method="POST">
  ...
  <mjl:command value="Update" action="csu.mrc.ivcc.mdss.geo.GeoEntityController.update.mojo" name="csu.mrc.ivcc.mdss.geo.GeoEntity.form.update.button" />
  <mjl:command value="Delete" action="csu.mrc.ivcc.mdss.geo.GeoEntityController.delete.mojo" name="csu.mrc.ivcc.mdss.geo.GeoEntity.form.delete.button" />
  <mjl:command value="Cancel" action="csu.mrc.ivcc.mdss.geo.GeoEntityController.cancel.mojo" name="csu.mrc.ivcc.mdss.geo.GeoEntity.form.cancel.button" />
</mjl:form>
