...
<mjl:form name="csu.mrc.ivcc.mdss.mo.CollectionMethod.form.name" id="csu.mrc.ivcc.mdss.mo.CollectionMethod.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.mo.CollectionMethodController.create.mojo" name="csu.mrc.ivcc.mdss.mo.CollectionMethod.form.create.button" />
</mjl:form>
