...
<mjl:form name="csu.mrc.ivcc.mdss.mo.Generation.form.name" id="csu.mrc.ivcc.mdss.mo.Generation.form.id" method="POST">
  ...
  <mjl:command value="Update" action="csu.mrc.ivcc.mdss.mo.GenerationController.update.mojo" name="csu.mrc.ivcc.mdss.mo.Generation.form.update.button" />
  <mjl:command value="Delete" action="csu.mrc.ivcc.mdss.mo.GenerationController.delete.mojo" name="csu.mrc.ivcc.mdss.mo.Generation.form.delete.button" />
  <mjl:command value="Cancel" action="csu.mrc.ivcc.mdss.mo.GenerationController.cancel.mojo" name="csu.mrc.ivcc.mdss.mo.Generation.form.cancel.button" />
</mjl:form>
