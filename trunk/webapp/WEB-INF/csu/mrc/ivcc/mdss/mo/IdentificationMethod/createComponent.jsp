...
<mjl:form name="csu.mrc.ivcc.mdss.mo.IdentificationMethod.form.name" id="csu.mrc.ivcc.mdss.mo.IdentificationMethod.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.mo.IdentificationMethodController.create.mojo" name="csu.mrc.ivcc.mdss.mo.IdentificationMethod.form.create.button" />
</mjl:form>
