...
<mjl:form name="csu.mrc.ivcc.mdss.mo.Insecticide.form.name" id="csu.mrc.ivcc.mdss.mo.Insecticide.form.id" method="POST">
  ...
  <mjl:command value="Update" action="csu.mrc.ivcc.mdss.mo.InsecticideController.update.mojo" name="csu.mrc.ivcc.mdss.mo.Insecticide.form.update.button" />
  <mjl:command value="Delete" action="csu.mrc.ivcc.mdss.mo.InsecticideController.delete.mojo" name="csu.mrc.ivcc.mdss.mo.Insecticide.form.delete.button" />
  <mjl:command value="Cancel" action="csu.mrc.ivcc.mdss.mo.InsecticideController.cancel.mojo" name="csu.mrc.ivcc.mdss.mo.Insecticide.form.cancel.button" />
</mjl:form>
