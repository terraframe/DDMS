...
<mjl:form name="csu.mrc.ivcc.mdss.mo.IdentificationMethod.form.name" id="csu.mrc.ivcc.mdss.mo.IdentificationMethod.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="csu.mrc.ivcc.mdss.mo.IdentificationMethodController.edit.mojo" name="csu.mrc.ivcc.mdss.mo.IdentificationMethod.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="csu.mrc.ivcc.mdss.mo.IdentificationMethodController.viewAll.mojo" name="csu.mrc.ivcc.mdss.mo.IdentificationMethod.viewAll.link" />
