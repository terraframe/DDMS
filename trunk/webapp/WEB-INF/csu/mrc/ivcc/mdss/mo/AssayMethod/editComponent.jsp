...
<mjl:form name="csu.mrc.ivcc.mdss.mo.AssayMethod.form.name" id="csu.mrc.ivcc.mdss.mo.AssayMethod.form.id" method="POST">
  ...
  <mjl:command value="Update" action="csu.mrc.ivcc.mdss.mo.AssayMethodController.update.mojo" name="csu.mrc.ivcc.mdss.mo.AssayMethod.form.update.button" />
  <mjl:command value="Delete" action="csu.mrc.ivcc.mdss.mo.AssayMethodController.delete.mojo" name="csu.mrc.ivcc.mdss.mo.AssayMethod.form.delete.button" />
  <mjl:command value="Cancel" action="csu.mrc.ivcc.mdss.mo.AssayMethodController.cancel.mojo" name="csu.mrc.ivcc.mdss.mo.AssayMethod.form.cancel.button" />
</mjl:form>
