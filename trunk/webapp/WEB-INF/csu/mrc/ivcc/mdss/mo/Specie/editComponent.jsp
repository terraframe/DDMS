...
<mjl:form name="csu.mrc.ivcc.mdss.mo.Specie.form.name" id="csu.mrc.ivcc.mdss.mo.Specie.form.id" method="POST">
  ...
  <mjl:command value="Update" action="csu.mrc.ivcc.mdss.mo.SpecieController.update.mojo" name="csu.mrc.ivcc.mdss.mo.Specie.form.update.button" />
  <mjl:command value="Delete" action="csu.mrc.ivcc.mdss.mo.SpecieController.delete.mojo" name="csu.mrc.ivcc.mdss.mo.Specie.form.delete.button" />
  <mjl:command value="Cancel" action="csu.mrc.ivcc.mdss.mo.SpecieController.cancel.mojo" name="csu.mrc.ivcc.mdss.mo.Specie.form.cancel.button" />
</mjl:form>
