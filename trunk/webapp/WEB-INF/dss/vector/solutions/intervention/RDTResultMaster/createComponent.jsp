...
<mjl:form name="dss.vector.solutions.intervention.RDTResultMaster.form.name" id="dss.vector.solutions.intervention.RDTResultMaster.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.intervention.RDTResultMasterController.create.mojo" name="dss.vector.solutions.intervention.RDTResultMaster.form.create.button" />
</mjl:form>
