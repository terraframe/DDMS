...
<mjl:form name="dss.vector.solutions.intervention.FeverTreatmentDisplayLabel.form.name" id="dss.vector.solutions.intervention.FeverTreatmentDisplayLabel.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.intervention.FeverTreatmentDisplayLabelController.create.mojo" name="dss.vector.solutions.intervention.FeverTreatmentDisplayLabel.form.create.button" />
</mjl:form>
