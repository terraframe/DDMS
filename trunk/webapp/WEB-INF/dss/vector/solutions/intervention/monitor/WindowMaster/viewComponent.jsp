...
<mjl:form name="dss.vector.solutions.intervention.monitor.WindowMaster.form.name" id="dss.vector.solutions.intervention.monitor.WindowMaster.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="dss.vector.solutions.intervention.monitor.WindowMasterController.edit.mojo" name="dss.vector.solutions.intervention.monitor.WindowMaster.form.edit.button" />
  <br />
</mjl:form>
<dl>
  <dt>
...
<mjl:commandLink display="View All" action="dss.vector.solutions.intervention.monitor.WindowMasterController.viewAll.mojo" name="dss.vector.solutions.intervention.monitor.WindowMaster.viewAll.link" />
