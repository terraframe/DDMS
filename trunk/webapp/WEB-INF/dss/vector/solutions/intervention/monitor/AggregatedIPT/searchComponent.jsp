...
<mjl:form name="search" method="POST" id ="searchAggregatedCase">
  <dl>
    ...
    <mjl:command classes="submitButton" action="dss.vector.solutions.intervention.monitor.AggregatedIPTController.searchByGeoIdAndPeriod.mojo" name="search.button" value="Search" />
  </dl>
</mjl:form>
