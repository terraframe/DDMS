...
<mjl:form name="dss.vector.solutions.intervention.monitor.WallHeiarchy.form.name" id="dss.vector.solutions.intervention.monitor.WallHeiarchy.form.id" method="POST">
  ...
  <mjl:command value="New_Instance" action="dss.vector.solutions.intervention.monitor.WallHeiarchyController.newInstance.mojo" name="dss.vector.solutions.intervention.monitor.WallHeiarchy.form.newInstance.button" />
</mjl:form>
