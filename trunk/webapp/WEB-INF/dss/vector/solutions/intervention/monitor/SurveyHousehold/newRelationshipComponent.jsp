...
<mjl:form name="dss.vector.solutions.intervention.monitor.SurveyHousehold.form.name" id="dss.vector.solutions.intervention.monitor.SurveyHousehold.form.id" method="POST">
  ...
  <mjl:command value="New Instance" action="dss.vector.solutions.intervention.monitor.SurveyHouseholdController.newInstance.mojo" name="dss.vector.solutions.intervention.monitor.SurveyHousehold.form.newInstance.button" />
</mjl:form>
