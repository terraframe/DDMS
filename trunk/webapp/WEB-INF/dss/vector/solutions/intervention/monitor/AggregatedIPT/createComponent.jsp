...
<mjl:form name="dss.vector.solutions.intervention.monitor.AggregatedIPT.form.name" id="dss.vector.solutions.intervention.monitor.AggregatedIPT.form.id" method="POST">
  <dl>
    ...
    <mjl:command value="Create" action="dss.vector.solutions.intervention.monitor.AggregatedIPTController.create.mojo" name="dss.vector.solutions.intervention.monitor.AggregatedIPT.form.create.button" />
  </dl>
</mjl:form>
