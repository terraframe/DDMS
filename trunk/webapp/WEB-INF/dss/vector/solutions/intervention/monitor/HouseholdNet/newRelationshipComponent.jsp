...
<mjl:form name="dss.vector.solutions.intervention.monitor.HouseholdNet.form.name" id="dss.vector.solutions.intervention.monitor.HouseholdNet.form.id" method="POST">
  ...
  <mjl:command value="New_Instance" action="dss.vector.solutions.intervention.monitor.HouseholdNetController.newInstance.mojo" name="dss.vector.solutions.intervention.monitor.HouseholdNet.form.newInstance.button" />
</mjl:form>
