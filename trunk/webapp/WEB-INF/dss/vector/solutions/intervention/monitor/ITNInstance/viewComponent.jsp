...
<dl>
  <mjl:form id="dss.vector.solutions.intervention.monitor.ITNInstance.form.id" name="dss.vector.solutions.intervention.monitor.ITNInstance.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.intervention.monitor.ITNInstance.form.edit.button" value="${Localized_Edit}" action="dss.vector.solutions.intervention.monitor.ITNInstanceController.edit.mojo" />
  </mjl:form>
</dl>
