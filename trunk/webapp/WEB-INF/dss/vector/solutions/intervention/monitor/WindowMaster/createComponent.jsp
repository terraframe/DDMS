...
<mjl:form name="dss.vector.solutions.intervention.monitor.WindowMaster.form.name" id="dss.vector.solutions.intervention.monitor.WindowMaster.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.intervention.monitor.WindowMasterController.create.mojo" name="dss.vector.solutions.intervention.monitor.WindowMaster.form.create.button" />
</mjl:form>
