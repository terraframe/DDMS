...
<mjl:form name="dss.vector.solutions.intervention.monitor.SurveyPoint.form.name" id="dss.vector.solutions.intervention.monitor.SurveyPoint.form.id" method="POST">
  ...
  <dl>
    ...
    <dd>
      <mjl:commandLink display="${item.geoEntity.geoId}" action="dss.vector.solutions.geo.generated.GeoEntityController.view.mojo" name="dss.vector.solutions.geo.generated.GeoEntity.form.view.link">
    ...
    <table class="displayTable">
      <c:forEach items="${households}" var="current" varStatus="status">
       <tr class="${status.index % 2 == 0 ? 'evenRow' : 'oddRow'}">
         ...
         <td>
           <mjl:commandLink display="View" action="dss.vector.solutions.intervention.monitor.HouseholdController.view.mojo" name="Household.view.link">
