...
<dl>
  ...
  <dd>
    <ul>
      <li>
        <mjl:commandLink display="" action="dss.vector.solutions.intervention.monitor.ITNServiceController.childQuery.mojo" name="dss.vector.solutions.intervention.monitor.ITNService.childQuery.link">
