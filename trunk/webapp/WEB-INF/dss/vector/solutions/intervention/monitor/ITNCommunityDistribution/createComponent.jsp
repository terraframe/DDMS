...
<dl>
  <mjl:form id="dss.vector.solutions.intervention.monitor.ITNCommunityDistribution.form.id" name="dss.vector.solutions.intervention.monitor.ITNCommunityDistribution.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.intervention.monitor.ITNCommunityDistribution.form.create.button" value="Create" action="dss.vector.solutions.intervention.monitor.ITNCommunityDistributionController.create.mojo" />
  </mjl:form>
</dl>
