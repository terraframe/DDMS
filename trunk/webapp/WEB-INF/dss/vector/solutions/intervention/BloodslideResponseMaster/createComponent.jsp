...
<mjl:form name="dss.vector.solutions.intervention.BloodslideResponseMaster.form.name" id="dss.vector.solutions.intervention.BloodslideResponseMaster.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.intervention.BloodslideResponseMasterController.create.mojo" name="dss.vector.solutions.intervention.BloodslideResponseMaster.form.create.button" />
</mjl:form>
