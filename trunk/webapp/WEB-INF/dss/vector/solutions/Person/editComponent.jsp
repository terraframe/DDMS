...
<mjl:form name="dss.vector.solutions.Person.form.name" id="dss.vector.solutions.Person.form.id" method="POST">
  <mjl:component item="${item}" param="person">
    <mjl:input value="${item.personId}" type="hidden" param="personId" />
    <dl>
      <dt>
        <label>
      ...
      <dd>
        <input id="userInput" type="hidden" value="${item.isMDSSUser}" name="person.isMDSSUser"/>
  ...
  <mjl:command value="Delete" action="dss.vector.solutions.PersonController.delete.mojo" name="dss.vector.solutions.Person.form.delete.button" />
