...
<c:set var="page_title" value="Larvae_Age_View" scope="request"/>
<mjl:messages>
  <mjl:message />
</mjl:messages>
...
<mjl:commandLink action="dss.vector.solutions.mo.LarvaeAgeController.viewAll.mojo" name="dss.vector.solutions.mo.LarvaeAge.viewAll.link">
