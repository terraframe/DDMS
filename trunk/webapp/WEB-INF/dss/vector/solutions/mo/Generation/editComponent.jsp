...
<c:set var="page_title" value="Generation_Method_Edit" scope="request"/>
<mjl:messages>
  <mjl:message />
</mjl:messages>
<mjl:form name="dss.vector.solutions.mo.Generation.form.name" id="dss.vector.solutions.mo.Generation.form.id" method="POST">
  <dl>
    ...
    <mjl:command value="Update" action="dss.vector.solutions.mo.GenerationController.update.mojo" name="dss.vector.solutions.mo.Generation.form.update.button" />
    <mjl:command value="Delete" action="dss.vector.solutions.mo.GenerationController.delete.mojo" name="dss.vector.solutions.mo.Generation.form.delete.button" />
    <mjl:command value="Cancel" action="dss.vector.solutions.mo.GenerationController.cancel.mojo" name="dss.vector.solutions.mo.Generation.form.cancel.button" />
  </dl>
</mjl:form>
