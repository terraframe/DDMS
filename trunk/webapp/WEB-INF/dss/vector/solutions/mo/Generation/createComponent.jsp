...
<c:set var="page_title" value="Generation_Method_Create" scope="request"/>
<mjl:messages>
  <mjl:message />
</mjl:messages>
<mjl:form name="dss.vector.solutions.mo.Generation.form.name" id="dss.vector.solutions.mo.Generation.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.mo.GenerationController.create.mojo" name="dss.vector.solutions.mo.Generation.form.create.button" />
</mjl:form>
