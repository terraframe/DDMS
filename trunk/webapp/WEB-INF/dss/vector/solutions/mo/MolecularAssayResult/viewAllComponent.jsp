...
<mjl:table var="item" query="${query}" classes="displayTable" even="evenRow" odd="oddRow">
  ...
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink action="dss.vector.solutions.mo.MolecularAssayResultController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink action="dss.vector.solutions.mo.MolecularAssayResultController.newInstance.mojo" name="MolecularAssayResultController.newInstance">
<fmt:message key="Create_a_new_Molecular_Assay_Result" />
</mjl:commandLink>
