...
<c:set var="page_title" value="Molecular_Assay_Result_Create" scope="request"/>
<mjl:messages>
  <mjl:message />
</mjl:messages>
<mjl:form name="dss.vector.solutions.mo.MolecularAssayResult.form.name" id="dss.vector.solutions.mo.MolecularAssayResult.form.id" method="POST">
  <dl>
    ...
    <mjl:command value="Create" action="dss.vector.solutions.mo.MolecularAssayResultController.create.mojo" name="dss.vector.solutions.mo.MolecularAssayResult.form.create.button" />
  </dl>
</mjl:form>
