...
<c:set var="page_title" value="Infectivity_Methodology_Create" scope="request"/>
<mjl:messages>
  <mjl:message />
</mjl:messages>
<mjl:form name="dss.vector.solutions.mo.InfectivityMethodology.form.name" id="dss.vector.solutions.mo.InfectivityMethodology.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.mo.InfectivityMethodologyController.create.mojo" name="dss.vector.solutions.mo.InfectivityMethodology.form.create.button" />
</mjl:form>
