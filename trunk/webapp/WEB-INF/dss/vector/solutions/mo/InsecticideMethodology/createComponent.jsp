...
<c:set var="page_title" value="Insecticide_Methodology_Create" scope="request"/>
<mjl:messages>
  <mjl:message />
</mjl:messages>
<mjl:form name="dss.vector.solutions.mo.InsecticideMethodology.form.name" id="dss.vector.solutions.mo.InsecticideMethodology.form.id" method="POST">
  <dl>
    ...
    <mjl:command value="Create" action="dss.vector.solutions.mo.InsecticideMethodologyController.create.mojo" name="dss.vector.solutions.mo.InsecticideMethodology.form.create.button" />
  </dl>
</mjl:form>
