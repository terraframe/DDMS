...
<c:set var="page_title" value="Resistance_Methodology_Edit" scope="request"/>
<mjl:messages>
  <mjl:message />
</mjl:messages>
<mjl:form name="dss.vector.solutions.mo.ResistanceMethodology.form.name" id="dss.vector.solutions.mo.ResistanceMethodology.form.id" method="POST">
  ...
  <mjl:command value="Update" action="dss.vector.solutions.mo.ResistanceMethodologyController.update.mojo" name="dss.vector.solutions.mo.ResistanceMethodology.form.update.button" />
  <mjl:command value="Delete" action="dss.vector.solutions.mo.ResistanceMethodologyController.delete.mojo" name="dss.vector.solutions.mo.ResistanceMethodology.form.delete.button" />
  <mjl:command value="Cancel" action="dss.vector.solutions.mo.ResistanceMethodologyController.cancel.mojo" name="dss.vector.solutions.mo.ResistanceMethodology.form.cancel.button" />
</mjl:form>
