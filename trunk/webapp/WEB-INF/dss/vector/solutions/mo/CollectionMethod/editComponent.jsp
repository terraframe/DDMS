...
<c:set var="page_title" value="Collection_Method_Edit" scope="request"/>
<mjl:messages>
  <mjl:message />
</mjl:messages>
<mjl:form name="dss.vector.solutions.mo.CollectionMethod.form.name" id="dss.vector.solutions.mo.CollectionMethod.form.id" method="POST">
  <dl>
    ...
    <mjl:command value="Update" action="dss.vector.solutions.mo.CollectionMethodController.update.mojo" name="dss.vector.solutions.mo.CollectionMethod.form.update.button" />
    <mjl:command value="Delete" action="dss.vector.solutions.mo.CollectionMethodController.delete.mojo" name="dss.vector.solutions.mo.CollectionMethod.form.delete.button" />
    <mjl:command value="Cancel" action="dss.vector.solutions.mo.CollectionMethodController.cancel.mojo" name="dss.vector.solutions.mo.CollectionMethod.form.cancel.button" />
  </dl>
</mjl:form>
