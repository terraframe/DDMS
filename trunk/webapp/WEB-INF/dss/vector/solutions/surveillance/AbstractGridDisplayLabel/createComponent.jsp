...
<mjl:form name="dss.vector.solutions.surveillance.AbstractGridDisplayLabel.form.name" id="dss.vector.solutions.surveillance.AbstractGridDisplayLabel.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.surveillance.AbstractGridDisplayLabelController.create.mojo" name="dss.vector.solutions.surveillance.AbstractGridDisplayLabel.form.create.button" />
</mjl:form>
