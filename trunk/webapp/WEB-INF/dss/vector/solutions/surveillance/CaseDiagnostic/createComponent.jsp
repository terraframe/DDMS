...
<mjl:form name="dss.vector.solutions.surveillance.CaseDiagnostic.form.name" id="dss.vector.solutions.surveillance.CaseDiagnostic.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.surveillance.CaseDiagnosticController.create.mojo" name="dss.vector.solutions.surveillance.CaseDiagnostic.form.create.button" />
</mjl:form>
