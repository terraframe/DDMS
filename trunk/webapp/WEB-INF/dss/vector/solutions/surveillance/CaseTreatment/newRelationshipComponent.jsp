...
<mjl:form name="dss.vector.solutions.surveillance.CaseTreatment.form.name" id="dss.vector.solutions.surveillance.CaseTreatment.form.id" method="POST">
  ...
  <mjl:command value="New_Instance" action="dss.vector.solutions.surveillance.CaseTreatmentController.newInstance.mojo" name="dss.vector.solutions.surveillance.CaseTreatment.form.newInstance.button" />
</mjl:form>
