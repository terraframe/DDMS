...
<c:set var="page_title" value="Treatment_Grid_View_All" scope="request"/>
<mjl:messages>
  <mjl:message />
</mjl:messages>
...
<br />
<mjl:commandLink display="Create a new Treatment Grid" action="dss.vector.solutions.surveillance.TreatmentGridController.newInstance.mojo" name="TreatmentGridController.newInstance" />
