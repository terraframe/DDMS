...
<mjl:form name="dss.vector.solutions.surveillance.CaseTreatmentStock.form.name" id="dss.vector.solutions.surveillance.CaseTreatmentStock.form.id" method="POST">
  ...
  <mjl:command value="New Instance" action="dss.vector.solutions.surveillance.CaseTreatmentStockController.newInstance.mojo" name="dss.vector.solutions.surveillance.CaseTreatmentStock.form.newInstance.button" />
</mjl:form>
