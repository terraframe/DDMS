...
<c:set var="page_title" value="Treatment_Method_Grid_Create" scope="request"/>
<mjl:messages>
  <mjl:message />
</mjl:messages>
<mjl:form name="dss.vector.solutions.surveillance.TreatmentMethodGrid.form.name" id="dss.vector.solutions.surveillance.TreatmentMethodGrid.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.surveillance.TreatmentMethodGridController.create.mojo" name="dss.vector.solutions.surveillance.TreatmentMethodGrid.form.create.button" />
</mjl:form>
