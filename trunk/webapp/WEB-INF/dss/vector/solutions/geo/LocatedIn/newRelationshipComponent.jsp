...
<mjl:form name="dss.vector.solutions.geo.LocatedIn.form.name" id="dss.vector.solutions.geo.LocatedIn.form.id" method="POST">
  ...
  <mjl:command value="New_Instance" action="dss.vector.solutions.geo.LocatedInController.newInstance.mojo" name="dss.vector.solutions.geo.LocatedIn.form.newInstance.button" />
</mjl:form>
