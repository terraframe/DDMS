...
<mjl:form name="dss.vector.solutions.geo.SpatialMaster.form.name" id="dss.vector.solutions.geo.SpatialMaster.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="dss.vector.solutions.geo.SpatialMasterController.edit.mojo" name="dss.vector.solutions.geo.SpatialMaster.form.edit.button" />
  <br />
</mjl:form>
<dl>
  <dt>
...
<mjl:commandLink action="dss.vector.solutions.geo.SpatialMasterController.viewAll.mojo" name="dss.vector.solutions.geo.SpatialMaster.viewAll.link">
