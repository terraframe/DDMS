...
<mjl:form name="dss.vector.solutions.geo.generated.RusticMatPlasticSheetRoof.form.name" id="dss.vector.solutions.geo.generated.RusticMatPlasticSheetRoof.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.RusticMatPlasticSheetRoofController.create.mojo" name="dss.vector.solutions.geo.generated.RusticMatPlasticSheetRoof.form.create.button" />
</mjl:form>
