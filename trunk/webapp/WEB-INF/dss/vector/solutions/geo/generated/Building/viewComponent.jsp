...
<c:set scope="request" var="page_title" value="View_Building" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="dss.vector.solutions.geo.generated.Building.form.id" name="dss.vector.solutions.geo.generated.Building.form.name" method="POST">
    ...
    <mjl:command localize="false" name="dss.vector.solutions.geo.generated.Building.form.edit.button" value="${Localized_Edit}" action="dss.vector.solutions.geo.generated.BuildingController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="dss.vector.solutions.geo.generated.Building.viewAll.link" action="dss.vector.solutions.geo.generated.BuildingController.viewAll.mojo">
