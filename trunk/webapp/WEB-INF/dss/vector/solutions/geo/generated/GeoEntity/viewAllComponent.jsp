...
<br />
<mjl:commandLink display="Create a new Geo Entity" action="dss.vector.solutions.geo.generated.GeoEntityController.newInstance.mojo" name="GeoEntityController.newInstance" />
