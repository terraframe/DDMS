...
<c:set scope="request" var="page_title" value="View_District" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="dss.vector.solutions.geo.generated.District.form.id" name="dss.vector.solutions.geo.generated.District.form.name" method="POST">
    ...
    <mjl:command localize="false" name="dss.vector.solutions.geo.generated.District.form.edit.button" value="${Localized_Edit}" action="dss.vector.solutions.geo.generated.DistrictController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="dss.vector.solutions.geo.generated.District.viewAll.link" action="dss.vector.solutions.geo.generated.DistrictController.viewAll.mojo">
