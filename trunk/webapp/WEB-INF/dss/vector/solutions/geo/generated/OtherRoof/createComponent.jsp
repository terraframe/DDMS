...
<mjl:form name="dss.vector.solutions.geo.generated.OtherRoof.form.name" id="dss.vector.solutions.geo.generated.OtherRoof.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.OtherRoofController.create.mojo" name="dss.vector.solutions.geo.generated.OtherRoof.form.create.button" />
</mjl:form>
