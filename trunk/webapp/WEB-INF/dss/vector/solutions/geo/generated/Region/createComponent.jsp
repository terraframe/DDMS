...
<mjl:form name="dss.vector.solutions.geo.generated.Region.form.name" id="dss.vector.solutions.geo.generated.Region.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.RegionController.create.mojo" name="dss.vector.solutions.geo.generated.Region.form.create.button" />
</mjl:form>
