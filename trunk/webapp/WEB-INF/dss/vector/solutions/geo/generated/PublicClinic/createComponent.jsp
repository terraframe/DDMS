...
<mjl:form name="dss.vector.solutions.geo.generated.PublicClinic.form.name" id="dss.vector.solutions.geo.generated.PublicClinic.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.PublicClinicController.create.mojo" name="dss.vector.solutions.geo.generated.PublicClinic.form.create.button" />
</mjl:form>
