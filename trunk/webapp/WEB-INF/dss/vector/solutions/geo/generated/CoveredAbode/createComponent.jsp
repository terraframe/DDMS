...
<mjl:form name="dss.vector.solutions.geo.generated.CoveredAbode.form.name" id="dss.vector.solutions.geo.generated.CoveredAbode.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.CoveredAbodeController.create.mojo" name="dss.vector.solutions.geo.generated.CoveredAbode.form.create.button" />
</mjl:form>
