...
<mjl:form name="dss.vector.solutions.geo.generated.Roof.form.name" id="dss.vector.solutions.geo.generated.Roof.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.RoofController.create.mojo" name="dss.vector.solutions.geo.generated.Roof.form.create.button" />
</mjl:form>
