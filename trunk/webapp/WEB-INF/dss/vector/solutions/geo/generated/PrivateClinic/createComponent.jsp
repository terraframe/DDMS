...
<mjl:form name="dss.vector.solutions.geo.generated.PrivateClinic.form.name" id="dss.vector.solutions.geo.generated.PrivateClinic.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.PrivateClinicController.create.mojo" name="dss.vector.solutions.geo.generated.PrivateClinic.form.create.button" />
</mjl:form>
