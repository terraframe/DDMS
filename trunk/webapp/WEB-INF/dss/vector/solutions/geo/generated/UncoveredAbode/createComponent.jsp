...
<mjl:form name="dss.vector.solutions.geo.generated.UncoveredAbode.form.name" id="dss.vector.solutions.geo.generated.UncoveredAbode.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.UncoveredAbodeController.create.mojo" name="dss.vector.solutions.geo.generated.UncoveredAbode.form.create.button" />
</mjl:form>
