...
<mjl:table classes="displayTable" var="item" query="${query}" even="evenRow" odd="oddRow">
  ...
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink name="view.link" action="dss.vector.solutions.geo.generated.HealthFacilityController.view.mojo">
...
<br />
<mjl:commandLink name="HealthFacilityController.newInstance" action="dss.vector.solutions.geo.generated.HealthFacilityController.newInstance.mojo">
  <mdss:localize key="Create_a_new_Health_Facility" />
</mjl:commandLink>
