...
<mjl:form name="dss.vector.solutions.geo.generated.LocalGvtMaternity.form.name" id="dss.vector.solutions.geo.generated.LocalGvtMaternity.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.LocalGvtMaternityController.create.mojo" name="dss.vector.solutions.geo.generated.LocalGvtMaternity.form.create.button" />
</mjl:form>
