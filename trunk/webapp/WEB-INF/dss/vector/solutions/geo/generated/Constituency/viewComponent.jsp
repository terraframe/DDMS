...
<c:set scope="request" var="page_title" value="View_Constituency" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="dss.vector.solutions.geo.generated.Constituency.form.id" name="dss.vector.solutions.geo.generated.Constituency.form.name" method="POST">
    ...
    <mjl:command localize="false" name="dss.vector.solutions.geo.generated.Constituency.form.edit.button" value="${Localized_Edit}" action="dss.vector.solutions.geo.generated.ConstituencyController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="dss.vector.solutions.geo.generated.Constituency.viewAll.link" action="dss.vector.solutions.geo.generated.ConstituencyController.viewAll.mojo">
