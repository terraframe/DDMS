...
<c:set scope="request" var="page_title" value="View_Reserve" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="dss.vector.solutions.geo.generated.Reserve.form.id" name="dss.vector.solutions.geo.generated.Reserve.form.name" method="POST">
    ...
    <mjl:command localize="false" name="dss.vector.solutions.geo.generated.Reserve.form.edit.button" value="${Localized_Edit}" action="dss.vector.solutions.geo.generated.ReserveController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="dss.vector.solutions.geo.generated.Reserve.viewAll.link" action="dss.vector.solutions.geo.generated.ReserveController.viewAll.mojo">
