...
<mjl:form name="dss.vector.solutions.geo.generated.ReedBambooRoof.form.name" id="dss.vector.solutions.geo.generated.ReedBambooRoof.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.ReedBambooRoofController.create.mojo" name="dss.vector.solutions.geo.generated.ReedBambooRoof.form.create.button" />
</mjl:form>
