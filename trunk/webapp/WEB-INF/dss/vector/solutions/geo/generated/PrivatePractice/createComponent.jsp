...
<mjl:form name="dss.vector.solutions.geo.generated.PrivatePractice.form.name" id="dss.vector.solutions.geo.generated.PrivatePractice.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.PrivatePracticeController.create.mojo" name="dss.vector.solutions.geo.generated.PrivatePractice.form.create.button" />
</mjl:form>
