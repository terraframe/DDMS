...
<mjl:form name="dss.vector.solutions.geo.generated.CentralHospital.form.name" id="dss.vector.solutions.geo.generated.CentralHospital.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.CentralHospitalController.create.mojo" name="dss.vector.solutions.geo.generated.CentralHospital.form.create.button" />
</mjl:form>
