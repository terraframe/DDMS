...
<mjl:form name="dss.vector.solutions.geo.generated.StickAndMudRoof.form.name" id="dss.vector.solutions.geo.generated.StickAndMudRoof.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.StickAndMudRoofController.create.mojo" name="dss.vector.solutions.geo.generated.StickAndMudRoof.form.create.button" />
</mjl:form>
