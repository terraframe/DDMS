...
<dl>
  <mjl:form id="dss.vector.solutions.geo.generated.CollectionSite.form.id" name="dss.vector.solutions.geo.generated.CollectionSite.form.name" method="POST">
    ...
    <mjl:command localize="false" name="dss.vector.solutions.geo.generated.CollectionSite.form.edit.button" value="${Localized_Edit}" action="dss.vector.solutions.geo.generated.CollectionSiteController.edit.mojo" />
  </mjl:form>
</dl>
