...
<mjl:form name="dss.vector.solutions.geo.generated.MobileClinic.form.name" id="dss.vector.solutions.geo.generated.MobileClinic.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.MobileClinicController.create.mojo" name="dss.vector.solutions.geo.generated.MobileClinic.form.create.button" />
</mjl:form>
