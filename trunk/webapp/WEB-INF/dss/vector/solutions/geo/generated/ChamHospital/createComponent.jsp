...
<mjl:form name="dss.vector.solutions.geo.generated.ChamHospital.form.name" id="dss.vector.solutions.geo.generated.ChamHospital.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.ChamHospitalController.create.mojo" name="dss.vector.solutions.geo.generated.ChamHospital.form.create.button" />
</mjl:form>
