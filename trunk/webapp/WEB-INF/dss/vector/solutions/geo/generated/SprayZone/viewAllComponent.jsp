...
<mjl:table var="item" query="${query}">
  ...
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="dss.vector.solutions.geo.generated.SprayZoneController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Spray Zone" action="dss.vector.solutions.geo.generated.SprayZoneController.newInstance.mojo" name="SprayZoneController.newInstance" />
