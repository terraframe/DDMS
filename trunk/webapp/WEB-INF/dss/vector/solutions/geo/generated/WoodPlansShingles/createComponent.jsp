...
<mjl:form name="dss.vector.solutions.geo.generated.WoodPlansShingles.form.name" id="dss.vector.solutions.geo.generated.WoodPlansShingles.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.WoodPlansShinglesController.create.mojo" name="dss.vector.solutions.geo.generated.WoodPlansShingles.form.create.button" />
</mjl:form>
