...
<c:set scope="request" var="page_title" value="View_HealthFacility" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="dss.vector.solutions.geo.generated.HealthFacility.form.id" name="dss.vector.solutions.geo.generated.HealthFacility.form.name" method="POST">
    ...
    <mjl:command localize="false" name="dss.vector.solutions.geo.generated.HealthFacility.form.edit.button" value="${Localized_Edit}" action="dss.vector.solutions.geo.generated.HealthFacilityController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="dss.vector.solutions.geo.generated.HealthFacility.viewAll.link" action="dss.vector.solutions.geo.generated.HealthFacilityController.viewAll.mojo">
