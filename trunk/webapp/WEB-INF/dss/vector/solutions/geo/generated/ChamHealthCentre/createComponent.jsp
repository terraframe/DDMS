...
<mjl:form name="dss.vector.solutions.geo.generated.ChamHealthCentre.form.name" id="dss.vector.solutions.geo.generated.ChamHealthCentre.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.ChamHealthCentreController.create.mojo" name="dss.vector.solutions.geo.generated.ChamHealthCentre.form.create.button" />
</mjl:form>
