...
<mjl:form name="dss.vector.solutions.geo.generated.Net.form.name" id="dss.vector.solutions.geo.generated.Net.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.NetController.create.mojo" name="dss.vector.solutions.geo.generated.Net.form.create.button" />
</mjl:form>
