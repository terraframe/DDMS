...
<mjl:form name="dss.vector.solutions.geo.generated.TraditionalAuthority.form.name" id="dss.vector.solutions.geo.generated.TraditionalAuthority.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.TraditionalAuthorityController.create.mojo" name="dss.vector.solutions.geo.generated.TraditionalAuthority.form.create.button" />
</mjl:form>
