...
<c:set scope="request" var="page_title" value="View_Province" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="dss.vector.solutions.geo.generated.Province.form.id" name="dss.vector.solutions.geo.generated.Province.form.name" method="POST">
    ...
    <mjl:command localize="false" name="dss.vector.solutions.geo.generated.Province.form.edit.button" value="${Localized_Edit}" action="dss.vector.solutions.geo.generated.ProvinceController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="dss.vector.solutions.geo.generated.Province.viewAll.link" action="dss.vector.solutions.geo.generated.ProvinceController.viewAll.mojo">
