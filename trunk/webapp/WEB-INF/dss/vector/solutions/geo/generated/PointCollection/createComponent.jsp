...
<mjl:form name="dss.vector.solutions.geo.generated.PointCollection.form.name" id="dss.vector.solutions.geo.generated.PointCollection.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.PointCollectionController.create.mojo" name="dss.vector.solutions.geo.generated.PointCollection.form.create.button" />
</mjl:form>
