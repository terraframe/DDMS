...
<c:set scope="request" var="page_title" value="View_SentinelSite" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="dss.vector.solutions.geo.generated.SentinelSite.form.id" name="dss.vector.solutions.geo.generated.SentinelSite.form.name" method="POST">
    ...
    <mjl:command localize="false" name="dss.vector.solutions.geo.generated.SentinelSite.form.edit.button" value="${Localized_Edit}" action="dss.vector.solutions.geo.generated.SentinelSiteController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="dss.vector.solutions.geo.generated.SentinelSite.viewAll.link" action="dss.vector.solutions.geo.generated.SentinelSiteController.viewAll.mojo">
