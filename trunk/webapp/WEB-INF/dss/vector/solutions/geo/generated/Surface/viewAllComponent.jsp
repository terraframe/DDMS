...
<mjl:table var="item" query="${query}">
  ...
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="dss.vector.solutions.geo.generated.SurfaceController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Surface" action="dss.vector.solutions.geo.generated.SurfaceController.newInstance.mojo" name="SurfaceController.newInstance" />
