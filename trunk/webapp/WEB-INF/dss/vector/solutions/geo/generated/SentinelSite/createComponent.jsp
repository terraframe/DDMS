...
<dl>
  <mjl:form id="dss.vector.solutions.geo.generated.SentinelSite.form.id" name="dss.vector.solutions.geo.generated.SentinelSite.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.geo.generated.SentinelSite.form.create.button" value="${Localized_Create}" action="dss.vector.solutions.geo.generated.SentinelSiteController.create.mojo" />
