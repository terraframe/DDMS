...
<dl>
  <mjl:form id="dss.vector.solutions.geo.generated.Earth.form.id" name="dss.vector.solutions.geo.generated.Earth.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.geo.generated.Earth.form.update.button" value="${Update_Localize}" action="dss.vector.solutions.geo.generated.EarthController.update.mojo" />
    <mdss:localize var="Delete_Localize" key="Delete" />
    <mjl:command name="dss.vector.solutions.geo.generated.Earth.form.delete.button" value="${Delete_Localize}" action="dss.vector.solutions.geo.generated.EarthController.delete.mojo" />
