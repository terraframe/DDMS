...
<mjl:form name="dss.vector.solutions.geo.generated.ThatchLeafRoof.form.name" id="dss.vector.solutions.geo.generated.ThatchLeafRoof.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.ThatchLeafRoofController.create.mojo" name="dss.vector.solutions.geo.generated.ThatchLeafRoof.form.create.button" />
</mjl:form>
