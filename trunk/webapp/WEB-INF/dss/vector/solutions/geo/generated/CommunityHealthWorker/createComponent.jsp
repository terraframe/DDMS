...
<mjl:form name="dss.vector.solutions.geo.generated.CommunityHealthWorker.form.name" id="dss.vector.solutions.geo.generated.CommunityHealthWorker.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.CommunityHealthWorkerController.create.mojo" name="dss.vector.solutions.geo.generated.CommunityHealthWorker.form.create.button" />
</mjl:form>
