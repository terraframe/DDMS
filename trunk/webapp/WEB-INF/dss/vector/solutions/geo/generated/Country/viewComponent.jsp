...
<c:set scope="request" var="page_title" value="View_Country" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="dss.vector.solutions.geo.generated.Country.form.id" name="dss.vector.solutions.geo.generated.Country.form.name" method="POST">
    ...
    <mjl:command localize="false" name="dss.vector.solutions.geo.generated.Country.form.edit.button" value="${Localized_Edit}" action="dss.vector.solutions.geo.generated.CountryController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="dss.vector.solutions.geo.generated.Country.viewAll.link" action="dss.vector.solutions.geo.generated.CountryController.viewAll.mojo">
