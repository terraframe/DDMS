...
<c:set scope="request" var="page_title" value="View_All_Railway" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<mjl:table classes="displayTable" var="item" query="${query}" even="evenRow" odd="oddRow">
  ...
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink name="view.link" action="dss.vector.solutions.geo.generated.RailwayController.view.mojo">
...
<br />
<mjl:commandLink name="RailwayController.newInstance" action="dss.vector.solutions.geo.generated.RailwayController.newInstance.mojo">
  <mdss:localize key="Create_a_new_Railway" />
</mjl:commandLink>
