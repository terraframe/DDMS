...
<mjl:form name="dss.vector.solutions.geo.generated.BambooWoodWithMudWall.form.name" id="dss.vector.solutions.geo.generated.BambooWoodWithMudWall.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.BambooWoodWithMudWallController.create.mojo" name="dss.vector.solutions.geo.generated.BambooWoodWithMudWall.form.create.button" />
</mjl:form>
