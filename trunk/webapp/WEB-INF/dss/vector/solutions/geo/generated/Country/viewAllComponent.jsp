...
<mjl:table var="item" query="${query}">
  ...
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="dss.vector.solutions.geo.generated.CountryController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Country" action="dss.vector.solutions.geo.generated.CountryController.newInstance.mojo" name="CountryController.newInstance" />
