...
<c:set scope="request" var="page_title" value="View_Earth" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="dss.vector.solutions.geo.generated.Earth.form.id" name="dss.vector.solutions.geo.generated.Earth.form.name" method="POST">
    ...
    <mjl:command localize="false" name="dss.vector.solutions.geo.generated.Earth.form.edit.button" value="${Localized_Edit}" action="dss.vector.solutions.geo.generated.EarthController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="dss.vector.solutions.geo.generated.Earth.viewAll.link" action="dss.vector.solutions.geo.generated.EarthController.viewAll.mojo">
