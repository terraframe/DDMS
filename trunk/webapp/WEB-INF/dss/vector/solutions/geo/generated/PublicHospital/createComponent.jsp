...
<mjl:form name="dss.vector.solutions.geo.generated.PublicHospital.form.name" id="dss.vector.solutions.geo.generated.PublicHospital.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.PublicHospitalController.create.mojo" name="dss.vector.solutions.geo.generated.PublicHospital.form.create.button" />
</mjl:form>
