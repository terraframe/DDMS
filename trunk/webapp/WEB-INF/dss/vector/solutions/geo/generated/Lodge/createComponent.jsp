...
<mjl:form name="dss.vector.solutions.geo.generated.Lodge.form.name" id="dss.vector.solutions.geo.generated.Lodge.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.LodgeController.create.mojo" name="dss.vector.solutions.geo.generated.Lodge.form.create.button" />
</mjl:form>
