...
<mjl:form name="dss.vector.solutions.geo.generated.RuralHospital.form.name" id="dss.vector.solutions.geo.generated.RuralHospital.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.RuralHospitalController.create.mojo" name="dss.vector.solutions.geo.generated.RuralHospital.form.create.button" />
</mjl:form>
