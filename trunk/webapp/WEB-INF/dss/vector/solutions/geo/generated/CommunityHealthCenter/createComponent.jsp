...
<mjl:form name="dss.vector.solutions.geo.generated.CommunityHealthCenter.form.name" id="dss.vector.solutions.geo.generated.CommunityHealthCenter.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.CommunityHealthCenterController.create.mojo" name="dss.vector.solutions.geo.generated.CommunityHealthCenter.form.create.button" />
</mjl:form>
