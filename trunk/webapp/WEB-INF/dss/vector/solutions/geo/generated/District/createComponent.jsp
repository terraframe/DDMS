...
<c:set scope="request" var="page_title" value="Create_District" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="dss.vector.solutions.geo.generated.District.form.id" name="dss.vector.solutions.geo.generated.District.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.geo.generated.District.form.create.button" value="${Localized_Create}" action="dss.vector.solutions.geo.generated.DistrictController.create.mojo" />
