...
<mjl:form name="dss.vector.solutions.geo.generated.CalamineCementFibreRoof.form.name" id="dss.vector.solutions.geo.generated.CalamineCementFibreRoof.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.CalamineCementFibreRoofController.create.mojo" name="dss.vector.solutions.geo.generated.CalamineCementFibreRoof.form.create.button" />
</mjl:form>
