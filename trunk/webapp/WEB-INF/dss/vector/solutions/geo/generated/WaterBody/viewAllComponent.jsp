...
<br />
<mjl:commandLink display="Create a new WaterBody" action="dss.vector.solutions.geo.generated.WaterBodyController.newInstance.mojo" name="WaterBodyController.newInstance" />
