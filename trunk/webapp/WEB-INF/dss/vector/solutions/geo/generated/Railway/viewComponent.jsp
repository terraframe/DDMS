...
<c:set scope="request" var="page_title" value="View_Railway" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="dss.vector.solutions.geo.generated.Railway.form.id" name="dss.vector.solutions.geo.generated.Railway.form.name" method="POST">
    ...
    <mjl:command localize="false" name="dss.vector.solutions.geo.generated.Railway.form.edit.button" value="${Localized_Edit}" action="dss.vector.solutions.geo.generated.RailwayController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="dss.vector.solutions.geo.generated.Railway.viewAll.link" action="dss.vector.solutions.geo.generated.RailwayController.viewAll.mojo">
