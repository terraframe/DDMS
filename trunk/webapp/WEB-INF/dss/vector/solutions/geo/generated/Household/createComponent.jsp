...
<mjl:form name="dss.vector.solutions.geo.generated.Household.form.name" id="dss.vector.solutions.geo.generated.Household.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.HouseholdController.create.mojo" name="dss.vector.solutions.geo.generated.Household.form.create.button" />
</mjl:form>
