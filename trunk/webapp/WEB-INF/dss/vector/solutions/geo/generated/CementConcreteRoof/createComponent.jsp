...
<mjl:form name="dss.vector.solutions.geo.generated.CementConcreteRoof.form.name" id="dss.vector.solutions.geo.generated.CementConcreteRoof.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.CementConcreteRoofController.create.mojo" name="dss.vector.solutions.geo.generated.CementConcreteRoof.form.create.button" />
</mjl:form>
