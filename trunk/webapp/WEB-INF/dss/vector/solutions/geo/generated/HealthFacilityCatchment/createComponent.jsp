...
<mjl:form name="dss.vector.solutions.geo.generated.HealthFacilityCatchment.form.name" id="dss.vector.solutions.geo.generated.HealthFacilityCatchment.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.HealthFacilityCatchmentController.create.mojo" name="dss.vector.solutions.geo.generated.HealthFacilityCatchment.form.create.button" />
</mjl:form>
