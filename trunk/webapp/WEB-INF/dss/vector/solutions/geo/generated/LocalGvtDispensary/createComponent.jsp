...
<mjl:form name="dss.vector.solutions.geo.generated.LocalGvtDispensary.form.name" id="dss.vector.solutions.geo.generated.LocalGvtDispensary.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.LocalGvtDispensaryController.create.mojo" name="dss.vector.solutions.geo.generated.LocalGvtDispensary.form.create.button" />
</mjl:form>
