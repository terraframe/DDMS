...
<c:set scope="request" var="page_title" value="Edit_StockDepot" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="dss.vector.solutions.geo.generated.StockDepot.form.id" name="dss.vector.solutions.geo.generated.StockDepot.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.geo.generated.StockDepot.form.update.button" value="${Update_Localize}" action="dss.vector.solutions.geo.generated.StockDepotController.update.mojo" />
    <mdss:localize var="Delete_Localize" key="Delete" />
    <mjl:command name="dss.vector.solutions.geo.generated.StockDepot.form.delete.button" value="${Delete_Localize}" action="dss.vector.solutions.geo.generated.StockDepotController.delete.mojo" />
