...
<br />
<mjl:commandLink display="Create a new OtherWall" action="dss.vector.solutions.geo.generated.OtherWallController.newInstance.mojo" name="OtherWallController.newInstance" />
