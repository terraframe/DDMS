...
<mjl:table var="item" query="${query}">
  ...
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="dss.vector.solutions.geo.generated.OtherWallController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Other wall" action="dss.vector.solutions.geo.generated.OtherWallController.newInstance.mojo" name="OtherWallController.newInstance" />
