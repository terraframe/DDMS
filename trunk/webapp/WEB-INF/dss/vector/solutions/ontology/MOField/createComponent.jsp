...
<dl>
  <mjl:form name="dss.vector.solutions.ontology.MOField.form.name" id="dss.vector.solutions.ontology.MOField.form.id" method="POST">
    ...
    <mjl:command value="Create" action="dss.vector.solutions.ontology.MOFieldController.create.mojo" name="dss.vector.solutions.ontology.MOField.form.create.button" />
  </mjl:form>
</dl>
