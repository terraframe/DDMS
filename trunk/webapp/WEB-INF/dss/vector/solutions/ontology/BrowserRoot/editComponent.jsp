...
<dl>
  <mjl:form name="dss.vector.solutions.ontology.BrowserRoot.form.name" id="dss.vector.solutions.ontology.BrowserRoot.form.id" method="POST">
    ...
    <mjl:command value="${Localized_Update}" action="dss.vector.solutions.ontology.BrowserRootController.update.mojo" name="dss.vector.solutions.ontology.BrowserRoot.form.update.button" />
