...
<mjl:commandLink display="View All" action="dss.vector.solutions.ontology.OntologyRelationshipController.viewAll.mojo" name="dss.vector.solutions.ontology.OntologyRelationship.viewAll.link" />
