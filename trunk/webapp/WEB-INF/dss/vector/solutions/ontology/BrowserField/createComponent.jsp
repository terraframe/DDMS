...
<dl>
  <mjl:form name="dss.vector.solutions.ontology.BrowserField.form.name" id="dss.vector.solutions.ontology.BrowserField.form.id" method="POST">
    ...
    <mjl:command value="${Localized_Create}" action="dss.vector.solutions.ontology.BrowserFieldController.create.mojo" name="dss.vector.solutions.ontology.BrowserField.form.create.button" />
  </mjl:form>
</dl>
