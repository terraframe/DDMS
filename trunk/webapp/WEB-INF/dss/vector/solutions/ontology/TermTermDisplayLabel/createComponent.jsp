...
<dl>
  <mjl:form id="dss.vector.solutions.ontology.TermTermDisplayLabel.form.id" name="dss.vector.solutions.ontology.TermTermDisplayLabel.form.name" method="POST">
    ...
    <mjl:command localize="false" name="dss.vector.solutions.ontology.TermTermDisplayLabel.form.create.button" value="Create" action="dss.vector.solutions.ontology.TermTermDisplayLabelController.create.mojo" />
  </mjl:form>
</dl>
