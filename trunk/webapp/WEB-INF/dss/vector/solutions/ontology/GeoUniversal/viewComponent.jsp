...
<c:set scope="request" var="page_title" value="View_GeoUniversal" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form id="dss.vector.solutions.ontology.GeoUniversal.form.id" name="dss.vector.solutions.ontology.GeoUniversal.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.ontology.GeoUniversal.form.edit.button" value="Edit" action="dss.vector.solutions.ontology.GeoUniversalController.edit.mojo" />
  </mjl:form>
</dl>
<mjl:commandLink name="dss.vector.solutions.ontology.GeoUniversal.viewAll.link" action="dss.vector.solutions.ontology.GeoUniversalController.viewAll.mojo">
