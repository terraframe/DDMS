...
<mjl:form name="dss.vector.solutions.query.ThematicVariable.form.name" id="dss.vector.solutions.query.ThematicVariable.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.query.ThematicVariableController.create.mojo" name="dss.vector.solutions.query.ThematicVariable.form.create.button" />
</mjl:form>
