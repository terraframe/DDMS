...
<mjl:form name="dss.vector.solutions.query.WellKnownNamesMaster.form.name" id="dss.vector.solutions.query.WellKnownNamesMaster.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.query.WellKnownNamesMasterController.create.mojo" name="dss.vector.solutions.query.WellKnownNamesMaster.form.create.button" />
</mjl:form>
