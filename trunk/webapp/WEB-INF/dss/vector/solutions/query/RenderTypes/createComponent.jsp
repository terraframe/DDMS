...
<dl>
  <mjl:form id="dss.vector.solutions.query.RenderTypes.form.id" name="dss.vector.solutions.query.RenderTypes.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.query.RenderTypes.form.create.button" value="${Localized_Create}" action="dss.vector.solutions.query.RenderTypesController.create.mojo" />
  </mjl:form>
</dl>
