...
<mjl:form name="dss.vector.solutions.query.DefaultSavedSearch.form.name" id="dss.vector.solutions.query.DefaultSavedSearch.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="dss.vector.solutions.query.DefaultSavedSearchController.edit.mojo" name="dss.vector.solutions.query.DefaultSavedSearch.form.edit.button" />
  <br />
</mjl:form>
<dl>
  <dt>
...
<mjl:commandLink display="View All" action="dss.vector.solutions.query.DefaultSavedSearchController.viewAll.mojo" name="dss.vector.solutions.query.DefaultSavedSearch.viewAll.link" />
