...
<mjl:form name="dss.vector.solutions.query.DefinesCategories.form.name" id="dss.vector.solutions.query.DefinesCategories.form.id" method="POST">
  ...
  <mjl:command value="${Localized_Edit}" action="dss.vector.solutions.query.DefinesCategoriesController.edit.mojo" name="dss.vector.solutions.query.DefinesCategories.form.edit.button" />
  <br />
</mjl:form>
