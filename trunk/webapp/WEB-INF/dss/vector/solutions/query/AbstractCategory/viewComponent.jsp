...
<mjl:commandLink display="View All" action="dss.vector.solutions.query.AbstractCategoryController.viewAll.mojo" name="dss.vector.solutions.query.AbstractCategory.viewAll.link" />
