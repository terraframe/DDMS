...
<mjl:form name="dss.vector.solutions.query.DefinesLayers.form.name" id="dss.vector.solutions.query.DefinesLayers.form.id" method="POST">
  ...
  <mjl:command value="New_Instance" action="dss.vector.solutions.query.DefinesLayersController.newInstance.mojo" name="dss.vector.solutions.query.DefinesLayers.form.newInstance.button" />
</mjl:form>
