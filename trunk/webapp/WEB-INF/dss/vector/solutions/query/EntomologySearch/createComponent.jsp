...
<mjl:form name="dss.vector.solutions.query.EntomologySearch.form.name" id="dss.vector.solutions.query.EntomologySearch.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.query.EntomologySearchController.create.mojo" name="dss.vector.solutions.query.EntomologySearch.form.create.button" />
</mjl:form>
