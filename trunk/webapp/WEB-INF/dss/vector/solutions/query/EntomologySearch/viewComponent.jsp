...
<mjl:form name="dss.vector.solutions.query.EntomologySearch.form.name" id="dss.vector.solutions.query.EntomologySearch.form.id" method="POST">
  ...
  <mjl:command value="${Localized_Edit}" action="dss.vector.solutions.query.EntomologySearchController.edit.mojo" name="dss.vector.solutions.query.EntomologySearch.form.edit.button" />
  <br />
</mjl:form>
<dl>
  <dt>
