...
<dl>
  <mjl:form id="dss.vector.solutions.stock.StockItem.form.id" name="dss.vector.solutions.stock.StockItem.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.stock.StockItem.form.create.button" value="${Localized_Create}" action="dss.vector.solutions.stock.StockItemController.create.mojo" />
  </mjl:form>
</dl>
