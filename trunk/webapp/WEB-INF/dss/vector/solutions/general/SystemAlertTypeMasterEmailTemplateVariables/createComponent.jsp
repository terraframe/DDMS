...
<dl>
  <mjl:form id="dss.vector.solutions.general.SystemAlertTypeMasterEmailTemplateVariables.form.id" name="dss.vector.solutions.general.SystemAlertTypeMasterEmailTemplateVariables.form.name" method="POST">
    ...
    <mjl:command localize="false" name="dss.vector.solutions.general.SystemAlertTypeMasterEmailTemplateVariables.form.create.button" value="Create" action="dss.vector.solutions.general.SystemAlertTypeMasterEmailTemplateVariablesController.create.mojo" />
  </mjl:form>
</dl>
