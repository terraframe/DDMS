...
<dl>
  <mjl:form id="dss.vector.solutions.general.EmailTemplateVariables.form.id" name="dss.vector.solutions.general.EmailTemplateVariables.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.general.EmailTemplateVariables.form.create.button" value="${Localized_Create}" action="dss.vector.solutions.general.EmailTemplateVariablesController.create.mojo" />
  </mjl:form>
</dl>
