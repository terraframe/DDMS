...
<dl>
  <mjl:form id="dss.vector.solutions.general.SystemAlertDisplayName.form.id" name="dss.vector.solutions.general.SystemAlertDisplayName.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.general.SystemAlertDisplayName.form.edit.button" value="${Localized_Edit}" action="dss.vector.solutions.general.SystemAlertDisplayNameController.edit.mojo" />
  </mjl:form>
</dl>
