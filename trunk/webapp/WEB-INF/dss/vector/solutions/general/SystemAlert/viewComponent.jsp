...
<dl>
  <mjl:form id="dss.vector.solutions.general.SystemAlert.form.id" name="dss.vector.solutions.general.SystemAlert.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.general.SystemAlert.form.edit.button" value="Edit" action="dss.vector.solutions.general.SystemAlertController.edit.mojo" />
  </mjl:form>
</dl>
