...
<dl>
  <mjl:form id="dss.vector.solutions.LocalProperty.form.id" name="dss.vector.solutions.LocalProperty.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.LocalProperty.form.edit.button" value="${Localized_Edit}" action="dss.vector.solutions.LocalPropertyController.edit.mojo" />
  </mjl:form>
</dl>
