...
<mjl:form name="dss.vector.solutions.irs.ActorSprayStatus.form.name" id="dss.vector.solutions.irs.ActorSprayStatus.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="dss.vector.solutions.irs.ActorSprayStatusController.edit.mojo" name="dss.vector.solutions.irs.ActorSprayStatus.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="dss.vector.solutions.irs.ActorSprayStatusController.viewAll.mojo" name="dss.vector.solutions.irs.ActorSprayStatus.viewAll.link" />
