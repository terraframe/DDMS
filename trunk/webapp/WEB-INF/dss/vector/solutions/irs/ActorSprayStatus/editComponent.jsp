...
<mjl:form name="dss.vector.solutions.irs.ActorSprayStatus.form.name" id="dss.vector.solutions.irs.ActorSprayStatus.form.id" method="POST">
  ...
  <mjl:command value="Update" action="dss.vector.solutions.irs.ActorSprayStatusController.update.mojo" name="dss.vector.solutions.irs.ActorSprayStatus.form.update.button" />
  <mjl:command value="Delete" action="dss.vector.solutions.irs.ActorSprayStatusController.delete.mojo" name="dss.vector.solutions.irs.ActorSprayStatus.form.delete.button" />
  <mjl:command value="Cancel" action="dss.vector.solutions.irs.ActorSprayStatusController.cancel.mojo" name="dss.vector.solutions.irs.ActorSprayStatus.form.cancel.button" />
</mjl:form>
