...
<mjl:form name="dss.vector.solutions.irs.ActorSprayStatus.form.name" id="dss.vector.solutions.irs.ActorSprayStatus.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.irs.ActorSprayStatusController.create.mojo" name="dss.vector.solutions.irs.ActorSprayStatus.form.create.button" />
</mjl:form>
