...
<mjl:form name="dss.vector.solutions.irs.InsecticideNozzle.form.name" id="dss.vector.solutions.irs.InsecticideNozzle.form.id" method="POST">
  ...
  <mjl:command value="New_Instance" action="dss.vector.solutions.irs.InsecticideNozzleController.newInstance.mojo" name="dss.vector.solutions.irs.InsecticideNozzle.form.newInstance.button" />
</mjl:form>
