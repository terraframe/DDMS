...
<mjl:form name="dss.vector.solutions.irs.ResourceTarget.form.name" id="dss.vector.solutions.irs.ResourceTarget.form.id" method="POST">
  ...
  <mjl:command value="Update" action="dss.vector.solutions.irs.ResourceTargetController.update.mojo" name="dss.vector.solutions.irs.ResourceTarget.form.update.button" />
  <mjl:command value="Delete" action="dss.vector.solutions.irs.ResourceTargetController.delete.mojo" name="dss.vector.solutions.irs.ResourceTarget.form.delete.button" />
  <mjl:command value="Cancel" action="dss.vector.solutions.irs.ResourceTargetController.cancel.mojo" name="dss.vector.solutions.irs.ResourceTarget.form.cancel.button" />
</mjl:form>
