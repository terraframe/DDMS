...
<mjl:form name="dss.vector.solutions.irs.ResourceTarget.form.name" id="dss.vector.solutions.irs.ResourceTarget.form.id" method="POST">
  ...
  <mjl:command value="${Localized_Create}" action="dss.vector.solutions.irs.ResourceTargetController.create.mojo" name="dss.vector.solutions.irs.ResourceTarget.form.create.button" />
</mjl:form>
