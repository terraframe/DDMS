...
<mjl:form name="dss.vector.solutions.irs.SprayData.form.name" id="dss.vector.solutions.irs.SprayData.form.id" method="POST">
  ...
  <mjl:command value="Update" action="dss.vector.solutions.irs.SprayDataController.update.mojo" name="dss.vector.solutions.irs.SprayData.form.update.button" />
  <mjl:command value="Delete" action="dss.vector.solutions.irs.SprayDataController.delete.mojo" name="dss.vector.solutions.irs.SprayData.form.delete.button" />
  <mjl:command value="Cancel" action="dss.vector.solutions.irs.SprayDataController.cancel.mojo" name="dss.vector.solutions.irs.SprayData.form.cancel.button" />
</mjl:form>
