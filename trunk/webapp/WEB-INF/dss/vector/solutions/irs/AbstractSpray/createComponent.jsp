...
<mjl:form name="dss.vector.solutions.irs.AbstractSpray.form.name" id="dss.vector.solutions.irs.AbstractSpray.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.irs.AbstractSprayController.create.mojo" name="dss.vector.solutions.irs.AbstractSpray.form.create.button" />
</mjl:form>
