...
<mjl:table var="item" query="${query}">
  <mjl:context action="dss.vector.solutions.irs.HouseholdSprayStatusController.viewPage.mojo" />
  <mjl:columns>
    <mjl:attributeColumn attributeName="householdId">
      <mjl:header>
        Household Id
      </mjl:header>
    </mjl:attributeColumn>
    <mjl:attributeColumn attributeName="structureId">
      <mjl:header>
        Structure Id
      </mjl:header>
    </mjl:attributeColumn>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="dss.vector.solutions.irs.HouseholdSprayStatusController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Household Spray Status" action="dss.vector.solutions.irs.HouseholdSprayStatusController.newInstance.mojo" name="HouseholdSprayStatusController.newInstance" />
