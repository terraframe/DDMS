...
<mjl:form name="dss.vector.solutions.irs.HouseholdSprayStatus.form.name" id="dss.vector.solutions.irs.HouseholdSprayStatus.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.irs.HouseholdSprayStatusController.create.mojo" name="dss.vector.solutions.irs.HouseholdSprayStatus.form.create.button" />
</mjl:form>
