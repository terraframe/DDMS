...
<mjl:form name="dss.vector.solutions.irs.SprayStatus.form.name" id="dss.vector.solutions.irs.SprayStatus.form.id" method="POST">
  ...
  <mjl:command value="Update" action="dss.vector.solutions.irs.SprayStatusController.update.mojo" name="dss.vector.solutions.irs.SprayStatus.form.update.button" />
  <mjl:command value="Delete" action="dss.vector.solutions.irs.SprayStatusController.delete.mojo" name="dss.vector.solutions.irs.SprayStatus.form.delete.button" />
  <mjl:command value="Cancel" action="dss.vector.solutions.irs.SprayStatusController.cancel.mojo" name="dss.vector.solutions.irs.SprayStatus.form.cancel.button" />
</mjl:form>
