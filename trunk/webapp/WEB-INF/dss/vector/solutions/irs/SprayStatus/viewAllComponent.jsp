...
<mjl:table var="item" query="${query}">
  <mjl:context action="dss.vector.solutions.irs.SprayStatusController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="dss.vector.solutions.irs.SprayStatusController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Spray Status" action="dss.vector.solutions.irs.SprayStatusController.newInstance.mojo" name="SprayStatusController.newInstance" />
