...
<mjl:form name="dss.vector.solutions.irs.SprayStatus.form.name" id="dss.vector.solutions.irs.SprayStatus.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.irs.SprayStatusController.create.mojo" name="dss.vector.solutions.irs.SprayStatus.form.create.button" />
</mjl:form>
