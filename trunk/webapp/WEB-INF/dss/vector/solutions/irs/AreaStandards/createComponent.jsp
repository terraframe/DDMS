...
<dl>
  <mjl:form id="dss.vector.solutions.irs.AreaStandards.form.id" name="dss.vector.solutions.irs.AreaStandards.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.irs.AreaStandards.form.create.button" value="${Localized_Create}" action="dss.vector.solutions.irs.AreaStandardsController.create.mojo" />
  </mjl:form>
</dl>
