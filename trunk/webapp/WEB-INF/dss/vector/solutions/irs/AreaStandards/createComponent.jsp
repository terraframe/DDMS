...
<mjl:form name="dss.vector.solutions.irs.AreaStandards.form.name" id="dss.vector.solutions.irs.AreaStandards.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.irs.AreaStandardsController.create.mojo" name="dss.vector.solutions.irs.AreaStandards.form.create.button" />
</mjl:form>
