...
<mjl:form name="dss.vector.solutions.irs.SprayMethodMaster.form.name" id="dss.vector.solutions.irs.SprayMethodMaster.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.irs.SprayMethodMasterController.create.mojo" name="dss.vector.solutions.irs.SprayMethodMaster.form.create.button" />
</mjl:form>
