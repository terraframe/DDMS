...
<mjl:form name="dss.vector.solutions.irs.GeoTarget.form.name" id="dss.vector.solutions.irs.GeoTarget.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="dss.vector.solutions.irs.GeoTargetController.edit.mojo" name="dss.vector.solutions.irs.GeoTarget.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="dss.vector.solutions.irs.GeoTargetController.viewAll.mojo" name="dss.vector.solutions.irs.GeoTarget.viewAll.link" />
