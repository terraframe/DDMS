...
<mjl:form name="dss.vector.solutions.irs.InsecticideBrand.form.name" id="dss.vector.solutions.irs.InsecticideBrand.form.id" method="POST">
  ...
  <mjl:command value="Update" action="dss.vector.solutions.irs.InsecticideBrandController.update.mojo" name="dss.vector.solutions.irs.InsecticideBrand.form.update.button" />
  <mjl:command value="Delete" action="dss.vector.solutions.irs.InsecticideBrandController.delete.mojo" name="dss.vector.solutions.irs.InsecticideBrand.form.delete.button" />
  <mjl:command value="Cancel" action="dss.vector.solutions.irs.InsecticideBrandController.cancel.mojo" name="dss.vector.solutions.irs.InsecticideBrand.form.cancel.button" />
</mjl:form>
