...
<dl>
  <mjl:form id="dss.vector.solutions.entomology.ResistancePropertyDescription.form.id" name="dss.vector.solutions.entomology.ResistancePropertyDescription.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.entomology.ResistancePropertyDescription.form.edit.button" value="Edit" action="dss.vector.solutions.entomology.ResistancePropertyDescriptionController.edit.mojo" />
  </mjl:form>
</dl>
