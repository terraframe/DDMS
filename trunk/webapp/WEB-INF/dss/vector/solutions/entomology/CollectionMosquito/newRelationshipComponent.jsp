...
<mjl:form name="dss.vector.solutions.entomology.CollectionMosquito.form.name" id="dss.vector.solutions.entomology.CollectionMosquito.form.id" method="POST">
  ...
  <mjl:command value="New Instance" action="dss.vector.solutions.entomology.CollectionMosquitoController.newInstance.mojo" name="dss.vector.solutions.entomology.CollectionMosquito.form.newInstance.button" />
</mjl:form>
