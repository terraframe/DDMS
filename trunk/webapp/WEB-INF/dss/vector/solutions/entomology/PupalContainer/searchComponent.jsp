...
<mjl:form name="PupalCollection.search" method="POST" id="searchPupalCollections">
  <dl>
    ...
    <mjl:command classes="submitButton" action="dss.vector.solutions.entomology.PupalContainerController.searchByDTO.mojo" name="search.button" value="${Localized_Search}" />
    <mdss:localize key="Create" var="Localized_Create" />
    <mjl:command classes="submitButton" action="dss.vector.solutions.entomology.PupalContainerController.forward.mojo" name="create.button" value="${Localized_Create}" />
  </dl>
</mjl:form>
