...
<mjl:input type="text" param="termName" />
  ...
  <mjl:command value="Create" action="dss.vector.solutions.entomology.SpecieController.create.mojo" name="dss.vector.solutions.entomology.Specie.form.create.button" />
</mjl:form>
