...
<mjl:input type="text" param="testDate" />
  ...
  <mjl:command value="Update" action="dss.vector.solutions.entomology.assay.CollectionAssayController.update.mojo" name="dss.vector.solutions.entomology.assay.CollectionAssay.form.update.button" />
  <mjl:command value="Delete" action="dss.vector.solutions.entomology.assay.CollectionAssayController.delete.mojo" name="dss.vector.solutions.entomology.assay.CollectionAssay.form.delete.button" />
  <mjl:command value="Cancel" action="dss.vector.solutions.entomology.assay.CollectionAssayController.cancel.mojo" name="dss.vector.solutions.entomology.assay.CollectionAssay.form.cancel.button" />
</mjl:form>
