...
<mjl:select var="current" valueAttribute="id" items="${dss_vector_solutions_entomology_assay_AssayTestResult_mosquito}" param="mosquito">
  ...
  <mjl:command value="Update" action="dss.vector.solutions.entomology.assay.molecular.GABAGTestResultController.update.mojo" name="dss.vector.solutions.entomology.assay.molecular.GABAGTestResult.form.update.button" />
  <mjl:command value="Delete" action="dss.vector.solutions.entomology.assay.molecular.GABAGTestResultController.delete.mojo" name="dss.vector.solutions.entomology.assay.molecular.GABAGTestResult.form.delete.button" />
  <mjl:command value="Cancel" action="dss.vector.solutions.entomology.assay.molecular.GABAGTestResultController.cancel.mojo" name="dss.vector.solutions.entomology.assay.molecular.GABAGTestResult.form.cancel.button" />
</mjl:form>
