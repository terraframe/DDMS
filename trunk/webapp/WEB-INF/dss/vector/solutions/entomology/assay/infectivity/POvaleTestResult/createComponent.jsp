...
<mjl:form name="dss.vector.solutions.entomology.assay.infectivity.POvaleTestResult.form.name" id="dss.vector.solutions.entomology.assay.infectivity.POvaleTestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.entomology.assay.infectivity.POvaleTestResultController.create.mojo" name="dss.vector.solutions.entomology.assay.infectivity.POvaleTestResult.form.create.button" />
</mjl:form>
