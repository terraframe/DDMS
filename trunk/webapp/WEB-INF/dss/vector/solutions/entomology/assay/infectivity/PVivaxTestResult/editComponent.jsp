...
<mjl:form name="dss.vector.solutions.entomology.assay.infectivity.PVivaxTestResult.form.name" id="dss.vector.solutions.entomology.assay.infectivity.PVivaxTestResult.form.id" method="POST">
  ...
  <mjl:command value="Delete" action="dss.vector.solutions.entomology.assay.infectivity.PVivaxTestResultController.delete.mojo" name="dss.vector.solutions.entomology.assay.infectivity.PVivaxTestResult.form.delete.button" />
  <mjl:command value="Cancel" action="dss.vector.solutions.entomology.assay.infectivity.PVivaxTestResultController.cancel.mojo" name="dss.vector.solutions.entomology.assay.infectivity.PVivaxTestResult.form.cancel.button" />
</mjl:form>
