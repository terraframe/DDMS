...
<mjl:form name="dss.vector.solutions.entomology.assay.molecular.TargetSiteAssayTestResult.form.name" id="dss.vector.solutions.entomology.assay.molecular.TargetSiteAssayTestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.entomology.assay.molecular.TargetSiteAssayTestResultController.create.mojo" name="dss.vector.solutions.entomology.assay.molecular.TargetSiteAssayTestResult.form.create.button" />
</mjl:form>
