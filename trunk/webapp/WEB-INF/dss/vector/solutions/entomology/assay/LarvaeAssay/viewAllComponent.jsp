...
<mjl:table var="item" query="${query}">
  <mjl:context action="dss.vector.solutions.entomology.assay.LarvaeAssayController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="dss.vector.solutions.entomology.assay.LarvaeAssayController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Larvae Assay" action="dss.vector.solutions.entomology.assay.LarvaeAssayController.newInstance.mojo" name="LarvaeAssayController.newInstance" />
