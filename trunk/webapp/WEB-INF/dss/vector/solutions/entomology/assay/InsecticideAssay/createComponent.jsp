...
<mjl:form name="dss.vector.solutions.entomology.assay.InsecticideAssay.form.name" id="dss.vector.solutions.entomology.assay.InsecticideAssay.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.entomology.assay.InsecticideAssayController.create.mojo" name="dss.vector.solutions.entomology.assay.InsecticideAssay.form.create.button" />
</mjl:form>
