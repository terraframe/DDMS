...
<mjl:select var="current" valueAttribute="id" items="${mdss_ivcc_mrc_csu_entomology_assay_molecular_GABATestResult_testResult}" param="testResult">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.entomology.assay.molecular.GABATestResultController.create.mojo" name="dss.vector.solutions.entomology.assay.molecular.GABATestResult.form.create.button" />
</mjl:form>
