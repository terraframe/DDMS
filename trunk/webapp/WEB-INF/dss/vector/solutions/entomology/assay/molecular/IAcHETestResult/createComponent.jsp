...
<mjl:form name="dss.vector.solutions.entomology.assay.molecular.IAcHETestResult.form.name" id="dss.vector.solutions.entomology.assay.molecular.IAcHETestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.entomology.assay.molecular.IAcHETestResultController.create.mojo" name="dss.vector.solutions.entomology.assay.molecular.IAcHETestResult.form.create.button" />
</mjl:form>
