...
<mjl:form name="dss.vector.solutions.entomology.assay.AbstractAssay.form.name" id="dss.vector.solutions.entomology.assay.AbstractAssay.form.id" method="POST">
  ...
  <mjl:command value="Update" action="dss.vector.solutions.entomology.assay.AbstractAssayController.update.mojo" name="dss.vector.solutions.entomology.assay.AbstractAssay.form.update.button" />
  <mjl:command value="Delete" action="dss.vector.solutions.entomology.assay.AbstractAssayController.delete.mojo" name="dss.vector.solutions.entomology.assay.AbstractAssay.form.delete.button" />
  <mjl:command value="Cancel" action="dss.vector.solutions.entomology.assay.AbstractAssayController.cancel.mojo" name="dss.vector.solutions.entomology.assay.AbstractAssay.form.cancel.button" />
</mjl:form>
