...
<mjl:boolean param="testResult" />
  ...
  <mjl:command value="Create" action="dss.vector.solutions.entomology.assay.infectivity.PVivaxTestResultController.create.mojo" name="dss.vector.solutions.entomology.assay.infectivity.PVivaxTestResult.form.create.button" />
</mjl:form>
