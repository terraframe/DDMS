...
<mjl:form name="dss.vector.solutions.entomology.assay.biochemical.BAcetateTestResult.form.name" id="dss.vector.solutions.entomology.assay.biochemical.BAcetateTestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.entomology.assay.biochemical.BAcetateTestResultController.create.mojo" name="dss.vector.solutions.entomology.assay.biochemical.BAcetateTestResult.form.create.button" />
</mjl:form>
