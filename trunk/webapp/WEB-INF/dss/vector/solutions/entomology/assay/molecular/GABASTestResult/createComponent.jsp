...
<mjl:form name="dss.vector.solutions.entomology.assay.molecular.GABASTestResult.form.name" id="dss.vector.solutions.entomology.assay.molecular.GABASTestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.entomology.assay.molecular.GABASTestResultController.create.mojo" name="dss.vector.solutions.entomology.assay.molecular.GABASTestResult.form.create.button" />
</mjl:form>
