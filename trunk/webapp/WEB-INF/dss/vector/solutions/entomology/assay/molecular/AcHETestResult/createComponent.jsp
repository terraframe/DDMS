...
<mjl:form name="dss.vector.solutions.entomology.assay.molecular.AcHETestResult.form.name" id="dss.vector.solutions.entomology.assay.molecular.AcHETestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.entomology.assay.molecular.AcHETestResultController.create.mojo" name="dss.vector.solutions.entomology.assay.molecular.AcHETestResult.form.create.button" />
</mjl:form>
