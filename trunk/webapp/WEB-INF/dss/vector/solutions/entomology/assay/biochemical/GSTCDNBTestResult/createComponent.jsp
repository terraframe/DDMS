...
<mjl:form name="dss.vector.solutions.entomology.assay.biochemical.GSTCDNBTestResult.form.name" id="dss.vector.solutions.entomology.assay.biochemical.GSTCDNBTestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.entomology.assay.biochemical.GSTCDNBTestResultController.create.mojo" name="dss.vector.solutions.entomology.assay.biochemical.GSTCDNBTestResult.form.create.button" />
</mjl:form>
