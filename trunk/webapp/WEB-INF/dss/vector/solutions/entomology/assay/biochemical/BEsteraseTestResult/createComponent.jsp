...
<mjl:form name="dss.vector.solutions.entomology.assay.biochemical.BEsteraseTestResult.form.name" id="dss.vector.solutions.entomology.assay.biochemical.BEsteraseTestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.entomology.assay.biochemical.BEsteraseTestResultController.create.mojo" name="dss.vector.solutions.entomology.assay.biochemical.BEsteraseTestResult.form.create.button" />
</mjl:form>
