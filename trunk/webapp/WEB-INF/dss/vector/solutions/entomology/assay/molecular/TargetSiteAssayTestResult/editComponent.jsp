...
<mjl:select var="current" valueAttribute="id" items="${dss_vector_solutions_entomology_assay_AssayTestResult_mosquito}" param="mosquito">
  ...
  <mjl:command value="Delete" action="dss.vector.solutions.entomology.assay.molecular.TargetSiteAssayTestResultController.delete.mojo" name="dss.vector.solutions.entomology.assay.molecular.TargetSiteAssayTestResult.form.delete.button" />
  <mjl:command value="Cancel" action="dss.vector.solutions.entomology.assay.molecular.TargetSiteAssayTestResultController.cancel.mojo" name="dss.vector.solutions.entomology.assay.molecular.TargetSiteAssayTestResult.form.cancel.button" />
</mjl:form>
