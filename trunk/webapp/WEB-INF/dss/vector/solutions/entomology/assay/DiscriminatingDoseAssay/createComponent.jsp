...
<mjl:form name="dss.vector.solutions.entomology.assay.DiscriminatingDoseAssay.form.name" id="dss.vector.solutions.entomology.assay.DiscriminatingDoseAssay.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.entomology.assay.DiscriminatingDoseAssayController.create.mojo" name="dss.vector.solutions.entomology.assay.DiscriminatingDoseAssay.form.create.button" />
</mjl:form>
