...
<dl>
  <mjl:form id="dss.vector.solutions.entomology.MosquitoCollection.form.id" name="dss.vector.solutions.entomology.MosquitoCollection.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.entomology.MosquitoCollection.form.create.button" value="${Localized_Create}" action="dss.vector.solutions.entomology.MosquitoCollectionController.create.mojo" />
  </mjl:form>
</dl>
