...
<mjl:commandLink display="${item.specie.keyName}" action="dss.vector.solutions.entomology.SpecieController.view.mojo" name="dss.vector.solutions.entomology.Specie.form.view.link">
  ...
  <mjl:command value="Edit" action="dss.vector.solutions.entomology.UninterestingSpecieGroupController.edit.mojo" name="dss.vector.solutions.entomology.UninterestingSpecieGroup.form.edit.button" />
  <br />
</mjl:form>
<dl>
  <dt>
...
<mjl:commandLink display="View All" action="dss.vector.solutions.entomology.UninterestingSpecieGroupController.viewAll.mojo" name="dss.vector.solutions.entomology.UninterestingSpecieGroup.viewAll.link" />
