...
<mjl:select var="current" valueAttribute="id" items="${mdss_ivcc_mrc_csu_entomology_TrueSpecieEntity_specie}" param="specie">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.entomology.UninterestingSpecieGroupController.create.mojo" name="dss.vector.solutions.entomology.UninterestingSpecieGroup.form.create.button" />
</mjl:form>
