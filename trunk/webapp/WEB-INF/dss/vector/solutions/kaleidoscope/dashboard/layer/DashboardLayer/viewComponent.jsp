...
<c:set var="page_title" scope="request" value="View_DashboardLayer" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form method="POST" name="dss.vector.solutions.kaleidoscope.dashboard.layer.DashboardLayer.form.name" id="dss.vector.solutions.kaleidoscope.dashboard.layer.DashboardLayer.form.id">
    ...
    <mjl:command name="dss.vector.solutions.kaleidoscope.dashboard.layer.DashboardLayer.form.edit.button" action="dss.vector.solutions.kaleidoscope.dashboard.layer.DashboardLayerController.edit.mojo" value="Edit" />
  </mjl:form>
</dl>
<mjl:commandLink name="dss.vector.solutions.kaleidoscope.dashboard.layer.DashboardLayer.viewAll.link" action="dss.vector.solutions.kaleidoscope.dashboard.layer.DashboardLayerController.viewAll.mojo">
