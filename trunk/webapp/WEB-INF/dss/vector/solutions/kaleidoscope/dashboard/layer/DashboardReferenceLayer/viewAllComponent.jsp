...
<c:set var="page_title" scope="request" value="View_All_DashboardReferenceLayer" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<mjl:table even="evenRow" var="item" query="${query}" classes="displayTable" odd="oddRow">
  <mjl:context action="dss.vector.solutions.kaleidoscope.dashboard.layer.DashboardReferenceLayerController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink name="view.link" action="dss.vector.solutions.kaleidoscope.dashboard.layer.DashboardReferenceLayerController.view.mojo">
...
<br />
<mjl:commandLink name="DashboardReferenceLayerController.newInstance" action="dss.vector.solutions.kaleidoscope.dashboard.layer.DashboardReferenceLayerController.newInstance.mojo">
