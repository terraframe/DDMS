...
<c:set var="page_title" scope="request" value="View_DashboardThematicStyle" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form method="POST" name="dss.vector.solutions.kaleidoscope.dashboard.DashboardThematicStyle.form.name" id="dss.vector.solutions.kaleidoscope.dashboard.DashboardThematicStyle.form.id">
    ...
    <mjl:component item="${item}" param="dto">
      ...
      <mjl:dt attribute="numBubbleSizeCategories">
        ${item.numBubbleSizeCategories}
      </mjl:dt>
      <mjl:dt attribute="numGradientPointCategories">
        ${item.numGradientPointCategories}
      </mjl:dt>
      <mjl:dt attribute="numGradientPolygonCategories">
        ${item.numGradientPolygonCategories}
      </mjl:dt>
    ...
    <mjl:command name="dss.vector.solutions.kaleidoscope.dashboard.DashboardThematicStyle.form.edit.button" action="dss.vector.solutions.kaleidoscope.dashboard.DashboardThematicStyleController.edit.mojo" value="Edit" />
  </mjl:form>
</dl>
<mjl:commandLink name="dss.vector.solutions.kaleidoscope.dashboard.DashboardThematicStyle.viewAll.link" action="dss.vector.solutions.kaleidoscope.dashboard.DashboardThematicStyleController.viewAll.mojo">
