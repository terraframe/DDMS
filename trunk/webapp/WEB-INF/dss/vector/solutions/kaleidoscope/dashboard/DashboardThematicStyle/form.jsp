...
<mjl:component item="${item}" param="dto">
  ...
  <mjl:dt attribute="numBubbleSizeCategories">
    <mjl:input param="numBubbleSizeCategories" type="text" />
  </mjl:dt>
  <mjl:dt attribute="numGradientPointCategories">
    <mjl:input param="numGradientPointCategories" type="text" />
  </mjl:dt>
  <mjl:dt attribute="numGradientPolygonCategories">
    <mjl:input param="numGradientPolygonCategories" type="text" />
  </mjl:dt>
