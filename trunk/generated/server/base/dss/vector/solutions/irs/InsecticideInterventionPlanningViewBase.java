...
@com.terraframe.mojo.business.ClassSignature(hash = -1937394268)
/**
 ...
 */
public abstract class InsecticideInterventionPlanningViewBase extends dss.vector.solutions.irs.InterventionPlanningView implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1937394268;
  ...
  public static com.terraframe.mojo.dataaccess.MdAttributeDAOIF getRequiredInsecticideMd()
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.irs.InsecticideInterventionPlanningView.CLASS);
  ...
  {
    return (InsecticideInterventionPlanningView) com.terraframe.mojo.business.View.get(id);
  }
