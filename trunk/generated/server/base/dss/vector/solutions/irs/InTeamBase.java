...
@com.terraframe.mojo.business.ClassSignature(hash = 1359154994)
/**
 ...
 */
public abstract class InTeamBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1359154994;
  
  public InTeamBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.irs.InTeam.CLASS);
  ...
  public static InTeamQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    InTeamQuery query = new InTeamQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public dss.vector.solutions.irs.SprayTeam getParent()
  {
    return (dss.vector.solutions.irs.SprayTeam) super.getParent();
  }
  
  public dss.vector.solutions.irs.SprayOperator getChild()
  {
    return (dss.vector.solutions.irs.SprayOperator) super.getChild();
  }
  
  public static InTeam get(String id)
  {
    return (InTeam) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static InTeam getByKey(String key)
  {
    return (InTeam) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static InTeam lock(java.lang.String id)
  {
    InTeam _instance = InTeam.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static InTeam unlock(java.lang.String id)
  {
    InTeam _instance = InTeam.get(id);
    _instance.unlock();
