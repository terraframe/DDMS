...
@com.runwaysdk.business.ClassSignature(hash = 1406977451)
/**
 ...
 */
public abstract class OperatorSprayStatusBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1406977451;
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.irs.OperatorSprayStatus.CLASS);
  ...
  public static com.runwaysdk.dataaccess.MdAttributeIntegerDAOIF getOperatorTargetMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.irs.OperatorSprayStatus.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeIntegerDAOIF)mdClassIF.definesAttribute(OPERATORTARGET);
  }
  ...
  {
    OperatorSprayStatusQuery query = new OperatorSprayStatusQuery(new com.runwaysdk.query.QueryFactory());
  ...
  {
    return (OperatorSprayStatus) com.runwaysdk.business.Business.get(id);
  }
  
  public static OperatorSprayStatus getByKey(String key)
  {
    return (OperatorSprayStatus) com.runwaysdk.business.Business.get(CLASS, key);
  }
