...
@com.terraframe.mojo.business.ClassSignature(hash = -139303741)
/**
 ...
 */
public abstract class SprayDataBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -139303741;
  
  public SprayDataBase()
  {
    super();
  }
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.irs.SprayData.CLASS);
  ...
  public static SprayDataQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    SprayDataQuery query = new SprayDataQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static SprayData get(String id)
  {
    return (SprayData) com.terraframe.mojo.business.Business.get(id);
  }
  
  public static SprayData getByKey(String key)
  {
    return (SprayData) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
  
  public static SprayData lock(java.lang.String id)
  {
    SprayData _instance = SprayData.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static SprayData unlock(java.lang.String id)
  {
    SprayData _instance = SprayData.get(id);
    _instance.unlock();
