...
@com.terraframe.mojo.business.ClassSignature(hash = -1903510940)
/**
 ...
 */
public abstract class SupervisorBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1903510940;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.irs.Supervisor.CLASS);
  ...
  public static SupervisorQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    SupervisorQuery query = new SupervisorQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static Supervisor get(String id)
  {
    return (Supervisor) com.terraframe.mojo.business.Business.get(id);
  }
  
  public static Supervisor getByKey(String key)
  {
    return (Supervisor) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
  
  public static Supervisor lock(java.lang.String id)
  {
    Supervisor _instance = Supervisor.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static Supervisor unlock(java.lang.String id)
  {
    Supervisor _instance = Supervisor.get(id);
    _instance.unlock();
