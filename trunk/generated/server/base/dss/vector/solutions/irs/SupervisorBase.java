...
public abstract class SupervisorBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    SupervisorQuery query = new SupervisorQuery(new com.runwaysdk.query.QueryFactory());
  ...
  {
    return (Supervisor) com.runwaysdk.business.Business.get(id);
  }
  
  public static Supervisor getByKey(String key)
  {
    return (Supervisor) com.runwaysdk.business.Business.get(CLASS, key);
  }
