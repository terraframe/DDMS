 ...
 */
public abstract class GeoTargetBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.irs.GeoTarget.CLASS);
  ...
  {
    GeoTargetQuery query = new GeoTargetQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (GeoTarget) com.terraframe.mojo.business.Business.get(id);
  }
  
  public static GeoTarget getByKey(String key)
  {
    return (GeoTarget) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
