...
@com.runwaysdk.business.ClassSignature(hash = 1811173176)
/**
 ...
 */
public abstract class ResourceTargetBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1811173176;
  ...
  {
    ResourceTargetQuery query = new ResourceTargetQuery(new com.runwaysdk.query.QueryFactory());
  ...
  {
    return (ResourceTarget) com.runwaysdk.business.Business.get(id);
  }
  
  public static ResourceTarget getByKey(String key)
  {
    return (ResourceTarget) com.runwaysdk.business.Business.get(CLASS, key);
  }
