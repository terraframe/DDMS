...
private static final long serialVersionUID = 1243602411;
  ...
  {
    return (com.terraframe.mojo.query.SelectableChar)this.getSelectable(dss.vector.solutions.irs.TeamSprayView.CONCRETEID, alias, null);

  }
 
  public com.terraframe.mojo.query.SelectableChar getConcreteId(String alias, String displayLabel)
  {
    return (com.terraframe.mojo.query.SelectableChar)this.getSelectable(dss.vector.solutions.irs.TeamSprayView.CONCRETEID, alias, displayLabel);
  ...
  {
    return (com.terraframe.mojo.query.SelectableChar)this.getSelectable(dss.vector.solutions.irs.TeamSprayView.ID, alias, null);

  }
 
  public com.terraframe.mojo.query.SelectableChar getId(String alias, String displayLabel)
  {
    return (com.terraframe.mojo.query.SelectableChar)this.getSelectable(dss.vector.solutions.irs.TeamSprayView.ID, alias, displayLabel);
  ...
  {
    return (com.terraframe.mojo.query.SelectableMoment)this.getSelectable(dss.vector.solutions.irs.TeamSprayView.SPRAYDATE, alias, null);

  }
 
  public com.terraframe.mojo.query.SelectableMoment getSprayDate(String alias, String displayLabel)
  {
    return (com.terraframe.mojo.query.SelectableMoment)this.getSelectable(dss.vector.solutions.irs.TeamSprayView.SPRAYDATE, alias, displayLabel);
  ...
  {
    return (com.terraframe.mojo.query.SelectableInteger)this.getSelectable(dss.vector.solutions.irs.TeamSprayView.TARGET, alias, null);

  }
 
  public com.terraframe.mojo.query.SelectableInteger getTarget(String alias, String displayLabel)
  {
    return (com.terraframe.mojo.query.SelectableInteger)this.getSelectable(dss.vector.solutions.irs.TeamSprayView.TARGET, alias, displayLabel);
  ...
  {
    return (com.terraframe.mojo.query.SelectableInteger)this.getSelectable(dss.vector.solutions.irs.TeamSprayView.TEAMSPRAYWEEK, alias, null);

  }
 
  public com.terraframe.mojo.query.SelectableInteger getTeamSprayWeek(String alias, String displayLabel)
  {
    return (com.terraframe.mojo.query.SelectableInteger)this.getSelectable(dss.vector.solutions.irs.TeamSprayView.TEAMSPRAYWEEK, alias, displayLabel);
