...
public abstract class GeoTargetViewBase extends com.runwaysdk.business.View implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  public static GeoTargetView get(String id)
  {
    return (GeoTargetView) com.runwaysdk.business.View.get(id);
  }
  
  public static dss.vector.solutions.irs.GeoTargetView[] applyAll(dss.vector.solutions.irs.GeoTargetView[] views)
  {
    String msg = "This method should never be invoked.  It should be overwritten in dss.vector.solutions.irs.GeoTargetView.java";
  ...
  {
    GeoTargetView _instance = GeoTargetView.get(id);
    _instance.deleteConcrete();
  }
  
  public java.lang.Integer[] getCalculatedTargets()
  {
    String msg = "This method should never be invoked.  It should be overwritten in dss.vector.solutions.irs.GeoTargetView.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  
  public static final java.lang.Integer[] getCalculatedTargets(java.lang.String id)
  {
    GeoTargetView _instance = GeoTargetView.get(id);
    return _instance.getCalculatedTargets();
  }
  
  public static dss.vector.solutions.irs.GeoTargetView[] getGeoTargetViews(java.lang.String geoId, dss.vector.solutions.general.MalariaSeason season)
  {
    String msg = "This method should never be invoked.  It should be overwritten in dss.vector.solutions.irs.GeoTargetView.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  
  public static dss.vector.solutions.irs.GeoTargetView[] getGeoTargets(java.lang.String[] geoEntities, dss.vector.solutions.general.MalariaSeason season)
  {
    String msg = "This method should never be invoked.  It should be overwritten in dss.vector.solutions.irs.GeoTargetView.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  
  public static dss.vector.solutions.irs.GeoTargetView[] lockAll(dss.vector.solutions.irs.GeoTargetView[] views)
  {
    String msg = "This method should never be invoked.  It should be overwritten in dss.vector.solutions.irs.GeoTargetView.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  
  public static dss.vector.solutions.irs.GeoTargetView sum(dss.vector.solutions.geo.generated.GeoEntity geoEntity, dss.vector.solutions.irs.GeoTargetView[] views)
  {
    String msg = "This method should never be invoked.  It should be overwritten in dss.vector.solutions.irs.GeoTargetView.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  
  public static dss.vector.solutions.irs.GeoTargetView[] unlockAll(dss.vector.solutions.irs.GeoTargetView[] views)
  {
    String msg = "This method should never be invoked.  It should be overwritten in dss.vector.solutions.irs.GeoTargetView.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
