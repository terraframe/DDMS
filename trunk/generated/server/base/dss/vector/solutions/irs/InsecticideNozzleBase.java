...
@com.terraframe.mojo.business.ClassSignature(hash = -748609388)
/**
...
public abstract class InsecticideNozzleBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -748609388;
  ...
  {
    InsecticideNozzleQuery query = new InsecticideNozzleQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (InsecticideNozzle) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static InsecticideNozzle getByKey(String key)
  {
    return (InsecticideNozzle) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
