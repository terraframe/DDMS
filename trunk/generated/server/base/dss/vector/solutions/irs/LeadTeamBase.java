...
@com.terraframe.mojo.business.ClassSignature(hash = -1645318163)
/**
 ...
 */
public abstract class LeadTeamBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1645318163;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.irs.LeadTeam.CLASS);
  ...
  public static LeadTeamQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    LeadTeamQuery query = new LeadTeamQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (LeadTeam) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static LeadTeam getByKey(String key)
  {
    return (LeadTeam) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static LeadTeam lock(java.lang.String id)
  {
    LeadTeam _instance = LeadTeam.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static LeadTeam unlock(java.lang.String id)
  {
    LeadTeam _instance = LeadTeam.get(id);
    _instance.unlock();
