...
@com.runwaysdk.business.ClassSignature(hash = -1380620115)
/**
 ...
 */
public abstract class LethalTimePropertyBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1380620115;
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.general.LethalTimeProperty.CLASS);
  ...
  public static com.runwaysdk.dataaccess.MdAttributeIntegerDAOIF getLowerPercentMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.general.LethalTimeProperty.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeIntegerDAOIF)mdClassIF.definesAttribute(LOWERPERCENT);
  }
  ...
  public static com.runwaysdk.dataaccess.MdAttributeIntegerDAOIF getLowerTimeMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.general.LethalTimeProperty.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeIntegerDAOIF)mdClassIF.definesAttribute(LOWERTIME);
  }
  ...
  public static com.runwaysdk.dataaccess.MdAttributeIntegerDAOIF getUpperPercentMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.general.LethalTimeProperty.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeIntegerDAOIF)mdClassIF.definesAttribute(UPPERPERCENT);
  }
  ...
  public static com.runwaysdk.dataaccess.MdAttributeIntegerDAOIF getUpperTimeMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.general.LethalTimeProperty.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeIntegerDAOIF)mdClassIF.definesAttribute(UPPERTIME);
  }
  ...
  {
    LethalTimePropertyQuery query = new LethalTimePropertyQuery(new com.runwaysdk.query.QueryFactory());
  ...
  {
    return (LethalTimeProperty) com.runwaysdk.business.Business.get(id);
  }
  
  public static LethalTimeProperty getByKey(String key)
  {
    return (LethalTimeProperty) com.runwaysdk.business.Business.get(CLASS, key);
  }
