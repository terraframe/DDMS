...
@com.runwaysdk.business.ClassSignature(hash = 1208665707)
/**
 ...
 */
public abstract class InsecticideBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1208665707;
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.general.Insecticide.CLASS);
  ...
  public static com.runwaysdk.dataaccess.MdAttributeDAOIF getUnitsMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.general.Insecticide.CLASS);
  ...
  {
    InsecticideQuery query = new InsecticideQuery(new com.runwaysdk.query.QueryFactory());
  ...
  {
    return (Insecticide) com.runwaysdk.business.Business.get(id);
  }
  
  public static Insecticide getByKey(String key)
  {
    return (Insecticide) com.runwaysdk.business.Business.get(CLASS, key);
  }
