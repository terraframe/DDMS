...
@com.terraframe.mojo.business.ClassSignature(hash = -716940497)
/**
 ...
 */
public abstract class OutbreakCalculationMasterBase extends com.terraframe.mojo.system.EnumerationMaster implements com.terraframe.mojo.generation.loader.Reloadable
{
  public final static String CLASS = "dss.vector.solutions.general.OutbreakCalculationMaster";
  private static final long serialVersionUID = -716940497;
  ...
  {
    OutbreakCalculationMasterQuery query = new OutbreakCalculationMasterQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (OutbreakCalculationMaster) com.terraframe.mojo.business.Business.get(id);
  }
  
  public static OutbreakCalculationMaster getByKey(String key)
  {
    return (OutbreakCalculationMaster) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
  
  public static OutbreakCalculationMaster getEnumeration(String enumName)
  {
    return (OutbreakCalculationMaster) com.terraframe.mojo.business.Business.getEnumeration("dss.vector.solutions.general.OutbreakCalculationMaster",enumName);
  }
