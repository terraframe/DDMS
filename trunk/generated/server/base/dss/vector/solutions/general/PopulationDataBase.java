...
@com.terraframe.mojo.business.ClassSignature(hash = -1208074183)
/**
 ...
 */
public abstract class PopulationDataBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1208074183;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.general.PopulationData.CLASS);
  ...
  {
    PopulationDataQuery query = new PopulationDataQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (PopulationData) com.terraframe.mojo.business.Business.get(id);
  }
  
  public static PopulationData getByKey(String key)
  {
    return (PopulationData) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
