 ...
 */
public abstract class EpiWeekBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.general.EpiWeek.CLASS);
  ...
  {
    EpiWeekQuery query = new EpiWeekQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  public com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.general.ThresholdData> getAllThresholds()
  {
    return (com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.general.ThresholdData>) getParents(dss.vector.solutions.general.WeeklyThreshold.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.general.WeeklyThreshold> getAllThresholdsRel()
  {
    return (com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.general.WeeklyThreshold>) getParentRelationships(dss.vector.solutions.general.WeeklyThreshold.CLASS);
  }
  ...
  {
    com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.general.WeeklyThreshold> iterator = (com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.general.WeeklyThreshold>) getRelationshipsWithParent(thresholdData, dss.vector.solutions.general.WeeklyThreshold.CLASS);
    try
    {
      if (iterator.hasNext())
      {
  ...
  {
    return (EpiWeek) com.terraframe.mojo.business.Business.get(id);
  }
  
  public static EpiWeek getByKey(String key)
  {
    return (EpiWeek) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
