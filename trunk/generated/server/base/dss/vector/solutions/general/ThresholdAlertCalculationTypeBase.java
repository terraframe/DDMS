 ...
 */
public abstract class ThresholdAlertCalculationTypeBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  public static com.runwaysdk.dataaccess.MdAttributeIntegerDAOIF getClinicalPositivePercentageMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.general.ThresholdAlertCalculationType.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeIntegerDAOIF)mdClassIF.definesAttribute(CLINICALPOSITIVEPERCENTAGE);
  }
  ...
  public static com.runwaysdk.dataaccess.MdAttributeEnumerationDAOIF getCountingMethodMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.general.ThresholdAlertCalculationType.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeEnumerationDAOIF)mdClassIF.definesAttribute(COUNTINGMETHOD);
  }
  ...
  public static com.runwaysdk.dataaccess.MdAttributeReferenceDAOIF getEpidemicUniversalMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.general.ThresholdAlertCalculationType.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeReferenceDAOIF)mdClassIF.definesAttribute(EPIDEMICUNIVERSAL);
  }
  ...
  public static ThresholdAlertCalculationTypeQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    ThresholdAlertCalculationTypeQuery query = new ThresholdAlertCalculationTypeQuery(new com.runwaysdk.query.QueryFactory());
    com.runwaysdk.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static ThresholdAlertCalculationType get(String id)
  {
    return (ThresholdAlertCalculationType) com.runwaysdk.business.Business.get(id);
  }
  
  public static ThresholdAlertCalculationType getByKey(String key)
  {
    return (ThresholdAlertCalculationType) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static ThresholdAlertCalculationType lock(java.lang.String id)
  {
    ThresholdAlertCalculationType _instance = ThresholdAlertCalculationType.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static ThresholdAlertCalculationType unlock(java.lang.String id)
  {
    ThresholdAlertCalculationType _instance = ThresholdAlertCalculationType.get(id);
    _instance.unlock();
