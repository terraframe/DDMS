 ...
 */
public abstract class MalariaSeasonBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.general.MalariaSeason.CLASS);
  ...
  {
    MalariaSeasonQuery query = new MalariaSeasonQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (MalariaSeason) com.terraframe.mojo.business.Business.get(id);
  }
  
  public static MalariaSeason getByKey(String key)
  {
    return (MalariaSeason) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
