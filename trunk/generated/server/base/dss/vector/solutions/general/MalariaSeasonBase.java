...
@com.runwaysdk.business.ClassSignature(hash = 2015998284)
/**
 ...
 */
public abstract class MalariaSeasonBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 2015998284;
  ...
  public static com.runwaysdk.dataaccess.MdAttributeLocalCharacterDAOIF getSeasonLabelMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.general.MalariaSeason.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeLocalCharacterDAOIF)mdClassIF.definesAttribute(SEASONLABEL);
  }
  ...
  public static MalariaSeasonQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
  ...
  public static MalariaSeason get(String id)
  {
    return (MalariaSeason) com.runwaysdk.business.Business.get(id);
  }
  
  public static MalariaSeason getByKey(String key)
  {
    return (MalariaSeason) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static dss.vector.solutions.general.MalariaSeason[] getAll()
  {
    String msg = "This method should never be invoked.  It should be overwritten in dss.vector.solutions.general.MalariaSeason.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  
  public static dss.vector.solutions.general.MalariaSeason[] getAllForDisease()
  {
    String msg = "This method should never be invoked.  It should be overwritten in dss.vector.solutions.general.MalariaSeason.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  
  public static dss.vector.solutions.general.MalariaSeasonQuery getAllInstancesForDisease(java.lang.String sortAttribute, java.lang.Boolean ascending, java.lang.Integer pageSize, java.lang.Integer pageNumber)
  {
    String msg = "This method should never be invoked.  It should be overwritten in dss.vector.solutions.general.MalariaSeason.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  
  public dss.vector.solutions.general.EpiDate[] getEpiWeeks()
  {
    String msg = "This method should never be invoked.  It should be overwritten in dss.vector.solutions.general.MalariaSeason.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  
  public static final dss.vector.solutions.general.EpiDate[] getEpiWeeks(java.lang.String id)
  {
    MalariaSeason _instance = MalariaSeason.get(id);
    return _instance.getEpiWeeks();
  }
  
  public static dss.vector.solutions.general.MalariaSeason getSeasonByDate(java.util.Date date)
  {
    String msg = "This method should never be invoked.  It should be overwritten in dss.vector.solutions.general.MalariaSeason.java";
    throw new com.runwaysdk.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  
  public static MalariaSeason lock(java.lang.String id)
  {
    MalariaSeason _instance = MalariaSeason.get(id);
    _instance.lock();
  ...
  public static MalariaSeason unlock(java.lang.String id)
  {
    MalariaSeason _instance = MalariaSeason.get(id);
    _instance.unlock();
