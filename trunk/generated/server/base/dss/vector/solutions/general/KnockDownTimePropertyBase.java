 ...
 */
public abstract class KnockDownTimePropertyBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.general.KnockDownTimeProperty.CLASS);
  ...
  {
    KnockDownTimePropertyQuery query = new KnockDownTimePropertyQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (KnockDownTimeProperty) com.terraframe.mojo.business.Business.get(id);
  }
  
  public static KnockDownTimeProperty getByKey(String key)
  {
    return (KnockDownTimeProperty) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
