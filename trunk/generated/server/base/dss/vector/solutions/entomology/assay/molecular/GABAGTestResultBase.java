...
@com.terraframe.mojo.business.ClassSignature(hash = 1070317826)
/**
...
public abstract class GABAGTestResultBase extends dss.vector.solutions.entomology.assay.molecular.TargetSiteAssayTestResult implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1070317826;
  ...
  public static GABAGTestResult getByKey(String key)
  {
    return (GABAGTestResult) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
