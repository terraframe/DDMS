...
@com.terraframe.mojo.business.ClassSignature(hash = -1644053098)
/**
 ...
 */
public abstract class KnockDownAssayViewBase extends com.terraframe.mojo.business.View implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1644053098;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.entomology.assay.KnockDownAssayView.CLASS);
  ...
  {
    return (KnockDownAssayView) com.terraframe.mojo.business.View.get(id);
  }
