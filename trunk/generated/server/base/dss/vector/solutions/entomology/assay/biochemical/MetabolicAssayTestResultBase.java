...
@com.terraframe.mojo.business.ClassSignature(hash = -1517917461)
/**
...
public abstract class MetabolicAssayTestResultBase extends dss.vector.solutions.entomology.assay.AssayTestResult implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1517917461;
  ...
  public static MetabolicAssayTestResult getByKey(String key)
  {
    return (MetabolicAssayTestResult) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
