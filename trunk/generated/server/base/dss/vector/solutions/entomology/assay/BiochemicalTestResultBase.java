...
@com.terraframe.mojo.business.ClassSignature(hash = -1908058066)
/**
 ...
 */
public abstract class BiochemicalTestResultBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1908058066;
  
  public BiochemicalTestResultBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.entomology.assay.BiochemicalTestResult.CLASS);
  ...
  public static BiochemicalTestResultQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    BiochemicalTestResultQuery query = new BiochemicalTestResultQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public dss.vector.solutions.entomology.Mosquito getParent()
  {
    return (dss.vector.solutions.entomology.Mosquito) super.getParent();
  }
  ...
  public static BiochemicalTestResult get(String id)
  {
    return (BiochemicalTestResult) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static BiochemicalTestResult getByKey(String key)
  {
    return (BiochemicalTestResult) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static BiochemicalTestResult lock(java.lang.String id)
  {
    BiochemicalTestResult _instance = BiochemicalTestResult.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static BiochemicalTestResult unlock(java.lang.String id)
  {
    BiochemicalTestResult _instance = BiochemicalTestResult.get(id);
    _instance.unlock();
