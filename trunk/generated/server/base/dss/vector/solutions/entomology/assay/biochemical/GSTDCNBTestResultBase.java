...
@com.terraframe.mojo.business.ClassSignature(hash = -1110153367)
/**
...
public abstract class GSTDCNBTestResultBase extends dss.vector.solutions.entomology.assay.biochemical.MetabolicAssayTestResult implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1110153367;
  ...
  public static GSTDCNBTestResult getByKey(String key)
  {
    return (GSTDCNBTestResult) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
