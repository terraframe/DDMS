...
@com.terraframe.mojo.business.ClassSignature(hash = 852100715)
/**
...
public abstract class MosquitoCollectionPointBase extends dss.vector.solutions.entomology.ConcreteMosquitoCollection implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 852100715;
  ...
  public static MosquitoCollectionPoint getByKey(String key)
  {
    return (MosquitoCollectionPoint) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
  ...
  public static dss.vector.solutions.entomology.MosquitoCollectionPoint searchByGeoEntityAndDateAndCollectionMethod(dss.vector.solutions.geo.generated.GeoEntity geoEntity, java.util.Date collectionDate, dss.vector.solutions.ontology.Term collectionMethod)
  {
    String msg = "This method should never be invoked.  It should be overwritten in dss.vector.solutions.entomology.MosquitoCollectionPoint.java";
    throw new com.terraframe.mojo.dataaccess.metadata.ForbiddenMethodException(msg);
  }
