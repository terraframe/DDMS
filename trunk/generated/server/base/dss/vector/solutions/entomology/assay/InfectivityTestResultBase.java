...
@com.terraframe.mojo.business.ClassSignature(hash = 112680532)
/**
 ...
 */
public abstract class InfectivityTestResultBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 112680532;
  
  public InfectivityTestResultBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.entomology.assay.InfectivityTestResult.CLASS);
  ...
  public static InfectivityTestResultQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    InfectivityTestResultQuery query = new InfectivityTestResultQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  public static InfectivityTestResult get(String id)
  {
    return (InfectivityTestResult) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static InfectivityTestResult getByKey(String key)
  {
    return (InfectivityTestResult) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static InfectivityTestResult lock(java.lang.String id)
  {
    InfectivityTestResult _instance = InfectivityTestResult.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static InfectivityTestResult unlock(java.lang.String id)
  {
    InfectivityTestResult _instance = InfectivityTestResult.get(id);
    _instance.unlock();
