...
@com.runwaysdk.business.ClassSignature(hash = -1401250450)
/**
 ...
 */
public abstract class PupalCollectionBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1401250450;
  
  public PupalCollectionBase()
  {
    super();
  }
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.entomology.PupalCollection.CLASS);
  ...
  public static com.runwaysdk.dataaccess.MdAttributeTextDAOIF getNotesMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.entomology.PupalCollection.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeTextDAOIF)mdClassIF.definesAttribute(NOTES);
  }
  ...
  public static PupalCollectionQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    PupalCollectionQuery query = new PupalCollectionQuery(new com.runwaysdk.query.QueryFactory());
    com.runwaysdk.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static PupalCollection get(String id)
  {
    return (PupalCollection) com.runwaysdk.business.Business.get(id);
  }
  
  public static PupalCollection getByKey(String key)
  {
    return (PupalCollection) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static PupalCollection lock(java.lang.String id)
  {
    PupalCollection _instance = PupalCollection.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static PupalCollection unlock(java.lang.String id)
  {
    PupalCollection _instance = PupalCollection.get(id);
    _instance.unlock();
