...
@com.terraframe.mojo.business.ClassSignature(hash = -1593645369)
/**
...
public abstract class GSTCDNBTestResultBase extends dss.vector.solutions.entomology.assay.biochemical.MetabolicAssayTestResult implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1593645369;
  ...
  public static GSTCDNBTestResult getByKey(String key)
  {
    return (GSTCDNBTestResult) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
