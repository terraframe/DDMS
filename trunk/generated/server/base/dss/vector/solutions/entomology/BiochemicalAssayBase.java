 ...
 */
public abstract class BiochemicalAssayBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.entomology.BiochemicalAssay.CLASS);
  ...
  public static com.runwaysdk.dataaccess.MdAttributeIntegerDAOIF getNumberElevatedMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.entomology.BiochemicalAssay.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeIntegerDAOIF)mdClassIF.definesAttribute(NUMBERELEVATED);
  }
  ...
  {
    BiochemicalAssayQuery query = new BiochemicalAssayQuery(new com.runwaysdk.query.QueryFactory());
  ...
  {
    return (BiochemicalAssay) com.runwaysdk.business.Business.get(id);
  }
  
  public static BiochemicalAssay getByKey(String key)
  {
    return (BiochemicalAssay) com.runwaysdk.business.Business.get(CLASS, key);
  }
