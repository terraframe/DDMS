...
@com.terraframe.mojo.business.ClassSignature(hash = 631611551)
/**
...
public abstract class ConcreteMosquitoCollectionBase extends dss.vector.solutions.entomology.AbstractMosquitoCollection implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 631611551;
  ...
  public static ConcreteMosquitoCollection getByKey(String key)
  {
    return (ConcreteMosquitoCollection) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
