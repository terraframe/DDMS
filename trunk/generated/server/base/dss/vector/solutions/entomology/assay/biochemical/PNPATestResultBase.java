...
@com.terraframe.mojo.business.ClassSignature(hash = 396582377)
/**
...
public abstract class PNPATestResultBase extends dss.vector.solutions.entomology.assay.biochemical.MetabolicAssayTestResult implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 396582377;
  ...
  public static PNPATestResult getByKey(String key)
  {
    return (PNPATestResult) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
