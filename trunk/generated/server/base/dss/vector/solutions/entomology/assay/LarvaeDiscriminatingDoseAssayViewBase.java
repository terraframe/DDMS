...
@com.terraframe.mojo.business.ClassSignature(hash = -1106815414)
/**
 ...
 */
public abstract class LarvaeDiscriminatingDoseAssayViewBase extends com.terraframe.mojo.business.View implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1106815414;
  ...
  public static com.terraframe.mojo.dataaccess.MdAttributeDAOIF getCollectionLabelMd()
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.entomology.assay.LarvaeDiscriminatingDoseAssayView.CLASS);
  ...
  public static LarvaeDiscriminatingDoseAssayView get(String id)
  {
    return (LarvaeDiscriminatingDoseAssayView) com.terraframe.mojo.business.View.get(id);
  }
  
  public static dss.vector.solutions.entomology.assay.LarvaeDiscriminatingDoseAssayViewQuery getPage(java.lang.String sortAttribute, java.lang.Boolean isAscending, java.lang.Integer pageSize, java.lang.Integer pageNumber)
  {
    String msg = "This method should never be invoked.  It should be overwritten in dss.vector.solutions.entomology.assay.LarvaeDiscriminatingDoseAssayView.java";
