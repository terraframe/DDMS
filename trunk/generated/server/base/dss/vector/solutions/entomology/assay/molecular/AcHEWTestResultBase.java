...
@com.terraframe.mojo.business.ClassSignature(hash = -3182036)
/**
...
public abstract class AcHEWTestResultBase extends dss.vector.solutions.entomology.assay.molecular.TargetSiteAssayTestResult implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -3182036;
  ...
  public static AcHEWTestResult getByKey(String key)
  {
    return (AcHEWTestResult) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
