...
@com.terraframe.mojo.business.ClassSignature(hash = -810603151)
/**
...
public abstract class TargetSiteAssayTestResultBase extends dss.vector.solutions.entomology.assay.AssayTestResult implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -810603151;
  ...
  public static TargetSiteAssayTestResult getByKey(String key)
  {
    return (TargetSiteAssayTestResult) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
