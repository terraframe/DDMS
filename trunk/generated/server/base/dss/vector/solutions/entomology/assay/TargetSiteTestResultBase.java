...
@com.terraframe.mojo.business.ClassSignature(hash = -1632248200)
/**
 ...
 */
public abstract class TargetSiteTestResultBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1632248200;
  
  public TargetSiteTestResultBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.entomology.assay.TargetSiteTestResult.CLASS);
  ...
  public static TargetSiteTestResultQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    TargetSiteTestResultQuery query = new TargetSiteTestResultQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  public static TargetSiteTestResult get(String id)
  {
    return (TargetSiteTestResult) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static TargetSiteTestResult getByKey(String key)
  {
    return (TargetSiteTestResult) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static TargetSiteTestResult lock(java.lang.String id)
  {
    TargetSiteTestResult _instance = TargetSiteTestResult.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static TargetSiteTestResult unlock(java.lang.String id)
  {
    TargetSiteTestResult _instance = TargetSiteTestResult.get(id);
    _instance.unlock();
