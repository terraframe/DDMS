...
@com.terraframe.mojo.business.ClassSignature(hash = 878296903)
/**
...
public abstract class POvaleTestResultBase extends dss.vector.solutions.entomology.assay.infectivity.InfectivityAssayTestResult implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 878296903;
  ...
  public static POvaleTestResult getByKey(String key)
  {
    return (POvaleTestResult) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
