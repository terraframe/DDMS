...
@com.runwaysdk.business.ClassSignature(hash = -104766521)
/**
 ...
 */
public  abstract  class AdultDiscriminatingDoseAssayViewQueryBase extends com.runwaysdk.query.GeneratedViewQuery
 implements com.runwaysdk.generation.loader.Reloadable
{

  public AdultDiscriminatingDoseAssayViewQueryBase(com.runwaysdk.query.QueryFactory componentQueryFactory)
  {
    super(componentQueryFactory);
  }

  public AdultDiscriminatingDoseAssayViewQueryBase(com.runwaysdk.query.QueryFactory componentQueryFactory, com.runwaysdk.query.ViewQueryBuilder viewQueryBuilder)
  {
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.COLLECTIONLABEL, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getCollectionLabel(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.COLLECTIONLABEL, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.CONCRETEID, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getConcreteId(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.CONCRETEID, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableInteger)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.EXPOSURETIME, alias, null);

  }
 
  public com.runwaysdk.query.SelectableInteger getExposureTime(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableInteger)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.EXPOSURETIME, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.ID, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getId(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.ID, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableInteger)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.QUANTITYTESTED, alias, null);

  }
 
  public com.runwaysdk.query.SelectableInteger getQuantityTested(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableInteger)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.QUANTITYTESTED, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableMoment)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.TESTDATE, alias, null);

  }
 
  public com.runwaysdk.query.SelectableMoment getTestDate(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableMoment)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.TESTDATE, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.UNIQUEASSAYID, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getUniqueAssayId(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.UNIQUEASSAYID, alias, displayLabel);
  ...
  public com.runwaysdk.query.OIterator<? extends AdultDiscriminatingDoseAssayView> getIterator()
  {
    ...
    return new com.runwaysdk.query.ViewIterator<AdultDiscriminatingDoseAssayView>(this.getMdClassIF(), valueIterator);
  }
