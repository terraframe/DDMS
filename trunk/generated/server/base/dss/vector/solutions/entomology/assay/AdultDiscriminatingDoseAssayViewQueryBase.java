...
private static final long serialVersionUID = 1741155775;
  ...
  {
    return (com.terraframe.mojo.query.AttributeChar)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.COLLECTIONLABEL, alias, null);

  }
 
  public com.terraframe.mojo.query.AttributeChar getCollectionLabel(String alias, String displayLabel)
  {
    return (com.terraframe.mojo.query.AttributeChar)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.COLLECTIONLABEL, alias, displayLabel);
  ...
  {
    return (com.terraframe.mojo.query.AttributeChar)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.CONCRETEID, alias, null);

  }
 
  public com.terraframe.mojo.query.AttributeChar getConcreteId(String alias, String displayLabel)
  {
    return (com.terraframe.mojo.query.AttributeChar)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.CONCRETEID, alias, displayLabel);
  ...
  {
    return (com.terraframe.mojo.query.AttributeInteger)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.EXPOSURETIME, alias, null);

  }
 
  public com.terraframe.mojo.query.AttributeInteger getExposureTime(String alias, String displayLabel)
  {
    return (com.terraframe.mojo.query.AttributeInteger)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.EXPOSURETIME, alias, displayLabel);
  ...
  {
    return (com.terraframe.mojo.query.AttributeChar)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.ID, alias, null);

  }
 
  public com.terraframe.mojo.query.AttributeChar getId(String alias, String displayLabel)
  {
    return (com.terraframe.mojo.query.AttributeChar)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.ID, alias, displayLabel);
  ...
  {
    return (com.terraframe.mojo.query.AttributeInteger)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.QUANTITYTESTED, alias, null);

  }
 
  public com.terraframe.mojo.query.AttributeInteger getQuantityTested(String alias, String displayLabel)
  {
    return (com.terraframe.mojo.query.AttributeInteger)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.QUANTITYTESTED, alias, displayLabel);
  ...
  {
    return (com.terraframe.mojo.query.AttributeMoment)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.TESTDATE, alias, null);

  }
 
  public com.terraframe.mojo.query.AttributeMoment getTestDate(String alias, String displayLabel)
  {
    return (com.terraframe.mojo.query.AttributeMoment)this.getSelectable(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView.TESTDATE, alias, displayLabel);
