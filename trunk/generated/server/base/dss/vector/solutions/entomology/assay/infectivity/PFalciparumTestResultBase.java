...
@com.terraframe.mojo.business.ClassSignature(hash = 1850472512)
/**
 ...
 */
public abstract class PFalciparumTestResultBase extends dss.vector.solutions.entomology.assay.infectivity.InfectivityAssayTestResult implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1850472512;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.entomology.assay.infectivity.PFalciparumTestResult.CLASS);
  ...
  public static PFalciparumTestResult getByKey(String key)
  {
    return (PFalciparumTestResult) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
