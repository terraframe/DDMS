...
@com.terraframe.mojo.business.ClassSignature(hash = 1025176772)
/**
...
public abstract class AbstractMosquitoCollectionBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1025176772;
  ...
  public dss.vector.solutions.entomology.CollectionMosquito addMosquitos(dss.vector.solutions.entomology.Mosquito mosquito)
  {
    return (dss.vector.solutions.entomology.CollectionMosquito) addChild(mosquito, dss.vector.solutions.entomology.CollectionMosquito.CLASS);
  }
  
  public void removeMosquitos(dss.vector.solutions.entomology.Mosquito mosquito)
  {
    removeAllChildren(mosquito, dss.vector.solutions.entomology.CollectionMosquito.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.entomology.Mosquito> getAllMosquitos()
  {
    return (com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.entomology.Mosquito>) getChildren(dss.vector.solutions.entomology.CollectionMosquito.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.entomology.CollectionMosquito> getAllMosquitosRel()
  {
    return (com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.entomology.CollectionMosquito>) getChildRelationships(dss.vector.solutions.entomology.CollectionMosquito.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public dss.vector.solutions.entomology.CollectionMosquito getMosquitosRel(dss.vector.solutions.entomology.Mosquito mosquito)
  {
    com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.entomology.CollectionMosquito> iterator = (com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.entomology.CollectionMosquito>) getRelationshipsWithChild(mosquito, dss.vector.solutions.entomology.CollectionMosquito.CLASS);
    try
    {
      if (iterator.hasNext())
      {
  ...
  public static AbstractMosquitoCollection getByKey(String key)
  {
    return (AbstractMosquitoCollection) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
  ...
  public static com.terraframe.mojo.query.ValueQuery searchByCollectionId(java.lang.String collectionId, java.lang.String type)
  {
    String msg = "This method should never be invoked.  It should be overwritten in dss.vector.solutions.entomology.AbstractMosquitoCollection.java";
    throw new com.terraframe.mojo.dataaccess.metadata.ForbiddenMethodException(msg);
  }
