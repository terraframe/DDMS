...
@com.terraframe.mojo.business.ClassSignature(hash = -2123783126)
/**
 ...
 */
public abstract class CollectionMosquitoBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -2123783126;
  
  public CollectionMosquitoBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.entomology.CollectionMosquito.CLASS);
  ...
  public static CollectionMosquitoQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    CollectionMosquitoQuery query = new CollectionMosquitoQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public dss.vector.solutions.entomology.AbstractMosquitoCollection getParent()
  {
    return (dss.vector.solutions.entomology.AbstractMosquitoCollection) super.getParent();
  }
  
  public dss.vector.solutions.entomology.Mosquito getChild()
  {
    return (dss.vector.solutions.entomology.Mosquito) super.getChild();
  }
  
  public static CollectionMosquito get(String id)
  {
    return (CollectionMosquito) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static CollectionMosquito getByKey(String key)
  {
    return (CollectionMosquito) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static CollectionMosquito lock(java.lang.String id)
  {
    CollectionMosquito _instance = CollectionMosquito.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static CollectionMosquito unlock(java.lang.String id)
  {
    CollectionMosquito _instance = CollectionMosquito.get(id);
    _instance.unlock();
