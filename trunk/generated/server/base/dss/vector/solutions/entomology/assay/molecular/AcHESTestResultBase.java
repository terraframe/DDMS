...
@com.terraframe.mojo.business.ClassSignature(hash = -727342808)
/**
...
public abstract class AcHESTestResultBase extends dss.vector.solutions.entomology.assay.molecular.TargetSiteAssayTestResult implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -727342808;
  ...
  public static AcHESTestResult getByKey(String key)
  {
    return (AcHESTestResult) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
