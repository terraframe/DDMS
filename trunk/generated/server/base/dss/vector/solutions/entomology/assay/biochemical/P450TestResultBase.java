...
@com.terraframe.mojo.business.ClassSignature(hash = -404735783)
/**
...
public abstract class P450TestResultBase extends dss.vector.solutions.entomology.assay.biochemical.MetabolicAssayTestResult implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -404735783;
  ...
  public static P450TestResult getByKey(String key)
  {
    return (P450TestResult) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
