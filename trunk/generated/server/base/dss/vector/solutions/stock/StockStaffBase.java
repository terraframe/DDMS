...
@com.terraframe.mojo.business.ClassSignature(hash = -944435111)
/**
 ...
 */
public abstract class StockStaffBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -944435111;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.stock.StockStaff.CLASS);
  ...
  {
    StockStaffQuery query = new StockStaffQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (StockStaff) com.terraframe.mojo.business.Business.get(id);
  }
