...
@com.runwaysdk.business.ClassSignature(hash = 1673821909)
/**
 ...
 */
public abstract class StockStaffBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1673821909;
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.stock.StockStaff.CLASS);
  ...
  public static StockStaffQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    StockStaffQuery query = new StockStaffQuery(new com.runwaysdk.query.QueryFactory());
    com.runwaysdk.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static StockStaff get(String id)
  {
    return (StockStaff) com.runwaysdk.business.Business.get(id);
  }
  
  public static StockStaff getByKey(String key)
  {
    return (StockStaff) com.runwaysdk.business.Business.get(CLASS, key);
  }
  ...
  {
    StockStaff _instance = StockStaff.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static StockStaff unlock(java.lang.String id)
  {
    StockStaff _instance = StockStaff.get(id);
    _instance.unlock();
