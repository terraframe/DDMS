...
@com.terraframe.mojo.business.ClassSignature(hash = -1819028790)
/**
 ...
 */
public abstract class SavedMapBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1819028790;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.query.SavedMap.CLASS);
  ...
  public static com.terraframe.mojo.dataaccess.MdAttributeDAOIF getMapNameMd()
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.query.SavedMap.CLASS);
  ...
  {
    SavedMapQuery query = new SavedMapQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  public com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.query.Layer> getAllLayer()
  {
    return (com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.query.Layer>) getChildren(dss.vector.solutions.query.HasLayers.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.query.HasLayers> getAllLayerRel()
  {
    return (com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.query.HasLayers>) getChildRelationships(dss.vector.solutions.query.HasLayers.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.query.HasLayers> getLayerRel(dss.vector.solutions.query.Layer layer)
  {
    return (com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.query.HasLayers>) getRelationshipsWithChild(layer, dss.vector.solutions.query.HasLayers.CLASS);
  }
  
  public static SavedMap get(String id)
  {
    return (SavedMap) com.terraframe.mojo.business.Business.get(id);
  }
