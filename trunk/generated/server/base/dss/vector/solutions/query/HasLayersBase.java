...
@com.terraframe.mojo.business.ClassSignature(hash = -810490337)
/**
 ...
 */
public abstract class HasLayersBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -810490337;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.query.HasLayers.CLASS);
  ...
  {
    HasLayersQuery query = new HasLayersQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (HasLayers) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static HasLayers getByKey(String key)
  {
    return (HasLayers) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
