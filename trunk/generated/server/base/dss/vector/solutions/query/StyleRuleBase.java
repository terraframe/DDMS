...
@com.terraframe.mojo.business.ClassSignature(hash = -1769123613)
/**
 ...
 */
public abstract class StyleRuleBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1769123613;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.query.StyleRule.CLASS);
  ...
  public static StyleRuleQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    StyleRuleQuery query = new StyleRuleQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static StyleRule get(String id)
  {
    return (StyleRule) com.terraframe.mojo.business.Business.get(id);
  }
  
  public static StyleRule getByKey(String key)
  {
    return (StyleRule) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
  
  public static StyleRule lock(java.lang.String id)
  {
    StyleRule _instance = StyleRule.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static StyleRule unlock(java.lang.String id)
  {
    StyleRule _instance = StyleRule.get(id);
    _instance.unlock();
