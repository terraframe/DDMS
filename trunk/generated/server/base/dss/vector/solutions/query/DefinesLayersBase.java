...
@com.terraframe.mojo.business.ClassSignature(hash = 711794079)
/**
 ...
 */
public abstract class DefinesLayersBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 711794079;
  
  public DefinesLayersBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.query.DefinesLayers.CLASS);
  ...
  public static DefinesLayersQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    DefinesLayersQuery query = new DefinesLayersQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public dss.vector.solutions.query.SavedSearch getParent()
  {
    return (dss.vector.solutions.query.SavedSearch) super.getParent();
  }
  
  public dss.vector.solutions.query.UniversalLayer getChild()
  {
    return (dss.vector.solutions.query.UniversalLayer) super.getChild();
  }
  
  public static DefinesLayers get(String id)
  {
    return (DefinesLayers) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static DefinesLayers getByKey(String key)
  {
    return (DefinesLayers) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static DefinesLayers lock(java.lang.String id)
  {
    DefinesLayers _instance = DefinesLayers.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static DefinesLayers unlock(java.lang.String id)
  {
    DefinesLayers _instance = DefinesLayers.get(id);
    _instance.unlock();
