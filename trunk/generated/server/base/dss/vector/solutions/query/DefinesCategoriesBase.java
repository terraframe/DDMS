...
@com.terraframe.mojo.business.ClassSignature(hash = -1292442804)
/**
 ...
 */
public abstract class DefinesCategoriesBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1292442804;
  
  public DefinesCategoriesBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.query.DefinesCategories.CLASS);
  ...
  public static DefinesCategoriesQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    DefinesCategoriesQuery query = new DefinesCategoriesQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public dss.vector.solutions.query.ThematicLayer getParent()
  {
    return (dss.vector.solutions.query.ThematicLayer) super.getParent();
  }
  
  public dss.vector.solutions.query.AbstractCategory getChild()
  {
    return (dss.vector.solutions.query.AbstractCategory) super.getChild();
  }
  
  public static DefinesCategories get(String id)
  {
    return (DefinesCategories) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static DefinesCategories getByKey(String key)
  {
    return (DefinesCategories) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static DefinesCategories lock(java.lang.String id)
  {
    DefinesCategories _instance = DefinesCategories.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static DefinesCategories unlock(java.lang.String id)
  {
    DefinesCategories _instance = DefinesCategories.get(id);
    _instance.unlock();
