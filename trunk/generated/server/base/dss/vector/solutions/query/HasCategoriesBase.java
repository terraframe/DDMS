 ...
 */
public abstract class HasCategoriesBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.query.HasCategories.CLASS);
  ...
  {
    HasCategoriesQuery query = new HasCategoriesQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (HasCategories) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static HasCategories getByKey(String key)
  {
    return (HasCategories) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
