 ...
 */
public abstract class PersistsSearchBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.query.PersistsSearch.CLASS);
  ...
  {
    PersistsSearchQuery query = new PersistsSearchQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (PersistsSearch) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static PersistsSearch getByKey(String key)
  {
    return (PersistsSearch) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
