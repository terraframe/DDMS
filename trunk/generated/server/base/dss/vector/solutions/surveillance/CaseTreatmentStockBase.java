...
@com.terraframe.mojo.business.ClassSignature(hash = -1844994903)
/**
 ...
 */
public abstract class CaseTreatmentStockBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1844994903;
  
  public CaseTreatmentStockBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.surveillance.CaseTreatmentStock.CLASS);
  ...
  public static com.terraframe.mojo.dataaccess.MdAttributeDAOIF getOutOfStockMd()
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.surveillance.CaseTreatmentStock.CLASS);
    return mdClassIF.definesAttribute(OUTOFSTOCK);
  }
  ...
  public static CaseTreatmentStockQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    CaseTreatmentStockQuery query = new CaseTreatmentStockQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public dss.vector.solutions.surveillance.AggregatedCase getParent()
  {
    return (dss.vector.solutions.surveillance.AggregatedCase) super.getParent();
  }
  ...
  public static CaseTreatmentStock get(String id)
  {
    return (CaseTreatmentStock) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static CaseTreatmentStock getByKey(String key)
  {
    return (CaseTreatmentStock) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static CaseTreatmentStock lock(java.lang.String id)
  {
    CaseTreatmentStock _instance = CaseTreatmentStock.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static CaseTreatmentStock unlock(java.lang.String id)
  {
    CaseTreatmentStock _instance = CaseTreatmentStock.get(id);
    _instance.unlock();
