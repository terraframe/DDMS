...
@com.runwaysdk.business.ClassSignature(hash = -797739575)
/**
 ...
 */
public abstract class CaseDiagnosticBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -797739575;
  
  public CaseDiagnosticBase()
  {
    super();
  }
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.surveillance.CaseDiagnostic.CLASS);
  ...
  {
    CaseDiagnosticQuery query = new CaseDiagnosticQuery(new com.runwaysdk.query.QueryFactory());
  ...
  {
    return (CaseDiagnostic) com.runwaysdk.business.Business.get(id);
  }
  
  public static CaseDiagnostic getByKey(String key)
  {
    return (CaseDiagnostic) com.runwaysdk.business.Business.get(CLASS, key);
  }
