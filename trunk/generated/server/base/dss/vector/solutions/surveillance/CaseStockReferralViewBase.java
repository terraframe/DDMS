...
@com.runwaysdk.business.ClassSignature(hash = -50616421)
/**
 ...
 */
public abstract class CaseStockReferralViewBase extends com.runwaysdk.business.View implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -50616421;
  
  public CaseStockReferralViewBase()
  {
    super();
  }
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.surveillance.CaseStockReferralView.CLASS);
  ...
  public static CaseStockReferralView get(String id)
  {
    return (CaseStockReferralView) com.runwaysdk.business.View.get(id);
  }
