...
@com.terraframe.mojo.business.ClassSignature(hash = -115608090)
/**
 ...
 */
public abstract class CaseTreatmentBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -115608090;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.surveillance.CaseTreatment.CLASS);
  ...
  {
    CaseTreatmentQuery query = new CaseTreatmentQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (CaseTreatment) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static CaseTreatment getByKey(String key)
  {
    return (CaseTreatment) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
