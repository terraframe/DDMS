...
@com.runwaysdk.business.ClassSignature(hash = -761441351)
/**
 ...
 */
public abstract class ElderCaseViewBase extends dss.vector.solutions.surveillance.AggregatedCaseView implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -761441351;
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.surveillance.ElderCaseView.CLASS);
  ...
  {
    return (ElderCaseView) com.runwaysdk.business.View.get(id);
  }
