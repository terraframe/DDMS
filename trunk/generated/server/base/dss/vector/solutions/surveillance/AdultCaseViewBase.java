...
@com.runwaysdk.business.ClassSignature(hash = 1577120617)
/**
 ...
 */
public abstract class AdultCaseViewBase extends dss.vector.solutions.surveillance.AggregatedCaseView implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1577120617;
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.surveillance.AdultCaseView.CLASS);
  ...
  {
    return (AdultCaseView) com.runwaysdk.business.View.get(id);
  }
