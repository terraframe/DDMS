...
@com.terraframe.mojo.business.ClassSignature(hash = 1030969761)
/**
 ...
 */
public abstract class ChildCaseViewBase extends dss.vector.solutions.surveillance.AggregatedCaseView implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1030969761;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.surveillance.ChildCaseView.CLASS);
  ...
  public static ChildCaseView get(String id)
  {
    return (ChildCaseView) com.terraframe.mojo.business.View.get(id);
  }
