...
@com.runwaysdk.business.ClassSignature(hash = -1638869518)
/**
 ...
 */
public abstract class ChildCaseViewBase extends dss.vector.solutions.surveillance.AggregatedCaseView implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1638869518;
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.surveillance.ChildCaseView.CLASS);
  ...
  {
    return (ChildCaseView) com.runwaysdk.business.View.get(id);
  }
