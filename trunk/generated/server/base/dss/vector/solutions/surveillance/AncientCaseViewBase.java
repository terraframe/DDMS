...
@com.terraframe.mojo.business.ClassSignature(hash = 338648061)
/**
 ...
 */
public abstract class AncientCaseViewBase extends dss.vector.solutions.surveillance.AggregatedCaseView implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 338648061;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.surveillance.AncientCaseView.CLASS);
  ...
  public static AncientCaseView get(String id)
  {
    return (AncientCaseView) com.terraframe.mojo.business.View.get(id);
  }
