...
@com.runwaysdk.business.ClassSignature(hash = -461039577)
/**
 ...
 */
public abstract class AncientCaseViewBase extends dss.vector.solutions.surveillance.AggregatedCaseView implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -461039577;
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.surveillance.AncientCaseView.CLASS);
  ...
  {
    return (AncientCaseView) com.runwaysdk.business.View.get(id);
  }
