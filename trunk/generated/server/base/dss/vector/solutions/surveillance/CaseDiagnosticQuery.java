...
private static final long serialVersionUID = -721731806;
  ...
  {
    return (com.terraframe.mojo.query.AttributeInteger)this.getComponentQuery().get(dss.vector.solutions.surveillance.CaseDiagnostic.AMOUNT, alias, null);

  }
 
  public com.terraframe.mojo.query.AttributeInteger getAmount(String alias, String displayLabel)
  {
    return (com.terraframe.mojo.query.AttributeInteger)this.getComponentQuery().get(dss.vector.solutions.surveillance.CaseDiagnostic.AMOUNT, alias, displayLabel);
  ...
  {
    return (com.terraframe.mojo.query.AttributeInteger)this.getComponentQuery().get(dss.vector.solutions.surveillance.CaseDiagnostic.AMOUNTPOSITIVE, alias, null);

  }
 
  public com.terraframe.mojo.query.AttributeInteger getAmountPositive(String alias, String displayLabel)
  {
    return (com.terraframe.mojo.query.AttributeInteger)this.getComponentQuery().get(dss.vector.solutions.surveillance.CaseDiagnostic.AMOUNTPOSITIVE, alias, displayLabel);
  ...
  {
    return (com.terraframe.mojo.query.AttributeMoment)this.getComponentQuery().get(dss.vector.solutions.surveillance.CaseDiagnostic.CREATEDATE, alias, null);

  }
 
  public com.terraframe.mojo.query.AttributeMoment getCreateDate(String alias, String displayLabel)
  {
    return (com.terraframe.mojo.query.AttributeMoment)this.getComponentQuery().get(dss.vector.solutions.surveillance.CaseDiagnostic.CREATEDATE, alias, displayLabel);
  ...
  {
    return (com.terraframe.mojo.query.AttributeChar)this.getComponentQuery().get(dss.vector.solutions.surveillance.CaseDiagnostic.ID, alias, null);

  }
 
  public com.terraframe.mojo.query.AttributeChar getId(String alias, String displayLabel)
  {
    return (com.terraframe.mojo.query.AttributeChar)this.getComponentQuery().get(dss.vector.solutions.surveillance.CaseDiagnostic.ID, alias, displayLabel);
  ...
  {
    return (com.terraframe.mojo.query.AttributeChar)this.getComponentQuery().get(dss.vector.solutions.surveillance.CaseDiagnostic.KEYNAME, alias, null);

  }
 
  public com.terraframe.mojo.query.AttributeChar getKeyName(String alias, String displayLabel)
  {
    return (com.terraframe.mojo.query.AttributeChar)this.getComponentQuery().get(dss.vector.solutions.surveillance.CaseDiagnostic.KEYNAME, alias, displayLabel);
  ...
  {
    return (com.terraframe.mojo.query.AttributeMoment)this.getComponentQuery().get(dss.vector.solutions.surveillance.CaseDiagnostic.LASTUPDATEDATE, alias, null);

  }
 
  public com.terraframe.mojo.query.AttributeMoment getLastUpdateDate(String alias, String displayLabel)
  {
    return (com.terraframe.mojo.query.AttributeMoment)this.getComponentQuery().get(dss.vector.solutions.surveillance.CaseDiagnostic.LASTUPDATEDATE, alias, displayLabel);
  ...
  {
    return (com.terraframe.mojo.query.AttributeLong)this.getComponentQuery().get(dss.vector.solutions.surveillance.CaseDiagnostic.SEQ, alias, null);

  }
 
  public com.terraframe.mojo.query.AttributeLong getSeq(String alias, String displayLabel)
  {
    return (com.terraframe.mojo.query.AttributeLong)this.getComponentQuery().get(dss.vector.solutions.surveillance.CaseDiagnostic.SEQ, alias, displayLabel);
  ...
  {
    return (com.terraframe.mojo.query.AttributeChar)this.getComponentQuery().get(dss.vector.solutions.surveillance.CaseDiagnostic.SITEMASTER, alias, null);

  }
 
  public com.terraframe.mojo.query.AttributeChar getSiteMaster(String alias, String displayLabel)
  {
    return (com.terraframe.mojo.query.AttributeChar)this.getComponentQuery().get(dss.vector.solutions.surveillance.CaseDiagnostic.SITEMASTER, alias, displayLabel);
  ...
  {
    return (com.terraframe.mojo.query.AttributeChar)this.getComponentQuery().get(dss.vector.solutions.surveillance.CaseDiagnostic.TYPE, alias, null);

  }
 
  public com.terraframe.mojo.query.AttributeChar getType(String alias, String displayLabel)
  {
    return (com.terraframe.mojo.query.AttributeChar)this.getComponentQuery().get(dss.vector.solutions.surveillance.CaseDiagnostic.TYPE, alias, displayLabel);
