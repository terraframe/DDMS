...
@com.terraframe.mojo.business.ClassSignature(hash = 1208195474)
/**
 ...
 */
public abstract class CaseReferralBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1208195474;
  
  public CaseReferralBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.surveillance.CaseReferral.CLASS);
  ...
  public static CaseReferralQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    CaseReferralQuery query = new CaseReferralQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  public static CaseReferral get(String id)
  {
    return (CaseReferral) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static CaseReferral getByKey(String key)
  {
    return (CaseReferral) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static CaseReferral lock(java.lang.String id)
  {
    CaseReferral _instance = CaseReferral.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static CaseReferral unlock(java.lang.String id)
  {
    CaseReferral _instance = CaseReferral.get(id);
    _instance.unlock();
