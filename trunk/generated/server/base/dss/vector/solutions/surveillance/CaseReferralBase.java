...
@com.runwaysdk.business.ClassSignature(hash = 1081192848)
/**
 ...
 */
public abstract class CaseReferralBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1081192848;
  
  public CaseReferralBase()
  {
    super();
  }
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.surveillance.CaseReferral.CLASS);
  ...
  {
    CaseReferralQuery query = new CaseReferralQuery(new com.runwaysdk.query.QueryFactory());
  ...
  {
    return (CaseReferral) com.runwaysdk.business.Business.get(id);
  }
  
  public static CaseReferral getByKey(String key)
  {
    return (CaseReferral) com.runwaysdk.business.Business.get(CLASS, key);
  }
