...
@com.runwaysdk.business.ClassSignature(hash = 707972531)
/**
 ...
 */
public abstract class CaseReferralViewBase extends com.runwaysdk.business.View implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 707972531;
  
  public CaseReferralViewBase()
  {
    super();
  }
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.surveillance.CaseReferralView.CLASS);
  ...
  public static CaseReferralView get(String id)
  {
    return (CaseReferralView) com.runwaysdk.business.View.get(id);
  }
