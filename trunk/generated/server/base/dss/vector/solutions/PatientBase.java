 ...
 */
public abstract class PatientBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.Patient.CLASS);
  ...
  {
    PatientQuery query = new PatientQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (Patient) com.terraframe.mojo.business.Business.get(id);
  }
  
  public static Patient getByKey(String key)
  {
    return (Patient) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
