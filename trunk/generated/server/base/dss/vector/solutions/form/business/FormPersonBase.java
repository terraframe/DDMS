 ...
 */
public abstract class FormPersonBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  public dss.vector.solutions.form.business.FormHousehold getHousehold()
  {
    ...
    {
      return dss.vector.solutions.form.business.FormHousehold.get(getValue(HOUSEHOLD));
    }
  }
  ...
  public void setHousehold(dss.vector.solutions.form.business.FormHousehold value)
  {
    if(value == null)
    {
      setValue(HOUSEHOLD, "");
  ...
  public dss.vector.solutions.form.business.FormBedNet getNet()
  {
    ...
    {
      return dss.vector.solutions.form.business.FormBedNet.get(getValue(NET));
    }
  }
  ...
  public void setNet(dss.vector.solutions.form.business.FormBedNet value)
  {
    if(value == null)
    {
      setValue(NET, "");
  ...
  public static com.runwaysdk.dataaccess.MdAttributeReferenceDAOIF getSurveyMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.form.business.FormPerson.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeReferenceDAOIF)mdClassIF.definesAttribute(SURVEY);
  }
  ...
  public static FormPersonQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    FormPersonQuery query = new FormPersonQuery(new com.runwaysdk.query.QueryFactory());
    com.runwaysdk.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static FormPerson get(String id)
  {
    return (FormPerson) com.runwaysdk.business.Business.get(id);
  }
  
  public static FormPerson getByKey(String key)
  {
    return (FormPerson) com.runwaysdk.business.Business.get(CLASS, key);
  }
  ...
  public static FormPerson lock(java.lang.String id)
  {
    FormPerson _instance = FormPerson.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static FormPerson unlock(java.lang.String id)
  {
    FormPerson _instance = FormPerson.get(id);
    _instance.unlock();
