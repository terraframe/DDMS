...
public abstract class HasSynonymBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.geo.HasSynonym.CLASS);
  ...
  {
    HasSynonymQuery query = new HasSynonymQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (HasSynonym) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static HasSynonym getByKey(String key)
  {
    return (HasSynonym) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
