 ...
 */
public abstract class LocatedInBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.geo.LocatedIn.CLASS);
  ...
  public static LocatedInQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    LocatedInQuery query = new LocatedInQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  public dss.vector.solutions.geo.generated.GeoEntity getChild()
  {
    return (dss.vector.solutions.geo.generated.GeoEntity) super.getChild();
  }
  
  public static LocatedIn get(String id)
  {
    return (LocatedIn) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static LocatedIn getByKey(String key)
  {
    return (LocatedIn) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
