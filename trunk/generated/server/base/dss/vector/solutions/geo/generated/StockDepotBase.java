...
@com.terraframe.mojo.business.ClassSignature(hash = 1658100397)
/**
 ...
 */
public abstract class StockDepotBase extends dss.vector.solutions.geo.generated.GeoEntity implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    StockDepotQuery query = new StockDepotQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (StockDepot) com.terraframe.mojo.business.Business.get(id);
  }
  
  public static StockDepot getByKey(String key)
  {
    return (StockDepot) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
