...
@com.terraframe.mojo.business.ClassSignature(hash = 1641047612)
/**
 ...
 */
public abstract class SettlementBase extends dss.vector.solutions.geo.generated.GeoEntity implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1641047612;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.geo.generated.Settlement.CLASS);
  ...
  {
    SettlementQuery query = new SettlementQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (Settlement) com.terraframe.mojo.business.Business.get(id);
  }
  
  public static Settlement getByKey(String key)
  {
    return (Settlement) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
