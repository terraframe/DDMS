...
@com.terraframe.mojo.business.ClassSignature(hash = 313419789)
/**
 ...
 */
public abstract class GeoHierarchyPropertyBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 313419789;
  
  public GeoHierarchyPropertyBase()
  {
    super();
  }
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.geo.GeoHierarchyProperty.CLASS);
  ...
  public static GeoHierarchyPropertyQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    GeoHierarchyPropertyQuery query = new GeoHierarchyPropertyQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static GeoHierarchyProperty get(String id)
  {
    return (GeoHierarchyProperty) com.terraframe.mojo.business.Business.get(id);
  }
  
  public static GeoHierarchyProperty getByKey(String key)
  {
    return (GeoHierarchyProperty) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
  
  public static GeoHierarchyProperty lock(java.lang.String id)
  {
    GeoHierarchyProperty _instance = GeoHierarchyProperty.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static GeoHierarchyProperty unlock(java.lang.String id)
  {
    GeoHierarchyProperty _instance = GeoHierarchyProperty.get(id);
    _instance.unlock();
