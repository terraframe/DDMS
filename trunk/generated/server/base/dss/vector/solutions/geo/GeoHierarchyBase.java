...
@com.terraframe.mojo.business.ClassSignature(hash = -206997028)
/**
...
public abstract class GeoHierarchyBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -206997028;
  ...
  {
    com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.geo.AllowedIn> iterator = (com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.geo.AllowedIn>) getRelationshipsWithChild(geoHierarchy, dss.vector.solutions.geo.AllowedIn.CLASS);
    try
    {
      if (iterator.hasNext())
      {
  ...
  {
    com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.geo.AllowedIn> iterator = (com.terraframe.mojo.query.OIterator<? extends dss.vector.solutions.geo.AllowedIn>) getRelationshipsWithParent(geoHierarchy, dss.vector.solutions.geo.AllowedIn.CLASS);
    try
    {
      if (iterator.hasNext())
      {
  ...
  {
    return (GeoHierarchy) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
