...
@com.terraframe.mojo.business.ClassSignature(hash = 1562349863)
/**
 ...
 */
public abstract class DefaultGeoEntityBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1562349863;
  
  public DefaultGeoEntityBase()
  {
    super();
  }
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.DefaultGeoEntity.CLASS);
  ...
  public static DefaultGeoEntityQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    DefaultGeoEntityQuery query = new DefaultGeoEntityQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static DefaultGeoEntity get(String id)
  {
    return (DefaultGeoEntity) com.terraframe.mojo.business.Business.get(id);
  }
  
  public static DefaultGeoEntity getByKey(String key)
  {
    return (DefaultGeoEntity) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
  
  public static dss.vector.solutions.DefaultGeoEntity getDefaultGeoEntity()
  {
    String msg = "This method should never be invoked.  It should be overwritten in dss.vector.solutions.DefaultGeoEntity.java";
    throw new com.terraframe.mojo.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  
  public static DefaultGeoEntity lock(java.lang.String id)
  {
    DefaultGeoEntity _instance = DefaultGeoEntity.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static DefaultGeoEntity unlock(java.lang.String id)
  {
    DefaultGeoEntity _instance = DefaultGeoEntity.get(id);
    _instance.unlock();
