 ...
 */
public abstract class TermRelationshipBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.ontology.TermRelationship.CLASS);
  ...
  {
    TermRelationshipQuery query = new TermRelationshipQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (TermRelationship) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static TermRelationship getByKey(String key)
  {
    return (TermRelationship) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
