 ...
 */
public abstract class FieldRootBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.ontology.FieldRoot.CLASS);
  ...
  {
    FieldRootQuery query = new FieldRootQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (FieldRoot) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static FieldRoot getByKey(String key)
  {
    return (FieldRoot) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
