...
@com.terraframe.mojo.business.ClassSignature(hash = -1874518235)
/**
 ...
 */
public abstract class OntologyHasRelationshipBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1874518235;
  
  public OntologyHasRelationshipBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.ontology.OntologyHasRelationship.CLASS);
  ...
  public static OntologyHasRelationshipQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    OntologyHasRelationshipQuery query = new OntologyHasRelationshipQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public dss.vector.solutions.ontology.Ontology getParent()
  {
    return (dss.vector.solutions.ontology.Ontology) super.getParent();
  }
  
  public dss.vector.solutions.ontology.OntologyRelationship getChild()
  {
    return (dss.vector.solutions.ontology.OntologyRelationship) super.getChild();
  }
  
  public static OntologyHasRelationship get(String id)
  {
    return (OntologyHasRelationship) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static OntologyHasRelationship getByKey(String key)
  {
    return (OntologyHasRelationship) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static OntologyHasRelationship lock(java.lang.String id)
  {
    OntologyHasRelationship _instance = OntologyHasRelationship.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static OntologyHasRelationship unlock(java.lang.String id)
  {
    OntologyHasRelationship _instance = OntologyHasRelationship.get(id);
    _instance.unlock();
