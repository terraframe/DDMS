...
@com.terraframe.mojo.business.ClassSignature(hash = -1935933573)
/**
 ...
 */
public abstract class ITNServiceBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1935933573;
  
  public ITNServiceBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.ITNService.CLASS);
  ...
  public static ITNServiceQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    ITNServiceQuery query = new ITNServiceQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  public static ITNService get(String id)
  {
    return (ITNService) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static ITNService getByKey(String key)
  {
    return (ITNService) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static ITNService lock(java.lang.String id)
  {
    ITNService _instance = ITNService.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static ITNService unlock(java.lang.String id)
  {
    ITNService _instance = ITNService.get(id);
    _instance.unlock();
