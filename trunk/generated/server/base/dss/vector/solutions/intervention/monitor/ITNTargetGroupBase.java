...
@com.terraframe.mojo.business.ClassSignature(hash = -1017625886)
/**
 ...
 */
public abstract class ITNTargetGroupBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1017625886;
  
  public ITNTargetGroupBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.ITNTargetGroup.CLASS);
  ...
  public static ITNTargetGroupQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    ITNTargetGroupQuery query = new ITNTargetGroupQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public dss.vector.solutions.intervention.monitor.ITNData getParent()
  {
    return (dss.vector.solutions.intervention.monitor.ITNData) super.getParent();
  }
  ...
  public static ITNTargetGroup get(String id)
  {
    return (ITNTargetGroup) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static ITNTargetGroup getByKey(String key)
  {
    return (ITNTargetGroup) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static ITNTargetGroup lock(java.lang.String id)
  {
    ITNTargetGroup _instance = ITNTargetGroup.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static ITNTargetGroup unlock(java.lang.String id)
  {
    ITNTargetGroup _instance = ITNTargetGroup.get(id);
    _instance.unlock();
