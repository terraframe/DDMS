...
@com.terraframe.mojo.business.ClassSignature(hash = -1345787798)
/**
 ...
 */
public abstract class PersonRDTResultBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1345787798;
  
  public PersonRDTResultBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.PersonRDTResult.CLASS);
  ...
  public static PersonRDTResultQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    PersonRDTResultQuery query = new PersonRDTResultQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public dss.vector.solutions.intervention.monitor.Person getParent()
  {
    return (dss.vector.solutions.intervention.monitor.Person) super.getParent();
  }
  ...
  public static PersonRDTResult get(String id)
  {
    return (PersonRDTResult) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static PersonRDTResult getByKey(String key)
  {
    return (PersonRDTResult) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static PersonRDTResult lock(java.lang.String id)
  {
    PersonRDTResult _instance = PersonRDTResult.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static PersonRDTResult unlock(java.lang.String id)
  {
    PersonRDTResult _instance = PersonRDTResult.get(id);
    _instance.unlock();
