 ...
 */
public abstract class IPTANCVisitBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.IPTANCVisit.CLASS);
  ...
  {
    IPTANCVisitQuery query = new IPTANCVisitQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (IPTANCVisit) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static IPTANCVisit getByKey(String key)
  {
    return (IPTANCVisit) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
