 ...
 */
public abstract class SurveyedPersonTreatmentBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.SurveyedPersonTreatment.CLASS);
  ...
  {
    SurveyedPersonTreatmentQuery query = new SurveyedPersonTreatmentQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (SurveyedPersonTreatment) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static SurveyedPersonTreatment getByKey(String key)
  {
    return (SurveyedPersonTreatment) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
