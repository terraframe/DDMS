...
@com.terraframe.mojo.business.ClassSignature(hash = 1941742309)
/**
 ...
 */
public abstract class SurveyHouseholdBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1941742309;
  
  public SurveyHouseholdBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.SurveyHousehold.CLASS);
  ...
  public static SurveyHouseholdQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    SurveyHouseholdQuery query = new SurveyHouseholdQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public dss.vector.solutions.intervention.monitor.SurveyPoint getParent()
  {
    return (dss.vector.solutions.intervention.monitor.SurveyPoint) super.getParent();
  }
  
  public dss.vector.solutions.intervention.monitor.Household getChild()
  {
    return (dss.vector.solutions.intervention.monitor.Household) super.getChild();
  }
  
  public static SurveyHousehold get(String id)
  {
    return (SurveyHousehold) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static SurveyHousehold getByKey(String key)
  {
    return (SurveyHousehold) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static SurveyHousehold lock(java.lang.String id)
  {
    SurveyHousehold _instance = SurveyHousehold.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static SurveyHousehold unlock(java.lang.String id)
  {
    SurveyHousehold _instance = SurveyHousehold.get(id);
    _instance.unlock();
