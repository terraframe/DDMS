 ...
 */
public abstract class IPTDoseBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.IPTDose.CLASS);
  ...
  public static IPTDoseQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    IPTDoseQuery query = new IPTDoseQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  public static IPTDose get(String id)
  {
    return (IPTDose) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static IPTDose getByKey(String key)
  {
    return (IPTDose) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static IPTDose lock(java.lang.String id)
  {
    IPTDose _instance = IPTDose.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static IPTDose unlock(java.lang.String id)
  {
    IPTDose _instance = IPTDose.get(id);
    _instance.unlock();
