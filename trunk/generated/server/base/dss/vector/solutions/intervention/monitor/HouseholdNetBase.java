...
@com.terraframe.mojo.business.ClassSignature(hash = -1494104739)
/**
 ...
 */
public abstract class HouseholdNetBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1494104739;
  
  public HouseholdNetBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.HouseholdNet.CLASS);
  ...
  public static HouseholdNetQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    HouseholdNetQuery query = new HouseholdNetQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  public static HouseholdNet get(String id)
  {
    return (HouseholdNet) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static HouseholdNet getByKey(String key)
  {
    return (HouseholdNet) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static HouseholdNet lock(java.lang.String id)
  {
    HouseholdNet _instance = HouseholdNet.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static HouseholdNet unlock(java.lang.String id)
  {
    HouseholdNet _instance = HouseholdNet.get(id);
    _instance.unlock();
