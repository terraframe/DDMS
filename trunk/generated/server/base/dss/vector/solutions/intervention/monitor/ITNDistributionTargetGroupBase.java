 ...
 */
public abstract class ITNDistributionTargetGroupBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.ITNDistributionTargetGroup.CLASS);
  ...
  {
    ITNDistributionTargetGroupQuery query = new ITNDistributionTargetGroupQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (ITNDistributionTargetGroup) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static ITNDistributionTargetGroup getByKey(String key)
  {
    return (ITNDistributionTargetGroup) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
