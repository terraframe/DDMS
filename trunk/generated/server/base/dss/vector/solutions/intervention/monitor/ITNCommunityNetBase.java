...
@com.terraframe.mojo.business.ClassSignature(hash = -575044611)
/**
 ...
 */
public abstract class ITNCommunityNetBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -575044611;
  
  public ITNCommunityNetBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.ITNCommunityNet.CLASS);
  ...
  public static ITNCommunityNetQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    ITNCommunityNetQuery query = new ITNCommunityNetQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public dss.vector.solutions.intervention.monitor.ITNCommunityDistribution getParent()
  {
    return (dss.vector.solutions.intervention.monitor.ITNCommunityDistribution) super.getParent();
  }
  ...
  public static ITNCommunityNet get(String id)
  {
    return (ITNCommunityNet) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static ITNCommunityNet getByKey(String key)
  {
    return (ITNCommunityNet) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static ITNCommunityNet lock(java.lang.String id)
  {
    ITNCommunityNet _instance = ITNCommunityNet.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static ITNCommunityNet unlock(java.lang.String id)
  {
    ITNCommunityNet _instance = ITNCommunityNet.get(id);
    _instance.unlock();
