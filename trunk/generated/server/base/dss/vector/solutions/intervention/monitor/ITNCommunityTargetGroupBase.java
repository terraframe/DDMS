 ...
 */
public abstract class ITNCommunityTargetGroupBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.ITNCommunityTargetGroup.CLASS);
  ...
  public static ITNCommunityTargetGroupQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    ITNCommunityTargetGroupQuery query = new ITNCommunityTargetGroupQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  public static ITNCommunityTargetGroup get(String id)
  {
    return (ITNCommunityTargetGroup) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static ITNCommunityTargetGroup getByKey(String key)
  {
    return (ITNCommunityTargetGroup) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static ITNCommunityTargetGroup lock(java.lang.String id)
  {
    ITNCommunityTargetGroup _instance = ITNCommunityTargetGroup.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static ITNCommunityTargetGroup unlock(java.lang.String id)
  {
    ITNCommunityTargetGroup _instance = ITNCommunityTargetGroup.get(id);
    _instance.unlock();
