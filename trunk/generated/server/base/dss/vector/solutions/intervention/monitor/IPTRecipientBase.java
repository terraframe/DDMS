...
@com.terraframe.mojo.business.ClassSignature(hash = -1143574641)
/**
 ...
 */
public abstract class IPTRecipientBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1143574641;
  
  public IPTRecipientBase()
  {
    super();
  }
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.IPTRecipient.CLASS);
  ...
  public static IPTRecipientQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    IPTRecipientQuery query = new IPTRecipientQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static IPTRecipient get(String id)
  {
    return (IPTRecipient) com.terraframe.mojo.business.Business.get(id);
  }
  
  public static IPTRecipient getByKey(String key)
  {
    return (IPTRecipient) com.terraframe.mojo.business.Business.get(CLASS, key);
  }
  
  public static IPTRecipient lock(java.lang.String id)
  {
    IPTRecipient _instance = IPTRecipient.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static IPTRecipient unlock(java.lang.String id)
  {
    IPTRecipient _instance = IPTRecipient.get(id);
    _instance.unlock();
