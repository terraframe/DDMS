...
@com.terraframe.mojo.business.ClassSignature(hash = -1607356145)
/**
 ...
 */
public abstract class SurveyedPersonTreatmentLocationBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1607356145;
  
  public SurveyedPersonTreatmentLocationBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.SurveyedPersonTreatmentLocation.CLASS);
  ...
  public static SurveyedPersonTreatmentLocationQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    SurveyedPersonTreatmentLocationQuery query = new SurveyedPersonTreatmentLocationQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public dss.vector.solutions.intervention.monitor.SurveyedPerson getParent()
  {
    return (dss.vector.solutions.intervention.monitor.SurveyedPerson) super.getParent();
  }
  ...
  public static SurveyedPersonTreatmentLocation get(String id)
  {
    return (SurveyedPersonTreatmentLocation) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static SurveyedPersonTreatmentLocation getByKey(String key)
  {
    return (SurveyedPersonTreatmentLocation) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static SurveyedPersonTreatmentLocation lock(java.lang.String id)
  {
    SurveyedPersonTreatmentLocation _instance = SurveyedPersonTreatmentLocation.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static SurveyedPersonTreatmentLocation unlock(java.lang.String id)
  {
    SurveyedPersonTreatmentLocation _instance = SurveyedPersonTreatmentLocation.get(id);
    _instance.unlock();
