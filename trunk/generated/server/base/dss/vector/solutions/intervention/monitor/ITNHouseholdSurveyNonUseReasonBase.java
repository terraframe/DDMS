...
@com.terraframe.mojo.business.ClassSignature(hash = -250252264)
/**
 ...
 */
public abstract class ITNHouseholdSurveyNonUseReasonBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -250252264;
  
  public ITNHouseholdSurveyNonUseReasonBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.ITNHouseholdSurveyNonUseReason.CLASS);
  ...
  public static ITNHouseholdSurveyNonUseReasonQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    ITNHouseholdSurveyNonUseReasonQuery query = new ITNHouseholdSurveyNonUseReasonQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public dss.vector.solutions.intervention.monitor.ITNHouseholdSurvey getParent()
  {
    return (dss.vector.solutions.intervention.monitor.ITNHouseholdSurvey) super.getParent();
  }
  ...
  public static ITNHouseholdSurveyNonUseReason get(String id)
  {
    return (ITNHouseholdSurveyNonUseReason) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static ITNHouseholdSurveyNonUseReason getByKey(String key)
  {
    return (ITNHouseholdSurveyNonUseReason) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static ITNHouseholdSurveyNonUseReason lock(java.lang.String id)
  {
    ITNHouseholdSurveyNonUseReason _instance = ITNHouseholdSurveyNonUseReason.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static ITNHouseholdSurveyNonUseReason unlock(java.lang.String id)
  {
    ITNHouseholdSurveyNonUseReason _instance = ITNHouseholdSurveyNonUseReason.get(id);
    _instance.unlock();
