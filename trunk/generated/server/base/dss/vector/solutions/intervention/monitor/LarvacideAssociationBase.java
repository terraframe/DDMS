...
@com.runwaysdk.business.ClassSignature(hash = 1845779806)
/**
 ...
 */
public abstract class LarvacideAssociationBase extends com.runwaysdk.business.Relationship implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1845779806;
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.LarvacideAssociation.CLASS);
  ...
  {
    LarvacideAssociationQuery query = new LarvacideAssociationQuery(new com.runwaysdk.query.QueryFactory());
  ...
  {
    return (LarvacideAssociation) com.runwaysdk.business.Relationship.get(id);
  }
  
  public static LarvacideAssociation getByKey(String key)
  {
    return (LarvacideAssociation) com.runwaysdk.business.Relationship.get(CLASS, key);
  }
