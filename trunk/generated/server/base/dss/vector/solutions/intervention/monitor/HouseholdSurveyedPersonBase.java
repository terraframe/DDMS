...
@com.terraframe.mojo.business.ClassSignature(hash = 1581496711)
/**
 ...
 */
public abstract class HouseholdSurveyedPersonBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1581496711;
  
  public HouseholdSurveyedPersonBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.HouseholdSurveyedPerson.CLASS);
  ...
  public static HouseholdSurveyedPersonQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    HouseholdSurveyedPersonQuery query = new HouseholdSurveyedPersonQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  public dss.vector.solutions.intervention.monitor.SurveyedPerson getChild()
  {
    return (dss.vector.solutions.intervention.monitor.SurveyedPerson) super.getChild();
  }
  
  public static HouseholdSurveyedPerson get(String id)
  {
    return (HouseholdSurveyedPerson) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static HouseholdSurveyedPerson getByKey(String key)
  {
    return (HouseholdSurveyedPerson) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static HouseholdSurveyedPerson lock(java.lang.String id)
  {
    HouseholdSurveyedPerson _instance = HouseholdSurveyedPerson.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static HouseholdSurveyedPerson unlock(java.lang.String id)
  {
    HouseholdSurveyedPerson _instance = HouseholdSurveyedPerson.get(id);
    _instance.unlock();
