...
@com.terraframe.mojo.business.ClassSignature(hash = -1530058990)
/**
 ...
 */
public abstract class ITNHouseholdSurveyTargetGroupBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1530058990;
  
  public ITNHouseholdSurveyTargetGroupBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.ITNHouseholdSurveyTargetGroup.CLASS);
  ...
  public static ITNHouseholdSurveyTargetGroupQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    ITNHouseholdSurveyTargetGroupQuery query = new ITNHouseholdSurveyTargetGroupQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  public static ITNHouseholdSurveyTargetGroup get(String id)
  {
    return (ITNHouseholdSurveyTargetGroup) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static ITNHouseholdSurveyTargetGroup getByKey(String key)
  {
    return (ITNHouseholdSurveyTargetGroup) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static ITNHouseholdSurveyTargetGroup lock(java.lang.String id)
  {
    ITNHouseholdSurveyTargetGroup _instance = ITNHouseholdSurveyTargetGroup.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static ITNHouseholdSurveyTargetGroup unlock(java.lang.String id)
  {
    ITNHouseholdSurveyTargetGroup _instance = ITNHouseholdSurveyTargetGroup.get(id);
    _instance.unlock();
