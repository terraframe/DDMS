...
@com.terraframe.mojo.business.ClassSignature(hash = 1044536257)
/**
 ...
 */
public abstract class ITNHouseholdSurveyNetBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1044536257;
  
  public ITNHouseholdSurveyNetBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.ITNHouseholdSurveyNet.CLASS);
  ...
  public static ITNHouseholdSurveyNetQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    ITNHouseholdSurveyNetQuery query = new ITNHouseholdSurveyNetQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  public static ITNHouseholdSurveyNet get(String id)
  {
    return (ITNHouseholdSurveyNet) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static ITNHouseholdSurveyNet getByKey(String key)
  {
    return (ITNHouseholdSurveyNet) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static ITNHouseholdSurveyNet lock(java.lang.String id)
  {
    ITNHouseholdSurveyNet _instance = ITNHouseholdSurveyNet.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static ITNHouseholdSurveyNet unlock(java.lang.String id)
  {
    ITNHouseholdSurveyNet _instance = ITNHouseholdSurveyNet.get(id);
    _instance.unlock();
