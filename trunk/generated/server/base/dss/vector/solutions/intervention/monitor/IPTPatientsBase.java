 ...
 */
public abstract class IPTPatientsBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.IPTPatients.CLASS);
  ...
  {
    IPTPatientsQuery query = new IPTPatientsQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  {
    return (IPTPatients) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static IPTPatients getByKey(String key)
  {
    return (IPTPatients) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
