...
@com.terraframe.mojo.business.ClassSignature(hash = 1962980679)
/**
 ...
 */
public abstract class IPTTreatmentBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1962980679;
  
  public IPTTreatmentBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.IPTTreatment.CLASS);
  ...
  public static IPTTreatmentQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    IPTTreatmentQuery query = new IPTTreatmentQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public dss.vector.solutions.intervention.monitor.AggregatedIPT getParent()
  {
    return (dss.vector.solutions.intervention.monitor.AggregatedIPT) super.getParent();
  }
  ...
  public static IPTTreatment get(String id)
  {
    return (IPTTreatment) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static IPTTreatment getByKey(String key)
  {
    return (IPTTreatment) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static IPTTreatment lock(java.lang.String id)
  {
    IPTTreatment _instance = IPTTreatment.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static IPTTreatment unlock(java.lang.String id)
  {
    IPTTreatment _instance = IPTTreatment.get(id);
    _instance.unlock();
