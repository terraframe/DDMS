...
@com.terraframe.mojo.business.ClassSignature(hash = 1519218708)
/**
 ...
 */
public abstract class ITNNetBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1519218708;
  
  public ITNNetBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.ITNNet.CLASS);
  ...
  public static ITNNetQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    ITNNetQuery query = new ITNNetQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  public static ITNNet get(String id)
  {
    return (ITNNet) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static ITNNet getByKey(String key)
  {
    return (ITNNet) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static ITNNet lock(java.lang.String id)
  {
    ITNNet _instance = ITNNet.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static ITNNet unlock(java.lang.String id)
  {
    ITNNet _instance = ITNNet.get(id);
    _instance.unlock();
