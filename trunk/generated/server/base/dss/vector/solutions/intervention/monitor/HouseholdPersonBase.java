...
@com.terraframe.mojo.business.ClassSignature(hash = 1019585493)
/**
 ...
 */
public abstract class HouseholdPersonBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1019585493;
  
  public HouseholdPersonBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.HouseholdPerson.CLASS);
  ...
  public static HouseholdPersonQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    HouseholdPersonQuery query = new HouseholdPersonQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  public dss.vector.solutions.intervention.monitor.Person getChild()
  {
    return (dss.vector.solutions.intervention.monitor.Person) super.getChild();
  }
  
  public static HouseholdPerson get(String id)
  {
    return (HouseholdPerson) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static HouseholdPerson getByKey(String key)
  {
    return (HouseholdPerson) com.terraframe.mojo.business.Relationship.get(CLASS, key);
  }
  
  public static HouseholdPerson lock(java.lang.String id)
  {
    HouseholdPerson _instance = HouseholdPerson.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static HouseholdPerson unlock(java.lang.String id)
  {
    HouseholdPerson _instance = HouseholdPerson.get(id);
    _instance.unlock();
