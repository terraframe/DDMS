 ...
 */
public abstract class AggregatedCaseExcelViewBase extends com.terraframe.mojo.business.View implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  public void validateAggregatedAgeGroup()
  {
    this.validateAttribute(AGGREGATEDAGEGROUP);
  }
  
  public static com.terraframe.mojo.dataaccess.MdAttributeDAOIF getAggregatedAgeGroupMd()
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.export.AggregatedCaseExcelView.CLASS);
    return mdClassIF.definesAttribute(AGGREGATEDAGEGROUP);
  }
  ...
  {
    return (AggregatedCaseExcelView) com.terraframe.mojo.business.View.get(id);
  }
