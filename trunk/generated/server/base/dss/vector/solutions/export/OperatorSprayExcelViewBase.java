...
@com.runwaysdk.business.ClassSignature(hash = 706455536)
/**
 ...
 */
public abstract class OperatorSprayExcelViewBase extends com.runwaysdk.business.View implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 706455536;
  ...
  public String getReasonNotSprayed()
  {
  ...
  public static com.runwaysdk.dataaccess.MdAttributeCharacterDAOIF getReasonNotSprayedMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.export.OperatorSprayExcelView.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeCharacterDAOIF)mdClassIF.definesAttribute(REASONNOTSPRAYED);
  }
  
  public void setReasonNotSprayed(String value)
  {
    if(value == null)
    {
    ...
    {
      setValue(REASONNOTSPRAYED, value);
    }
  }
  ...
  public static com.runwaysdk.dataaccess.MdAttributeCharacterDAOIF getStructureTypeMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.export.OperatorSprayExcelView.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeCharacterDAOIF)mdClassIF.definesAttribute(STRUCTURETYPE);
  }
  ...
  {
    return (OperatorSprayExcelView) com.runwaysdk.business.View.get(id);
  }
