...
public abstract class MorphologicalSpecieGroupBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1234203354354L;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(mdss.entomology.MorphologicalSpecieGroup.CLASS);
  ...
  public mdss.entomology.CollectionSpecie addAbstractMosqitoCollection(mdss.entomology.AbstractMosquitoCollection abstractMosquitoCollection)
  {
    return (mdss.entomology.CollectionSpecie) addParent(abstractMosquitoCollection, mdss.entomology.CollectionSpecie.CLASS);
  }
  
  public void removeAbstractMosqitoCollection(mdss.entomology.AbstractMosquitoCollection abstractMosquitoCollection)
  {
    removeAllParents(abstractMosquitoCollection, mdss.entomology.CollectionSpecie.CLASS);
  }
  ...
  {
    return (com.terraframe.mojo.query.OIterator<? extends mdss.entomology.AbstractMosquitoCollection>) getParents(mdss.entomology.CollectionSpecie.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public com.terraframe.mojo.query.OIterator<? extends mdss.entomology.CollectionSpecie> getAllAbstractMosqitoCollectionRel()
  {
    return (com.terraframe.mojo.query.OIterator<? extends mdss.entomology.CollectionSpecie>) getParentRelationships(mdss.entomology.CollectionSpecie.CLASS);
  }
  
  @SuppressWarnings("unchecked")
  public mdss.entomology.CollectionSpecie getAbstractMosqitoCollectionRel(mdss.entomology.AbstractMosquitoCollection abstractMosquitoCollection)
  {
    com.terraframe.mojo.query.OIterator<? extends mdss.entomology.CollectionSpecie> iterator = (com.terraframe.mojo.query.OIterator<? extends mdss.entomology.CollectionSpecie>) getRelationshipsWithParent(abstractMosquitoCollection, mdss.entomology.CollectionSpecie.CLASS);
    try
    {
      if (iterator.hasNext())
      {
