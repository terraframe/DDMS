 ...
 */
public  class MosquitoQuery extends mdss.entomology.TrueSpecieEntityQuery
 implements com.terraframe.mojo.generation.loader.Reloadable
{
private static final long serialVersionUID = 1234203358683L;
  ...
  {
    return "mdss.entomology.Mosquito";
  }
  public mdss.entomology.GenerationMasterQuery.GenerationQueryIF getGeneration()
  {
    return getGeneration(null);

  }
 
  public mdss.entomology.GenerationMasterQuery.GenerationQueryIF getGeneration(String alias)
  {

    com.terraframe.mojo.dataaccess.MdAttributeDAOIF mdAttributeIF = this.getComponentQuery().getMdAttributeROfromMap("generation");

    return (mdss.entomology.GenerationMasterQuery.GenerationQueryIF)this.getComponentQuery().internalAttributeFactory("generation", mdAttributeIF, this, alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeBooleanIF)this.getComponentQuery().attributeFactory(mdss.entomology.Mosquito.ISOFEMALE, "com.terraframe.mojo.system.metadata.MdAttributeBoolean", alias);

  }
  public mdss.general.SexMasterQuery.SexQueryIF getSex()
  {
    return getSex(null);

  }
 
  public mdss.general.SexMasterQuery.SexQueryIF getSex(String alias)
  {

    com.terraframe.mojo.dataaccess.MdAttributeDAOIF mdAttributeIF = this.getComponentQuery().getMdAttributeROfromMap("sex");

    return (mdss.general.SexMasterQuery.SexQueryIF)this.getComponentQuery().internalAttributeFactory("sex", mdAttributeIF, this, alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeMomentIF)this.getComponentQuery().attributeFactory(mdss.entomology.Mosquito.TESTDATE, "com.terraframe.mojo.system.metadata.MdAttributeDate", alias);
  ...
  protected com.terraframe.mojo.query.AttributeEnumeration enumerationFactory( com.terraframe.mojo.dataaccess.MdAttributeEnumerationDAOIF mdAttributeIF, String attributeNamespace, String definingTableName, String definingTableAlias,  String mdEnumerationTableName, com.terraframe.mojo.dataaccess.MdBusinessDAOIF masterListMdBusinessIF, String masterListTalbeAlias, com.terraframe.mojo.query.ComponentQuery rootQuery, java.util.Set<com.terraframe.mojo.query.Join> tableJoinSet, String userDefinedAlias)
  {
    ...
    {
       return new mdss.entomology.GenerationMasterQuery.GenerationQuery((com.terraframe.mojo.dataaccess.MdAttributeEnumerationDAOIF)mdAttributeIF,  attributeNamespace, definingTableName, definingTableAlias, mdEnumerationTableName, masterListMdBusinessIF, masterListTalbeAlias, rootQuery, tableJoinSet, userDefinedAlias);
    }
    else if (name.equals("sex")) 
    {
       return new mdss.general.SexMasterQuery.SexQuery((com.terraframe.mojo.dataaccess.MdAttributeEnumerationDAOIF)mdAttributeIF,  attributeNamespace, definingTableName, definingTableAlias, mdEnumerationTableName, masterListMdBusinessIF, masterListTalbeAlias, rootQuery, tableJoinSet, userDefinedAlias);
    }
    else 
    {
 ...
 **/
  public interface MosquitoQueryReferenceIF extends com.terraframe.mojo.generation.loader.Reloadable, mdss.entomology.TrueSpecieEntityQuery.TrueSpecieEntityQueryReferenceIF
  {
  ...
  public mdss.general.SexMasterQuery.SexQueryIF getSex(String alias);
    ...
    public com.terraframe.mojo.query.BasicCondition EQ(mdss.entomology.Mosquito mosquito);

    public com.terraframe.mojo.query.BasicCondition NE(mdss.entomology.Mosquito mosquito);
 ...
 * This type is used when a join is performed on this class as a reference.
 **/
  public static class MosquitoQueryReference extends mdss.entomology.TrueSpecieEntityQuery.TrueSpecieEntityQueryReference
 implements MosquitoQueryReferenceIF
, com.terraframe.mojo.generation.loader.Reloadable
  {
private static final long serialVersionUID = 1234203358819L;
  ...
  public mdss.entomology.GenerationMasterQuery.GenerationQueryIF getGeneration(String alias)
  {
    return (mdss.entomology.GenerationMasterQuery.GenerationQueryIF)this.attributeFactory("generation", "com.terraframe.mojo.system.metadata.MdAttributeEnumeration", alias);
  ...
  public mdss.general.SexMasterQuery.SexQueryIF getSex(String alias)
  {
    return (mdss.general.SexMasterQuery.SexQueryIF)this.attributeFactory("sex", "com.terraframe.mojo.system.metadata.MdAttributeEnumeration", alias);
