 ...
 */
public abstract class CollectionTrueSpecieBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1234294596370L;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(mdss.entomology.CollectionTrueSpecie.CLASS);
  ...
  public mdss.entomology.AbstractMosquitoCollection getParent()
  {
    return (mdss.entomology.AbstractMosquitoCollection) super.getParent();
  }
  
  public mdss.entomology.TrueSpecieEntity getChild()
  {
    return (mdss.entomology.TrueSpecieEntity) super.getChild();
  }
  
  public static CollectionTrueSpecie get(String id)
  {
    return (CollectionTrueSpecie) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static CollectionTrueSpecie lock(java.lang.String id)
  {
    CollectionTrueSpecie _instance = CollectionTrueSpecie.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static CollectionTrueSpecie unlock(java.lang.String id)
  {
    CollectionTrueSpecie _instance = CollectionTrueSpecie.get(id);
    _instance.unlock();
