 ...
 */
public abstract class CollectionSpecieBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1234294598206L;
  
  public CollectionSpecieBase(String parentId, String childId)
  {
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(mdss.entomology.CollectionSpecie.CLASS);
  ...
  public mdss.entomology.MorphologicalSpecieGroup getChild()
  {
    return (mdss.entomology.MorphologicalSpecieGroup) super.getChild();
  }
  
  public static CollectionSpecie get(String id)
  {
    return (CollectionSpecie) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static CollectionSpecie lock(java.lang.String id)
  {
    CollectionSpecie _instance = CollectionSpecie.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static CollectionSpecie unlock(java.lang.String id)
  {
    CollectionSpecie _instance = CollectionSpecie.get(id);
    _instance.unlock();
