...
public class ThresholdCalculationTypeView extends ThresholdCalculationTypeViewBase implements com.terraframe.mojo.generation.loader.Reloadable {
	...
	private void populateConcrete(ThresholdCalculationType concrete) {
		...
		concrete.setWeight0(this.getWeight0());
		concrete.setWeight1(this.getWeight1());
		concrete.setWeight2(this.getWeight2());
		concrete.setWeight3(this.getWeight3());
		concrete.setWeight4(this.getWeight4());
		concrete.setWeight5(this.getWeight5());
		concrete.setWeight6(this.getWeight6());
		concrete.setWeight7(this.getWeight7());
		concrete.setWeight8(this.getWeight8());
		concrete.setWeight9(this.getWeight9());
	...
	public double[] getWeights() {
		...
		switch (this.getPriorYears()) {
			case 10: weights[9] = this.getWeight9();
			case 9: weights[8] = this.getWeight8();
			case 8: weights[7] = this.getWeight7();
			case 7: weights[6] = this.getWeight6();
			case 6: weights[5] = this.getWeight5();
			case 5: weights[4] = this.getWeight4();
			case 4: weights[3] = this.getWeight3();
			case 3: weights[2] = this.getWeight2();
			case 2: weights[1] = this.getWeight1();
			case 1: weights[0] = this.getWeight0();
		}
		return weights;
	}
}
