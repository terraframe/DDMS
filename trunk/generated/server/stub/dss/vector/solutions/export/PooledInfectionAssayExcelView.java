...
public class PooledInfectionAssayExcelView extends PooledInfectionAssayExcelViewBase implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  public void apply()
  {
    ...
    assay.setIdentMethod(Term.validateByDisplayLabel(this.getIdentMethod(), PooledInfectionAssayView.getIdentMethodMd()));
    assay.setSex(Term.validateByDisplayLabel(this.getSex(), PooledInfectionAssayView.getSexMd()));
    assay.setParasite(Term.validateByDisplayLabel(this.getParasite(), PooledInfectionAssayView.getParasiteMd()));
    assay.setTestMethod(Term.validateByDisplayLabel(this.getTestMethod(), PooledInfectionAssayView.getTestMethodMd()));
