...
public class MosquitoCollectionExcelView extends MosquitoCollectionExcelViewBase implements com.runwaysdk.generation.loader.Reloadable, MobileImportViewIF
{
  ...
  public Map<String,String[]> getAttributeSourceMap()
  {
    ...
    map.put(MosquitoCollection.CLASS, new String[]{ABUNDANCE, COLLECTIONDATE, COLLECTIONID, COLLECTIONMETHOD, COLLECTIONROUND, COLLECTIONTYPE, DATELASTSPRAYED, GEOENTITY, INSECTICIDEBRAND, LIFESTAGE, NUMBEROFANIMALOCCUPANTS, NUMBEROFHUMANOCCUPANTS, NUMBEROFLLINS, WALLTYPE});
    map.put(SubCollection.CLASS, new String[]{SUBCOLLECTIONID, TAXON, EGGS, FEMALESFED, FEMALESGRAVID, FEMALESHALFGRAVID, FEMALESUNFED, FEMALESUNKNOWN, DISECTED, IDENTMETHOD, LARVAE, MALE, PAROUS, PUPAE, UNKNOWNS });
