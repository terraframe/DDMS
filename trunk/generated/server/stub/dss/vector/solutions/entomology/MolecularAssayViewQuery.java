...
private static final long serialVersionUID = -224575762;
  ...
  class DefaultMolecularAssayViewBuilder extends com.runwaysdk.query.ViewQueryBuilder implements com.runwaysdk.generation.loader.Reloadable
  {
    ...
    protected void buildSelectClause()
    {
      ...
      vQuery.map(MolecularAssayView.NUMBERRRP, query.getNumberRRp());
      vQuery.map(MolecularAssayView.NUMBERSRP, query.getNumberSRp());
      vQuery.map(MolecularAssayView.NUMBERRPRP, query.getNumberRpRp());
