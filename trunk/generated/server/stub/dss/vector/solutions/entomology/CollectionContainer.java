...
public class CollectionContainer extends CollectionContainerBase implements ChildOption, Reloadable {
	...
	public void apply() {
		 ...
		 * # with water, # destroyed, # treated with larvacide must all be LTE # containers
		 * # with immatures, # with larvae and # with pupae must all be LTE # with water 
		 * If # immatures is entered, it must be GTE # with larvae and GTE # with pupae
		 * # Containers must be GTE 0
		 */
	...
	public void validateNumberImmatures() {
		// Number of containers with immatures must be LTE number of containers with water
		...
		// Number of containers with immatures must be GTE number of containers with larvae
		...
		// Number of containers with immatures must be GTE number of containers with pupae
	...
	public void validateNumberLarvae() {
		// Number of containers with larvae must be LTE number of containers with water
	...
	public void validateNumberPupae() {
		// Number of containers with pupae must be LTE number of containers with water
