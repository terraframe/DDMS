...
public class MolecularAssayView extends MolecularAssayViewBase implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private void buildAttributeMap(MolecularAssay concrete)
  {
    ...
    new AttributeNotificationMap(concrete, MolecularAssay.COLLECTION, this, MolecularAssayView.COLLECTION);
    new AttributeNotificationMap(concrete, MolecularAssay.IDENTMETHOD, this, MolecularAssayView.IDENTMETHOD);
    new AttributeNotificationMap(concrete, MolecularAssay.ISOFEMALE, this, MolecularAssayView.ISOFEMALE);
    new AttributeNotificationMap(concrete, MolecularAssay.MOSQUITOID, this, MolecularAssayView.MOSQUITOID);
    ...
    new AttributeNotificationMap(concrete, MolecularAssay.GENERATION, this, MolecularAssayView.GENERATION);
    ...
    new AttributeNotificationMap(concrete, MolecularAssay.ASSAYMETHOD, this, MolecularAssayView.ASSAYMETHOD);
  ...
  public void apply()
  {
    MolecularAssay concrete = new MolecularAssay();
