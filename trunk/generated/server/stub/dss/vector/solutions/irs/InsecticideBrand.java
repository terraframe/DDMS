...
public class InsecticideBrand extends InsecticideBrandBase implements Reloadable
{
  ...
  /**
   * Converts the given string into an insecticide product term and then fetches
   * the corresponding InsecticideBrand
   * 
   * @param name
   *          name, display label, or termId of an insecticide
