...
@com.runwaysdk.business.ClassSignature(hash = 1262635565)
public abstract class LethalTimePropertyDTOBase extends com.runwaysdk.business.BusinessDTO implements com.runwaysdk.generation.loader.Reloadable
{
  public final static String CLASS = "dss.vector.solutions.general.LethalTimeProperty";
  private static final long serialVersionUID = 1262635565;
  
  protected LethalTimePropertyDTOBase(com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
    super(clientRequest);
  }
  ...
  */
  protected LethalTimePropertyDTOBase(com.runwaysdk.business.BusinessDTO businessDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  public static final dss.vector.solutions.general.LethalTimePropertyDTO searchByInsecticide(com.runwaysdk.constants.ClientRequestIF clientRequest, dss.vector.solutions.general.InsecticideDTO insecticide)
  {
    String[] _declaredTypes = new String[]{"dss.vector.solutions.general.Insecticide"};
    Object[] _parameters = new Object[]{insecticide};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(dss.vector.solutions.general.LethalTimePropertyDTO.CLASS, "searchByInsecticide", _declaredTypes);
    return (dss.vector.solutions.general.LethalTimePropertyDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  
  public static dss.vector.solutions.general.LethalTimePropertyDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String id)
  {
  ...
  public static dss.vector.solutions.general.LethalTimePropertyQueryDTO getAllInstances(com.runwaysdk.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (dss.vector.solutions.general.LethalTimePropertyQueryDTO) clientRequest.getAllInstances(dss.vector.solutions.general.LethalTimePropertyDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static dss.vector.solutions.general.LethalTimePropertyDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(dss.vector.solutions.general.LethalTimePropertyDTO.CLASS, "lock", _declaredTypes);
    return (dss.vector.solutions.general.LethalTimePropertyDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static dss.vector.solutions.general.LethalTimePropertyDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(dss.vector.solutions.general.LethalTimePropertyDTO.CLASS, "unlock", _declaredTypes);
    return (dss.vector.solutions.general.LethalTimePropertyDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
