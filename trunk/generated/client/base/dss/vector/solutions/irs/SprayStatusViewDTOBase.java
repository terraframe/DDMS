...
@com.terraframe.mojo.business.ClassSignature(hash = -2041727521)
public abstract class SprayStatusViewDTOBase extends com.terraframe.mojo.business.ViewDTO implements com.terraframe.mojo.generation.loader.Reloadable
{
  public final static String CLASS = "dss.vector.solutions.irs.SprayStatusView";
  private static final long serialVersionUID = -2041727521;
  
  protected SprayStatusViewDTOBase(com.terraframe.mojo.constants.ClientRequestIF clientRequest)
  {
    super(clientRequest);
  }
  ...
  public boolean isStatusIdWritable()
  {
    return isWritable(STATUSID);
  }
  
  public boolean isStatusIdReadable()
  {
    return isReadable(STATUSID);
  }
  
  public boolean isStatusIdModified()
  {
    return isModified(STATUSID);
  }
  
  public final com.terraframe.mojo.transport.metadata.AttributeCharacterMdDTO getStatusIdMd()
  {
    return (com.terraframe.mojo.transport.metadata.AttributeCharacterMdDTO) getAttributeDTO(STATUSID).getAttributeMdDTO();
  }
  ...
  public static SprayStatusViewDTO get(com.terraframe.mojo.constants.ClientRequestIF clientRequest, String id)
  {
    com.terraframe.mojo.business.ViewDTO dto = (com.terraframe.mojo.business.ViewDTO)clientRequest.get(id);
    
    return (SprayStatusViewDTO) dto;
  }
