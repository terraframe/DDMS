...
public abstract class ResourceTargetViewDTOBase extends com.terraframe.mojo.business.ViewDTO implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  public static java.lang.String TARGETID = "targetId";
  ...
  public boolean isTargetIdWritable()
  {
    return isWritable(TARGETID);
  }
  
  public boolean isTargetIdReadable()
  {
    return isReadable(TARGETID);
  }
  
  public boolean isTargetIdModified()
  {
    return isModified(TARGETID);
  }
  
  public final com.terraframe.mojo.transport.metadata.AttributeCharacterMdDTO getTargetIdMd()
  {
    return (com.terraframe.mojo.transport.metadata.AttributeCharacterMdDTO) getAttributeDTO(TARGETID).getAttributeMdDTO();
  }
  ...
  public dss.vector.solutions.irs.TargeterDTO getTargeter()
  {
    if(getValue(TARGETER) == null || getValue(TARGETER).trim().equals(""))
    {
      return null;
    }
    else
  ...
  public void setTargeter(dss.vector.solutions.irs.TargeterDTO value)
  {
    ...
    {
      setValue(TARGETER, value.getId());
    }
  }
  
  public boolean isTargeterWritable()
  {
    return isWritable(TARGETER);
  }
  
  public boolean isTargeterReadable()
  {
    return isReadable(TARGETER);
  }
  
  public boolean isTargeterModified()
  {
    return isModified(TARGETER);
  }
  
  public final com.terraframe.mojo.transport.metadata.AttributeReferenceMdDTO getTargeterMd()
  {
    return (com.terraframe.mojo.transport.metadata.AttributeReferenceMdDTO) getAttributeDTO(TARGETER).getAttributeMdDTO();
  }
  
  public String getTargeterName()
  {
    return getValue(TARGETERNAME);
  }
  
  public void setTargeterName(String value)
  {
    if(value == null)
    {
      setValue(TARGETERNAME, "");
    }
    else
    {
      setValue(TARGETERNAME, value);
    }
  }
  
  public boolean isTargeterNameWritable()
  {
    return isWritable(TARGETERNAME);
  }
  
  public boolean isTargeterNameReadable()
  {
    return isReadable(TARGETERNAME);
  }
  
  public boolean isTargeterNameModified()
  {
    return isModified(TARGETERNAME);
  }
  
  public final com.terraframe.mojo.transport.metadata.AttributeCharacterMdDTO getTargeterNameMd()
  {
    return (com.terraframe.mojo.transport.metadata.AttributeCharacterMdDTO) getAttributeDTO(TARGETERNAME).getAttributeMdDTO();
  }
  
  public static final dss.vector.solutions.irs.ResourceTargetViewDTO[] applyAll(com.terraframe.mojo.constants.ClientRequestIF clientRequest, dss.vector.solutions.irs.ResourceTargetViewDTO[] views)
  {
    String[] _declaredTypes = new String[]{"[Ldss.vector.solutions.irs.ResourceTargetView;"};
    Object[] _parameters = new Object[]{views};
    com.terraframe.mojo.business.MethodMetaData _metadata = new com.terraframe.mojo.business.MethodMetaData(dss.vector.solutions.irs.ResourceTargetViewDTO.CLASS, "applyAll", _declaredTypes);
    return (dss.vector.solutions.irs.ResourceTargetViewDTO[]) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public final void deleteConcrete()
  {
    ...
    com.terraframe.mojo.business.MethodMetaData _metadata = new com.terraframe.mojo.business.MethodMetaData(dss.vector.solutions.irs.ResourceTargetViewDTO.CLASS, "deleteConcrete", _declaredTypes);
  ...
  public static final dss.vector.solutions.irs.ResourceTargetViewDTO[] getResourceTargets(com.terraframe.mojo.constants.ClientRequestIF clientRequest, java.lang.String[] targeterIds, dss.vector.solutions.general.MalariaSeasonDTO season)
  {
    String[] _declaredTypes = new String[]{"[Ljava.lang.String;", "dss.vector.solutions.general.MalariaSeason"};
    Object[] _parameters = new Object[]{targeterIds, season};
    com.terraframe.mojo.business.MethodMetaData _metadata = new com.terraframe.mojo.business.MethodMetaData(dss.vector.solutions.irs.ResourceTargetViewDTO.CLASS, "getResourceTargets", _declaredTypes);
    return (dss.vector.solutions.irs.ResourceTargetViewDTO[]) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  
  public static final dss.vector.solutions.irs.ResourceTargetViewDTO[] lockAll(com.terraframe.mojo.constants.ClientRequestIF clientRequest, dss.vector.solutions.irs.ResourceTargetViewDTO[] views)
  {
    String[] _declaredTypes = new String[]{"[Ldss.vector.solutions.irs.ResourceTargetView;"};
    Object[] _parameters = new Object[]{views};
    com.terraframe.mojo.business.MethodMetaData _metadata = new com.terraframe.mojo.business.MethodMetaData(dss.vector.solutions.irs.ResourceTargetViewDTO.CLASS, "lockAll", _declaredTypes);
    return (dss.vector.solutions.irs.ResourceTargetViewDTO[]) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  
  public static final dss.vector.solutions.irs.ResourceTargetViewDTO sum(com.terraframe.mojo.constants.ClientRequestIF clientRequest, dss.vector.solutions.irs.TargeterDTO resource, dss.vector.solutions.irs.ResourceTargetViewDTO[] views)
  {
    String[] _declaredTypes = new String[]{"dss.vector.solutions.irs.Targeter", "[Ldss.vector.solutions.irs.ResourceTargetView;"};
    Object[] _parameters = new Object[]{resource, views};
    com.terraframe.mojo.business.MethodMetaData _metadata = new com.terraframe.mojo.business.MethodMetaData(dss.vector.solutions.irs.ResourceTargetViewDTO.CLASS, "sum", _declaredTypes);
    return (dss.vector.solutions.irs.ResourceTargetViewDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  
  public static final dss.vector.solutions.irs.ResourceTargetViewDTO[] unlockAll(com.terraframe.mojo.constants.ClientRequestIF clientRequest, dss.vector.solutions.irs.ResourceTargetViewDTO[] views)
  {
    String[] _declaredTypes = new String[]{"[Ldss.vector.solutions.irs.ResourceTargetView;"};
    Object[] _parameters = new Object[]{views};
    com.terraframe.mojo.business.MethodMetaData _metadata = new com.terraframe.mojo.business.MethodMetaData(dss.vector.solutions.irs.ResourceTargetViewDTO.CLASS, "unlockAll", _declaredTypes);
    return (dss.vector.solutions.irs.ResourceTargetViewDTO[]) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  
  public static ResourceTargetViewDTO get(com.terraframe.mojo.constants.ClientRequestIF clientRequest, String id)
  {
    com.terraframe.mojo.business.ViewDTO dto = (com.terraframe.mojo.business.ViewDTO)clientRequest.get(id);
    
    return (ResourceTargetViewDTO) dto;
  }
