...
public abstract class ResourceTargetViewDTOBase extends com.runwaysdk.business.ViewDTO implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  public final com.runwaysdk.transport.metadata.AttributeCharacterMdDTO getTargetIdMd()
  {
    return (com.runwaysdk.transport.metadata.AttributeCharacterMdDTO) getAttributeDTO(TARGETID).getAttributeMdDTO();
  }
  ...
  public final com.runwaysdk.transport.metadata.AttributeReferenceMdDTO getTargeterMd()
  {
    return (com.runwaysdk.transport.metadata.AttributeReferenceMdDTO) getAttributeDTO(TARGETER).getAttributeMdDTO();
  }
  ...
  public final com.runwaysdk.transport.metadata.AttributeCharacterMdDTO getTargeterNameMd()
  {
    return (com.runwaysdk.transport.metadata.AttributeCharacterMdDTO) getAttributeDTO(TARGETERNAME).getAttributeMdDTO();
  }
  
  public static final dss.vector.solutions.irs.ResourceTargetViewDTO[] applyAll(com.runwaysdk.constants.ClientRequestIF clientRequest, dss.vector.solutions.irs.ResourceTargetViewDTO[] views)
  {
    String[] _declaredTypes = new String[]{"[Ldss.vector.solutions.irs.ResourceTargetView;"};
    Object[] _parameters = new Object[]{views};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(dss.vector.solutions.irs.ResourceTargetViewDTO.CLASS, "applyAll", _declaredTypes);
  ...
  public static final dss.vector.solutions.irs.ResourceTargetViewDTO[] getResourceTargets(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String[] targeterIds, dss.vector.solutions.general.MalariaSeasonDTO season)
  {
    ...
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(dss.vector.solutions.irs.ResourceTargetViewDTO.CLASS, "getResourceTargets", _declaredTypes);
    return (dss.vector.solutions.irs.ResourceTargetViewDTO[]) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  
  public static final dss.vector.solutions.irs.ResourceTargetViewDTO[] lockAll(com.runwaysdk.constants.ClientRequestIF clientRequest, dss.vector.solutions.irs.ResourceTargetViewDTO[] views)
  {
    String[] _declaredTypes = new String[]{"[Ldss.vector.solutions.irs.ResourceTargetView;"};
    Object[] _parameters = new Object[]{views};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(dss.vector.solutions.irs.ResourceTargetViewDTO.CLASS, "lockAll", _declaredTypes);
    return (dss.vector.solutions.irs.ResourceTargetViewDTO[]) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  
  public static final dss.vector.solutions.irs.ResourceTargetViewDTO sum(com.runwaysdk.constants.ClientRequestIF clientRequest, dss.vector.solutions.irs.TargeterDTO resource, dss.vector.solutions.irs.ResourceTargetViewDTO[] views)
  {
    ...
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(dss.vector.solutions.irs.ResourceTargetViewDTO.CLASS, "sum", _declaredTypes);
    return (dss.vector.solutions.irs.ResourceTargetViewDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  
  public static final dss.vector.solutions.irs.ResourceTargetViewDTO[] unlockAll(com.runwaysdk.constants.ClientRequestIF clientRequest, dss.vector.solutions.irs.ResourceTargetViewDTO[] views)
  {
    String[] _declaredTypes = new String[]{"[Ldss.vector.solutions.irs.ResourceTargetView;"};
    Object[] _parameters = new Object[]{views};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(dss.vector.solutions.irs.ResourceTargetViewDTO.CLASS, "unlockAll", _declaredTypes);
    return (dss.vector.solutions.irs.ResourceTargetViewDTO[]) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  
  public static ResourceTargetViewDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String id)
  {
