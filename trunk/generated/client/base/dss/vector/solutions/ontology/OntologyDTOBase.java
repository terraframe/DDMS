...
public abstract class OntologyDTOBase extends com.terraframe.mojo.business.BusinessDTO implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  */
  protected OntologyDTOBase(com.terraframe.mojo.business.BusinessDTO businessDTO, com.terraframe.mojo.constants.ClientRequestIF clientRequest)
  {
  ...
  public final com.terraframe.mojo.transport.metadata.AttributeCharacterMdDTO getDefaultNamespaceMd()
  {
    return (com.terraframe.mojo.transport.metadata.AttributeCharacterMdDTO) getAttributeDTO(DEFAULTNAMESPACE).getAttributeMdDTO();
  }
  ...
  public final com.terraframe.mojo.transport.metadata.AttributeCharacterMdDTO getTitleMd()
  {
    return (com.terraframe.mojo.transport.metadata.AttributeCharacterMdDTO) getAttributeDTO(TITLE).getAttributeMdDTO();
  }
  ...
  @SuppressWarnings("unchecked")
  public static java.util.List<? extends dss.vector.solutions.ontology.OntologyRelationshipDTO> getAllOntologyRelationship(com.terraframe.mojo.constants.ClientRequestIF clientRequestIF, String id)
  {
  ...
  @SuppressWarnings("unchecked")
  public static java.util.List<? extends dss.vector.solutions.ontology.OntologyHasRelationshipDTO> getAllOntologyRelationshipRelationships(com.terraframe.mojo.constants.ClientRequestIF clientRequestIF, String id)
  {
  ...
  public static dss.vector.solutions.ontology.OntologyHasRelationshipDTO addOntologyRelationship(com.terraframe.mojo.constants.ClientRequestIF clientRequestIF, String id, dss.vector.solutions.ontology.OntologyRelationshipDTO child)
  {
  ...
  public static void removeOntologyRelationship(com.terraframe.mojo.constants.ClientRequestIF clientRequestIF, dss.vector.solutions.ontology.OntologyHasRelationshipDTO relationship)
  {
  ...
  public static void removeAllOntologyRelationship(com.terraframe.mojo.constants.ClientRequestIF clientRequestIF, String id)
  {
    clientRequestIF.deleteChildren(id, dss.vector.solutions.ontology.OntologyHasRelationshipDTO.CLASS);
  }
  
  public static dss.vector.solutions.ontology.OntologyDTO get(com.terraframe.mojo.constants.ClientRequestIF clientRequest, String id)
  {
  ...
  public static dss.vector.solutions.ontology.OntologyQueryDTO getAllInstances(com.terraframe.mojo.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (dss.vector.solutions.ontology.OntologyQueryDTO) clientRequest.getAllInstances("dss.vector.solutions.ontology.Ontology", sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static dss.vector.solutions.ontology.OntologyDTO lock(com.terraframe.mojo.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.terraframe.mojo.business.MethodMetaData _metadata = new com.terraframe.mojo.business.MethodMetaData(dss.vector.solutions.ontology.OntologyDTO.CLASS, "lock", _declaredTypes);
  ...
  public static dss.vector.solutions.ontology.OntologyDTO unlock(com.terraframe.mojo.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.terraframe.mojo.business.MethodMetaData _metadata = new com.terraframe.mojo.business.MethodMetaData(dss.vector.solutions.ontology.OntologyDTO.CLASS, "unlock", _declaredTypes);
    return (dss.vector.solutions.ontology.OntologyDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
