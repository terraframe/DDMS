...
@com.runwaysdk.business.ClassSignature(hash = 837768702)
public abstract class FormHouseholdDTOBase extends com.runwaysdk.business.BusinessDTO implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 837768702;
  ...
  */
  protected FormHouseholdDTOBase(com.runwaysdk.business.BusinessDTO businessDTO, com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
  ...
  public static final com.runwaysdk.business.ValueQueryDTO getHouseIds(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String value)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
  ...
  public static dss.vector.solutions.form.business.FormHouseholdDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String id)
  {
    ...
    return (dss.vector.solutions.form.business.FormHouseholdDTO) dto;
  }
  ...
  public static dss.vector.solutions.form.business.FormHouseholdQueryDTO getAllInstances(com.runwaysdk.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (dss.vector.solutions.form.business.FormHouseholdQueryDTO) clientRequest.getAllInstances(dss.vector.solutions.form.business.FormHouseholdDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static dss.vector.solutions.form.business.FormHouseholdDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(dss.vector.solutions.form.business.FormHouseholdDTO.CLASS, "lock", _declaredTypes);
    return (dss.vector.solutions.form.business.FormHouseholdDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static dss.vector.solutions.form.business.FormHouseholdDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(dss.vector.solutions.form.business.FormHouseholdDTO.CLASS, "unlock", _declaredTypes);
    return (dss.vector.solutions.form.business.FormHouseholdDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
