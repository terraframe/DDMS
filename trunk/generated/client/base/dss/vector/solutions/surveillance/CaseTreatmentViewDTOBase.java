...
@com.runwaysdk.business.ClassSignature(hash = -1003855658)
public abstract class CaseTreatmentViewDTOBase extends com.runwaysdk.business.ViewDTO implements com.runwaysdk.generation.loader.Reloadable
{
  public final static String CLASS = "dss.vector.solutions.surveillance.CaseTreatmentView";
  private static final long serialVersionUID = -1003855658;
  
  protected CaseTreatmentViewDTOBase(com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
    super(clientRequest);
  }
  ...
  public static CaseTreatmentViewDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String id)
  {
    com.runwaysdk.business.ViewDTO dto = (com.runwaysdk.business.ViewDTO)clientRequest.get(id);
    
    return (CaseTreatmentViewDTO) dto;
  }
