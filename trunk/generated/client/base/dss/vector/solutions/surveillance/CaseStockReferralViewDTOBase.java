...
@com.runwaysdk.business.ClassSignature(hash = 498247963)
public abstract class CaseStockReferralViewDTOBase extends com.runwaysdk.business.ViewDTO implements com.runwaysdk.generation.loader.Reloadable
{
  public final static String CLASS = "dss.vector.solutions.surveillance.CaseStockReferralView";
  private static final long serialVersionUID = 498247963;
  
  protected CaseStockReferralViewDTOBase(com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
    super(clientRequest);
  }
  ...
  public static CaseStockReferralViewDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String id)
  {
    com.runwaysdk.business.ViewDTO dto = (com.runwaysdk.business.ViewDTO)clientRequest.get(id);
    
    return (CaseStockReferralViewDTO) dto;
  }
