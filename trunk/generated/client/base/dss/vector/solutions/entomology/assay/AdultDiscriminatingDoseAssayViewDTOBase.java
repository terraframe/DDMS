...
@com.terraframe.mojo.business.ClassSignature(hash = 409957334)
public abstract class AdultDiscriminatingDoseAssayViewDTOBase extends com.terraframe.mojo.business.ViewDTO implements com.terraframe.mojo.generation.loader.Reloadable
{
  public final static String CLASS = "dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayView";
  private static final long serialVersionUID = 409957334;
  
  protected AdultDiscriminatingDoseAssayViewDTOBase(com.terraframe.mojo.constants.ClientRequestIF clientRequest)
  {
    super(clientRequest);
  }
  ...
  public static final dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayViewQueryDTO getPage(com.terraframe.mojo.constants.ClientRequestIF clientRequest, java.lang.String sortAttribute, java.lang.Boolean isAscending, java.lang.Integer pageSize, java.lang.Integer pageNumber)
  {
    ...
    com.terraframe.mojo.business.MethodMetaData _metadata = new com.terraframe.mojo.business.MethodMetaData(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayViewDTO.CLASS, "getPage", _declaredTypes);
    return (dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssayViewQueryDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  
  public static AdultDiscriminatingDoseAssayViewDTO get(com.terraframe.mojo.constants.ClientRequestIF clientRequest, String id)
  {
    com.terraframe.mojo.business.ViewDTO dto = (com.terraframe.mojo.business.ViewDTO)clientRequest.get(id);
    
    return (AdultDiscriminatingDoseAssayViewDTO) dto;
  }
