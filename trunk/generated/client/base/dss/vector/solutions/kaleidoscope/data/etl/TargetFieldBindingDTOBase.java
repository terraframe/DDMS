...
public abstract class TargetFieldBindingDTOBase extends com.runwaysdk.business.BusinessDTO implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  */
  ...
  public dss.vector.solutions.kaleidoscope.data.etl.TargetBindingDTO getTarget()
  {
    ...
    {
      return dss.vector.solutions.kaleidoscope.data.etl.TargetBindingDTO.get(getRequest(), getValue(TARGET));
    }
  }
  ...
  public void setTarget(dss.vector.solutions.kaleidoscope.data.etl.TargetBindingDTO value)
  {
    if(value == null)
    {
      setValue(TARGET, "");
  ...
  public static dss.vector.solutions.kaleidoscope.data.etl.TargetFieldBindingDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String id)
  {
    com.runwaysdk.business.EntityDTO dto = (com.runwaysdk.business.EntityDTO)clientRequest.get(id);
    
    return (dss.vector.solutions.kaleidoscope.data.etl.TargetFieldBindingDTO) dto;
  }
  ...
  public static dss.vector.solutions.kaleidoscope.data.etl.TargetFieldBindingQueryDTO getAllInstances(com.runwaysdk.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (dss.vector.solutions.kaleidoscope.data.etl.TargetFieldBindingQueryDTO) clientRequest.getAllInstances(dss.vector.solutions.kaleidoscope.data.etl.TargetFieldBindingDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static dss.vector.solutions.kaleidoscope.data.etl.TargetFieldBindingDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(dss.vector.solutions.kaleidoscope.data.etl.TargetFieldBindingDTO.CLASS, "lock", _declaredTypes);
    return (dss.vector.solutions.kaleidoscope.data.etl.TargetFieldBindingDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static dss.vector.solutions.kaleidoscope.data.etl.TargetFieldBindingDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(dss.vector.solutions.kaleidoscope.data.etl.TargetFieldBindingDTO.CLASS, "unlock", _declaredTypes);
    return (dss.vector.solutions.kaleidoscope.data.etl.TargetFieldBindingDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
