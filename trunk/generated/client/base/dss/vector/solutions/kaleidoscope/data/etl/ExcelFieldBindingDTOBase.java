...
@com.runwaysdk.business.ClassSignature(hash = 1007646078)
...
{
  public final static String CLASS = "dss.vector.solutions.kaleidoscope.data.etl.ExcelFieldBinding";
  private static final long serialVersionUID = 1007646078;
  ...
  */
  ...
  public dss.vector.solutions.kaleidoscope.data.etl.ExcelSourceBindingDTO getSourceDefinition()
  {
    ...
    {
      return dss.vector.solutions.kaleidoscope.data.etl.ExcelSourceBindingDTO.get(getRequest(), getValue(SOURCEDEFINITION));
    }
  }
  ...
  public void setSourceDefinition(dss.vector.solutions.kaleidoscope.data.etl.ExcelSourceBindingDTO value)
  {
    if(value == null)
    {
  ...
  public static dss.vector.solutions.kaleidoscope.data.etl.ExcelFieldBindingDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String id)
  {
    com.runwaysdk.business.EntityDTO dto = (com.runwaysdk.business.EntityDTO)clientRequest.get(id);
    
    return (dss.vector.solutions.kaleidoscope.data.etl.ExcelFieldBindingDTO) dto;
  }
  ...
  public static dss.vector.solutions.kaleidoscope.data.etl.ExcelFieldBindingQueryDTO getAllInstances(com.runwaysdk.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (dss.vector.solutions.kaleidoscope.data.etl.ExcelFieldBindingQueryDTO) clientRequest.getAllInstances(dss.vector.solutions.kaleidoscope.data.etl.ExcelFieldBindingDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static dss.vector.solutions.kaleidoscope.data.etl.ExcelFieldBindingDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(dss.vector.solutions.kaleidoscope.data.etl.ExcelFieldBindingDTO.CLASS, "lock", _declaredTypes);
    return (dss.vector.solutions.kaleidoscope.data.etl.ExcelFieldBindingDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static dss.vector.solutions.kaleidoscope.data.etl.ExcelFieldBindingDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(dss.vector.solutions.kaleidoscope.data.etl.ExcelFieldBindingDTO.CLASS, "unlock", _declaredTypes);
    return (dss.vector.solutions.kaleidoscope.data.etl.ExcelFieldBindingDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
