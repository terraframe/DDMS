...
@com.runwaysdk.business.ClassSignature(hash = -1399393273)
...
{
  public final static String CLASS = "dss.vector.solutions.kaleidoscope.dashboard.DashboardLegend";
  private static final long serialVersionUID = -1399393273;
  ...
  */
  ...
  public static dss.vector.solutions.kaleidoscope.dashboard.DashboardLegendQueryDTO getAllInstances(com.runwaysdk.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (dss.vector.solutions.kaleidoscope.dashboard.DashboardLegendQueryDTO) clientRequest.getAllInstances(dss.vector.solutions.kaleidoscope.dashboard.DashboardLegendDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
