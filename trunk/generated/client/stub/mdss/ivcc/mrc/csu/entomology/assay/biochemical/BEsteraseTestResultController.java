...
public class BEsteraseTestResultController extends BEsteraseTestResultControllerBase implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    mdss.ivcc.mrc.csu.entomology.assay.biochemical.BEsteraseTestResultQueryDTO query = mdss.ivcc.mrc.csu.entomology.assay.biochemical.BEsteraseTestResultDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
  ...
  public void delete(mdss.ivcc.mrc.csu.entomology.assay.biochemical.BEsteraseTestResultDTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dto.delete();
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    mdss.ivcc.mrc.csu.entomology.assay.biochemical.BEsteraseTestResultQueryDTO query = mdss.ivcc.mrc.csu.entomology.assay.biochemical.BEsteraseTestResultDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All BEsteraseTestResultController Objects");
    render("viewAllComponent.jsp");
  }
