...
public class PFalciparumTestResultController extends PFalciparumTestResultControllerBase implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  public void viewAll() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    mdss.ivcc.mrc.csu.entomology.assay.infectivity.PFalciparumTestResultQueryDTO query = mdss.ivcc.mrc.csu.entomology.assay.infectivity.PFalciparumTestResultDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    mdss.ivcc.mrc.csu.entomology.assay.infectivity.PFalciparumTestResultQueryDTO query = mdss.ivcc.mrc.csu.entomology.assay.infectivity.PFalciparumTestResultDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All PFalciparumTestResultController Objects");
    render("viewAllComponent.jsp");
  }
