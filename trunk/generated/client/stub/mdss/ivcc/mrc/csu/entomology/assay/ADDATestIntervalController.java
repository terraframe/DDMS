...
import mdss.ivcc.mrc.csu.entomology.assay.ADDATestIntervalControllerBase;
...
{
  public static final String JSP_DIR = "WEB-INF/mdss/ivcc/mrc/csu/entomology/assay/ADDATestInterval/";
  ...
  public void viewAll() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    mdss.ivcc.mrc.csu.entomology.assay.ADDATestIntervalQueryDTO query = mdss.ivcc.mrc.csu.entomology.assay.ADDATestIntervalDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  public void delete(mdss.ivcc.mrc.csu.entomology.assay.ADDATestIntervalDTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dto.delete();
  ...
  public void cancel(mdss.ivcc.mrc.csu.entomology.assay.ADDATestIntervalDTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
    dto.unlock();
    this.view(dto.getId());
  }
  public void failCancel(mdss.ivcc.mrc.csu.entomology.assay.ADDATestIntervalDTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
    resp.sendError(500);
  }
  public void create(mdss.ivcc.mrc.csu.entomology.assay.ADDATestIntervalDTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dto.apply();
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    mdss.ivcc.mrc.csu.entomology.assay.ADDATestIntervalQueryDTO query = mdss.ivcc.mrc.csu.entomology.assay.ADDATestIntervalDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All ADDATestIntervalController Objects");
    render("viewAllComponent.jsp");
  }
  ...
  public void update(mdss.ivcc.mrc.csu.entomology.assay.ADDATestIntervalDTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dto.apply();
