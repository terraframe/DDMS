...
public class MonooxygenaseTestResultController extends MonooxygenaseTestResultControllerBase implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1235599935307L;
  ...
  {
    req.setAttribute("mdss_ivcc_mrc_csu_entomology_assay_biochemical_MonooxygenaseTestResult_mosquito", mdss.ivcc.mrc.csu.entomology.MosquitoDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
