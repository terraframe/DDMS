...
public class WKDRTestResultController extends WKDRTestResultControllerBase implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  public void failCancel(mdss.ivcc.mrc.csu.entomology.assay.molecular.WKDRTestResultDTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
    resp.sendError(500);
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    mdss.ivcc.mrc.csu.entomology.assay.molecular.WKDRTestResultQueryDTO query = mdss.ivcc.mrc.csu.entomology.assay.molecular.WKDRTestResultDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All WKDRTestResultController Objects");
    render("viewAllComponent.jsp");
  }
  ...
  public void create(mdss.ivcc.mrc.csu.entomology.assay.molecular.WKDRTestResultDTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dto.apply();
  ...
  public void update(mdss.ivcc.mrc.csu.entomology.assay.molecular.WKDRTestResultDTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dto.apply();
