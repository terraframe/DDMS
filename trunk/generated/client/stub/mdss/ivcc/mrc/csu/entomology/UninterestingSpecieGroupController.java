...
import mdss.ivcc.mrc.csu.entomology.UninterestingSpecieGroupControllerBase;
...
public class UninterestingSpecieGroupController extends UninterestingSpecieGroupControllerBase implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  public void update(mdss.ivcc.mrc.csu.entomology.UninterestingSpecieGroupDTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dto.apply();
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    mdss.ivcc.mrc.csu.entomology.UninterestingSpecieGroupQueryDTO query = mdss.ivcc.mrc.csu.entomology.UninterestingSpecieGroupDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
  ...
  public void create(mdss.ivcc.mrc.csu.entomology.UninterestingSpecieGroupDTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dto.apply();
  ...
  public void delete(mdss.ivcc.mrc.csu.entomology.UninterestingSpecieGroupDTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dto.delete();
  ...
  public void cancel(mdss.ivcc.mrc.csu.entomology.UninterestingSpecieGroupDTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
    dto.unlock();
    this.view(dto.getId());
  }
  public void failCancel(mdss.ivcc.mrc.csu.entomology.UninterestingSpecieGroupDTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
    resp.sendError(500);
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    mdss.ivcc.mrc.csu.entomology.UninterestingSpecieGroupQueryDTO query = mdss.ivcc.mrc.csu.entomology.UninterestingSpecieGroupDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All UninterestingSpecieGroupController Objects");
    render("viewAllComponent.jsp");
  }
