...
public class InfectivityAssayTestResultController extends InfectivityAssayTestResultControllerBase implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  public void create(mdss.ivcc.mrc.csu.entomology.assay.infectivity.InfectivityAssayTestResultDTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dto.apply();
  ...
  public void update(mdss.ivcc.mrc.csu.entomology.assay.infectivity.InfectivityAssayTestResultDTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dto.apply();
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    mdss.ivcc.mrc.csu.entomology.assay.infectivity.InfectivityAssayTestResultQueryDTO query = mdss.ivcc.mrc.csu.entomology.assay.infectivity.InfectivityAssayTestResultDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All InfectivityAssayTestResultController Objects");
    render("viewAllComponent.jsp");
  }
