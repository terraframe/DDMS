...
{
  public static final String JSP_DIR = "WEB-INF/mdss/entomology/ResistantCutOff/";
  ...
  {
    mdss.entomology.ResistantCutOffDTO dto = mdss.entomology.ResistantCutOffDTO.lock(super.getClientRequest(), id);
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    mdss.entomology.ResistantCutOffDTO dto = new mdss.entomology.ResistantCutOffDTO(clientRequest);
    req.setAttribute("item", dto);
