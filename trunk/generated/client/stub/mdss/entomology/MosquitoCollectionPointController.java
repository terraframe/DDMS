...
{
  private static final long serialVersionUID = 1234741248907L;
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    {
      req.getRequestDispatcher("WEB-INF/mdss/entomology/MosquitoCollectionPoint/createComponent.jsp").forward(req, resp);
    }
    else
    {
  ...
  public void viewPage(java.lang.String sortAttribute, java.lang.Boolean isAscending, java.lang.Integer pageSize, java.lang.Integer pageNumber) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    if(this.isAsynchronous())
    {
      req.getRequestDispatcher("WEB-INF/mdss/entomology/MosquitoCollectionPoint/viewAllComponent.jsp").forward(req, resp);
    }
    else
    {
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    if(this.isAsynchronous())
    {
      req.getRequestDispatcher("WEB-INF/mdss/entomology/MosquitoCollectionPoint/viewComponent.jsp").forward(req, resp);
    }
    else
    {
  ...
  public void failUpdate(mdss.entomology.MosquitoCollectionPointDTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    if(this.isAsynchronous())
    {
      req.getRequestDispatcher("WEB-INF/mdss/entomology/MosquitoCollectionPoint/editComponent.jsp").forward(req, resp);
    }
    else
    {
