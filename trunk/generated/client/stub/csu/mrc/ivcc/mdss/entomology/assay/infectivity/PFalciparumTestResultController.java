...
import csu.mrc.ivcc.mdss.entomology.assay.infectivity.PFalciparumTestResultControllerBase;
...
{
  public static final String JSP_DIR = "WEB-INF/csu/mrc/ivcc/mdss/entomology/assay/infectivity/PFalciparumTestResult/";
  ...
  public void viewAll() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    csu.mrc.ivcc.mdss.entomology.assay.infectivity.PFalciparumTestResultQueryDTO query = csu.mrc.ivcc.mdss.entomology.assay.infectivity.PFalciparumTestResultDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    csu.mrc.ivcc.mdss.entomology.assay.infectivity.PFalciparumTestResultDTO dto = csu.mrc.ivcc.mdss.entomology.assay.infectivity.PFalciparumTestResultDTO.lock(super.getClientRequest(), id);
    req.setAttribute("mdss_ivcc_mrc_csu_entomology_assay_AssayTestResult_mosquito", csu.mrc.ivcc.mdss.entomology.MosquitoDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", dto);
    req.setAttribute("page_title", "Edit PFalciparumTestResultController");
    render("editComponent.jsp");
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    csu.mrc.ivcc.mdss.entomology.assay.infectivity.PFalciparumTestResultQueryDTO query = csu.mrc.ivcc.mdss.entomology.assay.infectivity.PFalciparumTestResultDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All PFalciparumTestResultController Objects");
    render("viewAllComponent.jsp");
  }
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("mdss_ivcc_mrc_csu_entomology_assay_AssayTestResult_mosquito", csu.mrc.ivcc.mdss.entomology.MosquitoDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", csu.mrc.ivcc.mdss.entomology.assay.infectivity.PFalciparumTestResultDTO.get(clientRequest, id));
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    csu.mrc.ivcc.mdss.entomology.assay.infectivity.PFalciparumTestResultDTO dto = new csu.mrc.ivcc.mdss.entomology.assay.infectivity.PFalciparumTestResultDTO(clientRequest);
    req.setAttribute("mdss_ivcc_mrc_csu_entomology_assay_AssayTestResult_mosquito", csu.mrc.ivcc.mdss.entomology.MosquitoDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", dto);
    req.setAttribute("page_title", "Create PFalciparumTestResultController");
    render("createComponent.jsp");
