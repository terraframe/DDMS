...
import csu.mrc.ivcc.mdss.mo.IdentificationMethodControllerBase;
...
{
  public static final String JSP_DIR = "WEB-INF/csu/mrc/ivcc/mdss/entomology/IdentificationMethod/";
  ...
  {
    csu.mrc.ivcc.mdss.mo.IdentificationMethodDTO dto = csu.mrc.ivcc.mdss.mo.IdentificationMethodDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    csu.mrc.ivcc.mdss.mo.IdentificationMethodDTO dto = new csu.mrc.ivcc.mdss.mo.IdentificationMethodDTO(clientRequest);
    req.setAttribute("item", dto);
    req.setAttribute("page_title", "Create IdentificationMethodController");
    render("createComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    csu.mrc.ivcc.mdss.mo.IdentificationMethodQueryDTO query = csu.mrc.ivcc.mdss.mo.IdentificationMethodDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    csu.mrc.ivcc.mdss.mo.IdentificationMethodQueryDTO query = csu.mrc.ivcc.mdss.mo.IdentificationMethodDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All IdentificationMethodController Objects");
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", csu.mrc.ivcc.mdss.mo.IdentificationMethodDTO.get(clientRequest, id));
