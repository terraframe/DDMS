...
import csu.mrc.ivcc.mdss.mo.InsecticideMethodologyControllerBase;
...
{
  public static final String JSP_DIR = "WEB-INF/csu/mrc/ivcc/mdss/mo/InsecticideMethodology/";
  ...
  public void viewAll() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    csu.mrc.ivcc.mdss.mo.InsecticideMethodologyQueryDTO query = csu.mrc.ivcc.mdss.mo.InsecticideMethodologyDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    csu.mrc.ivcc.mdss.mo.InsecticideMethodologyDTO dto = csu.mrc.ivcc.mdss.mo.InsecticideMethodologyDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    req.setAttribute("page_title", "Edit InsecticideMethodologyController");
    render("editComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    csu.mrc.ivcc.mdss.mo.InsecticideMethodologyQueryDTO query = csu.mrc.ivcc.mdss.mo.InsecticideMethodologyDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All InsecticideMethodologyController Objects");
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    csu.mrc.ivcc.mdss.mo.InsecticideMethodologyDTO dto = new csu.mrc.ivcc.mdss.mo.InsecticideMethodologyDTO(clientRequest);
    req.setAttribute("item", dto);
    req.setAttribute("page_title", "Create InsecticideMethodologyController");
    render("createComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", csu.mrc.ivcc.mdss.mo.InsecticideMethodologyDTO.get(clientRequest, id));
