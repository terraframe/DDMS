...
public class CountryController extends CountryControllerBase implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  public void viewPage(java.lang.String sortAttribute, java.lang.Boolean isAscending, java.lang.Integer pageSize, java.lang.Integer pageNumber) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    csu.mrc.ivcc.mdss.geo.generated.CountryQueryDTO query = csu.mrc.ivcc.mdss.geo.generated.CountryDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    csu.mrc.ivcc.mdss.geo.generated.CountryQueryDTO query = csu.mrc.ivcc.mdss.geo.generated.CountryDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All CountryController Objects");
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", csu.mrc.ivcc.mdss.geo.generated.CountryDTO.get(clientRequest, id));
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    csu.mrc.ivcc.mdss.geo.generated.CountryDTO dto = new csu.mrc.ivcc.mdss.geo.generated.CountryDTO(clientRequest);
  ...
  {
    csu.mrc.ivcc.mdss.geo.generated.CountryDTO dto = csu.mrc.ivcc.mdss.geo.generated.CountryDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
