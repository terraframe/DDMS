...
{
  public static final String JSP_DIR = "WEB-INF/csu/mrc/ivcc/mdss/geo/generated/GeoEntity/";
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    req.setAttribute("item", csu.mrc.ivcc.mdss.geo.generated.GeoEntityDTO.get(clientRequest, id));
  ...
  {
    csu.mrc.ivcc.mdss.geo.generated.GeoEntityDTO dto = csu.mrc.ivcc.mdss.geo.generated.GeoEntityDTO.lock(super.getClientRequest(), id);
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    csu.mrc.ivcc.mdss.geo.generated.GeoEntityQueryDTO query = csu.mrc.ivcc.mdss.geo.generated.GeoEntityDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    csu.mrc.ivcc.mdss.geo.generated.GeoEntityQueryDTO query = csu.mrc.ivcc.mdss.geo.generated.GeoEntityDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All GeoEntityController Objects");
    render("viewAllComponent.jsp");
  }
