...
public class LarvaeAgeController extends LarvaeAgeControllerBase implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.mo.LarvaeAgeQueryDTO query = dss.vector.solutions.mo.LarvaeAgeDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
  ...
  {
    dss.vector.solutions.mo.LarvaeAgeDTO dto = dss.vector.solutions.mo.LarvaeAgeDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  public void viewAll() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.mo.LarvaeAgeQueryDTO query = dss.vector.solutions.mo.LarvaeAgeDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
