...
import dss.vector.solutions.mo.ResistanceMethodologyControllerBase;
...
{
  public static final String JSP_DIR = "WEB-INF/dss/vector/solutions/entomology/AssayMethod/";
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    dss.vector.solutions.mo.ResistanceMethodologyDTO dto = new dss.vector.solutions.mo.ResistanceMethodologyDTO(clientRequest);
    req.setAttribute("item", dto);
    req.setAttribute("page_title", "Create AssayMethodController");
    render("createComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.mo.ResistanceMethodologyQueryDTO query = dss.vector.solutions.mo.ResistanceMethodologyDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
  ...
  {
    dss.vector.solutions.mo.ResistanceMethodologyDTO dto = dss.vector.solutions.mo.ResistanceMethodologyDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    req.setAttribute("page_title", "Edit AssayMethodController");
    render("editComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.mo.ResistanceMethodologyQueryDTO query = dss.vector.solutions.mo.ResistanceMethodologyDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All AssayMethodController Objects");
    render("viewAllComponent.jsp");
  }
