...
public class SurfaceController extends SurfaceControllerBase implements com.terraframe.mojo.generation.loader.Reloadable
{
  public static final String JSP_DIR = "WEB-INF/dss/vector/solutions/geo/generated/Surface/";
  public static final String LAYOUT = "/layout.jsp";
  
  private static final long serialVersionUID = 1246601001084L;
  ...
  public void failDelete(dss.vector.solutions.geo.generated.SurfaceDTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    req.setAttribute("page_title", "Edit Surface");
  ...
  {
    req.setAttribute("item", dto);
    req.setAttribute("page_title", "Update Surface");
    render("editComponent.jsp");
  }
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    req.setAttribute("item", dss.vector.solutions.geo.generated.SurfaceDTO.get(clientRequest, id));
    req.setAttribute("page_title", "View Surface");
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.geo.generated.SurfaceQueryDTO query = dss.vector.solutions.geo.generated.SurfaceDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All Surface Objects");
  ...
  {
    req.setAttribute("item", dto);
    req.setAttribute("page_title", "Create Surface");
    render("createComponent.jsp");
  }
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.geo.generated.SurfaceDTO dto = new dss.vector.solutions.geo.generated.SurfaceDTO(clientRequest);
    req.setAttribute("item", dto);
    req.setAttribute("page_title", "Create Surface");
    render("createComponent.jsp");
  }
  ...
  {
    dss.vector.solutions.geo.generated.SurfaceDTO dto = dss.vector.solutions.geo.generated.SurfaceDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    req.setAttribute("page_title", "Edit Surface");
    render("editComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.geo.generated.SurfaceQueryDTO query = dss.vector.solutions.geo.generated.SurfaceDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All Surface Objects");
    render("viewAllComponent.jsp");
  }
