...
public class PropertyDisplayLabelController extends PropertyDisplayLabelControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  public static final String JSP_DIR = "WEB-INF/dss/vector/solutions/PropertyDisplayLabel/";
  public static final String LAYOUT = "/layout.jsp";
  
  private static final long serialVersionUID = -1787270906;
  
  public PropertyDisplayLabelController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  public void edit(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dss.vector.solutions.PropertyDisplayLabelDTO dto = dss.vector.solutions.PropertyDisplayLabelDTO.get(super.getClientRequest(), id);
      req.setAttribute("item", dto);
      render("editComponent.jsp");
    }
    catch(java.lang.Throwable t)
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      ...
      dss.vector.solutions.PropertyDisplayLabelDTO dto = new dss.vector.solutions.PropertyDisplayLabelDTO(clientRequest);
      req.setAttribute("item", dto);
      render("createComponent.jsp");
    }
    catch(java.lang.Throwable t)
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      ...
      com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
      dss.vector.solutions.PropertyDisplayLabelDTO dto = dss.vector.solutions.PropertyDisplayLabelDTO.get(clientRequest, id);
      req.setAttribute("item", dto);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.PropertyDisplayLabelQueryDTO query = dss.vector.solutions.PropertyDisplayLabelDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.PropertyDisplayLabelQueryDTO query = dss.vector.solutions.PropertyDisplayLabelDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
