...
public class IsAController extends IsAControllerBase implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  public void update(dss.vector.solutions.ontology.IsADTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dto.apply();
  ...
  public void failUpdate(dss.vector.solutions.ontology.IsADTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.ontology.IsADTO dto = new dss.vector.solutions.ontology.IsADTO(clientRequest, parentId, childId);
    req.setAttribute("item", dto);
    render("createComponent.jsp");
  }
  ...
  {
    dss.vector.solutions.ontology.IsADTO dto = dss.vector.solutions.ontology.IsADTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.ontology.IsAQueryDTO query = dss.vector.solutions.ontology.IsADTO.parentQuery(clientRequest, parentId);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.ontology.IsAQueryDTO query = dss.vector.solutions.ontology.IsADTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
