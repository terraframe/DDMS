...
public class HasCategoriesController extends HasCategoriesControllerBase implements com.terraframe.mojo.generation.loader.Reloadable
{
  public static final String JSP_DIR = "WEB-INF/dss/vector/solutions/query/HasCategories/";
  public static final String LAYOUT = "/layout.jsp";
  
  private static final long serialVersionUID = -2065627361;
  
  public HasCategoriesController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  public void childQuery(java.lang.String childId) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    dss.vector.solutions.query.HasCategoriesQueryDTO query = dss.vector.solutions.query.HasCategoriesDTO.childQuery(clientRequest, childId);
  ...
  {
    dss.vector.solutions.query.HasCategoriesDTO dto = dss.vector.solutions.query.HasCategoriesDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.query.HasCategoriesDTO dto = new dss.vector.solutions.query.HasCategoriesDTO(clientRequest, parentId, childId);
    req.setAttribute("item", dto);
    render("createComponent.jsp");
  }
  ...
  {
    req.setAttribute("parentList", dss.vector.solutions.query.LayerDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.query.HasCategoriesQueryDTO query = dss.vector.solutions.query.HasCategoriesDTO.parentQuery(clientRequest, parentId);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.query.HasCategoriesDTO dto = dss.vector.solutions.query.HasCategoriesDTO.get(clientRequest, id);
    req.setAttribute("item", dto);
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.query.HasCategoriesQueryDTO query = dss.vector.solutions.query.HasCategoriesDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.query.HasCategoriesQueryDTO query = dss.vector.solutions.query.HasCategoriesDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
