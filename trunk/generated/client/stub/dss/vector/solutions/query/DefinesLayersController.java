...
public class DefinesLayersController extends DefinesLayersControllerBase implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  public DefinesLayersController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  public void newInstance(java.lang.String parentId, java.lang.String childId) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    dss.vector.solutions.query.DefinesLayersDTO dto = new dss.vector.solutions.query.DefinesLayersDTO(clientRequest, parentId, childId);
    req.setAttribute("item", dto);
    req.setAttribute("page_title", "Create DefinesLayersController");
    render("createComponent.jsp");
  }
  ...
  {
    req.setAttribute("parentList", dss.vector.solutions.query.SavedSearchDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.query.DefinesLayersQueryDTO query = dss.vector.solutions.query.DefinesLayersDTO.childQuery(clientRequest, childId);
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.query.DefinesLayersQueryDTO query = dss.vector.solutions.query.DefinesLayersDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All DefinesLayersController Objects");
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.query.DefinesLayersQueryDTO query = dss.vector.solutions.query.DefinesLayersDTO.parentQuery(clientRequest, parentId);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All DefinesLayersController Objects");
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.query.DefinesLayersQueryDTO query = dss.vector.solutions.query.DefinesLayersDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All DefinesLayersController Objects");
    render("viewAllComponent.jsp");
  }
  ...
  {
    dss.vector.solutions.query.DefinesLayersDTO dto = dss.vector.solutions.query.DefinesLayersDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
