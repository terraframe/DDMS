...
public class FontStyleController extends FontStyleControllerBase implements com.terraframe.mojo.generation.loader.Reloadable
{
  public static final String JSP_DIR = "WEB-INF/dss/vector/solutions/query/FontStyle/";
  public static final String LAYOUT = "/layout.jsp";
  
  private static final long serialVersionUID = 1069406756;
  
  public FontStyleController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  {
    dss.vector.solutions.query.FontStyleDTO dto = dss.vector.solutions.query.FontStyleDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    render("editComponent.jsp");
  }
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    dss.vector.solutions.query.FontStyleDTO dto = new dss.vector.solutions.query.FontStyleDTO(clientRequest);
    req.setAttribute("item", dto);
    render("createComponent.jsp");
  }
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.query.FontStyleDTO dto = dss.vector.solutions.query.FontStyleDTO.get(clientRequest, id);
    req.setAttribute("item", dto);
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.query.FontStyleQueryDTO query = dss.vector.solutions.query.FontStyleDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.query.FontStyleQueryDTO query = dss.vector.solutions.query.FontStyleDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
