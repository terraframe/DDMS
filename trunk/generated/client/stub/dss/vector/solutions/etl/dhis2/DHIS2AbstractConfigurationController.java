...
public class DHIS2AbstractConfigurationController extends DHIS2AbstractConfigurationControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  public static final String JSP_DIR = "WEB-INF/dss/vector/solutions/etl/dhis2/DHIS2AbstractConfiguration/";
  public static final String LAYOUT = "/layout.jsp";
  
  public DHIS2AbstractConfigurationController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  public void edit(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dss.vector.solutions.etl.dhis2.DHIS2AbstractConfigurationDTO dto = dss.vector.solutions.etl.dhis2.DHIS2AbstractConfigurationDTO.lock(super.getClientRequest(), id);
      req.setAttribute("item", dto);
      render("editComponent.jsp");
    }
    catch(java.lang.Throwable t)
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      ...
      dss.vector.solutions.etl.dhis2.DHIS2AbstractConfigurationDTO dto = new dss.vector.solutions.etl.dhis2.DHIS2AbstractConfigurationDTO(clientRequest);
      req.setAttribute("item", dto);
      render("createComponent.jsp");
    }
    catch(java.lang.Throwable t)
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      ...
      com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
      dss.vector.solutions.etl.dhis2.DHIS2AbstractConfigurationDTO dto = dss.vector.solutions.etl.dhis2.DHIS2AbstractConfigurationDTO.get(clientRequest, id);
      req.setAttribute("item", dto);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.etl.dhis2.DHIS2AbstractConfigurationQueryDTO query = dss.vector.solutions.etl.dhis2.DHIS2AbstractConfigurationDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.etl.dhis2.DHIS2AbstractConfigurationQueryDTO query = dss.vector.solutions.etl.dhis2.DHIS2AbstractConfigurationDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
