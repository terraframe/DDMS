...
public class OrgUnitController extends OrgUnitControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  public static final String JSP_DIR = "WEB-INF/dss/vector/solutions/etl/dhis2/OrgUnit/";
  public static final String LAYOUT = "/layout.jsp";
  
  public OrgUnitController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  public void failCreate(dss.vector.solutions.etl.dhis2.OrgUnitDTO dto) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    req.setAttribute("parent", dss.vector.solutions.etl.dhis2.OrgUnitDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
  ...
  public void edit(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dss.vector.solutions.etl.dhis2.OrgUnitDTO dto = dss.vector.solutions.etl.dhis2.OrgUnitDTO.lock(super.getClientRequest(), id);
      req.setAttribute("orgUnitLevel", dss.vector.solutions.etl.dhis2.OrgUnitLevelDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("parent", dss.vector.solutions.etl.dhis2.OrgUnitDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("item", dto);
      render("editComponent.jsp");
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      ...
      dss.vector.solutions.etl.dhis2.OrgUnitDTO dto = new dss.vector.solutions.etl.dhis2.OrgUnitDTO(clientRequest);
      req.setAttribute("orgUnitLevel", dss.vector.solutions.etl.dhis2.OrgUnitLevelDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("parent", dss.vector.solutions.etl.dhis2.OrgUnitDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("item", dto);
      render("createComponent.jsp");
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      ...
      com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
      dss.vector.solutions.etl.dhis2.OrgUnitDTO dto = dss.vector.solutions.etl.dhis2.OrgUnitDTO.get(clientRequest, id);
      req.setAttribute("orgUnitLevel", dss.vector.solutions.etl.dhis2.OrgUnitLevelDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("parent", dss.vector.solutions.etl.dhis2.OrgUnitDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("item", dto);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.etl.dhis2.OrgUnitQueryDTO query = dss.vector.solutions.etl.dhis2.OrgUnitDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.etl.dhis2.OrgUnitQueryDTO query = dss.vector.solutions.etl.dhis2.OrgUnitDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
