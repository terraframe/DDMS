...
import dss.vector.solutions.entomology.assay.biochemical.PNPATestResultControllerBase;
...
{
  public static final String JSP_DIR = "WEB-INF/dss/vector/solutions/entomology/assay/biochemical/PNPATestResult/";
  ...
  {
    dss.vector.solutions.entomology.assay.biochemical.PNPATestResultDTO dto = dss.vector.solutions.entomology.assay.biochemical.PNPATestResultDTO.lock(super.getClientRequest(), id);
  ...
  public void viewAll() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    dss.vector.solutions.entomology.assay.biochemical.PNPATestResultQueryDTO query = dss.vector.solutions.entomology.assay.biochemical.PNPATestResultDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.entomology.assay.biochemical.PNPATestResultDTO dto = new dss.vector.solutions.entomology.assay.biochemical.PNPATestResultDTO(clientRequest);
    req.setAttribute("mdss_ivcc_mrc_csu_entomology_assay_AssayTestResult_mosquito", dss.vector.solutions.entomology.MosquitoDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", dto);
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.entomology.assay.biochemical.PNPATestResultQueryDTO query = dss.vector.solutions.entomology.assay.biochemical.PNPATestResultDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All PNPATestResultController Objects");
    render("viewAllComponent.jsp");
  }
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("mdss_ivcc_mrc_csu_entomology_assay_AssayTestResult_mosquito", dss.vector.solutions.entomology.MosquitoDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", dss.vector.solutions.entomology.assay.biochemical.PNPATestResultDTO.get(clientRequest, id));
