...
import dss.vector.solutions.entomology.MosquitoCollectionControllerBase;
...
public class MosquitoCollectionController extends MosquitoCollectionControllerBase implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  public void failSearchByGeoEntityAndDate(dss.vector.solutions.geo.generated.GeoEntityDTO geoEntity, java.lang.String collectionDate) throws java.io.IOException, javax.servlet.ServletException
  {
    resp.sendError(500);
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.entomology.MosquitoCollectionQueryDTO query = dss.vector.solutions.entomology.MosquitoCollectionDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All Mosquito Collections");
    render("viewAllComponent.jsp");
  }
  ...
  {
    dss.vector.solutions.entomology.MosquitoCollectionDTO dto = dss.vector.solutions.entomology.MosquitoCollectionDTO.lock(super.getClientRequest(), id);
    req.setAttribute("MosquitoCollection_collectionMethod", dss.vector.solutions.mo.CollectionMethodDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    //req.setAttribute("AbstractMosquitoCollection_geoEntity", dss.vector.solutions.geo.generated.GeoEntityDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", dto);
  ...
  public void failSearchByGeoIdAndDate(String geoId, String collectionDate, CollectionMethodDTO collectionMethod) throws java.io.IOException, javax.servlet.ServletException
  {
	  ...
	  {
	      com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
	      dss.vector.solutions.entomology.MosquitoCollectionQueryDTO query = dss.vector.solutions.entomology.MosquitoCollectionDTO.getAllInstances(clientRequest, "createDate", false, 10, 1);
	      req.setAttribute("query", query);
	      render("searchComponent.jsp");
	  }
  }
