...
import dss.vector.solutions.entomology.MosquitoControllerBase;
...
{
  public static final String JSP_DIR = "WEB-INF/dss/vector/solutions/entomology/Mosquito/";
  ...
  {
    dss.vector.solutions.entomology.MosquitoDTO dto = dss.vector.solutions.entomology.MosquitoDTO.lock(super.getClientRequest(), id);
    req.setAttribute("mdss_ivcc_mrc_csu_entomology_Mosquito_generation", dss.vector.solutions.mo.GenerationDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("mdss_ivcc_mrc_csu_entomology_Mosquito_sex", dss.vector.solutions.entomology.SexDTO.allItems(super.getClientSession().getRequest()));
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.entomology.MosquitoDTO dto = new dss.vector.solutions.entomology.MosquitoDTO(clientRequest);
    req.setAttribute("mdss_ivcc_mrc_csu_entomology_Mosquito_generation", dss.vector.solutions.mo.GenerationDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("mdss_ivcc_mrc_csu_entomology_Mosquito_sex", dss.vector.solutions.entomology.SexDTO.allItems(super.getClientSession().getRequest()));
    req.setAttribute("mdss_ivcc_mrc_csu_entomology_TrueSpecieEntity_collection", dss.vector.solutions.entomology.AbstractMosquitoCollectionDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("mdss_ivcc_mrc_csu_entomology_TrueSpecieEntity_identificationMethod", dss.vector.solutions.mo.IdentificationMethodDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
