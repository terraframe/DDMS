...
public class PolygonStyleController extends PolygonStyleControllerBase implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.PolygonStyleDTO dto = new dss.vector.solutions.PolygonStyleDTO(clientRequest);
    req.setAttribute("item", dto);
    req.setAttribute("page_title", "Create PolygonStyleController");
    render("createComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", dss.vector.solutions.PolygonStyleDTO.get(clientRequest, id));
    req.setAttribute("page_title", "View PolygonStyleController");
