...
import ivcc.mrc.csu.mdss.entomology.Mosquito;
import ivcc.mrc.csu.mdss.entomology.MosquitoCollection;
import ivcc.mrc.csu.mdss.entomology.MosquitoView;
import ivcc.mrc.csu.mdss.entomology.Sex;
import ivcc.mrc.csu.mdss.entomology.UninterestingSpecieGroup;
import ivcc.mrc.csu.mdss.entomology.UninterestingSpecieGroupView;
import ivcc.mrc.csu.mdss.entomology.assay.AssayTestResult;
import ivcc.mrc.csu.mdss.entomology.assay.biochemical.AEsteraseTestResult;
import ivcc.mrc.csu.mdss.entomology.assay.biochemical.AcHETestResult;
import ivcc.mrc.csu.mdss.entomology.assay.infectivity.PMalariaeTestResult;
import ivcc.mrc.csu.mdss.geo.GeoEntity;
import ivcc.mrc.csu.mdss.geo.Terrain;
import ivcc.mrc.csu.mdss.mo.BiochemicalMethodology;
...
import ivcc.mrc.csu.mdss.mo.InfectivityMethodology;
import ivcc.mrc.csu.mdss.mo.InsecticideMethodology;
import ivcc.mrc.csu.mdss.mo.MolecularAssayResult;
  ...
  public void testCreateMosquito() throws ParseException
  {
    ...
    try
    {
      ...
      for (AssayTestResult r : testResults)
      {
        ...
        else if (r instanceof ivcc.mrc.csu.mdss.entomology.assay.molecular.AcHETestResult)
        {
          assertEquals(result.getId(), ( (MolecularAssayResult) r.getTestResult() ).getId());
