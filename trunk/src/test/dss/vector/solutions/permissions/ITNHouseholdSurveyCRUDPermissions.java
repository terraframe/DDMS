...
public class ITNHouseholdSurveyCRUDPermissions extends PermissionTest implements DoNotWeave
{
  public static Test suite()
  {
    return TestFixture.getTestSuite(ITNHouseholdSurveyCRUDPermissions.class, MDSSRoleInfo.MDSS_CORRDINATOR, MDSSRoleInfo.DATACAPTURER, MDSSRoleInfo.OPERATIONAL_MANAGER);
  }
  ...
  public void testITNCommunityDistribution()
  {
    ...
    view.setSurveyLocation(siteGeoId);
    ...
    try
    {
      ...
      edit.setSurveyLocation(siteGeoId);
