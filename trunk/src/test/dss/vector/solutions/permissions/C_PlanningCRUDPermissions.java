...
public class C_PlanningCRUDPermissions extends PlanningCRUDPermissions
{
  ...
  private static SprayZone site;

  public static Test suite()
  {
    TestSuite suite = new TestSuite();
    suite.addTestSuite(C_PlanningCRUDPermissions.class);
  ...
  protected static void setupVars()
  {
    ...
    RoleDAO role = RoleDAO.findRole(MDSSRoleInfo.MDSS_CORRDINATOR).getBusinessDAO();
