...
public class OM_EntomologyNoPermissions extends EntomologyNoPermissions
{
  ...
  public static Test suite()
  {
    ...
    suite.addTestSuite(OM_EntomologyNoPermissions.class);
  ...
  {    
    ...
    RoleDAO role = RoleDAO.findRole(MDSSRoleInfo.OPERATIONAL_MANAGER).getBusinessDAO();
