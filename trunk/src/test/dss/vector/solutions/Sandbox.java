...
//      HttpClient client = new HttpClient();
  ...
  private static void mosquitoCollection(String sessionId)
  {
    ...
    String json = "{\"selectedUniversals\":{\"dss.vector.solutions.entomology.MosquitoCollection.geoEntity\":[]},\"criteriaEntities\":{\"dss.vector.solutions.entomology.MosquitoCollection.geoEntity\":[]},\"terms\":{\"collectionMethod_mc\":{},\"taxon\":{\"qw7dhq85nwcl2ettny5l4gca9do2imwbqwct0oecq22mg1xwyrxg4s27x3xpzmz3\":\"\"}},\"date_attribute\":{\"date_attribute\":\"collectionDate\",\"klass\":\"dss.vector.solutions.entomology.MosquitoCollection\",\"start\":null,\"end\":null},\"termsAg\":{\"taxon\":\"\"},\"sortOrder\":[\"taxon\",\"collectionMethod_ab\",\"mosquitoCount\"]}";
  ...
  private static void irs(String sessionId)
  {
    ...
    // criteria
    String crit = "{\"selectesssssssdUniversals\":{\"dss.vector.solutions.irs.AbstractSpray.geoEntity\":[]},\"criteriaEntities\":{\"dss.vector.solutions.irs.AbstractSpray.geoEntity\":[]},\"terms\":{},\"date_attribute\":{\"date_attribute\":\"sprayDate\",\"klass\":\"dss.vector.solutions.irs.OperatorSpray\",\"start\":\"2013-11-04\",\"end\":null},\"sortOrder\":[\"aggregation_level\"]}";
...
//    runQuery(IRSQB.class, countryConfig, areaAudit, false, false);
  ...
  private static void runQuery(Class<? extends AbstractQB> qbClass, String json, String xml, boolean sql, boolean results)
  {
    ...
    try
    {
      ...
      String rows = printResults(v, v.getIterator().getAll());
