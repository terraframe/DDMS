...
public class WardController extends WardControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  public static final String JSP_DIR = "WEB-INF/dss/vector/solutions/geo/generated/Ward/";
  public static final String LAYOUT = "/layout.jsp";
  
  public WardController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  public void edit(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dss.vector.solutions.geo.generated.WardDTO dto = dss.vector.solutions.geo.generated.WardDTO.lock(super.getClientRequest(), id);
      req.setAttribute("term", dss.vector.solutions.util.AttributeUtil.getValue(dss.vector.solutions.geo.generated.GeoEntityDTO.TERM, dto));
      req.setAttribute("item", dto);
      render("editComponent.jsp");
    }
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      ...
      dss.vector.solutions.geo.generated.WardDTO dto = new dss.vector.solutions.geo.generated.WardDTO(clientRequest);
      req.setAttribute("term", dss.vector.solutions.util.AttributeUtil.getValue(dss.vector.solutions.geo.generated.GeoEntityDTO.TERM, dto));
      req.setAttribute("item", dto);
      render("createComponent.jsp");
    }
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      ...
      com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
      dss.vector.solutions.geo.generated.WardDTO dto = dss.vector.solutions.geo.generated.WardDTO.get(clientRequest, id);
      req.setAttribute("term", dss.vector.solutions.util.AttributeUtil.getValue(dss.vector.solutions.geo.generated.GeoEntityDTO.TERM, dto));
      req.setAttribute("item", dto);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.geo.generated.WardQueryDTO query = dss.vector.solutions.geo.generated.WardDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.geo.generated.WardQueryDTO query = dss.vector.solutions.geo.generated.WardDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
