...
public enum Alias implements Reloadable
{
  ...
  AGGREGATION_LEVEL("aggregation_level", IRSUnionIF.VARCHAR),
  ...
  SPRAY_OPERATOR_PERSON_ID("sprayoperator_personId", IRSUnionIF.TEXT),
  SPRAY_OPERATOR_PERSON("sprayoperator_person", IRSUnionIF.VARCHAR),
  SPRAY_OPERATOR_BIRTHDATE("sprayoperator_birthdate", IRSUnionIF.DATE),
  SPRAY_OPERATOR_SEX("sprayoperator_sex", IRSUnionIF.TEXT),
  ...
  SPRAY_LEADER_PERSON_ID("sprayleader_personId", IRSUnionIF.TEXT),
  SPRAY_LEADER_PERSON("sprayleader_person", IRSUnionIF.VARCHAR),
  SPRAY_LEADER_BIRTHDATE("sprayleader_birthdate", IRSUnionIF.DATE),
  SPRAY_LEADER_SEX("sprayleader_sex", IRSUnionIF.TEXT),
  ...
  ZONE_SUPERVISOR_PERSON_ID("zone_supervisor_personId", IRSUnionIF.TEXT),
  ZONE_SUPERVISOR_PERSON("zone_supervisor_person", IRSUnionIF.VARCHAR),
  ZONE_SUPERVISOR_BIRTHDATE("zone_supervisor_birthdate", IRSUnionIF.DATE),
  ZONE_SUPERVISOR_SEX("zone_supervisor_sex", IRSUnionIF.TEXT),
