...
public class TargetFieldDomain extends TargetFieldBasic implements TargetFieldIF, TargetFieldValidationIF, Reloadable
{
  ...
  public FieldValue getValue(MdAttributeConcreteDAOIF mdAttribute, Transient source)
  {
    ...
    if (value != null && value.length() > 0)
    {
      ...
      String termName = value.trim();

      Term classifier = Term.findByDisplayLabel(termName, mdAttributeTerm);
      ...
      if (classifier == null)
      {
        ...
        String msg = "Unknown " + attributeLabel + " with the given name [" + termName + "]";
        ...
        return new CategoryProblem(termName, roots.get(0).getTermId(), mdAttributeTerm.getId(), attributeLabel);
      }
