...
public class PupalCollectionListener extends AbstractExcelAdapter implements ExcelExportListener, ImportListener, Reloadable
{
  private static final String AMOUNT = "Pupae Amount - ";

  public void addColumns(List<ExcelColumn> extraColumns)
  {
    this.addGridColumns(extraColumns, PupalContainerView.getPupaeAmountMd(), AMOUNT);
  }
