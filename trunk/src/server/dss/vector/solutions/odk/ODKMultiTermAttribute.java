...
public class ODKMultiTermAttribute extends ODKMetadataAttribute implements Reloadable
{
  ...
  public ODKMultiTermAttribute(ODKForm containingForm, MdAttributeDAOIF sourceMdAttr, MdAttributeDAOIF viewMdAttr, Set<String> exported)
  {
  ...
  public void writeBody(Element parent, Document document, String title, int maxDepth)
  {
    ...
    Element select1 = document.createElement("select");
