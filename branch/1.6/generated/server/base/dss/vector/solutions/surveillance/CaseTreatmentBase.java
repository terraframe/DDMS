...
@com.runwaysdk.business.ClassSignature(hash = 704082382)
/**
 ...
 */
public abstract class CaseTreatmentBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 704082382;
  
  public CaseTreatmentBase()
  {
    super();
  }
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.surveillance.CaseTreatment.CLASS);
  ...
  public static CaseTreatmentQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    CaseTreatmentQuery query = new CaseTreatmentQuery(new com.runwaysdk.query.QueryFactory());
    com.runwaysdk.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static CaseTreatment get(String id)
  {
    return (CaseTreatment) com.runwaysdk.business.Business.get(id);
  }
  
  public static CaseTreatment getByKey(String key)
  {
    return (CaseTreatment) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static CaseTreatment lock(java.lang.String id)
  {
    CaseTreatment _instance = CaseTreatment.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static CaseTreatment unlock(java.lang.String id)
  {
    CaseTreatment _instance = CaseTreatment.get(id);
    _instance.unlock();
