...
public abstract class TargetFieldBindingBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.kaleidoscope.data.etl.TargetFieldBinding.CLASS);
  ...
  public dss.vector.solutions.kaleidoscope.data.etl.TargetBinding getTarget()
  {
    ...
    {
      return dss.vector.solutions.kaleidoscope.data.etl.TargetBinding.get(getValue(TARGET));
    }
  }
  ...
  public void setTarget(dss.vector.solutions.kaleidoscope.data.etl.TargetBinding value)
  {
    if(value == null)
    {
      setValue(TARGET, "");
