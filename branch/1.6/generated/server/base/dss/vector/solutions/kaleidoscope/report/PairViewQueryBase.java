...
@com.runwaysdk.business.ClassSignature(hash = -2063628980)
/**
 ...
 implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  {
    return dss.vector.solutions.kaleidoscope.report.PairView.CLASS;
  }
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(dss.vector.solutions.kaleidoscope.report.PairView.ID, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getId(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(dss.vector.solutions.kaleidoscope.report.PairView.ID, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(dss.vector.solutions.kaleidoscope.report.PairView.LABEL, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getLabel(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(dss.vector.solutions.kaleidoscope.report.PairView.LABEL, alias, displayLabel);
  ...
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(dss.vector.solutions.kaleidoscope.report.PairView.VALUE, alias, null);

  }
 
  public com.runwaysdk.query.SelectableChar getValue(String alias, String displayLabel)
  {
    return (com.runwaysdk.query.SelectableChar)this.getSelectable(dss.vector.solutions.kaleidoscope.report.PairView.VALUE, alias, displayLabel);
