...
@com.runwaysdk.business.ClassSignature(hash = -1092202885)
/**
 ...
 */
public abstract class HouseholdITNInstanceBase extends com.runwaysdk.business.Relationship implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1092202885;
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.intervention.monitor.HouseholdITNInstance.CLASS);
  ...
  {
    HouseholdITNInstanceQuery query = new HouseholdITNInstanceQuery(new com.runwaysdk.query.QueryFactory());
  ...
  {
    return (HouseholdITNInstance) com.runwaysdk.business.Relationship.get(id);
  }
  
  public static HouseholdITNInstance getByKey(String key)
  {
    return (HouseholdITNInstance) com.runwaysdk.business.Relationship.get(CLASS, key);
  }
