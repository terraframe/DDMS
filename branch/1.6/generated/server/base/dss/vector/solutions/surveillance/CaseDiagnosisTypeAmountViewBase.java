...
@com.runwaysdk.business.ClassSignature(hash = -1381067900)
/**
 ...
 */
public abstract class CaseDiagnosisTypeAmountViewBase extends com.runwaysdk.business.View implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1381067900;
  
  public CaseDiagnosisTypeAmountViewBase()
  {
    super();
  }
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.surveillance.CaseDiagnosisTypeAmountView.CLASS);
  ...
  public dss.vector.solutions.surveillance.CaseDiagnosisType getDiagnosis()
  {
    ...
    {
      return dss.vector.solutions.surveillance.CaseDiagnosisType.get(getValue(DIAGNOSIS));
    }
  }
  ...
  public void setDiagnosis(dss.vector.solutions.surveillance.CaseDiagnosisType value)
  {
    if(value == null)
    {
      setValue(DIAGNOSIS, "");
  ...
  public static CaseDiagnosisTypeAmountView get(String id)
  {
    return (CaseDiagnosisTypeAmountView) com.runwaysdk.business.View.get(id);
  }
