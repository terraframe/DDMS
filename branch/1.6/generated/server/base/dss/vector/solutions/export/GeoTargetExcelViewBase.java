...
@com.runwaysdk.business.ClassSignature(hash = -1517388742)
/**
 ...
 */
public abstract class GeoTargetExcelViewBase extends com.runwaysdk.business.View implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1517388742;
  
  public GeoTargetExcelViewBase()
  {
    super();
  }
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.export.GeoTargetExcelView.CLASS);
  ...
  public static GeoTargetExcelView get(String id)
  {
    return (GeoTargetExcelView) com.runwaysdk.business.View.get(id);
  }
