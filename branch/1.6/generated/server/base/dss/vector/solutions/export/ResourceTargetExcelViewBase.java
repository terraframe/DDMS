...
@com.runwaysdk.business.ClassSignature(hash = 1517732139)
/**
 ...
 */
public abstract class ResourceTargetExcelViewBase extends com.runwaysdk.business.View implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1517732139;
  
  public ResourceTargetExcelViewBase()
  {
    super();
  }
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.export.ResourceTargetExcelView.CLASS);
  ...
  public void validateTargeterId()
  {
    this.validateAttribute(TARGETERID);
  }
  
  public static com.runwaysdk.dataaccess.MdAttributeCharacterDAOIF getTargeterIdMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.export.ResourceTargetExcelView.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeCharacterDAOIF)mdClassIF.definesAttribute(TARGETERID);
  }
  ...
  public static ResourceTargetExcelView get(String id)
  {
    return (ResourceTargetExcelView) com.runwaysdk.business.View.get(id);
  }
