...
@com.runwaysdk.business.ClassSignature(hash = -621603800)
public abstract class DashboardThematicStyleDTOBase extends dss.vector.solutions.kaleidoscope.dashboard.DashboardStyleDTO implements com.runwaysdk.generation.loader.Reloadable
{
  public final static String CLASS = "dss.vector.solutions.kaleidoscope.dashboard.DashboardThematicStyle";
  private static final long serialVersionUID = -621603800;
  ...
  */
  ...
  public java.util.List<dss.vector.solutions.kaleidoscope.dashboard.AllAggregationTypeDTO> getSecondaryAggregationType()
  {
    return (java.util.List<dss.vector.solutions.kaleidoscope.dashboard.AllAggregationTypeDTO>) com.runwaysdk.transport.conversion.ConversionFacade.convertEnumDTOsFromEnumNames(getRequest(), dss.vector.solutions.kaleidoscope.dashboard.AllAggregationTypeDTO.CLASS, getEnumNames(SECONDARYAGGREGATIONTYPE));
  }
  ...
  public void addSecondaryAggregationType(dss.vector.solutions.kaleidoscope.dashboard.AllAggregationTypeDTO enumDTO)
  {
    addEnumItem(SECONDARYAGGREGATIONTYPE, enumDTO.toString());
  }
  
  public void removeSecondaryAggregationType(dss.vector.solutions.kaleidoscope.dashboard.AllAggregationTypeDTO enumDTO)
  {
  ...
  public static dss.vector.solutions.kaleidoscope.dashboard.DashboardThematicStyleDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String id)
  {
    com.runwaysdk.business.EntityDTO dto = (com.runwaysdk.business.EntityDTO)clientRequest.get(id);
    
    return (dss.vector.solutions.kaleidoscope.dashboard.DashboardThematicStyleDTO) dto;
  }
  ...
  public static dss.vector.solutions.kaleidoscope.dashboard.DashboardThematicStyleQueryDTO getAllInstances(com.runwaysdk.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (dss.vector.solutions.kaleidoscope.dashboard.DashboardThematicStyleQueryDTO) clientRequest.getAllInstances(dss.vector.solutions.kaleidoscope.dashboard.DashboardThematicStyleDTO.CLASS, sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static dss.vector.solutions.kaleidoscope.dashboard.DashboardThematicStyleDTO lock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(dss.vector.solutions.kaleidoscope.dashboard.DashboardThematicStyleDTO.CLASS, "lock", _declaredTypes);
    return (dss.vector.solutions.kaleidoscope.dashboard.DashboardThematicStyleDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static dss.vector.solutions.kaleidoscope.dashboard.DashboardThematicStyleDTO unlock(com.runwaysdk.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.runwaysdk.business.MethodMetaData _metadata = new com.runwaysdk.business.MethodMetaData(dss.vector.solutions.kaleidoscope.dashboard.DashboardThematicStyleDTO.CLASS, "unlock", _declaredTypes);
    return (dss.vector.solutions.kaleidoscope.dashboard.DashboardThematicStyleDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
