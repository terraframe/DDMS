...
@com.runwaysdk.business.ClassSignature(hash = 991892481)
public abstract class SearchMosquitoCollectionViewDTOBase extends dss.vector.solutions.entomology.MosquitoCollectionViewDTO implements com.runwaysdk.generation.loader.Reloadable
{
  public final static String CLASS = "dss.vector.solutions.entomology.SearchMosquitoCollectionView";
  private static final long serialVersionUID = 991892481;
  
  protected SearchMosquitoCollectionViewDTOBase(com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
    super(clientRequest);
  }
  ...
  public static SearchMosquitoCollectionViewDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String id)
  {
    com.runwaysdk.business.ViewDTO dto = (com.runwaysdk.business.ViewDTO)clientRequest.get(id);
    
    return (SearchMosquitoCollectionViewDTO) dto;
  }
