...
@com.runwaysdk.business.ClassSignature(hash = -1818723934)
public abstract class CaseDiagnosticViewDTOBase extends com.runwaysdk.business.ViewDTO implements com.runwaysdk.generation.loader.Reloadable
{
  public final static String CLASS = "dss.vector.solutions.surveillance.CaseDiagnosticView";
  private static final long serialVersionUID = -1818723934;
  
  protected CaseDiagnosticViewDTOBase(com.runwaysdk.constants.ClientRequestIF clientRequest)
  {
    super(clientRequest);
  }
  ...
  public static CaseDiagnosticViewDTO get(com.runwaysdk.constants.ClientRequestIF clientRequest, String id)
  {
    com.runwaysdk.business.ViewDTO dto = (com.runwaysdk.business.ViewDTO)clientRequest.get(id);
    
    return (CaseDiagnosticViewDTO) dto;
  }
