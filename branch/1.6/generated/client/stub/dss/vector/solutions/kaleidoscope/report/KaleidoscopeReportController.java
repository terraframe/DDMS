...
public class KaleidoscopeReportController extends KaleidoscopeReportControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  public static final String JSP_DIR = "WEB-INF/dss/vector/solutions/kaleidoscope/report/KaleidoscopeReport/";
  public static final String LAYOUT = "/layout.jsp";
  
  public KaleidoscopeReportController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  public void edit(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dss.vector.solutions.kaleidoscope.report.KaleidoscopeReportDTO dto = dss.vector.solutions.kaleidoscope.report.KaleidoscopeReportDTO.lock(super.getClientRequest(), id);
      req.setAttribute("dashboard", dss.vector.solutions.kaleidoscope.dashboard.DashboardDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("item", dto);
      render("editComponent.jsp");
    }
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      ...
      dss.vector.solutions.kaleidoscope.report.KaleidoscopeReportDTO dto = new dss.vector.solutions.kaleidoscope.report.KaleidoscopeReportDTO(clientRequest);
      req.setAttribute("dashboard", dss.vector.solutions.kaleidoscope.dashboard.DashboardDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("item", dto);
      render("createComponent.jsp");
    }
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      ...
      com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
      dss.vector.solutions.kaleidoscope.report.KaleidoscopeReportDTO dto = dss.vector.solutions.kaleidoscope.report.KaleidoscopeReportDTO.get(clientRequest, id);
      req.setAttribute("dashboard", dss.vector.solutions.kaleidoscope.dashboard.DashboardDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("item", dto);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.kaleidoscope.report.KaleidoscopeReportQueryDTO query = dss.vector.solutions.kaleidoscope.report.KaleidoscopeReportDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.kaleidoscope.report.KaleidoscopeReportQueryDTO query = dss.vector.solutions.kaleidoscope.report.KaleidoscopeReportDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
