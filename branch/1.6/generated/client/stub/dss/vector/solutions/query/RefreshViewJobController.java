...
public class RefreshViewJobController extends RefreshViewJobControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  public static final String JSP_DIR = "WEB-INF/dss/vector/solutions/query/RefreshViewJob/";
  public static final String LAYOUT = "/layout.jsp";
  
  public RefreshViewJobController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  {
    req.setAttribute("materializedTable", com.runwaysdk.system.metadata.MdTableDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
  ...
  public void edit(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dss.vector.solutions.query.RefreshViewJobDTO dto = dss.vector.solutions.query.RefreshViewJobDTO.lock(super.getClientRequest(), id);
      req.setAttribute("materializedTable", com.runwaysdk.system.metadata.MdTableDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("_jobOperation", com.runwaysdk.system.scheduler.AllJobOperationDTO.allItems(super.getClientSession().getRequest()));
      req.setAttribute("item", dto);
      render("editComponent.jsp");
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      ...
      dss.vector.solutions.query.RefreshViewJobDTO dto = new dss.vector.solutions.query.RefreshViewJobDTO(clientRequest);
      req.setAttribute("materializedTable", com.runwaysdk.system.metadata.MdTableDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("_jobOperation", com.runwaysdk.system.scheduler.AllJobOperationDTO.allItems(super.getClientSession().getRequest()));
      req.setAttribute("item", dto);
      render("createComponent.jsp");
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      ...
      com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
      dss.vector.solutions.query.RefreshViewJobDTO dto = dss.vector.solutions.query.RefreshViewJobDTO.get(clientRequest, id);
      req.setAttribute("materializedTable", com.runwaysdk.system.metadata.MdTableDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("_jobOperation", com.runwaysdk.system.scheduler.AllJobOperationDTO.allItems(super.getClientSession().getRequest()));
      req.setAttribute("item", dto);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.query.RefreshViewJobQueryDTO query = dss.vector.solutions.query.RefreshViewJobDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.query.RefreshViewJobQueryDTO query = dss.vector.solutions.query.RefreshViewJobDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
