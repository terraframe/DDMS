...
public class MalariaSeasonSeasonLabelController extends MalariaSeasonSeasonLabelControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  public static final String JSP_DIR = "WEB-INF/dss/vector/solutions/general/MalariaSeasonSeasonLabel/";
  public static final String LAYOUT = "/layout.jsp";
  
  public MalariaSeasonSeasonLabelController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  public void edit(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dss.vector.solutions.general.MalariaSeasonSeasonLabelDTO dto = dss.vector.solutions.general.MalariaSeasonSeasonLabelDTO.get(super.getClientRequest(), id);
      req.setAttribute("item", dto);
      render("editComponent.jsp");
    }
    catch(java.lang.Throwable t)
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      ...
      dss.vector.solutions.general.MalariaSeasonSeasonLabelDTO dto = new dss.vector.solutions.general.MalariaSeasonSeasonLabelDTO(clientRequest);
      req.setAttribute("item", dto);
      render("createComponent.jsp");
    }
    catch(java.lang.Throwable t)
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      ...
      com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
      dss.vector.solutions.general.MalariaSeasonSeasonLabelDTO dto = dss.vector.solutions.general.MalariaSeasonSeasonLabelDTO.get(clientRequest, id);
      req.setAttribute("item", dto);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.general.MalariaSeasonSeasonLabelQueryDTO query = dss.vector.solutions.general.MalariaSeasonSeasonLabelDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.general.MalariaSeasonSeasonLabelQueryDTO query = dss.vector.solutions.general.MalariaSeasonSeasonLabelDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
