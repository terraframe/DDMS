...
public class TargetFieldClassifierBindingController extends TargetFieldClassifierBindingControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  public static final String JSP_DIR = "WEB-INF/dss/vector/solutions/kaleidoscope/data/etl/TargetFieldClassifierBinding/";
  public static final String LAYOUT = "/layout.jsp";
  
  public TargetFieldClassifierBindingController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  public void edit(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dss.vector.solutions.kaleidoscope.data.etl.TargetFieldClassifierBindingDTO dto = dss.vector.solutions.kaleidoscope.data.etl.TargetFieldClassifierBindingDTO.lock(super.getClientRequest(), id);
      req.setAttribute("sourceAttribute", com.runwaysdk.system.metadata.MdAttributeDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("target", dss.vector.solutions.kaleidoscope.data.etl.TargetBindingDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("targetAttribute", com.runwaysdk.system.metadata.MdAttributeDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("item", dto);
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      ...
      dss.vector.solutions.kaleidoscope.data.etl.TargetFieldClassifierBindingDTO dto = new dss.vector.solutions.kaleidoscope.data.etl.TargetFieldClassifierBindingDTO(clientRequest);
      req.setAttribute("sourceAttribute", com.runwaysdk.system.metadata.MdAttributeDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("target", dss.vector.solutions.kaleidoscope.data.etl.TargetBindingDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("targetAttribute", com.runwaysdk.system.metadata.MdAttributeDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("item", dto);
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      ...
      com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
      dss.vector.solutions.kaleidoscope.data.etl.TargetFieldClassifierBindingDTO dto = dss.vector.solutions.kaleidoscope.data.etl.TargetFieldClassifierBindingDTO.get(clientRequest, id);
      req.setAttribute("sourceAttribute", com.runwaysdk.system.metadata.MdAttributeDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("target", dss.vector.solutions.kaleidoscope.data.etl.TargetBindingDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("targetAttribute", com.runwaysdk.system.metadata.MdAttributeDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("item", dto);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.kaleidoscope.data.etl.TargetFieldClassifierBindingQueryDTO query = dss.vector.solutions.kaleidoscope.data.etl.TargetFieldClassifierBindingDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.kaleidoscope.data.etl.TargetFieldClassifierBindingQueryDTO query = dss.vector.solutions.kaleidoscope.data.etl.TargetFieldClassifierBindingDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
