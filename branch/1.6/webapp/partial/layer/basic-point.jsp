...
<div class="tab-pane" id="tab001basicpoint" ng-class="{ 'active' : layerModel.layerType == 'BASICPOINT' }" >
  ...
  <div class="fill-block">
    ...
    <div class="cell-holder">
      <div class="cell">
        <label for="basic-point-radius-select"><mdss:localize key="DashboardLayer.form.size"/></label>
        <div class="text">
    ...
    <div id="point-type-container" class="cell">
      <label for="point-type"><mdss:localize key="DashboardLayer.form.pointType"/></label>
