...
<mjl:form name="dss.vector.solutions.irs.ResourceTarget.form.name" id="dss.vector.solutions.irs.ResourceTarget.form.id" method="POST">
  <mjl:component item="${item}" param="dto">
    <dl>
      ...
      <dd>
        <mjl:select var="current" valueAttribute="id" items="${dss_vector_solutions_irs_ResourceTarget_targeter}" param="targeter">
          <mjl:option>
            ${current.keyName}
          </mjl:option>
        </mjl:select>
        <mjl:messages attribute="targeter">
          <mjl:message />
        </mjl:messages>
      </dd>
    </dl>
  ...
  <mjl:command value="${Localized_Update}" action="dss.vector.solutions.irs.ResourceTargetController.update.mojo" name="dss.vector.solutions.irs.ResourceTarget.form.update.button" />
  <mdss:localize key="Delete" var="Localized_Delete" />
  <mjl:command value="${Localized_Delete}" action="dss.vector.solutions.irs.ResourceTargetController.delete.mojo" name="dss.vector.solutions.irs.ResourceTarget.form.delete.button" />
  <mdss:localize key="Cancel" var="Localized_Cancel" />
  <mjl:command value="${Localized_Cancel}" action="dss.vector.solutions.irs.ResourceTargetController.cancel.mojo" name="dss.vector.solutions.irs.ResourceTarget.form.cancel.button" />
</mjl:form>
