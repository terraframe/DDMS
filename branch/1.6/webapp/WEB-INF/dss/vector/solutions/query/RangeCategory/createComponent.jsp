...
<c:set var="page_title" value="Create_RangeCategory" scope="request" />
  ...
  <mjl:form name="dss.vector.solutions.query.RangeCategory.form.name" id="dss.vector.solutions.query.RangeCategory.form.id" method="POST">
    ...
    <mjl:command value="${Localized_Cancel}" action="dss.vector.solutions.query.RangeCategoryController.cancel.mojo" name="dss.vector.solutions.query.RangeCategoryController.form.cancel.button" />
    </div>
  </mjl:form>
