...
<dl>
  <mjl:form name="dss.vector.solutions.query.SavedMap.form.name" id="dss.vector.solutions.query.SavedMap.form.id" method="POST">
    ...
    <mjl:command value="${Localized_Edit}" action="dss.vector.solutions.query.SavedMapController.edit.mojo" name="dss.vector.solutions.query.SavedMap.form.edit.button" />
  </mjl:form>
</dl>
