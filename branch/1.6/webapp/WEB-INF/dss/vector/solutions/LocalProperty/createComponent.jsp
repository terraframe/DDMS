...
<dl>
  <mjl:form id="dss.vector.solutions.LocalProperty.form.id" name="dss.vector.solutions.LocalProperty.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.LocalProperty.form.create.button" value="${Localized_Create}" action="dss.vector.solutions.LocalPropertyController.create.mojo" />
  </mjl:form>
</dl>
