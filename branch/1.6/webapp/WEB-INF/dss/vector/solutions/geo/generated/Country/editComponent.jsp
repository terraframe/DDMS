...
<dl>
  <mjl:form id="dss.vector.solutions.geo.generated.Country.form.id" name="dss.vector.solutions.geo.generated.Country.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.geo.generated.Country.form.update.button" value="${Update_Localize}" action="dss.vector.solutions.geo.generated.CountryController.update.mojo" />
    <mdss:localize var="Delete_Localize" key="Delete" />
    <mjl:command name="dss.vector.solutions.geo.generated.Country.form.delete.button" value="${Delete_Localize}" action="dss.vector.solutions.geo.generated.CountryController.delete.mojo" />
