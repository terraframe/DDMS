...
<dl>
  <mjl:form id="dss.vector.solutions.general.SystemAlertEmailTemplateVariables.form.id" name="dss.vector.solutions.general.SystemAlertEmailTemplateVariables.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.general.SystemAlertEmailTemplateVariables.form.edit.button" value="${Localized_Edit}" action="dss.vector.solutions.general.SystemAlertEmailTemplateVariablesController.edit.mojo" />
  </mjl:form>
</dl>
