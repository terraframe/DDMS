...
<dl>
  <mjl:form id="dss.vector.solutions.general.SystemAlertEmailTemplateVariables.form.id" name="dss.vector.solutions.general.SystemAlertEmailTemplateVariables.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.general.SystemAlertEmailTemplateVariables.form.create.button" value="${Localized_Create}" action="dss.vector.solutions.general.SystemAlertEmailTemplateVariablesController.create.mojo" />
  </mjl:form>
</dl>
