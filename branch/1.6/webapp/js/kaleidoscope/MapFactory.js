(function(){
  ...
  var MapWidget = Mojo.Meta.newClass('dss.vector.solutions.kaleidoscope.gis.MapWidget', {
  ...
  var OpenLayersMap = Mojo.Meta.newClass('dss.vector.solutions.kaleidoscope.gis.OpenLayersMap', {
      Extends : MapWidget,  
      IsAbstract : false,
      Constants : {
	              ...
	              if(base.LAYER_SOURCE_TYPE.toLowerCase() === "osm"){
	                ...
	                baseObj.setSource( 
	                  new ol.source.TileWMS(({
	                	    url: 'http://localhost:8080/geoserver-2.9.1/gwc/service/wms',
