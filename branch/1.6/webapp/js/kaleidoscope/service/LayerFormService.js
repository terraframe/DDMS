(function(){
  ...
  function LayerFormService(runwayService) {
    ...
    service.apply = function(layer, style, dynamicDataModel, categoryWidget, state, element, onSuccess, onFailure) {
      ...
      if(strategy.type.indexOf("UniversalAggregationStrategy")  > -1){
        strategyDTO = new dss.vector.solutions.kaleidoscope.dashboard.UniversalAggregationStrategy();
      }
      else if(strategy.type.indexOf("GeometryAggregationStrategy")  > -1){
        strategyDTO = new dss.vector.solutions.kaleidoscope.dashboard.GeometryAggregationStrategy();
      }
    ...
    service.edit = function(layerId, element, onSuccess, onFailure) {
      ...
      dss.vector.solutions.kaleidoscope.dashboard.layer.DashboardThematicLayerController.edit(request, layerId);    
    }
    ...
    service.newInstance = function(mdAttributeId, mapId, element, onSuccess, onFailure) {
      ...
      dss.vector.solutions.kaleidoscope.dashboard.layer.DashboardThematicLayerController.newThematicInstance(request, mdAttributeId, mapId);
    }
    ...
    service.categoryAutoCompleteService = function(mdAttribute, geoNodeId, universalId, aggregationVal, text, limit, conditions, onSuccess, onFailure){
      ...
      dss.vector.solutions.kaleidoscope.dashboard.Dashboard.getCategoryInputSuggestions(request, mdAttribute, geoNodeId, universalId, aggregationVal, text, limit, conditions);
    }
  ...
  function ReferenceLayerFormService(runwayService) {
    ...
    service.edit = function(layerId, element, onSuccess, onFailure) {
      ...
      dss.vector.solutions.kaleidoscope.dashboard.layer.DashboardReferenceLayerController.edit(request, layerId);    	
    }
    ...
    service.newInstance = function(mapId, element, onSuccess, onFailure) {
      ...
      dss.vector.solutions.kaleidoscope.dashboard.layer.DashboardReferenceLayerController.newReferenceInstance(request, '', mapId);
    }
