...
import dss.vector.solutions.kaleidoscope.report.BirtConstants;
...
{
  private static final String TYPE             = "dss.vector.solutions.kaleidoscope.report.KaleidoscopeReport";
    ...
    if (query != null)
    {
      try
      {
        ...
        if (action.equals(QUERIES))
        {
          ...
          String method = "getQueriesForReporting";
          MethodMetaData _metadata = new MethodMetaData(TYPE, method, _declaredTypes);

          String results = (String) request.invokeMethod(_metadata, null, _parameters);
        ...
        else if (action.equals(GET_AGGREGATIONS))
        {
          ...
          String method = "getSupportedAggregation";
          MethodMetaData _metadata = new MethodMetaData(TYPE, method, _declaredTypes);
        ...
        else if (action.equals(GET_GEO_NODE))
        {
          ...
          String method = "getSupportedGeoNodes";
          MethodMetaData _metadata = new MethodMetaData(TYPE, method, _declaredTypes);
  ...
  private IResultSet executeQuery(ClientRequestIF request, boolean queryMetadata, String queryId, JSONObject context)
  {
    if (queryMetadata)
    {
      ...
      Object[] _parameters = new Object[] { queryId, context.toString() };

      String method = "getMetadataForReporting";
      MethodMetaData _metadata = new MethodMetaData(TYPE, method, _declaredTypes);

      String json = (String) request.invokeMethod(_metadata, null, _parameters);
  ...
  private IResultSet getDefaultGeoIds(ClientRequestIF request, String text)
  {
    ...
    Object[] _parameters = new Object[] { text, new Integer(10) };

    String method = "getGeoEntitySuggestions";
    MethodMetaData _metadata = new MethodMetaData(TYPE, method, _declaredTypes);
  ...
  public static Integer getPageCount(ClientRequestIF request, String queryId, String context, int pageSize)
  {
    ...
    String method = "getPageCount";

    MethodMetaData _metadata = new MethodMetaData(TYPE, method, _declaredTypes);
    return (Integer) request.invokeMethod(_metadata, null, _parameters);
  }

  public static String getValuesForReporting(ClientRequestIF request, String queryId, String context, int pageSize, int pageNumber)
  {
    ...
    String method = "getValuesForReporting";

    MethodMetaData _metadata = new MethodMetaData(TYPE, method, _declaredTypes);
    return (String) request.invokeMethod(_metadata, null, _parameters);
  }
}
