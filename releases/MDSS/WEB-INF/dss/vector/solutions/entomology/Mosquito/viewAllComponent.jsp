...
<mjl:table var="item" query="${query}">
  <mjl:context action="dss.vector.solutions.entomology.MosquitoController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="dss.vector.solutions.entomology.MosquitoController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Mosquito" action="dss.vector.solutions.entomology.MosquitoController.newInstance.mojo" name="MosquitoController.newInstance" />
