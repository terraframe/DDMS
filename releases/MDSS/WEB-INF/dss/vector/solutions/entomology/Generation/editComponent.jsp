...
<mjl:input type="text" param="termName" />
  ...
  <mjl:command value="Delete" action="dss.vector.solutions.entomology.GenerationController.delete.mojo" name="dss.vector.solutions.entomology.Generation.form.delete.button" />
  <mjl:command value="Cancel" action="dss.vector.solutions.entomology.GenerationController.cancel.mojo" name="dss.vector.solutions.entomology.Generation.form.cancel.button" />
</mjl:form>
