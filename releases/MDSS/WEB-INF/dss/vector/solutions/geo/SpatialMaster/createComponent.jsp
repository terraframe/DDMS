...
<mjl:form name="dss.vector.solutions.geo.SpatialMaster.form.name" id="dss.vector.solutions.geo.SpatialMaster.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.SpatialMasterController.create.mojo" name="dss.vector.solutions.geo.SpatialMaster.form.create.button" />
</mjl:form>
