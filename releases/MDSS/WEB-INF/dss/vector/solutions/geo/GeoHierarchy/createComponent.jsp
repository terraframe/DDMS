...
<mjl:form name="dss.vector.solutions.geo.GeoHierarchy.form.name" id="dss.vector.solutions.geo.GeoHierarchy.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.GeoHierarchyController.create.mojo" name="dss.vector.solutions.geo.GeoHierarchy.form.create.button" />
</mjl:form>
