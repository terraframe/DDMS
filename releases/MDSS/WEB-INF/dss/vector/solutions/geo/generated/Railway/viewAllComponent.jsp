...
<c:set var="page_title" value="View_All_Railway" scope="request" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<mjl:table var="item" query="${query}" odd="oddRow" classes="displayTable" even="evenRow">
  ...
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink action="dss.vector.solutions.geo.generated.RailwayController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink action="dss.vector.solutions.geo.generated.RailwayController.newInstance.mojo" name="RailwayController.newInstance">
  <fmt:message key="Create_a_new_Railway" />
</mjl:commandLink>
