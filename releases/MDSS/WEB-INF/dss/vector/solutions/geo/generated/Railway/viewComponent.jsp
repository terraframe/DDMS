...
<c:set var="page_title" value="View_Railway" scope="request" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<dl>
  <mjl:form name="dss.vector.solutions.geo.generated.Railway.form.name" id="dss.vector.solutions.geo.generated.Railway.form.id" method="POST">
    ...
    <mjl:command value="Edit" action="dss.vector.solutions.geo.generated.RailwayController.edit.mojo" name="dss.vector.solutions.geo.generated.Railway.form.edit.button" />
  </mjl:form>
</dl>
<mjl:commandLink action="dss.vector.solutions.geo.generated.RailwayController.viewAll.mojo" name="dss.vector.solutions.geo.generated.Railway.viewAll.link">
