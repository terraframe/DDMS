...
<c:set var="page_title" value="Referral_Grid_Create" scope="request"/>
<mjl:messages>
  <mjl:message />
</mjl:messages>
<mjl:form name="dss.vector.solutions.surveillance.ReferralGrid.form.name" id="dss.vector.solutions.surveillance.ReferralGrid.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.surveillance.ReferralGridController.create.mojo" name="dss.vector.solutions.surveillance.ReferralGrid.form.create.button" />
</mjl:form>
