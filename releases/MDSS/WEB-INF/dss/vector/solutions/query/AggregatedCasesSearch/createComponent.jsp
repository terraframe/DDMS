...
<mjl:form name="dss.vector.solutions.query.AggregatedCasesSearch.form.name" id="dss.vector.solutions.query.AggregatedCasesSearch.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.query.AggregatedCasesSearchController.create.mojo" name="dss.vector.solutions.query.AggregatedCasesSearch.form.create.button" />
</mjl:form>
