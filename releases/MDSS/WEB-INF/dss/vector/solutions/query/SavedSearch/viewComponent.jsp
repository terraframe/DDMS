...
<mjl:form name="dss.vector.solutions.query.SavedSearch.form.name" id="dss.vector.solutions.query.SavedSearch.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="dss.vector.solutions.query.SavedSearchController.edit.mojo" name="dss.vector.solutions.query.SavedSearch.form.edit.button" />
  <br />
</mjl:form>
<dl>
  <dt>
...
<mjl:commandLink display="View All" action="dss.vector.solutions.query.SavedSearchController.viewAll.mojo" name="dss.vector.solutions.query.SavedSearch.viewAll.link" />
