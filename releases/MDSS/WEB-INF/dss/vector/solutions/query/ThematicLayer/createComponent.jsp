...
<mjl:form name="dss.vector.solutions.query.ThematicLayer.form.name" id="dss.vector.solutions.query.ThematicLayer.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.query.ThematicLayerController.create.mojo" name="dss.vector.solutions.query.ThematicLayer.form.create.button" />
</mjl:form>
