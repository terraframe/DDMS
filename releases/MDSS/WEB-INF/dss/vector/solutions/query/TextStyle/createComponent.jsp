...
<mjl:form name="dss.vector.solutions.query.TextStyle.form.name" id="dss.vector.solutions.query.TextStyle.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.query.TextStyleController.create.mojo" name="dss.vector.solutions.query.TextStyle.form.create.button" />
</mjl:form>
