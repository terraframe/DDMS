...
<c:set var="page_title" value="Specie_Method_Create" scope="request"/>
<mjl:messages>
  <mjl:message />
</mjl:messages>
<mjl:form name="dss.vector.solutions.mo.Specie.form.name" id="dss.vector.solutions.mo.Specie.form.id" method="POST">
  <dl>
    ...
    <mjl:command value="Create" action="dss.vector.solutions.mo.SpecieController.create.mojo" name="dss.vector.solutions.mo.Specie.form.create.button" />
  </dl>
</mjl:form>
