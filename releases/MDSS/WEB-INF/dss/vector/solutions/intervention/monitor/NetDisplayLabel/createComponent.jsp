...
<mjl:form name="dss.vector.solutions.intervention.monitor.NetDisplayLabel.form.name" id="dss.vector.solutions.intervention.monitor.NetDisplayLabel.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.intervention.monitor.NetDisplayLabelController.create.mojo" name="dss.vector.solutions.intervention.monitor.NetDisplayLabel.form.create.button" />
</mjl:form>
