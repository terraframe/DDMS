...
// HOW TO USE
// 1. Put this at the bottom of the page 
<%@page import="org.json.JSONArray"%><div id="cal1Container" class="yui-skin-sam"></div> 
...
Date today = new Date();
AttributedCharacterIterator aci = formatter.formatToCharacterIterator(today);

out.println("var date_pattern = '"+formatter.toPattern()+"';");

JSONArray months = new JSONArray(Arrays.asList(formatter.getDateFormatSymbols().getMonths()));
out.println("var months = "+months+";");

JSONArray short_days = new JSONArray(Arrays.asList(formatter.getDateFormatSymbols().getMonths()));
out.println("var sort_days = "+short_days+";");

JSONArray test = new JSONArray(aci.getAllAttributeKeys());
out.println("var test = "+test+";");


out.println("var month_pos = "+aci.getAttribute(DateFormat.Field.DAY_OF_MONTH)+";");
%>
