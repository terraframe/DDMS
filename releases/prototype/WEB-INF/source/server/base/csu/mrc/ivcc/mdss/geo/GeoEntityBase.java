...
public abstract class GeoEntityBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1236462531034L;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(csu.mrc.ivcc.mdss.geo.GeoEntity.CLASS);
  ...
  public java.util.List<csu.mrc.ivcc.mdss.geo.Terrain> getTerrain()
  {
    return (java.util.List<csu.mrc.ivcc.mdss.geo.Terrain>) getEnumValues(TERRAIN);
  }
  
  public void addTerrain(csu.mrc.ivcc.mdss.geo.Terrain value)
  {
    addEnumItem(TERRAIN, value.getId());
  }
  
  public void removeTerrain(csu.mrc.ivcc.mdss.geo.Terrain value)
  {
