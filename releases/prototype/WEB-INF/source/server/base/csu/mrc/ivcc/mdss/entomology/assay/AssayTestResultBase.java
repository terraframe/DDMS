...
public abstract class AssayTestResultBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1236360381368L;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.CLASS);
  ...
  public csu.mrc.ivcc.mdss.entomology.Mosquito getMosquito()
  {
    try
    {
      return csu.mrc.ivcc.mdss.entomology.Mosquito.get(getValue(MOSQUITO));
    }
    catch (com.terraframe.mojo.dataaccess.cache.DataNotFoundException e)
    {
      return null;
  ...
  public void setMosquito(csu.mrc.ivcc.mdss.entomology.Mosquito value)
  {
    if(value == null)
    {
      setValue(MOSQUITO, "");
