...
{
private static final long serialVersionUID = 1237219375399L;
  ...
  {
    return (com.terraframe.mojo.query.AttributeMomentIF)this.getComponentQuery().attributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AbstractAssay.CREATEDATE, "com.terraframe.mojo.system.metadata.MdAttributeDateTime", alias);
  ...
  public com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF getCreatedBy(String alias)
  {
    ...
    return (com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AbstractAssay.CREATEDBY, mdAttributeIF, this, alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AbstractAssay.KEYNAME, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeMomentIF)this.getComponentQuery().attributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AbstractAssay.LASTUPDATEDATE, "com.terraframe.mojo.system.metadata.MdAttributeDateTime", alias);
  ...
  public com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF getLastUpdatedBy(String alias)
  {
    ...
    return (com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AbstractAssay.LASTUPDATEDBY, mdAttributeIF, this, alias);
  ...
  public com.terraframe.mojo.system.UsersQuery.UsersQueryReferenceIF getLockedBy(String alias)
  {
    ...
    return (com.terraframe.mojo.system.UsersQuery.UsersQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AbstractAssay.LOCKEDBY, mdAttributeIF, this, alias);
  ...
  public com.terraframe.mojo.system.ActorQuery.ActorQueryReferenceIF getOwner(String alias)
  {
    ...
    return (com.terraframe.mojo.system.ActorQuery.ActorQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AbstractAssay.OWNER, mdAttributeIF, this, alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AbstractAssay.SITEMASTER, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  public csu.mrc.ivcc.mdss.mo.SpecieQuery.SpecieQueryReferenceIF getSpecie(String alias)
  {
    ...
    return (csu.mrc.ivcc.mdss.mo.SpecieQuery.SpecieQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AbstractAssay.SPECIE, mdAttributeIF, this, alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AbstractAssay.TYPE, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
 ...
 **/
  public interface AbstractAssayQueryReferenceIF extends com.terraframe.mojo.generation.loader.Reloadable, com.terraframe.mojo.query.AttributeReferenceIF
  {
    ...
    public com.terraframe.mojo.query.BasicCondition EQ(csu.mrc.ivcc.mdss.entomology.assay.AbstractAssay abstractAssay);

    public com.terraframe.mojo.query.BasicCondition NE(csu.mrc.ivcc.mdss.entomology.assay.AbstractAssay abstractAssay);
...
, com.terraframe.mojo.generation.loader.Reloadable
  {
private static final long serialVersionUID = 1237219375516L;
