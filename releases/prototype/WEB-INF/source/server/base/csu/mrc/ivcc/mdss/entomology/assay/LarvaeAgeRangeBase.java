 ...
 */
public abstract class LarvaeAgeRangeBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1236982477568L;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange.CLASS);
  ...
  public csu.mrc.ivcc.mdss.mo.LarvaeAge getEndPoint()
  {
    try
    {
      return csu.mrc.ivcc.mdss.mo.LarvaeAge.get(getValue(ENDPOINT));
    }
    catch (com.terraframe.mojo.dataaccess.cache.DataNotFoundException e)
    {
      return null;
  ...
  public void setEndPoint(csu.mrc.ivcc.mdss.mo.LarvaeAge value)
  {
    if(value == null)
    {
      setValue(ENDPOINT, "");
  ...
  public csu.mrc.ivcc.mdss.mo.LarvaeAge getStartPoint()
  {
    try
    {
      return csu.mrc.ivcc.mdss.mo.LarvaeAge.get(getValue(STARTPOINT));
    }
    catch (com.terraframe.mojo.dataaccess.cache.DataNotFoundException e)
    {
      return null;
  ...
  public void setStartPoint(csu.mrc.ivcc.mdss.mo.LarvaeAge value)
  {
    if(value == null)
    {
      setValue(STARTPOINT, "");
  ...
  public static LarvaeAgeRangeQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    LarvaeAgeRangeQuery query = new LarvaeAgeRangeQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static LarvaeAgeRange get(String id)
  {
    return (LarvaeAgeRange) com.terraframe.mojo.business.Business.get(id);
  }
  
  public static LarvaeAgeRange lock(java.lang.String id)
  {
    LarvaeAgeRange _instance = LarvaeAgeRange.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static LarvaeAgeRange unlock(java.lang.String id)
  {
    LarvaeAgeRange _instance = LarvaeAgeRange.get(id);
    _instance.unlock();
