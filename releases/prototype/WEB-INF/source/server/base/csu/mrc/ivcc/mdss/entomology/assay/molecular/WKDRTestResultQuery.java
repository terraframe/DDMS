...
{
private static final long serialVersionUID = 1236982474023L;
  ...
  {
    return "csu.mrc.ivcc.mdss.entomology.assay.molecular.WKDRTestResult";
  }
  ...
  public csu.mrc.ivcc.mdss.mo.MolecularAssayResultQuery.MolecularAssayResultQueryReferenceIF getTestResult(String alias)
  {
    ...
    return (csu.mrc.ivcc.mdss.mo.MolecularAssayResultQuery.MolecularAssayResultQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(csu.mrc.ivcc.mdss.entomology.assay.molecular.WKDRTestResult.TESTRESULT, mdAttributeIF, this, alias);
 ...
 **/
  public interface WKDRTestResultQueryReferenceIF extends com.terraframe.mojo.generation.loader.Reloadable, csu.mrc.ivcc.mdss.entomology.assay.molecular.MolecularAssayTestResultQuery.MolecularAssayTestResultQueryReferenceIF
  {

    public csu.mrc.ivcc.mdss.mo.MolecularAssayResultQuery.MolecularAssayResultQueryReferenceIF getTestResult();
    public csu.mrc.ivcc.mdss.mo.MolecularAssayResultQuery.MolecularAssayResultQueryReferenceIF getTestResult(String alias);

    public com.terraframe.mojo.query.BasicCondition EQ(csu.mrc.ivcc.mdss.entomology.assay.molecular.WKDRTestResult wKDRTestResult);

    public com.terraframe.mojo.query.BasicCondition NE(csu.mrc.ivcc.mdss.entomology.assay.molecular.WKDRTestResult wKDRTestResult);
 ...
 * This type is used when a join is performed on this class as a reference.
 **/
  public static class WKDRTestResultQueryReference extends csu.mrc.ivcc.mdss.entomology.assay.molecular.MolecularAssayTestResultQuery.MolecularAssayTestResultQueryReference
 implements WKDRTestResultQueryReferenceIF
, com.terraframe.mojo.generation.loader.Reloadable
  {
private static final long serialVersionUID = 1236982474118L;
