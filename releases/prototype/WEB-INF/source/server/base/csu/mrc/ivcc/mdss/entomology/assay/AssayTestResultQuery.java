...
{
private static final long serialVersionUID = 1236382965574L;
  ...
  {
    return "csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult";
  }
  ...
  {
    return (com.terraframe.mojo.query.AttributeMomentIF)this.getComponentQuery().attributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.CREATEDATE, "com.terraframe.mojo.system.metadata.MdAttributeDateTime", alias);
  ...
  public com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF getCreatedBy(String alias)
  {
    ...
    return (com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.CREATEDBY, mdAttributeIF, this, alias);
  ...
  public com.terraframe.mojo.system.metadata.MdDomainQuery.MdDomainQueryReferenceIF getEntityDomain(String alias)
  {
    ...
    return (com.terraframe.mojo.system.metadata.MdDomainQuery.MdDomainQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.ENTITYDOMAIN, mdAttributeIF, this, alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.ID, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.KEYNAME, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeMomentIF)this.getComponentQuery().attributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.LASTUPDATEDATE, "com.terraframe.mojo.system.metadata.MdAttributeDateTime", alias);
  ...
  public com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF getLastUpdatedBy(String alias)
  {
    ...
    return (com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.LASTUPDATEDBY, mdAttributeIF, this, alias);
  ...
  public com.terraframe.mojo.system.UsersQuery.UsersQueryReferenceIF getLockedBy(String alias)
  {
    ...
    return (com.terraframe.mojo.system.UsersQuery.UsersQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.LOCKEDBY, mdAttributeIF, this, alias);

  }
  public csu.mrc.ivcc.mdss.entomology.MosquitoQuery.MosquitoQueryReferenceIF getMosquito()
  {
    return getMosquito(null);

  }
 
  public csu.mrc.ivcc.mdss.entomology.MosquitoQuery.MosquitoQueryReferenceIF getMosquito(String alias)
  {

    com.terraframe.mojo.dataaccess.MdAttributeDAOIF mdAttributeIF = this.getComponentQuery().getMdAttributeROfromMap("mosquito");

    return (csu.mrc.ivcc.mdss.entomology.MosquitoQuery.MosquitoQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.MOSQUITO, mdAttributeIF, this, alias);
  ...
  public com.terraframe.mojo.system.ActorQuery.ActorQueryReferenceIF getOwner(String alias)
  {
    ...
    return (com.terraframe.mojo.system.ActorQuery.ActorQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.OWNER, mdAttributeIF, this, alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeLongIF)this.getComponentQuery().attributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.SEQ, "com.terraframe.mojo.system.metadata.MdAttributeLong", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.SITEMASTER, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.TYPE, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  protected com.terraframe.mojo.query.AttributeReference referenceFactory( com.terraframe.mojo.dataaccess.MdAttributeRefDAOIF mdAttributeIF, String attributeNamespace, String definingTableName, String definingTableAlias,  com.terraframe.mojo.dataaccess.MdBusinessDAOIF referenceMdBusinessIF, String referenceTableAlias, com.terraframe.mojo.query.ComponentQuery rootQuery, java.util.Set<com.terraframe.mojo.query.Join> tableJoinSet, String userDefinedAlias)
  {
    ...
    {
       return new csu.mrc.ivcc.mdss.entomology.MosquitoQuery.MosquitoQueryReference((com.terraframe.mojo.dataaccess.MdAttributeRefDAOIF)mdAttributeIF, attributeNamespace, definingTableName, definingTableAlias, referenceMdBusinessIF, referenceTableAlias, rootQuery, tableJoinSet, userDefinedAlias);
    }
 ...
 **/
  public interface AssayTestResultQueryReferenceIF extends com.terraframe.mojo.generation.loader.Reloadable, com.terraframe.mojo.query.AttributeReferenceIF
  {
    ...
    public com.terraframe.mojo.query.BasicCondition EQ(csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult assayTestResult);

    public com.terraframe.mojo.query.BasicCondition NE(csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult assayTestResult);
...
, com.terraframe.mojo.generation.loader.Reloadable
  {
private static final long serialVersionUID = 1236382965673L;
  ...
  public csu.mrc.ivcc.mdss.entomology.MosquitoQuery.MosquitoQueryReferenceIF getMosquito(String alias)
  {
    return (csu.mrc.ivcc.mdss.entomology.MosquitoQuery.MosquitoQueryReferenceIF)this.attributeFactory("mosquito", "com.terraframe.mojo.system.metadata.MdAttributeReference", alias);
