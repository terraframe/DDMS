...
public abstract class DeleteEarthExceptionBase extends com.terraframe.mojo.business.SmartException implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1237219384818L;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(csu.mrc.ivcc.mdss.geo.DeleteEarthException.CLASS);
  ...
  public String toString()
  {
    if (this.isNew())
    {
      return "New: Delete Earth Exception";
    }
    else
    {
