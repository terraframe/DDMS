 ...
 */
public abstract class InfectivityAssayTestResultBase extends csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult implements com.terraframe.mojo.generation.loader.Reloadable
{
  public final static String CLASS = "csu.mrc.ivcc.mdss.entomology.assay.infectivity.InfectivityAssayTestResult";
  public static java.lang.String TESTMETHOD = "testMethod";
  private static final long serialVersionUID = 1236803166624L;
  ...
  public csu.mrc.ivcc.mdss.mo.InfectivityMethodology getTestMethod()
  {
    try
    {
      return csu.mrc.ivcc.mdss.mo.InfectivityMethodology.get(getValue(TESTMETHOD));
    }
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(csu.mrc.ivcc.mdss.entomology.assay.infectivity.InfectivityAssayTestResult.CLASS);
    return mdClassIF.definesAttribute(TESTMETHOD);
  }
  
  public void setTestMethod(csu.mrc.ivcc.mdss.mo.InfectivityMethodology value)
  {
    if(value == null)
    {
      setValue(TESTMETHOD, "");
  ...
  public static csu.mrc.ivcc.mdss.entomology.assay.infectivity.InfectivityAssayTestResult getInfectivityAssays()
  {
    return null;
  }
