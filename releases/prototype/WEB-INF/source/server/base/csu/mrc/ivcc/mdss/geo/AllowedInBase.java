...
public abstract class AllowedInBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1236612272325L;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(csu.mrc.ivcc.mdss.geo.AllowedIn.CLASS);
  ...
  public csu.mrc.ivcc.mdss.geo.GeoHierarchy getParent()
  {
    return (csu.mrc.ivcc.mdss.geo.GeoHierarchy) super.getParent();
  }
  
  public csu.mrc.ivcc.mdss.geo.GeoHierarchy getChild()
  {
    return (csu.mrc.ivcc.mdss.geo.GeoHierarchy) super.getChild();
  }
