...
private static final long serialVersionUID = 1236982477652L;
  ...
  {
    return "csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange";
  }
  ...
  {
    return (com.terraframe.mojo.query.AttributeMomentIF)this.getComponentQuery().attributeFactory(csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange.CREATEDATE, "com.terraframe.mojo.system.metadata.MdAttributeDateTime", alias);
  ...
  public com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF getCreatedBy(String alias)
  {
    ...
    return (com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange.CREATEDBY, mdAttributeIF, this, alias);

  }
  public csu.mrc.ivcc.mdss.mo.LarvaeAgeQuery.LarvaeAgeQueryReferenceIF getEndPoint()
  {
    return getEndPoint(null);

  }
 
  public csu.mrc.ivcc.mdss.mo.LarvaeAgeQuery.LarvaeAgeQueryReferenceIF getEndPoint(String alias)
  {

    com.terraframe.mojo.dataaccess.MdAttributeDAOIF mdAttributeIF = this.getComponentQuery().getMdAttributeROfromMap("endPoint");

    return (csu.mrc.ivcc.mdss.mo.LarvaeAgeQuery.LarvaeAgeQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange.ENDPOINT, mdAttributeIF, this, alias);
  ...
  public com.terraframe.mojo.system.metadata.MdDomainQuery.MdDomainQueryReferenceIF getEntityDomain(String alias)
  {
    ...
    return (com.terraframe.mojo.system.metadata.MdDomainQuery.MdDomainQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange.ENTITYDOMAIN, mdAttributeIF, this, alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange.ID, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange.KEYNAME, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeMomentIF)this.getComponentQuery().attributeFactory(csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange.LASTUPDATEDATE, "com.terraframe.mojo.system.metadata.MdAttributeDateTime", alias);
  ...
  public com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF getLastUpdatedBy(String alias)
  {
    ...
    return (com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange.LASTUPDATEDBY, mdAttributeIF, this, alias);
  ...
  public com.terraframe.mojo.system.UsersQuery.UsersQueryReferenceIF getLockedBy(String alias)
  {
    ...
    return (com.terraframe.mojo.system.UsersQuery.UsersQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange.LOCKEDBY, mdAttributeIF, this, alias);
  ...
  public com.terraframe.mojo.system.ActorQuery.ActorQueryReferenceIF getOwner(String alias)
  {
    ...
    return (com.terraframe.mojo.system.ActorQuery.ActorQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange.OWNER, mdAttributeIF, this, alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeLongIF)this.getComponentQuery().attributeFactory(csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange.SEQ, "com.terraframe.mojo.system.metadata.MdAttributeLong", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange.SITEMASTER, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);

  }
  public csu.mrc.ivcc.mdss.mo.LarvaeAgeQuery.LarvaeAgeQueryReferenceIF getStartPoint()
  {
    return getStartPoint(null);

  }
 
  public csu.mrc.ivcc.mdss.mo.LarvaeAgeQuery.LarvaeAgeQueryReferenceIF getStartPoint(String alias)
  {

    com.terraframe.mojo.dataaccess.MdAttributeDAOIF mdAttributeIF = this.getComponentQuery().getMdAttributeROfromMap("startPoint");

    return (csu.mrc.ivcc.mdss.mo.LarvaeAgeQuery.LarvaeAgeQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange.STARTPOINT, mdAttributeIF, this, alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange.TYPE, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  protected com.terraframe.mojo.query.AttributeReference referenceFactory( com.terraframe.mojo.dataaccess.MdAttributeRefDAOIF mdAttributeIF, String attributeNamespace, String definingTableName, String definingTableAlias,  com.terraframe.mojo.dataaccess.MdBusinessDAOIF referenceMdBusinessIF, String referenceTableAlias, com.terraframe.mojo.query.ComponentQuery rootQuery, java.util.Set<com.terraframe.mojo.query.Join> tableJoinSet, String userDefinedAlias)
  {
    ...
    {
       return new csu.mrc.ivcc.mdss.mo.LarvaeAgeQuery.LarvaeAgeQueryReference((com.terraframe.mojo.dataaccess.MdAttributeRefDAOIF)mdAttributeIF, attributeNamespace, definingTableName, definingTableAlias, referenceMdBusinessIF, referenceTableAlias, rootQuery, tableJoinSet, userDefinedAlias);
    }
   ...
   * on this query object.
   */
  public com.terraframe.mojo.query.OIterator<? extends LarvaeAgeRange> getIterator()
  {
    String sqlStmt;
    ...
    return new com.terraframe.mojo.business.BusinessIterator<LarvaeAgeRange>(this.getComponentQuery().getMdEntityIF(), columnInfoMap, results);
  }
 ...
 **/
  public interface LarvaeAgeRangeQueryReferenceIF extends com.terraframe.mojo.generation.loader.Reloadable, com.terraframe.mojo.query.AttributeReferenceIF
  {
    ...
    public com.terraframe.mojo.query.BasicCondition EQ(csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange larvaeAgeRange);

    public com.terraframe.mojo.query.BasicCondition NE(csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange larvaeAgeRange);
 ...
 * This type is used when a join is performed on this class as a reference.
 **/
  public static class LarvaeAgeRangeQueryReference extends com.terraframe.mojo.query.AttributeReference
...
private static final long serialVersionUID = 1236982477768L;
  ...
  public LarvaeAgeRangeQueryReference(com.terraframe.mojo.dataaccess.MdAttributeRefDAOIF mdAttributeIF, String attributeNamespace, String definingTableName, String definingTableAlias, com.terraframe.mojo.dataaccess.MdBusinessDAOIF referenceMdBusinessIF, String referenceTableAlias, com.terraframe.mojo.query.ComponentQuery rootQuery, java.util.Set<com.terraframe.mojo.query.Join> tableJoinSet, String alias)
  {
    ...
    public com.terraframe.mojo.query.BasicCondition EQ(csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange larvaeAgeRange)
    {
      return this.EQ(larvaeAgeRange.getId());
    }

    public com.terraframe.mojo.query.BasicCondition NE(csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange larvaeAgeRange)
    {
      return this.NE(larvaeAgeRange.getId());
    }
  ...
  public csu.mrc.ivcc.mdss.mo.LarvaeAgeQuery.LarvaeAgeQueryReferenceIF getEndPoint(String alias)
  {
    return (csu.mrc.ivcc.mdss.mo.LarvaeAgeQuery.LarvaeAgeQueryReferenceIF)this.attributeFactory("endPoint", "com.terraframe.mojo.system.metadata.MdAttributeReference", alias);
  ...
  public csu.mrc.ivcc.mdss.mo.LarvaeAgeQuery.LarvaeAgeQueryReferenceIF getStartPoint(String alias)
  {
    return (csu.mrc.ivcc.mdss.mo.LarvaeAgeQuery.LarvaeAgeQueryReferenceIF)this.attributeFactory("startPoint", "com.terraframe.mojo.system.metadata.MdAttributeReference", alias);
