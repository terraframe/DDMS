...
public abstract class GeoEntityDefinitionBase extends com.terraframe.mojo.business.View implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1236803169713L;
  ...
  public java.util.List<csu.mrc.ivcc.mdss.geo.SpatialTypes> getSpatialType()
  {
    return (java.util.List<csu.mrc.ivcc.mdss.geo.SpatialTypes>) getEnumValues(SPATIALTYPE);
  }
  
  public void addSpatialType(csu.mrc.ivcc.mdss.geo.SpatialTypes value)
  {
    addEnumItem(SPATIALTYPE, value.getId());
  }
  
  public void removeSpatialType(csu.mrc.ivcc.mdss.geo.SpatialTypes value)
  {
