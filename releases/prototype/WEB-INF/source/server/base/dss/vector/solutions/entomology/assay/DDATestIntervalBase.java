 ...
 */
public abstract class DDATestIntervalBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1237423099459L;
  ...
  public dss.vector.solutions.entomology.assay.CollectionAssay getAssay()
  {
    try
    {
      return dss.vector.solutions.entomology.assay.CollectionAssay.get(getValue(ASSAY));
    }
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.entomology.assay.DDATestInterval.CLASS);
    return mdClassIF.definesAttribute(ASSAY);
  }
  
  public void setAssay(dss.vector.solutions.entomology.assay.CollectionAssay value)
  {
    if(value == null)
    {
      setValue(ASSAY, "");
  ...
  public static DDATestIntervalQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    DDATestIntervalQuery query = new DDATestIntervalQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static DDATestInterval get(String id)
  {
    return (DDATestInterval) com.terraframe.mojo.business.Business.get(id);
  }
  
  public static DDATestInterval lock(java.lang.String id)
  {
    DDATestInterval _instance = DDATestInterval.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static DDATestInterval unlock(java.lang.String id)
  {
    DDATestInterval _instance = DDATestInterval.get(id);
    _instance.unlock();
