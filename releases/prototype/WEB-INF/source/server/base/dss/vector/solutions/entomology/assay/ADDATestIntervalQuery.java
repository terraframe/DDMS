...
{
private static final long serialVersionUID = 1237224313013L;
  ...
  {
    return "dss.vector.solutions.entomology.assay.ADDATestInterval";
  }
  ...
  public dss.vector.solutions.entomology.assay.DiscriminatingDoseAssayQuery.DiscriminatingDoseAssayQueryReferenceIF getAssay(String alias)
  {
    ...
    return (dss.vector.solutions.entomology.assay.DiscriminatingDoseAssayQuery.DiscriminatingDoseAssayQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(dss.vector.solutions.entomology.assay.ADDATestInterval.ASSAY, mdAttributeIF, this, alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeMomentIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.entomology.assay.ADDATestInterval.CREATEDATE, "com.terraframe.mojo.system.metadata.MdAttributeDateTime", alias);
  ...
  public com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF getCreatedBy(String alias)
  {
    ...
    return (com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(dss.vector.solutions.entomology.assay.ADDATestInterval.CREATEDBY, mdAttributeIF, this, alias);
  ...
  public com.terraframe.mojo.system.metadata.MdDomainQuery.MdDomainQueryReferenceIF getEntityDomain(String alias)
  {
    ...
    return (com.terraframe.mojo.system.metadata.MdDomainQuery.MdDomainQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(dss.vector.solutions.entomology.assay.ADDATestInterval.ENTITYDOMAIN, mdAttributeIF, this, alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.entomology.assay.ADDATestInterval.ID, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.entomology.assay.ADDATestInterval.KEYNAME, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeIntegerIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.entomology.assay.ADDATestInterval.KNOCKEDDOWN, "com.terraframe.mojo.system.metadata.MdAttributeInteger", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeMomentIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.entomology.assay.ADDATestInterval.LASTUPDATEDATE, "com.terraframe.mojo.system.metadata.MdAttributeDateTime", alias);
  ...
  public com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF getLastUpdatedBy(String alias)
  {
    ...
    return (com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(dss.vector.solutions.entomology.assay.ADDATestInterval.LASTUPDATEDBY, mdAttributeIF, this, alias);
  ...
  public com.terraframe.mojo.system.UsersQuery.UsersQueryReferenceIF getLockedBy(String alias)
  {
    ...
    return (com.terraframe.mojo.system.UsersQuery.UsersQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(dss.vector.solutions.entomology.assay.ADDATestInterval.LOCKEDBY, mdAttributeIF, this, alias);
  ...
  public com.terraframe.mojo.system.ActorQuery.ActorQueryReferenceIF getOwner(String alias)
  {
    ...
    return (com.terraframe.mojo.system.ActorQuery.ActorQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(dss.vector.solutions.entomology.assay.ADDATestInterval.OWNER, mdAttributeIF, this, alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeIntegerIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.entomology.assay.ADDATestInterval.PERIOD, "com.terraframe.mojo.system.metadata.MdAttributeInteger", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeLongIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.entomology.assay.ADDATestInterval.SEQ, "com.terraframe.mojo.system.metadata.MdAttributeLong", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.entomology.assay.ADDATestInterval.SITEMASTER, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.entomology.assay.ADDATestInterval.TYPE, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
   ...
   * on this query object.
   */
  public com.terraframe.mojo.query.OIterator<? extends ADDATestInterval> getIterator()
  {
    String sqlStmt;
    ...
    return new com.terraframe.mojo.business.BusinessIterator<ADDATestInterval>(this.getComponentQuery().getMdEntityIF(), columnInfoMap, results);
  }
 ...
 **/
  public interface ADDATestIntervalQueryReferenceIF extends com.terraframe.mojo.generation.loader.Reloadable, com.terraframe.mojo.query.AttributeReferenceIF
  {
    ...
    public com.terraframe.mojo.query.BasicCondition EQ(dss.vector.solutions.entomology.assay.ADDATestInterval aDDATestInterval);

    public com.terraframe.mojo.query.BasicCondition NE(dss.vector.solutions.entomology.assay.ADDATestInterval aDDATestInterval);
 ...
 * This type is used when a join is performed on this class as a reference.
 **/
  public static class ADDATestIntervalQueryReference extends com.terraframe.mojo.query.AttributeReference
 implements ADDATestIntervalQueryReferenceIF
, com.terraframe.mojo.generation.loader.Reloadable
  {
private static final long serialVersionUID = 1237224313107L;
  ...
  public ADDATestIntervalQueryReference(com.terraframe.mojo.dataaccess.MdAttributeRefDAOIF mdAttributeIF, String attributeNamespace, String definingTableName, String definingTableAlias, com.terraframe.mojo.dataaccess.MdBusinessDAOIF referenceMdBusinessIF, String referenceTableAlias, com.terraframe.mojo.query.ComponentQuery rootQuery, java.util.Set<com.terraframe.mojo.query.Join> tableJoinSet, String alias)
  {
    ...
    public com.terraframe.mojo.query.BasicCondition EQ(dss.vector.solutions.entomology.assay.ADDATestInterval aDDATestInterval)
    {
      return this.EQ(aDDATestInterval.getId());
    }
  ...
  public dss.vector.solutions.entomology.assay.DiscriminatingDoseAssayQuery.DiscriminatingDoseAssayQueryReferenceIF getAssay(String alias)
  {
    return (dss.vector.solutions.entomology.assay.DiscriminatingDoseAssayQuery.DiscriminatingDoseAssayQueryReferenceIF)this.attributeFactory("assay", "com.terraframe.mojo.system.metadata.MdAttributeReference", alias);
