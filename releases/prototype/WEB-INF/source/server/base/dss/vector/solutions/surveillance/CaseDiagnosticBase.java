 ...
 */
public abstract class CaseDiagnosticBase extends com.terraframe.mojo.business.Relationship implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1239670278071L;
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.surveillance.CaseDiagnostic.CLASS);
  ...
  public static com.terraframe.mojo.dataaccess.MdAttributeDAOIF getAmountPositiveMd()
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.surveillance.CaseDiagnostic.CLASS);
  ...
  public static CaseDiagnosticQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    CaseDiagnosticQuery query = new CaseDiagnosticQuery(new com.terraframe.mojo.query.QueryFactory());
  ...
  public dss.vector.solutions.surveillance.DiagnosticGrid getChild()
  {
    return (dss.vector.solutions.surveillance.DiagnosticGrid) super.getChild();
  }
  
  public static CaseDiagnostic get(String id)
  {
    return (CaseDiagnostic) com.terraframe.mojo.business.Relationship.get(id);
  }
  
  public static CaseDiagnostic lock(java.lang.String id)
  {
    CaseDiagnostic _instance = CaseDiagnostic.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static CaseDiagnostic unlock(java.lang.String id)
  {
    CaseDiagnostic _instance = CaseDiagnostic.get(id);
    _instance.unlock();
