...
public abstract class GeoHierarchyBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1239572462091L;
  ...
  public void confirmDeleteHierarchy(java.lang.String parentId)
  {
    String msg = "This method should never be invoked.  It should be overwritten in dss.vector.solutions.geo.GeoHierarchy.java";
    throw new com.terraframe.mojo.dataaccess.metadata.ForbiddenMethodException(msg);
  }
  
  public static final void confirmDeleteHierarchy(java.lang.String id, java.lang.String parentId)
  {
    GeoHierarchy _instance = GeoHierarchy.get(id);
    _instance.confirmDeleteHierarchy(parentId);
  }
