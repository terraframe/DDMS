...
{
private static final long serialVersionUID = 1239658627225L;
  ...
  {
    return "dss.vector.solutions.general.Insecticide";
  }
  public dss.vector.solutions.mo.ActiveIngredientQuery.ActiveIngredientQueryReferenceIF getActiveIngredient()
  {
    return getActiveIngredient(null);

  }
 
  public dss.vector.solutions.mo.ActiveIngredientQuery.ActiveIngredientQueryReferenceIF getActiveIngredient(String alias)
  {
    ...
    return (dss.vector.solutions.mo.ActiveIngredientQuery.ActiveIngredientQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(dss.vector.solutions.general.Insecticide.ACTIVEINGREDIENT, mdAttributeIF, this, alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeIntegerIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.general.Insecticide.AMOUNT, "com.terraframe.mojo.system.metadata.MdAttributeInteger", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeMomentIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.general.Insecticide.CREATEDATE, "com.terraframe.mojo.system.metadata.MdAttributeDateTime", alias);
  ...
  public com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF getCreatedBy(String alias)
  {
    ...
    return (com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(dss.vector.solutions.general.Insecticide.CREATEDBY, mdAttributeIF, this, alias);
  ...
  public com.terraframe.mojo.system.metadata.MdDomainQuery.MdDomainQueryReferenceIF getEntityDomain(String alias)
  {
    ...
    return (com.terraframe.mojo.system.metadata.MdDomainQuery.MdDomainQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(dss.vector.solutions.general.Insecticide.ENTITYDOMAIN, mdAttributeIF, this, alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.general.Insecticide.ID, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.general.Insecticide.KEYNAME, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeMomentIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.general.Insecticide.LASTUPDATEDATE, "com.terraframe.mojo.system.metadata.MdAttributeDateTime", alias);
  ...
  public com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF getLastUpdatedBy(String alias)
  {
    ...
    return (com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(dss.vector.solutions.general.Insecticide.LASTUPDATEDBY, mdAttributeIF, this, alias);
  ...
  public com.terraframe.mojo.system.UsersQuery.UsersQueryReferenceIF getLockedBy(String alias)
  {
    ...
    return (com.terraframe.mojo.system.UsersQuery.UsersQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(dss.vector.solutions.general.Insecticide.LOCKEDBY, mdAttributeIF, this, alias);
  ...
  public com.terraframe.mojo.system.ActorQuery.ActorQueryReferenceIF getOwner(String alias)
  {
    ...
    return (com.terraframe.mojo.system.ActorQuery.ActorQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(dss.vector.solutions.general.Insecticide.OWNER, mdAttributeIF, this, alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeLongIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.general.Insecticide.SEQ, "com.terraframe.mojo.system.metadata.MdAttributeLong", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.general.Insecticide.SITEMASTER, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.general.Insecticide.TYPE, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  protected com.terraframe.mojo.query.AttributeReference referenceFactory( com.terraframe.mojo.dataaccess.MdAttributeRefDAOIF mdAttributeIF, String attributeNamespace, String definingTableName, String definingTableAlias,  com.terraframe.mojo.dataaccess.MdBusinessDAOIF referenceMdBusinessIF, String referenceTableAlias, com.terraframe.mojo.query.ComponentQuery rootQuery, java.util.Set<com.terraframe.mojo.query.Join> tableJoinSet, String userDefinedAlias)
  {
    ...
    {
       return new dss.vector.solutions.mo.ActiveIngredientQuery.ActiveIngredientQueryReference((com.terraframe.mojo.dataaccess.MdAttributeRefDAOIF)mdAttributeIF, attributeNamespace, definingTableName, definingTableAlias, referenceMdBusinessIF, referenceTableAlias, rootQuery, tableJoinSet, userDefinedAlias);
    }
 ...
 **/
  public interface InsecticideQueryReferenceIF extends com.terraframe.mojo.generation.loader.Reloadable, com.terraframe.mojo.query.AttributeReferenceIF
  {
...
, com.terraframe.mojo.generation.loader.Reloadable
  {
private static final long serialVersionUID = 1239658627530L;
  ...
  public dss.vector.solutions.mo.ActiveIngredientQuery.ActiveIngredientQueryReferenceIF getActiveIngredient(String alias)
  {
    return (dss.vector.solutions.mo.ActiveIngredientQuery.ActiveIngredientQueryReferenceIF)this.attributeFactory("activeIngredient", "com.terraframe.mojo.system.metadata.MdAttributeReference", alias);
