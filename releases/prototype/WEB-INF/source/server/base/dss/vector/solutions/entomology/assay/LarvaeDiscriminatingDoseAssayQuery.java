...
{
private static final long serialVersionUID = 1238027421263L;
  ...
  {
    return (com.terraframe.mojo.query.AttributeFloatIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.entomology.assay.LarvaeDiscriminatingDoseAssay.CONTROLTESTMORTALITY, "com.terraframe.mojo.system.metadata.MdAttributeFloat", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeIntegerIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.entomology.assay.LarvaeDiscriminatingDoseAssay.HOLDINGTIME, "com.terraframe.mojo.system.metadata.MdAttributeInteger", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeFloatIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.entomology.assay.LarvaeDiscriminatingDoseAssay.MORTALITY, "com.terraframe.mojo.system.metadata.MdAttributeFloat", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeIntegerIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.entomology.assay.LarvaeDiscriminatingDoseAssay.QUANTITYDEAD, "com.terraframe.mojo.system.metadata.MdAttributeInteger", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeIntegerIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.entomology.assay.LarvaeDiscriminatingDoseAssay.QUANTITYLIVE, "com.terraframe.mojo.system.metadata.MdAttributeInteger", alias);
...
, com.terraframe.mojo.generation.loader.Reloadable
  {
private static final long serialVersionUID = 1238027421432L;
