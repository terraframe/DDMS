...
{
private static final long serialVersionUID = 1239658578754L;
  ...
  {
    return (com.terraframe.mojo.query.AttributeFloatIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssay.CONTROLTESTMORTALITY, "com.terraframe.mojo.system.metadata.MdAttributeFloat", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeIntegerIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssay.HOLDINGTIME, "com.terraframe.mojo.system.metadata.MdAttributeInteger", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeFloatIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssay.MORTALITY, "com.terraframe.mojo.system.metadata.MdAttributeFloat", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeIntegerIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssay.QUANTITYDEAD, "com.terraframe.mojo.system.metadata.MdAttributeInteger", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeIntegerIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.entomology.assay.AdultDiscriminatingDoseAssay.QUANTITYLIVE, "com.terraframe.mojo.system.metadata.MdAttributeInteger", alias);
...
, com.terraframe.mojo.generation.loader.Reloadable
  {
private static final long serialVersionUID = 1239658579062L;
