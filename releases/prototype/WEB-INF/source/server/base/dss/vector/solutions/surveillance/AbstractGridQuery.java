...
{
private static final long serialVersionUID = 1239670277186L;
  ...
  {
    return "dss.vector.solutions.surveillance.AbstractGrid";
  }
  ...
  {
    return (com.terraframe.mojo.query.AttributeBooleanIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.surveillance.AbstractGrid.ACTIVE, "com.terraframe.mojo.system.metadata.MdAttributeBoolean", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeMomentIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.surveillance.AbstractGrid.CREATEDATE, "com.terraframe.mojo.system.metadata.MdAttributeDateTime", alias);
  ...
  public com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF getCreatedBy(String alias)
  {
    ...
    return (com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(dss.vector.solutions.surveillance.AbstractGrid.CREATEDBY, mdAttributeIF, this, alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.surveillance.AbstractGrid.DISPLAYLABEL, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  public com.terraframe.mojo.system.metadata.MdDomainQuery.MdDomainQueryReferenceIF getEntityDomain(String alias)
  {
    ...
    return (com.terraframe.mojo.system.metadata.MdDomainQuery.MdDomainQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(dss.vector.solutions.surveillance.AbstractGrid.ENTITYDOMAIN, mdAttributeIF, this, alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.surveillance.AbstractGrid.ID, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.surveillance.AbstractGrid.KEYNAME, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeMomentIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.surveillance.AbstractGrid.LASTUPDATEDATE, "com.terraframe.mojo.system.metadata.MdAttributeDateTime", alias);
  ...
  public com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF getLastUpdatedBy(String alias)
  {
    ...
    return (com.terraframe.mojo.system.SingleActorQuery.SingleActorQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(dss.vector.solutions.surveillance.AbstractGrid.LASTUPDATEDBY, mdAttributeIF, this, alias);
  ...
  public com.terraframe.mojo.system.UsersQuery.UsersQueryReferenceIF getLockedBy(String alias)
  {
    ...
    return (com.terraframe.mojo.system.UsersQuery.UsersQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(dss.vector.solutions.surveillance.AbstractGrid.LOCKEDBY, mdAttributeIF, this, alias);

  }
  public com.terraframe.mojo.query.AttributeCharIF getOptionName()
  {
    return getOptionName(null);

  }
 
  public com.terraframe.mojo.query.AttributeCharIF getOptionName(String alias)
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.surveillance.AbstractGrid.OPTIONNAME, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  public com.terraframe.mojo.system.ActorQuery.ActorQueryReferenceIF getOwner(String alias)
  {
    ...
    return (com.terraframe.mojo.system.ActorQuery.ActorQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(dss.vector.solutions.surveillance.AbstractGrid.OWNER, mdAttributeIF, this, alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeLongIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.surveillance.AbstractGrid.SEQ, "com.terraframe.mojo.system.metadata.MdAttributeLong", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.surveillance.AbstractGrid.SITEMASTER, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
  ...
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.getComponentQuery().attributeFactory(dss.vector.solutions.surveillance.AbstractGrid.TYPE, "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
   ...
   * on this query object.
   */
  public com.terraframe.mojo.query.OIterator<? extends AbstractGrid> getIterator()
  {
    String sqlStmt;
    ...
    return new com.terraframe.mojo.business.BusinessIterator<AbstractGrid>(this.getComponentQuery().getMdEntityIF(), columnInfoMap, results);
  }
 ...
 **/
  public interface AbstractGridQueryReferenceIF extends com.terraframe.mojo.generation.loader.Reloadable, com.terraframe.mojo.query.AttributeReferenceIF
  {
    ...
    public com.terraframe.mojo.query.BasicCondition EQ(dss.vector.solutions.surveillance.AbstractGrid abstractGrid);

    public com.terraframe.mojo.query.BasicCondition NE(dss.vector.solutions.surveillance.AbstractGrid abstractGrid);
 ...
 * This type is used when a join is performed on this class as a reference.
 **/
  public static class AbstractGridQueryReference extends com.terraframe.mojo.query.AttributeReference
 implements AbstractGridQueryReferenceIF
, com.terraframe.mojo.generation.loader.Reloadable
  {
private static final long serialVersionUID = 1239670277486L;
  ...
  public AbstractGridQueryReference(com.terraframe.mojo.dataaccess.MdAttributeRefDAOIF mdAttributeIF, String attributeNamespace, String definingTableName, String definingTableAlias, com.terraframe.mojo.dataaccess.MdBusinessDAOIF referenceMdBusinessIF, String referenceTableAlias, com.terraframe.mojo.query.ComponentQuery rootQuery, java.util.Set<com.terraframe.mojo.query.Join> tableJoinSet, String alias)
  {
    ...
    public com.terraframe.mojo.query.BasicCondition EQ(dss.vector.solutions.surveillance.AbstractGrid abstractGrid)
    {
      return this.EQ(abstractGrid.getId());
    }

    public com.terraframe.mojo.query.BasicCondition NE(dss.vector.solutions.surveillance.AbstractGrid abstractGrid)
    {
      return this.NE(abstractGrid.getId());
    }
  ...
  public com.terraframe.mojo.query.AttributeCharIF getOptionName(String alias)
  {
    return (com.terraframe.mojo.query.AttributeCharIF)this.attributeFactory("optionName", "com.terraframe.mojo.system.metadata.MdAttributeCharacter", alias);
