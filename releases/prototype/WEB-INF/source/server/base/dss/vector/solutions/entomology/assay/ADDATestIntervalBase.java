 ...
 */
public abstract class ADDATestIntervalBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1237224312943L;
  ...
  public dss.vector.solutions.entomology.assay.DiscriminatingDoseAssay getAssay()
  {
    try
    {
      return dss.vector.solutions.entomology.assay.DiscriminatingDoseAssay.get(getValue(ASSAY));
    }
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.entomology.assay.ADDATestInterval.CLASS);
    return mdClassIF.definesAttribute(ASSAY);
  }
  
  public void setAssay(dss.vector.solutions.entomology.assay.DiscriminatingDoseAssay value)
  {
    if(value == null)
    {
      setValue(ASSAY, "");
  ...
  public static ADDATestIntervalQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    ADDATestIntervalQuery query = new ADDATestIntervalQuery(new com.terraframe.mojo.query.QueryFactory());
    com.terraframe.mojo.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static ADDATestInterval get(String id)
  {
    return (ADDATestInterval) com.terraframe.mojo.business.Business.get(id);
  }
  
  public static ADDATestInterval lock(java.lang.String id)
  {
    ADDATestInterval _instance = ADDATestInterval.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static ADDATestInterval unlock(java.lang.String id)
  {
    ADDATestInterval _instance = ADDATestInterval.get(id);
    _instance.unlock();
