 ...
 */
public abstract class InsecticideBase extends com.terraframe.mojo.business.Business implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1237423113205L;
  ...
  public dss.vector.solutions.mo.ActiveIngredient getActiveIngredient()
  {
    try
    {
      return dss.vector.solutions.mo.ActiveIngredient.get(getValue(ACTIVEINGREDIENT));
    }
  ...
  {
    com.terraframe.mojo.dataaccess.MdClassDAOIF mdClassIF = com.terraframe.mojo.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.general.Insecticide.CLASS);
    return mdClassIF.definesAttribute(ACTIVEINGREDIENT);
  }
  
  public void setActiveIngredient(dss.vector.solutions.mo.ActiveIngredient value)
  {
    if(value == null)
    {
