 ...
 */
public  class AcHETestResultQuery extends dss.vector.solutions.entomology.assay.molecular.MolecularAssayTestResultQuery
 implements com.terraframe.mojo.generation.loader.Reloadable
{
private static final long serialVersionUID = 1237423121436L;
  ...
  {
    return "dss.vector.solutions.entomology.assay.molecular.AcHETestResult";
  }
  ...
  public dss.vector.solutions.mo.MolecularAssayResultQuery.MolecularAssayResultQueryReferenceIF getTestResult(String alias)
  {
    ...
    return (dss.vector.solutions.mo.MolecularAssayResultQuery.MolecularAssayResultQueryReferenceIF)this.getComponentQuery().internalAttributeFactory(dss.vector.solutions.entomology.assay.molecular.AcHETestResult.TESTRESULT, mdAttributeIF, this, alias);
 ...
 **/
  public interface AcHETestResultQueryReferenceIF extends com.terraframe.mojo.generation.loader.Reloadable, dss.vector.solutions.entomology.assay.molecular.MolecularAssayTestResultQuery.MolecularAssayTestResultQueryReferenceIF
  {

    public dss.vector.solutions.mo.MolecularAssayResultQuery.MolecularAssayResultQueryReferenceIF getTestResult();
    public dss.vector.solutions.mo.MolecularAssayResultQuery.MolecularAssayResultQueryReferenceIF getTestResult(String alias);

    public com.terraframe.mojo.query.BasicCondition EQ(dss.vector.solutions.entomology.assay.molecular.AcHETestResult acHETestResult);

    public com.terraframe.mojo.query.BasicCondition NE(dss.vector.solutions.entomology.assay.molecular.AcHETestResult acHETestResult);
 ...
 * This type is used when a join is performed on this class as a reference.
 **/
  public static class AcHETestResultQueryReference extends dss.vector.solutions.entomology.assay.molecular.MolecularAssayTestResultQuery.MolecularAssayTestResultQueryReference
 implements AcHETestResultQueryReferenceIF
, com.terraframe.mojo.generation.loader.Reloadable
  {
private static final long serialVersionUID = 1237423121535L;
