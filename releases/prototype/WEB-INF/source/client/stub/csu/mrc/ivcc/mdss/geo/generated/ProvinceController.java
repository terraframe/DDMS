...
public class ProvinceController extends ProvinceControllerBase implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  public void viewPage(java.lang.String sortAttribute, java.lang.Boolean isAscending, java.lang.Integer pageSize, java.lang.Integer pageNumber) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    csu.mrc.ivcc.mdss.geo.generated.ProvinceQueryDTO query = csu.mrc.ivcc.mdss.geo.generated.ProvinceDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    csu.mrc.ivcc.mdss.geo.generated.ProvinceQueryDTO query = csu.mrc.ivcc.mdss.geo.generated.ProvinceDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All ProvinceController Objects");
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", csu.mrc.ivcc.mdss.geo.generated.ProvinceDTO.get(clientRequest, id));
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    csu.mrc.ivcc.mdss.geo.generated.ProvinceDTO dto = new csu.mrc.ivcc.mdss.geo.generated.ProvinceDTO(clientRequest);
  ...
  {
    csu.mrc.ivcc.mdss.geo.generated.ProvinceDTO dto = csu.mrc.ivcc.mdss.geo.generated.ProvinceDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
