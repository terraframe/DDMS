...
import dss.vector.solutions.entomology.assay.biochemical.AcHETestResultControllerBase;
...
{
  public static final String JSP_DIR = "WEB-INF/dss/vector/solutions/entomology/assay/biochemical/AcHETestResult/";
  ...
  {
    dss.vector.solutions.entomology.assay.biochemical.AcHETestResultDTO dto = dss.vector.solutions.entomology.assay.biochemical.AcHETestResultDTO.lock(super.getClientRequest(), id);
    req.setAttribute("mdss_ivcc_mrc_csu_entomology_assay_biochemical_AcHETestResult_testResult", dss.vector.solutions.mo.MolecularAssayResultDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    req.setAttribute("mdss_ivcc_mrc_csu_entomology_assay_biochemical_AcHETestResult_testResult", dss.vector.solutions.mo.MolecularAssayResultDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("mdss_ivcc_mrc_csu_entomology_assay_AssayTestResult_mosquito", dss.vector.solutions.entomology.MosquitoDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", dss.vector.solutions.entomology.assay.biochemical.AcHETestResultDTO.get(clientRequest, id));
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.entomology.assay.biochemical.AcHETestResultDTO dto = new dss.vector.solutions.entomology.assay.biochemical.AcHETestResultDTO(clientRequest);
    req.setAttribute("mdss_ivcc_mrc_csu_entomology_assay_biochemical_AcHETestResult_testResult", dss.vector.solutions.mo.MolecularAssayResultDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("mdss_ivcc_mrc_csu_entomology_assay_AssayTestResult_mosquito", dss.vector.solutions.entomology.MosquitoDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("item", dto);
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.entomology.assay.biochemical.AcHETestResultQueryDTO query = dss.vector.solutions.entomology.assay.biochemical.AcHETestResultDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.entomology.assay.biochemical.AcHETestResultQueryDTO query = dss.vector.solutions.entomology.assay.biochemical.AcHETestResultDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All AcHETestResultController Objects");
    render("viewAllComponent.jsp");
  }
