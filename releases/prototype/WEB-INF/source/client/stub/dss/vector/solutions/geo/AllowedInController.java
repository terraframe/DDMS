...
import dss.vector.solutions.geo.AllowedInControllerBase;
...
{
  public static final String JSP_DIR = "WEB-INF/dss/vector/solutions/geo/AllowedIn/";
  ...
  public void viewPage(java.lang.String sortAttribute, java.lang.Boolean isAscending, java.lang.Integer pageSize, java.lang.Integer pageNumber) throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    dss.vector.solutions.geo.AllowedInQueryDTO query = dss.vector.solutions.geo.AllowedInDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
  ...
  {
    dss.vector.solutions.geo.AllowedInDTO dto = dss.vector.solutions.geo.AllowedInDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    req.setAttribute("page_title", "Edit AllowedInController");
    render("editComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.geo.AllowedInQueryDTO query = dss.vector.solutions.geo.AllowedInDTO.parentQuery(clientRequest, parentId);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All AllowedInController Objects");
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.geo.AllowedInQueryDTO query = dss.vector.solutions.geo.AllowedInDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All AllowedInController Objects");
    render("viewAllComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.geo.AllowedInDTO dto = new dss.vector.solutions.geo.AllowedInDTO(clientRequest, parentId, childId);
    req.setAttribute("item", dto);
    req.setAttribute("page_title", "Create AllowedInController");
    render("createComponent.jsp");
  }
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.geo.AllowedInQueryDTO query = dss.vector.solutions.geo.AllowedInDTO.childQuery(clientRequest, childId);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All AllowedInController Objects");
    render("viewAllComponent.jsp");
  }
  ...
  {
    req.setAttribute("parentList", dss.vector.solutions.geo.GeoHierarchyDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
    req.setAttribute("childList", dss.vector.solutions.geo.GeoHierarchyDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", dss.vector.solutions.geo.AllowedInDTO.get(clientRequest, id));
