...
public class NationalRoadController extends NationalRoadControllerBase implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  public NationalRoadController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  public void viewAll() throws java.io.IOException, javax.servlet.ServletException
  {
    ...
    dss.vector.solutions.geo.generated.NationalRoadQueryDTO query = dss.vector.solutions.geo.generated.NationalRoadDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All NationalRoadController Objects");
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.geo.generated.NationalRoadDTO dto = new dss.vector.solutions.geo.generated.NationalRoadDTO(clientRequest);
    req.setAttribute("item", dto);
    req.setAttribute("page_title", "Create NationalRoadController");
  ...
  {
    req.setAttribute("item", dto);
    req.setAttribute("page_title", "Update NationalRoadController");
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    req.setAttribute("item", dss.vector.solutions.geo.generated.NationalRoadDTO.get(clientRequest, id));
    req.setAttribute("page_title", "View NationalRoadController");
  ...
  {
    dss.vector.solutions.geo.generated.NationalRoadDTO dto = dss.vector.solutions.geo.generated.NationalRoadDTO.lock(super.getClientRequest(), id);
    req.setAttribute("item", dto);
    req.setAttribute("page_title", "Edit NationalRoadController");
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.geo.generated.NationalRoadQueryDTO query = dss.vector.solutions.geo.generated.NationalRoadDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All NationalRoadController Objects");
    render("viewAllComponent.jsp");
  }
