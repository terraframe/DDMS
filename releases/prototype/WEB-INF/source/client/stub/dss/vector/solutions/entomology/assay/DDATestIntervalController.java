...
public class DDATestIntervalController extends DDATestIntervalControllerBase implements com.terraframe.mojo.generation.loader.Reloadable
{
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.entomology.assay.DDATestIntervalQueryDTO query = dss.vector.solutions.entomology.assay.DDATestIntervalDTO.getAllInstances(clientRequest, null, true, 20, 1);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All DDATestIntervalController Objects");
  ...
  {
    com.terraframe.mojo.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.entomology.assay.DDATestIntervalQueryDTO query = dss.vector.solutions.entomology.assay.DDATestIntervalDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    req.setAttribute("page_title", "View All DDATestIntervalController Objects");
    render("viewAllComponent.jsp");
  }
