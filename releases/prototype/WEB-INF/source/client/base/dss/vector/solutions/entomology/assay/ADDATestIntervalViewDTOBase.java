...
{
  public final static String CLASS = "dss.vector.solutions.entomology.assay.ADDATestIntervalView";
  ...
  public static final dss.vector.solutions.entomology.assay.ADDATestIntervalViewDTO[] saveAll(com.terraframe.mojo.constants.ClientRequestIF clientRequest, dss.vector.solutions.entomology.assay.ADDATestIntervalViewDTO[] array)
  {
    String[] _declaredTypes = new String[]{"[Ldss.vector.solutions.entomology.assay.ADDATestIntervalView;"};
    Object[] _parameters = new Object[]{array};
    com.terraframe.mojo.business.MethodMetaData _metadata = new com.terraframe.mojo.business.MethodMetaData(dss.vector.solutions.entomology.assay.ADDATestIntervalViewDTO.CLASS, "saveAll", _declaredTypes);
    return (dss.vector.solutions.entomology.assay.ADDATestIntervalViewDTO[]) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
