...
{
  private static final long serialVersionUID = 1238027427543L;
  ...
  */
  protected KnockDownTimePropertyDTOBase(com.terraframe.mojo.business.BusinessDTO businessDTO, com.terraframe.mojo.constants.ClientRequestIF clientRequest)
  {
  ...
  public static final dss.vector.solutions.general.KnockDownTimePropertyDTO searchByInsecticide(com.terraframe.mojo.constants.ClientRequestIF clientRequest, dss.vector.solutions.general.InsecticideDTO insecticide)
  {
    String[] _declaredTypes = new String[]{"dss.vector.solutions.general.Insecticide"};
    Object[] _parameters = new Object[]{insecticide};
    com.terraframe.mojo.business.MethodMetaData _metadata = new com.terraframe.mojo.business.MethodMetaData(dss.vector.solutions.general.KnockDownTimePropertyDTO.CLASS, "searchByInsecticide", _declaredTypes);
    return (dss.vector.solutions.general.KnockDownTimePropertyDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  
  public static dss.vector.solutions.general.KnockDownTimePropertyDTO get(com.terraframe.mojo.constants.ClientRequestIF clientRequest, String id)
  {
  ...
  public static dss.vector.solutions.general.KnockDownTimePropertyQueryDTO getAllInstances(com.terraframe.mojo.constants.ClientRequestIF clientRequest, String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    return (dss.vector.solutions.general.KnockDownTimePropertyQueryDTO) clientRequest.getAllInstances("dss.vector.solutions.general.KnockDownTimeProperty", sortAttribute, ascending, pageSize, pageNumber);
  }
  ...
  public static dss.vector.solutions.general.KnockDownTimePropertyDTO lock(com.terraframe.mojo.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.terraframe.mojo.business.MethodMetaData _metadata = new com.terraframe.mojo.business.MethodMetaData(dss.vector.solutions.general.KnockDownTimePropertyDTO.CLASS, "lock", _declaredTypes);
    return (dss.vector.solutions.general.KnockDownTimePropertyDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
  ...
  public static dss.vector.solutions.general.KnockDownTimePropertyDTO unlock(com.terraframe.mojo.constants.ClientRequestIF clientRequest, java.lang.String id)
  {
    String[] _declaredTypes = new String[]{"java.lang.String"};
    Object[] _parameters = new Object[]{id};
    com.terraframe.mojo.business.MethodMetaData _metadata = new com.terraframe.mojo.business.MethodMetaData(dss.vector.solutions.general.KnockDownTimePropertyDTO.CLASS, "unlock", _declaredTypes);
    return (dss.vector.solutions.general.KnockDownTimePropertyDTO) clientRequest.invokeMethod(_metadata, null, _parameters);
  }
