...
{
private static final long serialVersionUID = 1236803160786L;
...
public java.util.List<? extends csu.mrc.ivcc.mdss.entomology.assay.biochemical.BEsteraseTestResultDTO> getResultSet()
{
  return (java.util.List<? extends csu.mrc.ivcc.mdss.entomology.assay.biochemical.BEsteraseTestResultDTO>)super.getResultSet();
}
}
