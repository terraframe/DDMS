...
<mjl:form name="dss.vector.solutions.general.KnockDownTimeProperty.form.name" id="dss.vector.solutions.general.KnockDownTimeProperty.form.id" method="POST">
  ...
  <mjl:command value="Update" action="dss.vector.solutions.general.KnockDownTimePropertyController.update.mojo" name="dss.vector.solutions.general.KnockDownTimeProperty.form.update.button" />
  <mjl:command value="Delete" action="dss.vector.solutions.general.KnockDownTimePropertyController.delete.mojo" name="dss.vector.solutions.general.KnockDownTimeProperty.form.delete.button" />
  <mjl:command value="Cancel" action="dss.vector.solutions.general.KnockDownTimePropertyController.cancel.mojo" name="dss.vector.solutions.general.KnockDownTimeProperty.form.cancel.button" />
</mjl:form>
