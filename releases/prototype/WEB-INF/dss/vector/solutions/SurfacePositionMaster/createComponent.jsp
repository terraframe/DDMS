...
<mjl:form name="dss.vector.solutions.SurfacePositionMaster.form.name" id="dss.vector.solutions.SurfacePositionMaster.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.SurfacePositionMasterController.create.mojo" name="dss.vector.solutions.SurfacePositionMaster.form.create.button" />
</mjl:form>
