...
<mjl:form name="dss.vector.solutions.entomology.Generation.form.name" id="dss.vector.solutions.entomology.Generation.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.entomology.GenerationController.create.mojo" name="dss.vector.solutions.entomology.Generation.form.create.button" />
</mjl:form>
