...
<mjl:form name="dss.vector.solutions.entomology.Mosquito.form.name" id="dss.vector.solutions.entomology.Mosquito.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.entomology.MosquitoController.create.mojo" name="dss.vector.solutions.entomology.Mosquito.form.create.button" />
</mjl:form>
