...
<mjl:form name="dss.vector.solutions.entomology.assay.biochemical.GSTDCNBTestResult.form.name" id="dss.vector.solutions.entomology.assay.biochemical.GSTDCNBTestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.entomology.assay.biochemical.GSTDCNBTestResultController.create.mojo" name="dss.vector.solutions.entomology.assay.biochemical.GSTDCNBTestResult.form.create.button" />
</mjl:form>
