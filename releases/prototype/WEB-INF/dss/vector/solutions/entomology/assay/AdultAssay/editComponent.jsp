...
<mjl:form name="dss.vector.solutions.entomology.assay.AdultAssay.form.name" id="dss.vector.solutions.entomology.assay.AdultAssay.form.id" method="POST">
  ...
  <mjl:command value="Update" action="dss.vector.solutions.entomology.assay.AdultAssayController.update.mojo" name="dss.vector.solutions.entomology.assay.AdultAssay.form.update.button" />
  <mjl:command value="Delete" action="dss.vector.solutions.entomology.assay.AdultAssayController.delete.mojo" name="dss.vector.solutions.entomology.assay.AdultAssay.form.delete.button" />
  <mjl:command value="Cancel" action="dss.vector.solutions.entomology.assay.AdultAssayController.cancel.mojo" name="dss.vector.solutions.entomology.assay.AdultAssay.form.cancel.button" />
</mjl:form>
