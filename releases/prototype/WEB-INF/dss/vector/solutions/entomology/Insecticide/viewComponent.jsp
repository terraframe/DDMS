...
<mjl:commandLink display="View All" action="dss.vector.solutions.entomology.InsecticideController.viewAll.mojo" name="dss.vector.solutions.entomology.Insecticide.viewAll.link" />
