...
<mjl:form name="dss.vector.solutions.geo.generated.AdminPost.form.name" id="dss.vector.solutions.geo.generated.AdminPost.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.AdminPostController.create.mojo" name="dss.vector.solutions.geo.generated.AdminPost.form.create.button" />
</mjl:form>
