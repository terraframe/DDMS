...
<mjl:form name="dss.vector.solutions.geo.generated.SentinalSite.form.name" id="dss.vector.solutions.geo.generated.SentinalSite.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.SentinalSiteController.create.mojo" name="dss.vector.solutions.geo.generated.SentinalSite.form.create.button" />
</mjl:form>
