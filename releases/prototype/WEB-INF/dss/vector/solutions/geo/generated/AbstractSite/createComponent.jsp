...
<mjl:form name="dss.vector.solutions.geo.generated.AbstractSite.form.name" id="dss.vector.solutions.geo.generated.AbstractSite.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.AbstractSiteController.create.mojo" name="dss.vector.solutions.geo.generated.AbstractSite.form.create.button" />
</mjl:form>
