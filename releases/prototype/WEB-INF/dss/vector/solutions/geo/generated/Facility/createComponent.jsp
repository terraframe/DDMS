...
<mjl:form name="dss.vector.solutions.geo.generated.Facility.form.name" id="dss.vector.solutions.geo.generated.Facility.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.FacilityController.create.mojo" name="dss.vector.solutions.geo.generated.Facility.form.create.button" />
</mjl:form>
