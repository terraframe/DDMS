...
<mjl:form name="dss.vector.solutions.geo.generated.NationalRoad.form.name" id="dss.vector.solutions.geo.generated.NationalRoad.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.geo.generated.NationalRoadController.create.mojo" name="dss.vector.solutions.geo.generated.NationalRoad.form.create.button" />
</mjl:form>
