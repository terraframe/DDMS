...
<mjl:form name="dss.vector.solutions.surveillance.PeriodTypeMaster.form.name" id="dss.vector.solutions.surveillance.PeriodTypeMaster.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.surveillance.PeriodTypeMasterController.create.mojo" name="dss.vector.solutions.surveillance.PeriodTypeMaster.form.create.button" />
</mjl:form>
