...
<mjl:form name="dss.vector.solutions.surveillance.CaseTreatmentMethod.form.name" id="dss.vector.solutions.surveillance.CaseTreatmentMethod.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.surveillance.CaseTreatmentMethodController.create.mojo" name="dss.vector.solutions.surveillance.CaseTreatmentMethod.form.create.button" />
</mjl:form>
