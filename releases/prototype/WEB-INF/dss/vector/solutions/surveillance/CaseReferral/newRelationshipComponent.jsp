...
<mjl:form name="dss.vector.solutions.surveillance.CaseReferral.form.name" id="dss.vector.solutions.surveillance.CaseReferral.form.id" method="POST">
  ...
  <mjl:command value="New Instance" action="dss.vector.solutions.surveillance.CaseReferralController.newInstance.mojo" name="dss.vector.solutions.surveillance.CaseReferral.form.newInstance.button" />
</mjl:form>
