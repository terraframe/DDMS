...
<mjl:form name="dss.vector.solutions.surveillance.AbstractGrid.form.name" id="dss.vector.solutions.surveillance.AbstractGrid.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.surveillance.AbstractGridController.create.mojo" name="dss.vector.solutions.surveillance.AbstractGrid.form.create.button" />
</mjl:form>
