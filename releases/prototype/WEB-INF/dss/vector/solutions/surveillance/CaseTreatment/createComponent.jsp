...
<mjl:form name="dss.vector.solutions.surveillance.CaseTreatment.form.name" id="dss.vector.solutions.surveillance.CaseTreatment.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.surveillance.CaseTreatmentController.create.mojo" name="dss.vector.solutions.surveillance.CaseTreatment.form.create.button" />
</mjl:form>
