...
<mjl:form name="dss.vector.solutions.mo.BiochemicalMethodology.form.name" id="dss.vector.solutions.mo.BiochemicalMethodology.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.mo.BiochemicalMethodologyController.create.mojo" name="dss.vector.solutions.mo.BiochemicalMethodology.form.create.button" />
</mjl:form>
