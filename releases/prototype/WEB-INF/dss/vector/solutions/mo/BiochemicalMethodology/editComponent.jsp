...
<mjl:form name="dss.vector.solutions.mo.BiochemicalMethodology.form.name" id="dss.vector.solutions.mo.BiochemicalMethodology.form.id" method="POST">
  ...
  <mjl:command value="Update" action="dss.vector.solutions.mo.BiochemicalMethodologyController.update.mojo" name="dss.vector.solutions.mo.BiochemicalMethodology.form.update.button" />
  <mjl:command value="Delete" action="dss.vector.solutions.mo.BiochemicalMethodologyController.delete.mojo" name="dss.vector.solutions.mo.BiochemicalMethodology.form.delete.button" />
  <mjl:command value="Cancel" action="dss.vector.solutions.mo.BiochemicalMethodologyController.cancel.mojo" name="dss.vector.solutions.mo.BiochemicalMethodology.form.cancel.button" />
</mjl:form>
