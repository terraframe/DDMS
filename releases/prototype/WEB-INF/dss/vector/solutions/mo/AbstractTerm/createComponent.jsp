...
<mjl:form name="dss.vector.solutions.mo.AbstractTerm.form.name" id="dss.vector.solutions.mo.AbstractTerm.form.id" method="POST">
  ...
  <mjl:command value="Create" action="dss.vector.solutions.mo.AbstractTermController.create.mojo" name="dss.vector.solutions.mo.AbstractTerm.form.create.button" />
</mjl:form>
