...
<mjl:form name="csu.mrc.ivcc.mdss.geo.generated.AbstractSite.form.name" id="csu.mrc.ivcc.mdss.geo.generated.AbstractSite.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.geo.generated.AbstractSiteController.create.mojo" name="csu.mrc.ivcc.mdss.geo.generated.AbstractSite.form.create.button" />
</mjl:form>
