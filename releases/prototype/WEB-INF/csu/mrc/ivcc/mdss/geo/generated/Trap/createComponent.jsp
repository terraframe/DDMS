...
<mjl:form name="csu.mrc.ivcc.mdss.geo.generated.Trap.form.name" id="csu.mrc.ivcc.mdss.geo.generated.Trap.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.geo.generated.TrapController.create.mojo" name="csu.mrc.ivcc.mdss.geo.generated.Trap.form.create.button" />
</mjl:form>
