...
<mjl:form name="csu.mrc.ivcc.mdss.geo.TerrainMaster.form.name" id="csu.mrc.ivcc.mdss.geo.TerrainMaster.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="csu.mrc.ivcc.mdss.geo.TerrainMasterController.edit.mojo" name="csu.mrc.ivcc.mdss.geo.TerrainMaster.form.edit.button" />
  <br />
</mjl:form>
<dl>
  <dt>
...
<mjl:commandLink display="View All" action="csu.mrc.ivcc.mdss.geo.TerrainMasterController.viewAll.mojo" name="csu.mrc.ivcc.mdss.geo.TerrainMaster.viewAll.link" />
