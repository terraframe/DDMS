...
<mjl:form name="csu.mrc.ivcc.mdss.geo.generated.District.form.name" id="csu.mrc.ivcc.mdss.geo.generated.District.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.geo.generated.DistrictController.create.mojo" name="csu.mrc.ivcc.mdss.geo.generated.District.form.create.button" />
</mjl:form>
