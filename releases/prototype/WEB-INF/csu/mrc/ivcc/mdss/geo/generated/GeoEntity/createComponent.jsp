...
<mjl:form name="csu.mrc.ivcc.mdss.geo.generated.GeoEntity.form.name" id="csu.mrc.ivcc.mdss.geo.generated.GeoEntity.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.geo.generated.GeoEntityController.create.mojo" name="csu.mrc.ivcc.mdss.geo.generated.GeoEntity.form.create.button" />
</mjl:form>
