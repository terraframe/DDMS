...
<mjl:form name="csu.mrc.ivcc.mdss.mo.ResistanceMethodology.form.name" id="csu.mrc.ivcc.mdss.mo.ResistanceMethodology.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.mo.ResistanceMethodologyController.create.mojo" name="csu.mrc.ivcc.mdss.mo.ResistanceMethodology.form.create.button" />
</mjl:form>
