...
<mjl:form name="csu.mrc.ivcc.mdss.mo.BiochemicalMethodology.form.name" id="csu.mrc.ivcc.mdss.mo.BiochemicalMethodology.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.mo.BiochemicalMethodologyController.create.mojo" name="csu.mrc.ivcc.mdss.mo.BiochemicalMethodology.form.create.button" />
</mjl:form>
