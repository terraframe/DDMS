...
<mjl:table var="item" query="${query}">
  <mjl:context action="csu.mrc.ivcc.mdss.mo.LarvaeAgeController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="csu.mrc.ivcc.mdss.mo.LarvaeAgeController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Larvae Age" action="csu.mrc.ivcc.mdss.mo.LarvaeAgeController.newInstance.mojo" name="LarvaeAgeController.newInstance" />
