...
<mjl:form name="csu.mrc.ivcc.mdss.mo.MolecularAssayResult.form.name" id="csu.mrc.ivcc.mdss.mo.MolecularAssayResult.form.id" method="POST">
  ...
  <mjl:command value="Update" action="csu.mrc.ivcc.mdss.mo.MolecularAssayResultController.update.mojo" name="csu.mrc.ivcc.mdss.mo.MolecularAssayResult.form.update.button" />
  <mjl:command value="Delete" action="csu.mrc.ivcc.mdss.mo.MolecularAssayResultController.delete.mojo" name="csu.mrc.ivcc.mdss.mo.MolecularAssayResult.form.delete.button" />
  <mjl:command value="Cancel" action="csu.mrc.ivcc.mdss.mo.MolecularAssayResultController.cancel.mojo" name="csu.mrc.ivcc.mdss.mo.MolecularAssayResult.form.cancel.button" />
</mjl:form>
