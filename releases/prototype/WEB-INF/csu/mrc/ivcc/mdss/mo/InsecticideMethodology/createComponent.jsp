...
<mjl:form name="csu.mrc.ivcc.mdss.mo.InsecticideMethodology.form.name" id="csu.mrc.ivcc.mdss.mo.InsecticideMethodology.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.mo.InsecticideMethodologyController.create.mojo" name="csu.mrc.ivcc.mdss.mo.InsecticideMethodology.form.create.button" />
</mjl:form>
