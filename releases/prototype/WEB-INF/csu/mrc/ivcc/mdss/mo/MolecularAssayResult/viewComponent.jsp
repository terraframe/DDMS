...
<mjl:form name="csu.mrc.ivcc.mdss.mo.MolecularAssayResult.form.name" id="csu.mrc.ivcc.mdss.mo.MolecularAssayResult.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="csu.mrc.ivcc.mdss.mo.MolecularAssayResultController.edit.mojo" name="csu.mrc.ivcc.mdss.mo.MolecularAssayResult.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="csu.mrc.ivcc.mdss.mo.MolecularAssayResultController.viewAll.mojo" name="csu.mrc.ivcc.mdss.mo.MolecularAssayResult.viewAll.link" />
