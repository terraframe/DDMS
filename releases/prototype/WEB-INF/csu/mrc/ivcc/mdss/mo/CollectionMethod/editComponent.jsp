...
<mjl:form name="csu.mrc.ivcc.mdss.mo.CollectionMethod.form.name" id="csu.mrc.ivcc.mdss.mo.CollectionMethod.form.id" method="POST">
  ...
  <mjl:command value="Update" action="csu.mrc.ivcc.mdss.mo.CollectionMethodController.update.mojo" name="csu.mrc.ivcc.mdss.mo.CollectionMethod.form.update.button" />
  <mjl:command value="Delete" action="csu.mrc.ivcc.mdss.mo.CollectionMethodController.delete.mojo" name="csu.mrc.ivcc.mdss.mo.CollectionMethod.form.delete.button" />
  <mjl:command value="Cancel" action="csu.mrc.ivcc.mdss.mo.CollectionMethodController.cancel.mojo" name="csu.mrc.ivcc.mdss.mo.CollectionMethod.form.cancel.button" />
</mjl:form>
