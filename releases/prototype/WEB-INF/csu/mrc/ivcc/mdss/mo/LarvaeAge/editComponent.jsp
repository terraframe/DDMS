...
<mjl:form name="csu.mrc.ivcc.mdss.mo.LarvaeAge.form.name" id="csu.mrc.ivcc.mdss.mo.LarvaeAge.form.id" method="POST">
  ...
  <mjl:command value="Update" action="csu.mrc.ivcc.mdss.mo.LarvaeAgeController.update.mojo" name="csu.mrc.ivcc.mdss.mo.LarvaeAge.form.update.button" />
  <mjl:command value="Delete" action="csu.mrc.ivcc.mdss.mo.LarvaeAgeController.delete.mojo" name="csu.mrc.ivcc.mdss.mo.LarvaeAge.form.delete.button" />
  <mjl:command value="Cancel" action="csu.mrc.ivcc.mdss.mo.LarvaeAgeController.cancel.mojo" name="csu.mrc.ivcc.mdss.mo.LarvaeAge.form.cancel.button" />
</mjl:form>
