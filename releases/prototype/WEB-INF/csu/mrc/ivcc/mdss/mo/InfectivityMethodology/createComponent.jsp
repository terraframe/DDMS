...
<mjl:form name="csu.mrc.ivcc.mdss.mo.InfectivityMethodology.form.name" id="csu.mrc.ivcc.mdss.mo.InfectivityMethodology.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.mo.InfectivityMethodologyController.create.mojo" name="csu.mrc.ivcc.mdss.mo.InfectivityMethodology.form.create.button" />
</mjl:form>
