...
<mjl:form name="csu.mrc.ivcc.mdss.mo.BiochemicalMethodology.form.name" id="csu.mrc.ivcc.mdss.mo.BiochemicalMethodology.form.id" method="POST">
  ...
  <mjl:command value="Update" action="csu.mrc.ivcc.mdss.mo.BiochemicalMethodologyController.update.mojo" name="csu.mrc.ivcc.mdss.mo.BiochemicalMethodology.form.update.button" />
  <mjl:command value="Delete" action="csu.mrc.ivcc.mdss.mo.BiochemicalMethodologyController.delete.mojo" name="csu.mrc.ivcc.mdss.mo.BiochemicalMethodology.form.delete.button" />
  <mjl:command value="Cancel" action="csu.mrc.ivcc.mdss.mo.BiochemicalMethodologyController.cancel.mojo" name="csu.mrc.ivcc.mdss.mo.BiochemicalMethodology.form.cancel.button" />
</mjl:form>
