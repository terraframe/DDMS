...
<mjl:form name="csu.mrc.ivcc.mdss.mo.InsecticideMethodology.form.name" id="csu.mrc.ivcc.mdss.mo.InsecticideMethodology.form.id" method="POST">
  ...
  <mjl:command value="Update" action="csu.mrc.ivcc.mdss.mo.InsecticideMethodologyController.update.mojo" name="csu.mrc.ivcc.mdss.mo.InsecticideMethodology.form.update.button" />
  <mjl:command value="Delete" action="csu.mrc.ivcc.mdss.mo.InsecticideMethodologyController.delete.mojo" name="csu.mrc.ivcc.mdss.mo.InsecticideMethodology.form.delete.button" />
  <mjl:command value="Cancel" action="csu.mrc.ivcc.mdss.mo.InsecticideMethodologyController.cancel.mojo" name="csu.mrc.ivcc.mdss.mo.InsecticideMethodology.form.cancel.button" />
</mjl:form>
