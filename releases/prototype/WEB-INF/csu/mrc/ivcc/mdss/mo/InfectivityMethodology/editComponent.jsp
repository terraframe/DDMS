...
<mjl:form name="csu.mrc.ivcc.mdss.mo.InfectivityMethodology.form.name" id="csu.mrc.ivcc.mdss.mo.InfectivityMethodology.form.id" method="POST">
  ...
  <mjl:command value="Update" action="csu.mrc.ivcc.mdss.mo.InfectivityMethodologyController.update.mojo" name="csu.mrc.ivcc.mdss.mo.InfectivityMethodology.form.update.button" />
  <mjl:command value="Delete" action="csu.mrc.ivcc.mdss.mo.InfectivityMethodologyController.delete.mojo" name="csu.mrc.ivcc.mdss.mo.InfectivityMethodology.form.delete.button" />
  <mjl:command value="Cancel" action="csu.mrc.ivcc.mdss.mo.InfectivityMethodologyController.cancel.mojo" name="csu.mrc.ivcc.mdss.mo.InfectivityMethodology.form.cancel.button" />
</mjl:form>
