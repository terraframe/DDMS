...
<mjl:table var="item" query="${query}">
  <mjl:context action="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssayController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssayController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Discriminating Dose Assay" action="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssayController.newInstance.mojo" name="DiscriminatingDoseAssayController.newInstance" />
