...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.ConcreteMosquitoCollection.form.name" id="csu.mrc.ivcc.mdss.entomology.ConcreteMosquitoCollection.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.ConcreteMosquitoCollectionController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.ConcreteMosquitoCollection.form.create.button" />
</mjl:form>
