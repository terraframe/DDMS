...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.Insecticide.form.name" id="csu.mrc.ivcc.mdss.entomology.Insecticide.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.InsecticideController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.Insecticide.form.create.button" />
</mjl:form>
