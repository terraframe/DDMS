...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.MorphologicalSpecieGroup.form.name" id="csu.mrc.ivcc.mdss.entomology.MorphologicalSpecieGroup.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.MorphologicalSpecieGroupController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.MorphologicalSpecieGroup.form.create.button" />
</mjl:form>
