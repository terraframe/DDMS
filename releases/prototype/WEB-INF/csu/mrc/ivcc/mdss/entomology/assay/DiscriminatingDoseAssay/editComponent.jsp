...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssay.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssay.form.id" method="POST">
  ...
  <mjl:command value="Update" action="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssayController.update.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssay.form.update.button" />
  <mjl:command value="Delete" action="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssayController.delete.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssay.form.delete.button" />
  <mjl:command value="Cancel" action="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssayController.cancel.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssay.form.cancel.button" />
</mjl:form>
