...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.infectivity.PMalariaeTestResult.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.infectivity.PMalariaeTestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.assay.infectivity.PMalariaeTestResultController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.infectivity.PMalariaeTestResult.form.create.button" />
</mjl:form>
