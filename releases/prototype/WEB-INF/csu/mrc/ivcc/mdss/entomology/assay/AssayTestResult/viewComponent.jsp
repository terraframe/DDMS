...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="csu.mrc.ivcc.mdss.entomology.assay.AssayTestResultController.edit.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="csu.mrc.ivcc.mdss.entomology.assay.AssayTestResultController.viewAll.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.AssayTestResult.viewAll.link" />
