...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.AdultAgeRange.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.AdultAgeRange.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.assay.AdultAgeRangeController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.AdultAgeRange.form.create.button" />
</mjl:form>
