...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.infectivity.PMalariaeTestResult.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.infectivity.PMalariaeTestResult.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="csu.mrc.ivcc.mdss.entomology.assay.infectivity.PMalariaeTestResultController.edit.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.infectivity.PMalariaeTestResult.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="csu.mrc.ivcc.mdss.entomology.assay.infectivity.PMalariaeTestResultController.viewAll.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.infectivity.PMalariaeTestResult.viewAll.link" />
