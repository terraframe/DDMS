...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.InsecticideAssay.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.InsecticideAssay.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="csu.mrc.ivcc.mdss.entomology.assay.InsecticideAssayController.edit.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.InsecticideAssay.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="csu.mrc.ivcc.mdss.entomology.assay.InsecticideAssayController.viewAll.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.InsecticideAssay.viewAll.link" />
