...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssay.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssay.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssayController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssay.form.create.button" />
</mjl:form>
