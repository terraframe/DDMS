...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.AbstractMosquitoCollection.form.name" id="csu.mrc.ivcc.mdss.entomology.AbstractMosquitoCollection.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="csu.mrc.ivcc.mdss.entomology.AbstractMosquitoCollectionController.edit.mojo" name="csu.mrc.ivcc.mdss.entomology.AbstractMosquitoCollection.form.edit.button" />
  <br />
</mjl:form>
<dl>
  <dt>
...
<mjl:commandLink display="View All" action="csu.mrc.ivcc.mdss.entomology.AbstractMosquitoCollectionController.viewAll.mojo" name="csu.mrc.ivcc.mdss.entomology.AbstractMosquitoCollection.viewAll.link" />
