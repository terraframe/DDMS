...
<mjl:table var="item" query="${query}">
  <mjl:context action="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssayController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssayController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Larvae Discriminating Dose Assay" action="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssayController.newInstance.mojo" name="LarvaeDiscriminatingDoseAssayController.newInstance" />
