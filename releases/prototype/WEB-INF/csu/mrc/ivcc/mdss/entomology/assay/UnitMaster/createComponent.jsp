...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.UnitMaster.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.UnitMaster.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.assay.UnitMasterController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.UnitMaster.form.create.button" />
</mjl:form>
