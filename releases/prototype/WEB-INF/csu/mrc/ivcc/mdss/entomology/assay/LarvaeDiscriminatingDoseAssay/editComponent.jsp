...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssay.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssay.form.id" method="POST">
  ...
  <mjl:command value="Update" action="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssayController.update.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssay.form.update.button" />
  <mjl:command value="Delete" action="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssayController.delete.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssay.form.delete.button" />
  <mjl:command value="Cancel" action="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssayController.cancel.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssay.form.cancel.button" />
</mjl:form>
