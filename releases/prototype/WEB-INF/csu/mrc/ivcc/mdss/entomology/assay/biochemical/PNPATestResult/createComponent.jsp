...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.biochemical.PNPATestResult.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.biochemical.PNPATestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.assay.biochemical.PNPATestResultController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.biochemical.PNPATestResult.form.create.button" />
</mjl:form>
