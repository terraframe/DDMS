...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.MosquitoCollectionPoint.form.name" id="csu.mrc.ivcc.mdss.entomology.MosquitoCollectionPoint.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.MosquitoCollectionPointController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.MosquitoCollectionPoint.form.create.button" />
</mjl:form>
