...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssay.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssay.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssayController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssay.form.create.button" />
</mjl:form>
