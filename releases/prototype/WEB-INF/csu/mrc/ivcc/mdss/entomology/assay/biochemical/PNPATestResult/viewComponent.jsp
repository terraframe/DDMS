...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.biochemical.PNPATestResult.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.biochemical.PNPATestResult.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="csu.mrc.ivcc.mdss.entomology.assay.biochemical.PNPATestResultController.edit.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.biochemical.PNPATestResult.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="csu.mrc.ivcc.mdss.entomology.assay.biochemical.PNPATestResultController.viewAll.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.biochemical.PNPATestResult.viewAll.link" />
