...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.molecular.EKDRTestResult.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.molecular.EKDRTestResult.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.assay.molecular.EKDRTestResultController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.molecular.EKDRTestResult.form.create.button" />
</mjl:form>
