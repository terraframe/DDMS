...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.CollectionAssay.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.CollectionAssay.form.id" method="POST">
  ...
  <mjl:command value="Update" action="csu.mrc.ivcc.mdss.entomology.assay.CollectionAssayController.update.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.CollectionAssay.form.update.button" />
  <mjl:command value="Delete" action="csu.mrc.ivcc.mdss.entomology.assay.CollectionAssayController.delete.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.CollectionAssay.form.delete.button" />
  <mjl:command value="Cancel" action="csu.mrc.ivcc.mdss.entomology.assay.CollectionAssayController.cancel.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.CollectionAssay.form.cancel.button" />
</mjl:form>
