...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.Mosquito.form.name" id="csu.mrc.ivcc.mdss.entomology.Mosquito.form.id" method="POST">
  ...
  <mjl:command value="Update" action="csu.mrc.ivcc.mdss.entomology.MosquitoController.update.mojo" name="csu.mrc.ivcc.mdss.entomology.Mosquito.form.update.button" />
  <mjl:command value="Delete" action="csu.mrc.ivcc.mdss.entomology.MosquitoController.delete.mojo" name="csu.mrc.ivcc.mdss.entomology.Mosquito.form.delete.button" />
  <mjl:command value="Cancel" action="csu.mrc.ivcc.mdss.entomology.MosquitoController.cancel.mojo" name="csu.mrc.ivcc.mdss.entomology.Mosquito.form.cancel.button" />
</mjl:form>
