...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.UninterestingSpecieGroup.form.name" id="csu.mrc.ivcc.mdss.entomology.UninterestingSpecieGroup.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.UninterestingSpecieGroupController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.UninterestingSpecieGroup.form.create.button" />
</mjl:form>
