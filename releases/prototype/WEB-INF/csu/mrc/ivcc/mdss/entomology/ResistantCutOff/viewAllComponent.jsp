...
<mjl:table var="item" query="${query}">
  <mjl:context action="csu.mrc.ivcc.mdss.entomology.ResistantCutOffController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="csu.mrc.ivcc.mdss.entomology.ResistantCutOffController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Property" action="csu.mrc.ivcc.mdss.entomology.ResistantCutOffController.newInstance.mojo" name="ResistantCutOffController.newInstance" />
