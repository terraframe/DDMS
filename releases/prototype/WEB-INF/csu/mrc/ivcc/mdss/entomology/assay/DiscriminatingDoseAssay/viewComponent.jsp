...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssay.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssay.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssayController.edit.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssay.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssayController.viewAll.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.DiscriminatingDoseAssay.viewAll.link" />
