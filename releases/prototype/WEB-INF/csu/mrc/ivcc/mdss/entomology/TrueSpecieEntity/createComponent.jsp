...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.TrueSpecieEntity.form.name" id="csu.mrc.ivcc.mdss.entomology.TrueSpecieEntity.form.id" method="POST">
  ...
  <mjl:command value="Create" action="csu.mrc.ivcc.mdss.entomology.TrueSpecieEntityController.create.mojo" name="csu.mrc.ivcc.mdss.entomology.TrueSpecieEntity.form.create.button" />
</mjl:form>
