...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.AbstractAssay.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.AbstractAssay.form.id" method="POST">
  ...
  <mjl:command value="Update" action="csu.mrc.ivcc.mdss.entomology.assay.AbstractAssayController.update.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.AbstractAssay.form.update.button" />
  <mjl:command value="Delete" action="csu.mrc.ivcc.mdss.entomology.assay.AbstractAssayController.delete.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.AbstractAssay.form.delete.button" />
  <mjl:command value="Cancel" action="csu.mrc.ivcc.mdss.entomology.assay.AbstractAssayController.cancel.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.AbstractAssay.form.cancel.button" />
</mjl:form>
