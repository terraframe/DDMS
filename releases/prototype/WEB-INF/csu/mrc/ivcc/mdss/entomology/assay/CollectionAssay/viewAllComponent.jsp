...
<mjl:table var="item" query="${query}">
  <mjl:context action="csu.mrc.ivcc.mdss.entomology.assay.CollectionAssayController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink display="View" action="csu.mrc.ivcc.mdss.entomology.assay.CollectionAssayController.view.mojo" name="view.link">
...
<br />
<mjl:commandLink display="Create a new Collection Assay" action="csu.mrc.ivcc.mdss.entomology.assay.CollectionAssayController.newInstance.mojo" name="CollectionAssayController.newInstance" />
