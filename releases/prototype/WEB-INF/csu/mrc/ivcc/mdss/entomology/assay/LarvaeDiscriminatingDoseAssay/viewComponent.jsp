...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssay.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssay.form.id" method="POST">
  ...
  <dl>
    ...
    <dd>
      <mjl:commandLink display="${item.ageRange.keyName}" action="csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRangeController.view.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.LarvaeAgeRange.form.view.link">
  ...
  <mjl:command value="Edit" action="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssayController.edit.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssay.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssayController.viewAll.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.LarvaeDiscriminatingDoseAssay.viewAll.link" />
