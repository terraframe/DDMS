...
<mjl:form name="csu.mrc.ivcc.mdss.entomology.assay.molecular.AcHETestResult.form.name" id="csu.mrc.ivcc.mdss.entomology.assay.molecular.AcHETestResult.form.id" method="POST">
  ...
  <mjl:command value="Edit" action="csu.mrc.ivcc.mdss.entomology.assay.molecular.AcHETestResultController.edit.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.molecular.AcHETestResult.form.edit.button" />
  <br />
</mjl:form>
<dl>
</dl>
<mjl:commandLink display="View All" action="csu.mrc.ivcc.mdss.entomology.assay.molecular.AcHETestResultController.viewAll.mojo" name="csu.mrc.ivcc.mdss.entomology.assay.molecular.AcHETestResult.viewAll.link" />
