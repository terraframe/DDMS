...
public class ShapeFileAttributePage extends ShapefileBeanPage implements IInitPage, PropertyChangeListener, Reloadable
{
  ...
  public ShapeFileAttributePage(ShapeFileBean data)
  {
    ...
    setTitle(GISAdminLocalizer.getMessage("SHAPE_FILE_COLUMNS"));
    setDescription(GISAdminLocalizer.getMessage("SHAPE_FILE_ATTRIBUTES_DESC"));
  ...
  public void createControl(Composite parent)
  {
    ...
    new Label(composite, SWT.NULL).setText(GISAdminLocalizer.getMessage("GEO_ENTITY") + ": ");
    ...
    new Label(composite, SWT.NULL).setText(GISAdminLocalizer.getMessage("GEO_ID") + ": ");
    ...
    new Label(composite, SWT.NULL).setText(GISAdminLocalizer.getMessage("LOCATED_IN") + ": ");
    ...
    new Label(composite, SWT.NULL).setText(GISAdminLocalizer.getMessage("LOCATED_IN_SUBTYPE") + ": ");
