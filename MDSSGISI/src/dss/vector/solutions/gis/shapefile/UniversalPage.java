...
public class UniversalPage extends ShapefileBeanPage implements IInitPage, PropertyChangeListener, Reloadable
{
  ...
  public UniversalPage(ShapeFileBean data, GeoHierarchyView[] views)
  {
    ...
    setTitle(GISAdminLocalizer.getMessage("UNIVERSAL_TITLE"));
    setDescription(GISAdminLocalizer.getMessage("UNIVERSAL_DESC"));
  ...
  public void createControl(Composite parent)
  {
    ...
    new Label(composite, SWT.NULL).setText(GISAdminLocalizer.getMessage("UNIVERSAL") + ": ");
    ...
    new Label(composite, SWT.NULL).setText(GISAdminLocalizer.getMessage("TYPE") + ": ");
    ...
    new Label(composite, SWT.NULL).setText(GISAdminLocalizer.getMessage("SUBTYPE") + ": ");
