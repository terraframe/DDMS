...
public class ShapeFilePage extends WizardPage implements Reloadable
{
  ...
  {
    super(PAGE_NAME);
    setTitle(GISAdminLocalizer.getMessage("SHAPE_FILE_PAGE"));
    setDescription(GISAdminLocalizer.getMessage("SHAPE_FILE_DESC"));
  ...
  public void createControl(Composite parent)
  {
    ...
    label.setText(GISAdminLocalizer.getMessage("SHAPE_FILE") + ": ");
  ...
  private void openFileDialog()
  {
    ...
    dialog.setFilterNames(new String[] { GISAdminLocalizer.getMessage("SHAPE_FILES"), GISAdminLocalizer.getMessage("ALL_FILES") });
  ...
  private void processShapefile()
  {
    class ProcessShapefileRunner implements IRunnableWithProgress, Reloadable
    {
      ...
      {
        monitor.beginTask(GISAdminLocalizer.getMessage("READ_SHAPE_FILE"), -1);
    ...
    catch (Exception e)
    {
      ...
      if(msg == null)
      {
        msg = GISAdminLocalizer.getMessage("UNABLE_TO_READ_SHAPEFILE");
      }
//      e.printStackTrace();
