...
public class ShapeFileWizard extends Wizard implements Reloadable
{
  ...
  public ShapeFileWizard(GeoHierarchyView[] views)
  {
    ...
    setWindowTitle(GISAdminLocalizer.getMessage("SHAPE_FILE_WIZARD"));
  ...
  public boolean performFinish()
  {
    try
    {
      File file = new File(MainWindow.LOG_DIR + File.separator + SHAPEFILE_LOG_DIR + File.separator + System.currentTimeMillis() + MainWindow.LOG_EXT);
      ...
      if (logger.hasLogged())
      {
        String message = GISAdminLocalizer.getMessage("ERROR_IN_IMPORT") + " " + file.getAbsolutePath();
  ...
  private void handleException(Throwable throwable)
  {
    ...
    {
      String message = GISAdminLocalizer.getMessage("UNKNOWN_SHAPE_FILE_EXCEPTION");
