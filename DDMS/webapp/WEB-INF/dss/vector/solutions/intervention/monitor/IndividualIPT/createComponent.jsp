...
<dl>
  <mjl:form id="dss.vector.solutions.intervention.monitor.IndividualIPT.form.id" name="dss.vector.solutions.intervention.monitor.IndividualIPT.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.intervention.monitor.IndividualIPT.form.create.button" value="${Localized_Create}" action="dss.vector.solutions.intervention.monitor.IndividualIPTController.create.mojo" />
  </mjl:form>
</dl>
