  ...
  Instance : {
    ...
    <mjl:component item="${item}" param="dto">
      ...
      <mjl:dt attribute="geoId">
        <mdss:geo param="geoId" value="${geoId}" concrete="false" universals="${entityUniversals}" political="false" spray="true" id="geoId" classes="geoField" listener="MDSS.EfficacyAssayValidation.getInstance()" filter="${surface}" />      
      </mjl:dt>
