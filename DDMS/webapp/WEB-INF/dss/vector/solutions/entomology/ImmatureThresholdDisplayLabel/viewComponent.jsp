...
<dl>
  <mjl:form id="dss.vector.solutions.entomology.ImmatureThresholdDisplayLabel.form.id" name="dss.vector.solutions.entomology.ImmatureThresholdDisplayLabel.form.name" method="POST">
    ...
    <mjl:command name="dss.vector.solutions.entomology.ImmatureThresholdDisplayLabel.form.edit.button" value="${Localized_Edit}" action="dss.vector.solutions.entomology.ImmatureThresholdDisplayLabelController.edit.mojo" />
  </mjl:form>
</dl>
