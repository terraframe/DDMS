...
<c:set scope="request" var="page_title" value="View_All_ResistancePropertyDisplayLabel" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<mjl:table classes="displayTable" var="item" query="${query}" even="evenRow" odd="oddRow">
  <mjl:context action="dss.vector.solutions.entomology.ResistancePropertyDisplayLabelController.viewPage.mojo" />
  <mjl:columns>
