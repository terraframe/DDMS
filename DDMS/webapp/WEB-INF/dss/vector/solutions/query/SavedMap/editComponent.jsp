...
<dl>
  <mjl:form name="dss.vector.solutions.query.SavedMap.form.name" id="dss.vector.solutions.query.SavedMap.form.id" method="POST">
    ...
    <mjl:command value="${Localized_Update}" action="dss.vector.solutions.query.SavedMapController.update.mojo" name="dss.vector.solutions.query.SavedMap.form.update.button" />
    <mdss:localize key="Delete" var="Localized_Delete" />
    <mjl:command value="${Localized_Delete}" action="dss.vector.solutions.query.SavedMapController.delete.mojo" name="dss.vector.solutions.query.SavedMap.form.delete.button" />
