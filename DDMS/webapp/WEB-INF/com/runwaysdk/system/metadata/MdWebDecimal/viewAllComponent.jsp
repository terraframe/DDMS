...
<c:set scope="request" var="page_title" value="View_All_MdWebDecimal" />
<mjl:messages>
  <mjl:message />
</mjl:messages>
<mjl:table classes="displayTable" var="item" query="${query}" even="evenRow" odd="oddRow">
  <mjl:context action="com.runwaysdk.system.metadata.MdWebDecimalController.viewPage.mojo" />
  <mjl:columns>
    ...
    <mjl:freeColumn>
      ...
      <mjl:row>
        <mjl:commandLink name="view.link" action="com.runwaysdk.system.metadata.MdWebDecimalController.view.mojo">
...
<br />
<mjl:commandLink name="MdWebDecimalController.newInstance" action="com.runwaysdk.system.metadata.MdWebDecimalController.newInstance.mojo">
  <mdss:localize key="Create_a_new_MdWebDecimal" />
</mjl:commandLink>
