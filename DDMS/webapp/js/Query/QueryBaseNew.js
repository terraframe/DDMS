...
Mojo.Meta.newClass('MDSS.QueryBaseNew', {
  ...
  Instance : {
    ...
    _visibleAttributeHandler : function(e, attribute)
    {
      ...
      else
      {
        ...
        if(attribute instanceof MDSS.TermAttribute)
        {
  ...
  _setTextCriteriaFromLoad : function(checked, userAlias)
  {
    ...
    _loadQueryState : function(view)
    {
      ...
      if(dateRestrictions)
      {
        ...
        if(dateRestrictions.start)
        {
          ...
          {            
            ...
            thisRef._queryPanel.getStartDateCurrentDateCheck().disabled = true;
          }
          else
          {
            ...
            thisRef._queryPanel.getStartDate().disabled = true;
          }
        ...
        if(dateRestrictions.end)
        {
          ...
          {            
            ...
            thisRef._queryPanel.getEndDateCurrentDateCheck().disabled = true;
          }
          else
          {
            ...
            thisRef._queryPanel.getEndDate().disabled = true;
          }
      ...
      var aggregates = this._config.getTermAggregates();
