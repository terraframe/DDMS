...
<div id="app-container" class="container">
  ...
  <h2> <mdss:localize key="category.management.title"/> </h2>
  ...
  <div ng-if="category.management === null"><mdss:localize key='category.management.loadingData'/></div>
      ...
      <tbody>
        <tr ng-repeat="category in categories" class="fade-ngRepeat-item" ng-cloak>
          <td class="button-column">
            <a class="fa fa-tasks ico-edit" ng-click="ctrl.edit(category)" title="<mdss:localize key="category.management.editTooltip"/>"></a>                             
            <a class="fa fa-trash-o ico-remove" ng-click="ctrl.remove(category)" title="<mdss:localize key="category.management.removeTooltip"/>"></a>                       
          </td>
