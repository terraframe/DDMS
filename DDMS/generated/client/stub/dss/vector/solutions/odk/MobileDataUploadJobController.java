...
public class MobileDataUploadJobController extends MobileDataUploadJobControllerBase implements com.runwaysdk.generation.loader.Reloadable
{
  public static final String JSP_DIR = "WEB-INF/dss/vector/solutions/odk/MobileDataUploadJob/";
  public static final String LAYOUT = "/layout.jsp";
  
  public MobileDataUploadJobController(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse resp, java.lang.Boolean isAsynchronous)
  {
  ...
  public void edit(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      dss.vector.solutions.odk.MobileDataUploadJobDTO dto = dss.vector.solutions.odk.MobileDataUploadJobDTO.lock(super.getClientRequest(), id);
      req.setAttribute("runAsDimension", com.runwaysdk.system.metadata.MdDimensionDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("runAsUser", com.runwaysdk.system.SingleActorDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("_jobOperation", com.runwaysdk.system.scheduler.AllJobOperationDTO.allItems(super.getClientSession().getRequest()));
      req.setAttribute("item", dto);
  ...
  public void newInstance() throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      ...
      dss.vector.solutions.odk.MobileDataUploadJobDTO dto = new dss.vector.solutions.odk.MobileDataUploadJobDTO(clientRequest);
      req.setAttribute("runAsDimension", com.runwaysdk.system.metadata.MdDimensionDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("runAsUser", com.runwaysdk.system.SingleActorDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("_jobOperation", com.runwaysdk.system.scheduler.AllJobOperationDTO.allItems(super.getClientSession().getRequest()));
      req.setAttribute("item", dto);
  ...
  public void view(java.lang.String id) throws java.io.IOException, javax.servlet.ServletException
  {
    try
    {
      ...
      com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
      dss.vector.solutions.odk.MobileDataUploadJobDTO dto = dss.vector.solutions.odk.MobileDataUploadJobDTO.get(clientRequest, id);
      req.setAttribute("runAsDimension", com.runwaysdk.system.metadata.MdDimensionDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("runAsUser", com.runwaysdk.system.SingleActorDTO.getAllInstances(super.getClientSession().getRequest(), "keyName", true, 0, 0).getResultSet());
      req.setAttribute("_jobOperation", com.runwaysdk.system.scheduler.AllJobOperationDTO.allItems(super.getClientSession().getRequest()));
      req.setAttribute("item", dto);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.odk.MobileDataUploadJobQueryDTO query = dss.vector.solutions.odk.MobileDataUploadJobDTO.getAllInstances(clientRequest, null, true, 20, 1);
  ...
  {
    com.runwaysdk.constants.ClientRequestIF clientRequest = super.getClientRequest();
    dss.vector.solutions.odk.MobileDataUploadJobQueryDTO query = dss.vector.solutions.odk.MobileDataUploadJobDTO.getAllInstances(clientRequest, sortAttribute, isAscending, pageSize, pageNumber);
    req.setAttribute("query", query);
    render("viewAllComponent.jsp");
  }
