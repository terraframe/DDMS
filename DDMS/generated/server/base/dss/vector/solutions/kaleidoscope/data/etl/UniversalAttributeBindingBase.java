...
@com.runwaysdk.business.ClassSignature(hash = -1959946873)
/**
...
public abstract class UniversalAttributeBindingBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1959946873;
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.kaleidoscope.data.etl.UniversalAttributeBinding.CLASS);
  ...
  public dss.vector.solutions.kaleidoscope.data.etl.TargetFieldGeoEntityBinding getField()
  {
    ...
    {
      return dss.vector.solutions.kaleidoscope.data.etl.TargetFieldGeoEntityBinding.get(getValue(FIELD));
    }
  }
  ...
  public void setField(dss.vector.solutions.kaleidoscope.data.etl.TargetFieldGeoEntityBinding value)
  {
    if(value == null)
    {
      setValue(FIELD, "");
