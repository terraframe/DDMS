...
@com.runwaysdk.business.ClassSignature(hash = 1081821756)
/**
 ...
 */
public abstract class GeneratedDashboardBase extends com.runwaysdk.business.Business implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = 1081821756;
  
  public GeneratedDashboardBase()
  {
    super();
  }
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.kaleidoscope.dashboard.GeneratedDashboard.CLASS);
  ...
  public static com.runwaysdk.dataaccess.MdAttributeCharacterDAOIF getCycleLayerNameMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.kaleidoscope.dashboard.GeneratedDashboard.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeCharacterDAOIF)mdClassIF.definesAttribute(CYCLELAYERNAME);
  }
  ...
  public static com.runwaysdk.dataaccess.MdAttributeCharacterDAOIF getCycleUniversalMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.kaleidoscope.dashboard.GeneratedDashboard.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeCharacterDAOIF)mdClassIF.definesAttribute(CYCLEUNIVERSAL);
  }
  ...
  public static com.runwaysdk.dataaccess.MdAttributeCharacterDAOIF getFilterGeoEntityNameMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.kaleidoscope.dashboard.GeneratedDashboard.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeCharacterDAOIF)mdClassIF.definesAttribute(FILTERGEOENTITYNAME);
  }
  ...
  public static com.runwaysdk.dataaccess.MdAttributeCharacterDAOIF getFilterGeoIdMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.kaleidoscope.dashboard.GeneratedDashboard.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeCharacterDAOIF)mdClassIF.definesAttribute(FILTERGEOID);
  }
  ...
  public static com.runwaysdk.dataaccess.MdAttributeBlobDAOIF getMapImageMd()
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.kaleidoscope.dashboard.GeneratedDashboard.CLASS);
    return (com.runwaysdk.dataaccess.MdAttributeBlobDAOIF)mdClassIF.definesAttribute(MAPIMAGE);
  }
  ...
  public static GeneratedDashboardQuery getAllInstances(String sortAttribute, Boolean ascending, Integer pageSize, Integer pageNumber)
  {
    GeneratedDashboardQuery query = new GeneratedDashboardQuery(new com.runwaysdk.query.QueryFactory());
    com.runwaysdk.business.Entity.getAllInstances(query, sortAttribute, ascending, pageSize, pageNumber);
    return query;
  }
  
  public static GeneratedDashboard get(String id)
  {
    return (GeneratedDashboard) com.runwaysdk.business.Business.get(id);
  }
  
  public static GeneratedDashboard getByKey(String key)
  {
    return (GeneratedDashboard) com.runwaysdk.business.Business.get(CLASS, key);
  }
  
  public static GeneratedDashboard lock(java.lang.String id)
  {
    GeneratedDashboard _instance = GeneratedDashboard.get(id);
    _instance.lock();
    
    return _instance;
  }
  
  public static GeneratedDashboard unlock(java.lang.String id)
  {
    GeneratedDashboard _instance = GeneratedDashboard.get(id);
    _instance.unlock();
