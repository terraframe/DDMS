...
@com.runwaysdk.business.ClassSignature(hash = -1093397848)
/**
 ...
 */
public abstract class DashboardThematicStyleBase extends dss.vector.solutions.kaleidoscope.dashboard.DashboardStyle implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -1093397848;
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.kaleidoscope.dashboard.DashboardThematicStyle.CLASS);
  ...
  public java.util.List<dss.vector.solutions.kaleidoscope.dashboard.AllAggregationType> getSecondaryAggregationType()
  {
    return (java.util.List<dss.vector.solutions.kaleidoscope.dashboard.AllAggregationType>) getEnumValues(SECONDARYAGGREGATIONTYPE);
  }
  
  public void addSecondaryAggregationType(dss.vector.solutions.kaleidoscope.dashboard.AllAggregationType value)
  {
    if(value != null)
    {
  ...
  public void removeSecondaryAggregationType(dss.vector.solutions.kaleidoscope.dashboard.AllAggregationType value)
  {
    if(value != null)
    {
