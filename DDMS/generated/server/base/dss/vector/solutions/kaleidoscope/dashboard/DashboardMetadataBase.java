...
@com.runwaysdk.business.ClassSignature(hash = -294216323)
/**
...
public abstract class DashboardMetadataBase extends com.runwaysdk.business.Relationship implements com.runwaysdk.generation.loader.Reloadable
{
  ...
  private static final long serialVersionUID = -294216323;
  ...
  {
    com.runwaysdk.dataaccess.MdClassDAOIF mdClassIF = com.runwaysdk.dataaccess.metadata.MdClassDAO.getMdClassDAO(dss.vector.solutions.kaleidoscope.dashboard.DashboardMetadata.CLASS);
  ...
  public dss.vector.solutions.kaleidoscope.dashboard.Dashboard getParent()
  {
    return (dss.vector.solutions.kaleidoscope.dashboard.Dashboard) super.getParent();
  }
  
  public dss.vector.solutions.kaleidoscope.dashboard.MetadataWrapper getChild()
  {
    return (dss.vector.solutions.kaleidoscope.dashboard.MetadataWrapper) super.getChild();
  }
