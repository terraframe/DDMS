-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
-- pgRouting extension upgrade from 2.3.1 to 2.3.2
-- generated by tools/build-extension-update-files
-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
-- remove functions no longer in the 2.3.2 extension
DROP FUNCTION IF EXISTS _pgr_astar(text,bigint,bigint,boolean ,integer ,float ,float ,boolean ,out integer,out integer,out bigint,out bigint,out float,out float);
...
DROP FUNCTION IF EXISTS _pgr_maxflow(text,bigint,bigint,text ,out integer,out bigint,out bigint,out bigint,out bigint,out bigint );
DROP FUNCTION IF EXISTS _pgr_maxflow(text,bigint,anyarray,text ,out integer,out bigint,out bigint,out bigint,out bigint,out bigint );
DROP FUNCTION IF EXISTS _pgr_maxflow(text,anyarray,bigint,text ,out integer,out bigint,out bigint,out bigint,out bigint,out bigint );
DROP FUNCTION IF EXISTS _pgr_maxflow(text,anyarray,anyarray,text ,out integer,out bigint,out bigint,out bigint,out bigint,out bigint );
...
DROP FUNCTION IF EXISTS _pgr_pickdeliver(text,integer,float,float ,integer ,out integer,out integer,out integer,out bigint,out float,out float,out float,out float,out float );
...
DROP FUNCTION IF EXISTS _pgr_trsp(text,integer,float8,integer,float8,boolean,boolean,text );
...
DROP FUNCTION IF EXISTS pgr_tsp(text,bigint ,bigint ,float ,integer ,integer ,integer ,float ,float ,float ,boolean ,out integer,out bigint,out float,out float);
...
DROP FUNCTION IF EXISTS pgr_astar(text,bigint,bigint,boolean ,integer ,float ,float ,out integer,out integer,out bigint,out bigint,out float,out float);
...
DROP FUNCTION IF EXISTS pgr_contractgraph(text,bigint[],integer ,bigint[] ,boolean ,out integer,out text,out bigint,out bigint[],out bigint,out bigint,out float);
...
DROP FUNCTION IF EXISTS pgr_dijkstracostmatrix(text,anyarray,boolean ,out bigint,out bigint,out float);
...
DROP FUNCTION IF EXISTS pgr_edgedisjointpaths(in text,in bigint,in bigint,in boolean ,out integer,out integer,out bigint,out bigint );
DROP FUNCTION IF EXISTS pgr_edgedisjointpaths(in text,in bigint,in anyarray,in boolean ,out integer,out integer,out bigint,out bigint,out bigint );
DROP FUNCTION IF EXISTS pgr_edgedisjointpaths(in text,in anyarray,in bigint,in boolean ,out integer,out integer,out bigint,out bigint,out bigint );
DROP FUNCTION IF EXISTS pgr_edgedisjointpaths(in text,in anyarray,in anyarray,in boolean ,out integer,out integer,out bigint,out bigint,out bigint,out bigint );
DROP FUNCTION IF EXISTS pgr_endpoint(geometry);
DROP FUNCTION IF EXISTS pgr_euclediantsp(text,bigint ,bigint ,float ,integer ,integer ,integer ,float ,float ,float ,boolean ,out integer,out bigint,out float,out float);
...
DROP FUNCTION IF EXISTS pgr_maxflowboykovkolmogorov(text,bigint,bigint,out integer,out bigint,out bigint,out bigint,out bigint,out bigint );
DROP FUNCTION IF EXISTS pgr_maxflowboykovkolmogorov(text,bigint,anyarray,out integer,out bigint,out bigint,out bigint,out bigint,out bigint );
DROP FUNCTION IF EXISTS pgr_maxflowboykovkolmogorov(text,anyarray,bigint,out integer,out bigint,out bigint,out bigint,out bigint,out bigint );
DROP FUNCTION IF EXISTS pgr_maxflowboykovkolmogorov(text,anyarray,anyarray,out integer,out bigint,out bigint,out bigint,out bigint,out bigint );
DROP FUNCTION IF EXISTS pgr_maxflowedmondskarp(text,bigint,bigint,out integer,out bigint,out bigint,out bigint,out bigint,out bigint );
DROP FUNCTION IF EXISTS pgr_maxflowedmondskarp(text,bigint,anyarray,out integer,out bigint,out bigint,out bigint,out bigint,out bigint );
DROP FUNCTION IF EXISTS pgr_maxflowedmondskarp(text,anyarray,bigint,out integer,out bigint,out bigint,out bigint,out bigint,out bigint );
DROP FUNCTION IF EXISTS pgr_maxflowedmondskarp(text,anyarray,anyarray,out integer,out bigint,out bigint,out bigint,out bigint,out bigint );
DROP FUNCTION IF EXISTS pgr_maxflowpushrelabel(text,bigint,bigint,out integer,out bigint,out bigint,out bigint,out bigint,out bigint );
DROP FUNCTION IF EXISTS pgr_maxflowpushrelabel(text,bigint,anyarray,out integer,out bigint,out bigint,out bigint,out bigint,out bigint );
DROP FUNCTION IF EXISTS pgr_maxflowpushrelabel(text,anyarray,bigint,out integer,out bigint,out bigint,out bigint,out bigint,out bigint );
DROP FUNCTION IF EXISTS pgr_maxflowpushrelabel(text,anyarray,anyarray,out integer,out bigint,out bigint,out bigint,out bigint,out bigint );
DROP FUNCTION IF EXISTS pgr_maximumcardinalitymatching(text,boolean ,out integer,out bigint,out bigint,out bigint );
...
DROP FUNCTION IF EXISTS pgr_withpointscostmatrix(text,text,anyarray,boolean ,char ,out bigint,out bigint,out float);
