...
#	ExecWait `"$FPath\firefox.exe" "$INSTDIR\closeme.html"`
	...
	File /r /x .svn cache\global\*
	  ...
	  LogEx::Write "Searching for folders under $INSTDIR\tomcat\cache\global\*"
      ClearErrors
      ...
      Top:
        StrCmp $R1 "." Next
        StrCmp $R1 ".." Next
        IfFileExists "$INSTDIR\tomcat\cache\global\$R1\*.*" 0 Next
        # We found the cache!!
		LogEx::Write "Found a directory named [$R1]. Renaming to [$INSTDIR\tomcat\cache\global\$AppName_5bc784535e21ff17222e498cce8207ece6e49cf8]"
