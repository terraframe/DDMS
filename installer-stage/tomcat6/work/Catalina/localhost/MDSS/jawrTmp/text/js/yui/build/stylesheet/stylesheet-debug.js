...
return this;}
if(!StyleSheet.isValidSelector(sel)){YAHOO.log("Invalid selector '"+sel+"' passed to set (ignoring).",'warn','StyleSheet');return this;}
...
catch(e){YAHOO.log('Error assigning property "'+prop+'" to "'+css[prop]+"\" (ignored):\n"+e.message,'warn','StyleSheet');}}}}
