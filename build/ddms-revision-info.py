...
def writeRevisionInfo(nsisFile, projectRoot):
  ...
  replaceInFile(nsisFile, "BirtVersion", getModTime(projectRoot, "installer-stage/birt"))
  replaceInFile(nsisFile, "EclipseVersion", getModTime(projectRoot, "installer-stage/eclipse"))
  replaceInFile(nsisFile, "WebappsVersion", getModTime(projectRoot, "installer-stage/tomcat/webapps"))
  replaceInFile(nsisFile, "JavaVersion", getModTime(projectRoot, "installer-stage/Java"))
  replaceInFile(nsisFile, "TomcatVersion", getModTime(projectRoot, "installer-stage/tomcat"))
