 ...
 */
package dss.vector.solutions.kaleidoscope.oda.driver.ui.profile;
...
import dss.vector.solutions.kaleidoscope.oda.driver.CryptographySingleton;
import dss.vector.solutions.kaleidoscope.oda.driver.ui.GeoprismPlugin;
import dss.vector.solutions.kaleidoscope.oda.driver.ui.editors.IPageWrapper;
import dss.vector.solutions.kaleidoscope.oda.driver.ui.editors.PreferencePageWrapper;
import dss.vector.solutions.kaleidoscope.oda.driver.ui.editors.WizardPageWrapper;
import dss.vector.solutions.kaleidoscope.oda.driver.ui.util.Constants;
import dss.vector.solutions.kaleidoscope.oda.driver.ui.util.DriverLoader;
...
public class GeodashboardSelectionPageHelper implements ModifyListener
{
  ...
  /**
   * This method should be called in the following occations: 1. The value of inputed URL, username is changed 2. When the control is created.
   */
