 ...
 */
package dss.vector.solutions.kaleidoscope.oda.driver.ui;
...
import dss.vector.solutions.kaleidoscope.oda.driver.ui.ssl.SecureKeystoreManager;
...
public class GeoprismPlugin extends AbstractUIPlugin
{
  ...
  public GeoprismPlugin()
  {
    ...
    try
    {
      resourceBundle = ResourceBundle.getBundle("dss.vector.solutions.kaleidoscope.oda.driver.ui.nls.GeodashboardPluginResources"); //$NON-NLS-1$
    }
